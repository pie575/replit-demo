---
title: "Conversation и Project: что выбрать"
description: "Узнайте, когда стоит продолжать работу в Conversation, а когда перенести крупную задачу в Project."
sidebarTitle: "Conversation и Project: что выбрать"
tag: "New"
icon: "objects-column"
...
В Replit вы работаете в Conversation или создаёте Project. Conversation предназначены для вопросов, исследований, дальнейшей работы и Routines. Project — для создания приложений, слайдов и дизайнов.

[Узнайте, как преобразовать Conversation в Project.](/ru/ko/chat/continue-or-create-a-project)

<div id="section">
  ## Различия
</div>

Conversation и Project связаны между собой, но служат разным целям. Вот чем они отличаются:

| Область           | Conversation                                   | Project                                                                                                                                                |
| ----------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Подходит для      | Вопросы, исследование, Routines                 | Более глубокая работа по созданию и дизайну: приложения, слайды, дашборды, несколько артефактов                                                         |
| Структура         | Один тред                                       | Рабочее пространство Project с несколькими артефактами                                                                                                  |
| Фоновые задачи    | Недоступны                                      | Можно запускать параллельно                                                                                                                             |
| Routines          | Доступны                                        | Недоступны                                                                                                                                              |
| Интеграции        | Доступны                                        | Доступны                                                                                                                                                |
| Что можно создать | Ассеты: документы, изображения, таблицы и т. д. | Ассеты (документы, изображения, таблицы и т. д.), а также [артефакты](/ru/ko/features/projects-and-artifacts/artifacts): слайды, приложения, сайты и т. д. |
| Publishing        | Публикация невозможна                           | Можно опубликовать и сделать общедоступным                                                                                                              |

<Frame>
  <img src="/assets/mirror/conversation-and-project-icons-025a17613daa.png" alt="Боковая панель Replit с иконкой чата для Conversation и иконкой сетки для Project" width="466" height="290" data-path="images/chat/conversation-and-project-icons.png" />
</Frame>