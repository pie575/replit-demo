---
title: "上传并使用文件"
description: "将相关的文档、电子表格、图片和截图添加到 Conversation 中，并告诉 Replit 如何利用这些信息来处理你的请求。"
sidebarTitle: "上传并使用文件"
icon: "file-arrow-up"
...
上传文档、电子表格、图片和截图，比费力说明更能轻松地向 Replit 传达证据、需求和视觉方向。

<div id="section">
  ## 如何上传文件
</div>

点击提示词框中的**加号**按钮，然后选择**上传文件**。你也可以将文件拖放到提示词框中。请在发送需要该文件的请求前先添加文件。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示词框的加号菜单，第一个选项为“上传文件”" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* 分析电子表格。
* 针对 PDF 提问。
* 让 Replit 根据截图创建或改进设计。
* 向 Replit 说明你要构建的应用的方向或相关信息。
