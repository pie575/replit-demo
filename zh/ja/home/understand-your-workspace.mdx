---
title: "了解工作区"
description: "了解 Replit 工作区如何将人员、项目、对话、Routine、数据、集成和安全功能整合在一起。"
---
...
Replit 工作区汇集了围绕某个想法所需的一切。
通过将[项目](/zh/ja/home/projects)、[对话](/zh/ja/home/conversations)、
[Routine](/zh/ja/chat/routines)和集成整合在一起，
助您从最初的疑问走向有价值的成果。
...
在着手将咖啡店的想法变为现实之前，先为它准备一个专属空间。这个
工作区会随着启动工作的推进，将各项内容集中在一起。

* 用于完善概念和调研当地市场的 对话
* 为计划补充实用背景信息的文件和已连接的工具
* 后续用于监测竞争对手和市场变化的 Routine
* 最终将设计并发布的网站

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="显示 Projects、Conversations、Routines、建议提示词和消息框的 Demo 工作区 Replit 主页" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

这个项目从提示框开始。你可以在这里开启 对话，向 Replit 初步介绍你想创建的
咖啡店。
...
工作区集中管理成员、设置、共享资源、集成和账单。您的访问权限决定您可以查看和管理的内容。

工作区设置和组织管理选项与用于调整 Agent 响应请求方式的设置相互独立。

在发布过程中，您随时可以返回工作区，查看支持发布所需的一切资源。

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ja/home/start-a-conversation">
    ...
    <p>描述您想实现的目标，开始打造您的咖啡店。</p>
    <div className="chat-card-link">了解更多 →</div>
  </a>

  <a className="chat-example has-visual" href="/zh/ja/features/collaboration/workspaces">
...
接下来，通过[开始对话](/zh/ja/home/start-a-conversation)，开始将您的咖啡店创意变为现实。