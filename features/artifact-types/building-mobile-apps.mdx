...
description: "Learn how to build a native mobile app with Agent, test it on your phone, and submit to App Review for App Store publishing."
icon: "mobile-screen"
---
...
<Steps>
  <Step title="Open your mobile project">
    Open a project that has a mobile artifact.
  </Step>

  <Step title="Pick your device">
  ...
  <Step title="Interact like a real device">
...
<AccordionGroup>
  ...
  <Accordion title="Should I test in the Project Editor simulator or on a real phone?">
