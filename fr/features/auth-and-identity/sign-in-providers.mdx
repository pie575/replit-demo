...
description: "Configurez des identifiants OAuth personnalisés pour la connexion avec Google, GitHub, Apple et X sur les applications qui utilisent Clerk Auth."
---
