---
title: "Добро пожаловать в Replit"
description: "Узнайте, как Replit превращает идеи, повседневные задачи и интеллект в полезные результаты."
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      <div className="welcome-eyebrow">Начало работы</div>
      <h1 id="welcome-home-heading">Добро пожаловать в Replit</h1>
      <p>Превращайте идеи, повседневные задачи и знания в полезные результаты.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/ru/ko/home/get-started">Начать работу <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/ru/use-cases">Посмотреть примеры использования</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Пошаговое знакомство с Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Сайт кофейни с заголовком «Тихое пространство для повседневной жизни»" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Узнайте, как превратить идею в готовый сайт
      </div>

      <p>
        Пройдите весь путь с пошаговыми инструкциями — от первого диалога до исследования, планирования, дизайна и публикации.
      </p>

      <a className="welcome-journey-link" href="/ru/ko/home/get-started">
        Начать путь <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    <h2 className="welcome-section-heading" id="welcome-use-cases-heading">
      Что можно делать в Replit?
    </h2>

    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/ru/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Перед каждой встречей с клиентом получайте бриф с ключевыми моментами.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Превращайте необработанную обратную связь в темы и практические рекомендации.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Находите и фильтруйте кандидатов с помощью подключённого контекста.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Отслеживайте важные обсуждения и оперативно делитесь ими.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Создать еженедельный отчёт о продажах
          </div>

          <p>Превратите актуальные данные воронки продаж в понятный отчёт.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/track-subscriptions">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Отслеживайте подписки
          </div>

          <p>Находите регулярные платежи и рассчитывайте ежемесячные расходы.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/ru/use-cases">
        Посмотреть примеры использования <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/ru/ko/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Небольшое окно чата, представляющее Replit Chat">
        ...
        <p>
          Начните с разговора. Задавайте вопросы, исследуйте идеи и
          документируйте планы.
        </p>

        <div className="welcome-product-link">
          Начать чат <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/ko/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Редактор кода и предпросмотр в реальном времени, представляющие Replit Build">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Превращайте идеи в реальные приложения и сайты. Уверенно
          создавайте, совершенствуйте и публикуйте их.
        </p>

        <div className="welcome-product-link">
          Начать сборку <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/ko/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Выбранная композиция на холсте, представляющая Replit Design">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Создавайте красивые интерфейсы и контент. Совершенствуйте
          макеты, компоненты и пользовательский опыт.
        </p>

        <div className="welcome-product-link">
          Начать дизайн <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Начните работу с Replit</h2>
      <p>Выберите, где хотите использовать Replit, затем войдите в систему или создайте учётную запись. Вы можете начать в веб-версии, настольном или мобильном приложении.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Веб</strong><b aria-hidden="true">→</b><small>Открыть в браузере</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>Настольное приложение</strong><b aria-hidden="true">→</b><small>macOS и Windows</small></a>
      <a className="welcome-access-card" href="https://replit.com/mobile" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▯</span><strong>Мобильное приложение</strong><b aria-hidden="true">→</b><small>iOS и Android</small></a>
    </div>
  </section>
</div>