---
title: "Téléverser et utiliser des fichiers"
description: "Ajoutez à la Conversation des documents, feuilles de calcul, images et captures d’écran pertinents, puis indiquez à Replit comment utiliser ces informations pour répondre à votre demande."
sidebarTitle: "Téléverser et utiliser des fichiers"
icon: "file-arrow-up"
...
En téléversant des documents, des feuilles de calcul, des images et des captures d’écran, vous pouvez communiquer plus facilement à Replit des éléments probants,
des exigences et des orientations visuelles qu’en les décrivant.

<div id="section">
  ## Comment téléverser des fichiers
</div>

Dans la zone de prompt, sélectionnez le bouton **plus**, puis **Upload a file**. Vous pouvez également
glisser-déposer des fichiers dans la zone de prompt. Ajoutez les fichiers avant d’envoyer une
demande qui en dépend.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu plus de la zone de prompt avec Upload a file comme première option" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

<div id="section-2">
  ## Exemples d&#39;utilisation des fichiers
</div>

* Analysez des feuilles de calcul.
* Posez des questions sur des PDF.
* Demandez à Replit de créer ou d&#39;affiner un design à partir de captures d&#39;écran.
* Donnez à Replit des indications ou des informations sur l&#39;application que vous souhaitez créer.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ko/chat/upload-and-use-files">
    ...
    <p>Découvrez un exemple complet pour comprendre et analyser des fichiers.</p>
