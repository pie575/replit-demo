---
title: "Conversas x Projects"
description: "Entenda quando continuar em uma Conversa e quando transformar um trabalho substancial em um Project."
sidebarTitle: "Conversas x Projects"
tag: "New"
icon: "objects-column"
...
Quando você usa o Replit, está trabalhando em uma Conversa ou construindo um Project. As Conversas servem para perguntas, exploração, acompanhamentos e Routines. Os Projects servem para construir aplicações e criar apresentações e designs.

[Saiba como transformar uma Conversa em um Project.](/pt/chat/continue-or-create-a-project)

## Como eles diferem

Embora estejam conectados, Conversas e Projects têm propósitos diferentes. Veja como eles diferem:

| Área                     | Conversas                                    | Projects                                                                                                                                           |
| ------------------------ | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| Melhor para              | Perguntas, exploração e Routines             | Trabalho mais profundo de construção e design, como apps, apresentações, dashboards e múltiplos artefatos                                          |
| Estrutura                | Uma única thread                             | Um espaço de trabalho de Project com múltiplos artefatos                                                                                           |
| Tarefas em segundo plano | Não disponível                               | Podem ser executadas em paralelo                                                                                                                   |
| Routines                 | Disponível                                   | Não disponível                                                                                                                                     |
| Integrações              | Disponível                                   | Disponível                                                                                                                                         |
| Pode criar               | Ativos, como documentos, imagens e planilhas | Ativos, como documentos, imagens e planilhas, além de [Artifacts](/pt/features/projects-and-artifacts/artifacts), como apresentações, apps e sites |
| Publicação               | Não pode ser publicada                       | Pode ser publicado e tornado público                                                                                                               |

<Frame>
  <img src="/assets/mirror/conversation-and-project-icons-025a17613daa.png" alt="Barra lateral do Replit mostrando o ícone de chat para uma Conversa e o ícone de grade para um Project" width="466" height="290" data-path="images/chat/conversation-and-project-icons.png" />
</Frame>
