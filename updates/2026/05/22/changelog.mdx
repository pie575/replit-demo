...
<Frame>
  <img src="/assets/mirror/visual-editor-layout-6379783e1802.png" alt="Visual Editor right pane with a flex container selected, showing the Layout section with Alignment 3x3 dot picker, Direction arrow buttons, Gap input with adjacent space-between toggle, Outer space inputs for each side, and Inner space inputs" width="1220" height="977" data-path="images/changelog/2026-05-22/visual-editor-layout.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/power-mode-nudge-b354634fda0b.png" alt="Power Mode nudge card in the Agent chat showing the prompt 'Not quite there? Switch to Power Mode for stronger performance.' with Dismiss and Switch to Power buttons" width="737" height="227" data-path="images/changelog/2026-05-22/power-mode-nudge.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/task-settings-dropdown-6ed9ba5282d9.png" alt="Task settings dropdown open on a task card showing Apply changes, Rename, Review changes, and Cancel actions in a fixed-width popover" width="858" height="536" data-path="images/changelog/2026-05-22/task-settings-dropdown.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/browserbase-connector-picker-b62ba8a01225.png" alt="Agent chat composer with /browser typed in the input, showing the Connectors popover above the input box with Browserbase as the matching connector and an Enter hint" width="450" height="154" data-path="images/changelog/2026-05-22/browserbase-connector-picker.png" />
</Frame>
