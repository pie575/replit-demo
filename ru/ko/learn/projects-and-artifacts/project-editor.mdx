...
description: "Узнайте, что такое Project Editor: общайтесь с Agent, наблюдайте за созданием приложения и управляйте всем в главном рабочем пространстве Replit."
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="Главный экран Replit Project Editor с полем для ввода промпта с описанием того, что вы хотите создать" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>
...
Project Editor — ваша основная рабочая среда в Replit: здесь вы начинаете разработку, управляете проектами и видите, как ваши приложения становятся реальностью. Опишите, что хотите создать, и [Agent](/ru/ko/features/agent/overview) напишет код, настроит проект и покажет предпросмотр в реальном времени.

<div id="section">
  ## Начало работы
</div>

Введите в поле промпта описание того, что хотите создать. Опишите идею простыми словами — «трекер бюджета с диаграммами расходов», «лендинг для моей кофейни», «генератор комиксов с ИИ для детей» — и Agent сделает всё остальное.

<AgentInput />

Также можно выбрать тип проекта в карусели, чтобы указать Agent желаемый тип результата: веб-приложение, мобильное приложение, слайды, дизайн и т. д. Или пропустите выбор и просто опишите свою идею — Agent автоматически подберёт подходящие настройки.

<AgentCarousel />

Чтобы начать прямо сейчас, следуйте руководству [Создание первого приложения](/ru/ko/build/your-first-app).

<div id="plan">
  ## Режим Plan
</div>

Режим Plan позволяет проводить мозговой штурм, задавать вопросы и планировать работу над проектом. Создайте упорядоченный список задач, который Agent сможет проверить и доработать. Когда план вас устроит, утвердите его — и Agent начнёт разработку. В режиме Plan также можно задавать вопросы и прорабатывать идеи: Agent не будет вносить изменения, пока вы не выйдете из этого режима.

<AgentInput highlightPlan={true} showTypewriter={false} />

Переключить режим Plan можно кнопкой в нижней части поля ввода. Подробнее см. в [руководстве по режиму Plan](/ru/ko/features/agent/plan-mode).

<div id="section-2">
  ## Что можно создать
</div>

Выберите тип проекта, чтобы сообщить Agent, что вы хотите создать, или опишите свою идею, и Agent подберёт подходящую конфигурацию.

* **Веб-приложения** — панели управления, внутренние инструменты, SaaS-продукты, лендинги
...
* **Дизайн** — визуальные макеты и прототипы в [Design Canvas](/ru/ko/design/canvas)
* **Визуализация данных** — диаграммы, панели управления и инструменты на основе баз данных
...
Когда Agent начнёт создавать приложение, в Project Editor вы увидите, как формируется проект. С одной стороны находится чат с Agent, а с другой — интерактивный предпросмотр в реальном времени приложения.

<div id="section-3">
  ### Потоки
</div>

Все взаимодействия с Agent происходят в потоках. В основном потоке вы описываете желаемый результат и наблюдаете, как Agent разрабатывает приложение. При использовании [системы задач](/ru/ko/core-concepts/agent/task-system) у каждой фоновой задачи есть собственный поток, что позволяет Agent не смешивать диалоги и изолировать задачи.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Поток с вашим промптом и разработкой проекта с помощью Agent" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>
...
На доске задач задачи распределены по столбцам **Drafts**, **Active**, **Ready** и **Done**. По мере выполнения они перемещаются слева направо, поэтому вы сразу видите запланированные задачи, задачи, над которыми работает Agent, и завершённые задачи. Подробнее см. в разделе [Система задач](/ru/ko/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Доска задач со столбцами Drafts, Active, Ready и Done" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>
...
Design Canvas — визуальный редактор для создания и доработки макетов перед коммитом кода. Перетаскивайте элементы, настраивайте макеты, дорабатывайте дизайн, а затем поручите Agent превратить его в работающее приложение. Подробнее — в разделе [Design Canvas](/ru/ko/design/canvas).

<div id="section-5">
  ## Совместная работа
</div>

Создайте командное рабочее пространство и разрабатывайте приложения вместе в Build. Приглашайте участников команды, делитесь проектами и работайте над одним приложением в реальном времени. Подробнее о настройках команды см. в разделе [Командные рабочие пространства](/ru/ko/features/collaboration/team-workspaces), а о совместной работе на уровне проекта — в разделе [Приглашение участников команды](/ru/ko/build/invite-teammates).

<div id="section-6">
  ## Импорт кода и дизайна
</div>

Уже есть проект? Импортируйте его в Replit из GitHub или Figma либо загрузите файлы напрямую. Agent продолжит работу с того места, где вы остановились, и поможет развивать проект на основе существующего кода или дизайна. См. [Импорт в Replit](/ru/ko/build/import-from-providers).
...
<CardGroup cols={2}>
  <Card title="Редактор и инструменты" href="/ru/ko/features/editor/editor-and-tools" icon="window-restore">
    Основная панель для предпросмотра приложения, вывода консоли и других инструментов
  </Card>

  <Card title="Настройки приложения" href="/ru/ko/features/project-setup/configuration" icon="gear">
    Настройки приложения, зависимости, секреты и конфигурация окружения
  </Card>

  <Card title="Управление версиями" href="/ru/ko/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Отслеживание изменений, откат к предыдущим версиям и управление историей приложения
  </Card>

  <Card title="Публикация" href="/ru/ko/learn/projects-and-artifacts/replit-deployments" icon="rocket">
    Задеплойте приложение по общедоступному URL, чтобы оно стало доступно всем
  </Card>
</CardGroup>
...
<Accordion title="Нужно ли уметь программировать?">
  Нет. Опишите, что вы хотите, простым языком, и Agent позаботится о технических деталях. При желании вы можете редактировать всё самостоятельно.
</Accordion>

<Accordion title="Что произойдет, если я закрою браузер?">
  Проекты сохраняются в облаке. Вы можете вернуться в любое время и продолжить с того места, где остановились: файлы, история и запущенные приложения будут сохранены.
</Accordion>

<Accordion title="Можно ли работать вместе с другими людьми?">
  Да. Вы можете приглашать соавторов в отдельный проект или создать командное рабочее пространство, участники которого получат доступ ко всем проектам. См. [командные рабочие пространства](/ru/ko/features/collaboration/team-workspaces) и [Приглашение участников команды](/ru/ko/build/invite-teammates).
</Accordion>

<Accordion title="Как опубликовать приложение?">
  Когда приложение будет готово, опубликуйте его по публичному URL прямо из Project Editor. См. [деплой](/ru/ko/learn/projects-and-artifacts/replit-deployments).
</Accordion>
...
Project Editor доступен на всех тарифах. Некоторые функции, например расширенные вычислительные ресурсы и постоянный деплой, доступны только на платных тарифах. Подробнее см. в разделе [Оплата](/ru/ko/billing/ai-billing).