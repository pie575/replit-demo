...
<Accordion title="Como acessar os Reserved VM Deployments">
...
Para mais informações sobre configuração de portas, consulte [Ports](/pt/core-concepts/project-editor/app-setup/ports/).

## Próximos passos

Para saber mais sobre publicação, consulte os seguintes recursos:

* [Monitoramento do App Publicado](/pt/cloud-services/deployments/monitoring-a-deployment/): Saiba como visualizar logs e monitorar o seu deployment agendado.
