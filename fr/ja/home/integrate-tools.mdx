...
description: "Connectez vos fichiers et vos outils pour donner à Replit le contexte nécessaire à l'élaboration du plan de lancement de votre café."
---
...
Maintenant que vous connaissez les intégrations, mettons-les à profit pour le
lancement de votre café.

Vous avez déjà choisi votre piste : créer un **café de quartier** plutôt qu&#39;un bar
destiné aux navetteurs près de la gare. Donnez à Replit les éléments nécessaires
pour transformer cette piste en un plan concret.

Les intégrations connectent Replit aux outils et aux fichiers que vous utilisez
déjà. Replit peut ainsi récupérer les informations pertinentes et effectuer les
actions nécessaires à vos tâches. Vous pouvez connecter plus de 450 services,
dont **[Slack](/fr/ja/features/integrations/overview#connectors)**,
**[Google Drive](/fr/ja/features/integrations/overview#connectors)**,
**[Notion](/fr/ja/features/integrations/overview#connectors)** et
**[Salesforce](/fr/ja/features/integrations/overview#connectors)**.

Pour ce café, Google Drive permet à Replit d&#39;accéder au budget, aux notes sur
l&#39;emplacement, aux idées de menu, aux photos et aux références visuelles. Notion
offre un espace unique où consigner le plan de lancement, les décisions prises
et les questions en suspens.

En savoir plus sur la façon d&#39;[Connecter vos outils](/fr/ja/chat/integrate-your-tools).

<Steps>
  <Step title="Demander à Replit de rassembler les éléments">
    Commencez par la demande suivante. Replit identifie ce dont il a besoin pour
    finaliser le plan et vous demande de connecter les services auxquels il doit accéder.

    <AiPrompt>
      À partir des fichiers de mon café, crée un plan de lancement pour le premier mois
      d&#39;un café de quartier. Mets à jour les hypothèses pertinentes, puis consigne le
      concept, les décisions clés, les questions en suspens et la liste de contrôle du
      lancement dans Notion.
    </AiPrompt>
  </Step>

  <Step title="Connecter Google Drive lorsque Replit le demande">
    Autorisez la connexion à Google Drive afin que Replit puisse consulter les éléments
    qu&#39;il souhaite utiliser. Replit ouvre la demande de connexion directement dans la conversation.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit demandant de connecter Google Drive pour consulter les fichiers du café" />
  </Step>

  <Step title="Connecter Notion lorsque Replit doit documenter le plan">
    Autorisez Notion lorsque Replit vous le demande pour rédiger le brief de lancement.
    Vous pouvez ainsi regrouper au même endroit le concept, les décisions, les questions
    en suspens et la liste de contrôle.
  </Step>
</Steps>

Google Drive fournit à Replit les éléments concrets sur lesquels fonder son travail. Notion réunit
au même endroit un plan qui évolue au fil des questions auxquelles vous répondez
et des décisions que vous prenez.

En savoir plus sur [l&#39;ajout de contexte](/fr/ja/chat/add-context), le [téléversement de fichiers](/fr/ja/chat/upload-and-use-files)
et l&#39;[intégration de vos outils](/fr/ja/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ja/home/watch-the-competition">
    ...
    <div className="chat-card-title">Garder un œil sur la concurrence</div>
    <p>Pendant que vous préparez votre lancement, mettez en place une routine qui surveille les évolutions.</p>
