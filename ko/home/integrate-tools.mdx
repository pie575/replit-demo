---
title: "도구 통합"
description: "커피숍 출시 계획을 만드는 데 필요한 맥락을 Replit에 제공하는 파일과 도구를 연결하세요."
---
...
<Steps>
  ...
  <Step title="Replit이 요청하면 Google Drive 연결하기">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="카페 파일을 검토할 수 있도록 Google Drive 연결을 요청하는 Replit" />
  </Step>
