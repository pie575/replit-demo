...
description: "Transformez un CSV public, une feuille de calcul, une base de données, un connecteur d'entrepôt ou une API en tableau de bord qui répond à une question claire."
---
...
Les tableaux de bord peuvent aussi prendre en charge l'export PDF, l'export CSV des graphiques, le rafraîchissement, le rafraîchissement automatique, le mode clair/sombre et les résumés d'analyse. Consultez [Visualisation de données](/fr/features/artifact-types/data-apps) pour la vue d'ensemble conceptuelle.
