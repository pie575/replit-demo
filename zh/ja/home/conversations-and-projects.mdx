---
title: "对话与项目"
description: "了解何时在对话中继续工作，以及何时使用项目进行完整的开发和设计。"
---
...
您已经调研了周边地区、连接了工具，并制定了发布计划。接下来，终于到了让大家了解您的咖啡店的时候了。为此，您将创建一个开业公告网站。

开始之前，了解这项工作在 Replit 中的两个位置——对话和项目——分别承担什么作用，会很有帮助。

<div id="section">
  ## 从计划到项目
</div>

咖啡店的上线始于一次对话。在这里，您将想法付诸实践，
调研市场、连接工具并创建例行任务。

现在，您已准备好构建开业公告网站。项目是开展这类正式
设计和构建工作的场所。Replit 可以利用对话中已有的上下文，因此您
无需从头再来。
...
**对话**是一个线程，你可以在其中提问、探索信息、运行例行任务，并通过后续跟进继续开展
工作。在此示例中，咖啡店调研和发布计划都保存在这里。

<div id="section-3">
  ## 什么是项目？
</div>

**项目**是用于开展正式构建和设计工作的持久化、结构化空间。
在此示例中，你可以在这里创建并不断完善开业公告网站。
...
| 领域   | 对话                   | 项目                     |
| ---- | -------------------- | ---------------------- |
| 擅长事项 | 探索想法、调研竞争对手、开展每周市场观察 | 设计和构建开业公告网站            |
| 结构   | 包含研究、决策和后续跟进的单个线程    | 为网站、其设计及其他构建成果提供的结构化空间 |
| 例行任务 | 创建和管理定期调研            | 使用返回对话的结果              |
| 上下文  | 保留迄今为止指导你的发布计划       | 以在对话中确立的方向为起点          |

想提问或探索时，请从对话开始。准备好构建后，再转到项目中。这样交接后，你已确立的方向将得以保留。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ja/chat/conversations">
    ...
    <div className="chat-card-title">对话</div>

    <p>
      了解对话如何支持提问、探索、例行任务和成果产出。
    </p>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ja/home/design-an-opening-site">
    <div className="chat-use-case-visual">
    ...
    <div className="chat-example-tag">开业公告网站</div>
    <div className="chat-card-title">设计开业公告网站</div>
    <p>使用 对话 和发布计划，为你的咖啡馆打造网站。</p>
