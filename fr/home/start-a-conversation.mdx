...
description: "Démarrez une Conversation avec une simple question, une recherche sur le Web ou du contexte connecté, puis choisissez la suite."
sidebarTitle: "Démarrer une conversation"
icon: "comments"
...
Votre Workspace est prêt. Il est maintenant temps de faire avancer votre idée de café.
Lancez une [conversation](/fr/chat/conversations), expliquez à Replit ce que vous souhaitez
créer et transformez cette première idée en véritable plan de lancement.

<div id="start-a-new-conversation">
  ## Démarrer une nouvelle conversation
</div>

Sélectionnez **New** dans la barre latérale de Replit. Vous ouvrirez ainsi la conversation dans laquelle vous affinerez le concept, étudierez le marché et préparerez le lancement.
...
<div id="explore-the-prompt-box">
  ## Découvrir le champ de prompt
</div>

Après avoir sélectionné **New**, examinez le champ de prompt. C&#39;est là que vous
donnerez des indications à Replit, ajouterez du contexte utile et poursuivrez le lancement du café.
L&#39;étape suivante consiste à rédiger votre premier prompt.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu Plus du champ de prompt proposant des options pour téléverser un fichier, créer quelque chose, importer un projet, utiliser une compétence ou un système de design et ajouter une intégration" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/home/describe-your-idea">
    ...
    <div className="chat-card-title">Donnez forme au concept</div>
