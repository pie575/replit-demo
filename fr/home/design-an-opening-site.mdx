---
title: "Concevez un site d'ouverture"
description: "Transformez le plan de lancement du café en un design pour un site « ouverture prochaine »."
---
...
<Steps>
  <Step title="Passez en revue le premier site">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/opening-site-preview-269c92373f00.jpg" alt="Aperçu du site d'ouverture du café avec les contrôles de publication dans Replit" />
  </Step>
  ...
  <Step title="Ouvrez Design">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/open-design-94e3ca17d3e8.jpg" alt="Menu Design de Replit ouvert au-dessus d'un site de café « ouverture prochaine »" />
  </Step>
  ...
  <Step title="Passez en revue le design">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/review-updated-site-design-d8550c0887c0.jpg" alt="Design mis à jour du site d'ouverture du café avec une image de cappuccino générée dans la section hero" />
  </Step>
  ...
  <Step title="Explorez différentes mises en page">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/explore-design-directions-af53342d08e9.jpg" alt="Prochaines étapes suggérées de Replit Design pour réimaginer, essayer des mises en page, et affiner un site de café" />
  </Step>
  ...
  <Step title="Ajoutez un asset image">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/open-generate-menu-c69c7736a0b9.png" alt="Menu Generate dans le canvas de Replit Design avec les options Design, Image, Video, et Vector Graphic" />

    <CoffeeShopScreenshotFrame src="/assets/mirror/write-image-request-61a1e519ba91.png" alt="Prompt de génération d'image pour une image de cappuccino dans le canvas de Replit Design" />
  </Step>
  ...
  <Step title="Utilisez le nouvel asset dans le site">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/replace-hero-image-1d797508fe6c.jpg" alt="Image de cappuccino générée sélectionnée dans le canvas de Replit Design avec une demande de remplacement de l'image hero du site web" />
  </Step>
