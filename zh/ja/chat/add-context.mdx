---
title: "添加上下文"
description: "把相关文件、信息来源、已连接的工具和现有成果提供给 Replit，帮助它理解你们的对话。"
sidebarTitle: "添加上下文"
icon: "paperclip"
...
如果有助于 Replit 理解你的请求，可以添加相关的上下文或工具。有了有用的上下文，Replit 能更准确地把握你的意图，产出的质量也会更高。

<div id="section">
  ## 如何添加上下文
</div>

在 prompt 框中选择**加号**菜单，即可上传文件、导入已有项目、使用 skill 和设计系统，或添加集成。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="prompt 框的加号菜单，其中依次为上传文件、新建、导入已有项目、使用 skill、使用设计系统、添加集成" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
你可以添加文件、截图和图片、网络来源与研究结果，以及已连接的工具。选择对当前任务有帮助的信息来源。

* **[文件、截图和图片](/zh/ja/chat/upload-and-use-files)：** 添加包含有用证据或需求的文档、电子表格、导出数据、截图和视觉参考资料。
* **[网络来源与研究](/zh/ja/features/agent/web-search)：** 如果最新信息或外部视角有助于改善结果，请让 Replit 进行网络搜索。
* **[集成](/zh/ja/chat/integrate-your-tools)：** 连接所需工具，并告知 Replit 应考虑哪些服务、频道、记录及其他信息。
* **[设计上下文](/zh/ja/chat/work-with-figma)：** 当布局、层级结构和视觉方向很重要时，请附加 Figma 画框。
* **[现有工作](/zh/ja/chat/import-a-project)：** 如果你想基于代码、设计或在其他地方创建的内容继续构建，请导入项目。导入项目不同于将文件作为证据附加。

你也可以粘贴与请求相关的链接，或让 Replit 进行网络搜索。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ja/chat/upload-and-use-files">
    <FilesCardVisual />
  ...
  <a className="chat-example has-visual" href="/zh/ja/chat/work-with-figma">
    <FigmaCardVisual />
    ...
    <p>当视觉方向很重要时，指定使用特定的画框。</p>
    <div className="chat-card-link">了解更多 →</div>
  </a>

  <a className="chat-example has-visual" href="/zh/ja/chat/integrate-your-tools">
  ...
  <a className="chat-example has-visual" href="/zh/ja/chat/import-a-project">
    ...
    <div className="chat-card-title">导入已有项目</div>

    <p>
      在已有的代码、设计或其他项目成果基础上继续构建。
    </p>
...
如需获取最新的公开信息，请参阅[网页搜索指南](/zh/ja/features/agent/web-search)。对于支持的工具和客户端，[MCP](/zh/ja/chat/connect-through-mcp) 是另一种扩展方式。