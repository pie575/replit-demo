---
title: "Comprendre votre workspace"
description: "Découvrez comment votre Workspace Replit rassemble les utilisateurs, les Projects, les Conversations, les Routines, les données, les intégrations et les outils de sécurité."
sidebarTitle: "Comprendre votre workspace"
icon: "briefcase"
...
Votre Workspace Replit rassemble tout ce qui se rapporte à une idée. Il réunit les
[Projects](/fr/home/projects), les [Conversations](/fr/home/conversations), les
[Routines](/fr/chat/routines) et les intégrations, afin de vous permettre de passer d&#39;une première
question à un résultat concret.

<div id="set-up-the-coffee-shop-project">
  ## Configurez le projet de café
</div>

Avant de commencer à développer votre idée de café, créez-lui un espace dédié. Ce Workspace
regroupera tous les éléments nécessaires au lancement à mesure que le projet évolue :

* Une conversation pour développer le concept et étudier le marché local
* Des fichiers et des outils connectés qui apportent un contexte utile au projet
* Une Routine qui surveillera ultérieurement la concurrence et l&#39;évolution du marché
* Le site que vous finirez par concevoir et publier

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Écran d'accueil de Replit pour le workspace Demo avec Projects, Conversations, Routines, des prompts suggérés et le champ de message" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

Le champ de prompt est le point de départ de ce projet. Vous y lancerez une
conversation et donnerez à Replit la première description du café que vous souhaitez
créer.
...
Il regroupe également les personnes concernées, les paramètres, les ressources partagées, les intégrations et la facturation. Vos droits d&#39;accès déterminent ce que vous pouvez voir et gérer.

Les paramètres du Workspace et les contrôles de l&#39;organisation sont distincts de ceux qui permettent de définir la façon dont Agent répond à une demande.

Vous pouvez revenir au Workspace tout au long du lancement pour retrouver tout ce dont vous avez besoin pour le mener à bien.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/home/start-a-conversation">
    ...
    <p>Commencez le lancement du café en décrivant le résultat que vous souhaitez obtenir.</p>
  ...
  <a className="chat-example has-visual" href="/fr/features/collaboration/workspaces">
    ...
    <p>
      Découvrez les Workspaces personnels et d&#39;équipe, les accès, les paramètres et la
      gestion.
    </p>
...
Ensuite, [démarrez une conversation](/fr/home/start-a-conversation) pour commencer à développer l&#39;idée du
café.