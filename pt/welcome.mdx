---
title: "Bem-vindo ao Replit"
description: "Saiba como o Replit transforma ideias, trabalho do dia a dia e inteligência em resultados úteis."
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      <div className="welcome-eyebrow">Primeiros passos</div>
      <h1 id="welcome-home-heading">Bem-vindo ao Replit</h1>
      <p>Transforme ideias, trabalho do dia a dia e inteligência em resultados úteis.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/pt/home/get-started">Primeiros passos <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/use-cases">Explore casos de uso</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Jornada guiada do Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Site de abertura de cafeteria com o título 'Um lugar tranquilo para o dia a dia'" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Saiba como transformar sua ideia em um site no ar
      </div>

      <p>
        Siga uma jornada guiada desde sua primeira conversa até pesquisa,
        planejamento, design e publicação.
      </p>

      <a className="welcome-journey-link" href="/pt/home/get-started">
        Comece a jornada <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    <h2 className="welcome-section-heading" id="welcome-use-cases-heading">
      O que o Replit pode ajudar você a fazer?
    </h2>
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Prepare-se para uma chamada com cliente
          </div>

          <p>Receba um briefing focado antes de cada reunião com cliente.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Transforme feedback bruto em temas e insights que geram ação.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Encontre e filtre candidatos com contexto conectado.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Monitore menções à marca
          </div>

          <p>Capture conversas importantes e as encaminhe rapidamente.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Transforme dados atuais do pipeline em uma atualização de vendas clara.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/track-subscriptions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Encontre pagamentos recorrentes e calcule custos mensais.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/use-cases">
        Explore casos de uso <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/pt/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Uma janela de conversa compacta representando o Chat do Replit">
        ...
        <p>
          Comece com uma conversa. Faça perguntas, pesquise ideias e documente
          seu plano.
        </p>

        <div className="welcome-product-link">
          Inicie uma conversa <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/pt/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Um editor de código e uma visualização em tempo real representando o Build do Replit">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Transforme ideias em apps e sites reais. Construa, itere e publique
          com confiança.
        </p>

        <div className="welcome-product-link">
          Comece a construir <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/pt/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Uma composição de canvas selecionada representando o Design do Replit">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Crie interfaces e conteúdos bonitos. Itere em layouts, componentes
          e experiências.
        </p>

        <div className="welcome-product-link">
          Comece a criar designs <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Obtenha o Replit</h2>
      <p>Escolha onde você quer usar o Replit e depois faça login ou crie uma conta. Comece na web, no Desktop App ou no Mobile App.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Web</strong><b aria-hidden="true">→</b><small>Abra no seu navegador</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>Desktop</strong><b aria-hidden="true">→</b><small>macOS e Windows</small></a>
      <a className="welcome-access-card" href="https://replit.com/mobile" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▯</span><strong>Mobile</strong><b aria-hidden="true">→</b><small>iOS e Android</small></a>
    </div>
  </section>
</div>
