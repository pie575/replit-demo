...
description: "Lancez une conversation en posant une question simple, en effectuant une recherche sur le Web ou à partir de votre contexte connecté, puis choisissez la suite."
---
...
Votre espace de travail est prêt. Il est temps de donner vie à votre idée de café.
Lancez une [Conversation](/fr/ja/chat/conversations), expliquez à Replit ce que vous souhaitez créer et transformez votre idée initiale
en véritable plan de lancement.

<div id="section">
  ## Démarrer une nouvelle conversation
</div>

Dans la barre latérale de Replit, sélectionnez **New**. Une conversation s’ouvre alors pour vous aider à développer votre concept, à étudier le marché et à planifier votre lancement.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Page d’accueil de Replit dans l’espace de travail Demo, avec le bouton New mis en évidence, des prompts suggérés et une zone de message" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

<div id="section-2">
  ## Découvrir la zone de saisie
</div>

Après avoir sélectionné **Nouveau**, examinez la zone de saisie. C’est ici que vous donnez des indications à Replit,
ajoutez du contexte utile et faites avancer le lancement de votre café. L’étape suivante consiste à
rédiger votre premier prompt.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu Plus de la zone de saisie affichant des options pour téléverser des fichiers, créer un projet, importer un projet, utiliser des compétences ou des systèmes de design et ajouter des intégrations" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ja/home/describe-your-idea">
    ...
    <div className="chat-card-title">Donnez vie à votre concept</div>
    <p>Rédigez une première demande ciblée pour le lancement d’un café.</p>
