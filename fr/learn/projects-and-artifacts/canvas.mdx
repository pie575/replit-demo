---
title: "Canvas"
description: "Apprenez à utiliser le Canvas pour explorer et itérer sur des designs avec Agent, et voir vos artefacts affichés dans des cadres."
---
...
<Frame>
  <img src="/assets/mirror/canvas-desktop-85e8bfec38a2.png" alt="Canvas montrant un aperçu d'application à côté du chat Agent avec les mises à jour de tâches" width="3452" height="2006" data-path="images/replitai/canvas-desktop.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/canvas-mockups-057e738a78da.png" alt="Canvas montrant plusieurs maquettes de design côte à côte — thème sombre, vues mobiles et pages de détails" width="3452" height="1620" data-path="images/replitai/canvas-mockups.png" />
</Frame>
...
<Steps>
  ...
  <Step title="Amenez une page existante sur le Canvas">
...
<Steps>
  <Step title="Ouvrez le menu du cadre">
  ...
  <Step title="Choisissez Exporter PNG">
    Sélectionnez **Exporter** > **PNG**. L'image se télécharge sur votre ordinateur avec un nom de fichier basé sur le nom du cadre.
  </Step>
</Steps>

<Frame>
  <img src="/assets/mirror/canvas-export-png-b903c6afacb8.png" alt="Menu contextuel d'un cadre Canvas ouvert avec le sous-menu Export montrant PNG comme option d'exportation" width="1740" height="1160" data-path="images/replitai/canvas-export-png.png" />
</Frame>

<Note>Le PNG exporté correspond à ce que le cadre affiche actuellement sur le Canvas. Si votre application ou design est encore en cours de chargement, attendez qu'il soit entièrement rendu avant d'exporter.</Note>
...
<Steps>
  <Step title="Sélectionnez un cadre">
    Cliquez sur le cadre que vous souhaitez convertir.
  </Step>

  <Step title="Demandez à Agent de convertir">
...
<Accordion title="Puis-je redessiner une page sans casser mon application en direct ?">
...
<Accordion title="Puis-je convertir vers des types autres que les applications web ?">
...
<Accordion title="Puis-je importer des designs depuis Figma ou d'autres outils ?">
  ...
  * **Importer depuis Figma** : Allez sur [replit.com/import](https://replit.com/import), connectez votre compte Figma et collez l'URL d'un cadre pour convertir un design en application React fonctionnelle. Consultez le [démarrage rapide Import depuis Figma](/fr/design/import-figma-designs-into-replit-design) pour plus de détails.
  * **Figma MCP dans le chat Agent** : Collez un lien Figma directement dans le chat Agent et demandez-lui de générer du code, d'extraire des données de design ou de construire un composant à partir du design. Consultez le guide [Intégration Figma MCP](/fr/features/mcp/figma).
