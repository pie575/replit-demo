...
description: "Replit 프로젝트에서 Design과 Build의 차이점과 각각을 언제 시작해야 하는지 알아보세요."
...
<Frame>
  <img src="/assets/mirror/design-vs-build-project-f320d446db00.png" alt="헤더에 Design과 Build 진입점이 나란히 있는 Replit 프로젝트, APEX X1 Exact Replica 디자인 프레임이 선택된 캔버스 표시" width="2000" height="1255" data-path="images/design/replit-design/design-vs-build-project.png" />
</Frame>
...
<Steps>
  ...
  <Step title="디자인 빌드하기">
    ...
    <Frame>
      <img src="/assets/mirror/canvas-build-menu-f06b8b8b455f.png" alt="선택된 Design 프레임(APEX X1 Exact Replica)에서 열린 Build 메뉴, 'Build or apply your designs' 헤더 아래 새 아티팩트를 만드는 'Build this design'과 프로젝트의 APEX X1 Design System 및 Scroll Hero 웹사이트를 나열하는 'Apply to an existing creation' 표시" width="2000" height="1153" data-path="images/replitai/canvas-build-menu.png" />
    </Frame>
