---
title: "Free Mode를 최대한 활용하는 방법"
description: "일상적인 채팅, 생성, 빌드에서 Free Mode를 더 잘 활용하는 방법을 알아보세요."
sidebarTitle: "Free Mode를 최대한 활용하는 방법"
tag: "New"
icon: "seedling"
...
<Note>
  Free Mode는 항상 지능형 모델 라우팅을 사용하므로 Replit이 요청에 맞는 모델을
  선택합니다. Free Mode에서는 특정 모델을 선택할 수 없습니다.
</Note>

Routine은 Free Mode에서 실행되지 않습니다. Power Mode 또는 Max Mode에서 실행되며 실행마다 예산이 필요합니다. 자세한 내용은 [Routine](/ko/chat/routines)을 참고하세요.
...
Power Mode는 동일한 비용으로 Economy Mode를 대체하며, 동등하거나 더 나은 성능을 제공합니다. Core 및 Pro 플랜에서는 Power Mode 또는 Max Mode에서 사용 가능한 모델을 선택할 수 있습니다.
...
다음으로 [지능형 모델 라우팅](/ko/chat/auto-mode)이 작업 변화에 따라 모델을 선택하는 방법을 알아보세요.
