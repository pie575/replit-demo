---
title: "replit.md"
description: "Découvrez comment utiliser replit.md pour personnaliser le comportement d'Agent, le style de codage et le contexte du projet."
---
...
Apprenez-en davantage sur le [travail avec Agent](/fr/features/agent/overview) ou explorez d'autres [outils IA](/fr/welcome).

**Enterprise** : Préconfigurez `replit.md` dans des [modèles personnalisés](/fr/teams/custom-templates) pour donner à chaque développeur de votre organisation un contexte de départ cohérent. Pour des conseils spécifiques au design, voir [configurer un système de design](/fr/teams/custom-design-system).
