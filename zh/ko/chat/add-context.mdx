...
如果有助于 Replit 理解你的请求，请添加相关的上下文和工具。有用的上下文能让 Replit 更清楚地了解你的意图，从而提升成果质量。

<div id="section">
  ## 如何添加上下文？
</div>

选择提示框中的 **plus** 菜单，即可上传文件、导入现有工作、使用 Skill 或设计系统，或添加集成。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示框的 plus 菜单，包含 Upload a file、Create something new、Import an existing project、Use a skill、Use a design system、Add an integration" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
你可以添加文件、截图和图片、网络来源和调研资料，以及已连接的工具。请选择对当前任务有帮助的来源：

* **[文件、截图、图片](/zh/ko/chat/upload-and-use-files)：** 添加包含有用佐证或需求信息的文档、电子表格、导出文件、截图和视觉参考资料。
* **[网络来源与调研](/zh/ko/features/agent/web-search)：** 当最新信息或外部视角有助于提升结果时，可以让 Replit 进行网页搜索。
* **[集成](/zh/ko/chat/integrate-your-tools)：** 连接所需的工具，然后指定 Replit 需要参考的服务、频道、记录及其他信息。
* **[设计上下文](/zh/ko/chat/work-with-figma)：** 当布局、层级结构和视觉方向较为关键时，附上 Figma 设计帧。
* **[现有工作](/zh/ko/chat/import-a-project)：** 如果你想在别处创建的代码、设计或其他成果基础上继续构建，可以导入 Project。导入 Project 与把文件作为佐证附加并不相同。

你也可以在请求中粘贴相关链接，或让 Replit 进行网页搜索。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ko/chat/upload-and-use-files">
    <FilesCardVisual />
  ...
  <a className="chat-example has-visual" href="/zh/ko/chat/work-with-figma">
    <FigmaCardVisual />
    ...
    <div className="chat-card-title">与 Figma 协作</div>
    <p>当视觉方向很重要时，可指定具体的设计帧。</p>
    <div className="chat-card-link">查看详情 →</div>
  </a>

  <a className="chat-example has-visual" href="/zh/ko/chat/integrate-your-tools">
...
如需获取最新的公开信息，请参阅[网页搜索指南](/zh/ko/features/agent/web-search)。[MCP](/zh/ko/chat/connect-through-mcp) 则是面向兼容工具和客户端的另一条扩展路径。