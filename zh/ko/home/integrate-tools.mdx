---
title: "工具集成"
description: "连接文件和工具，为 Replit 提供制定咖啡店上线计划所需的背景信息。"
---
...
现在您已了解集成，接下来将其应用到咖啡店上线中。

您决定打造一家**社区咖啡馆**，而非面向通勤者的车站咖啡吧。请向 Replit
提供将这一构想转化为可执行计划所需的资料。

集成功能可将 Replit 与您已在使用的工具和文件连接起来。这样，
Replit 就能获取相关信息，或执行完成任务所需的操作。
您可以连接 **[Slack](/zh/ko/features/integrations/overview#connectors)**、
**[Google Drive](/zh/ko/features/integrations/overview#connectors)**、
**[Notion](/zh/ko/features/integrations/overview#connectors)** 或
**[Salesforce](/zh/ko/features/integrations/overview#connectors)**，以及其他
450 多项服务。

对于咖啡店，Google Drive 可让 Replit 访问预算、选址备注、菜单创意、
照片和视觉参考资料。Notion 则提供了一个记录上线计划、
决策事项和待解决问题的空间。

详细了解[集成您的工具](/zh/ko/chat/integrate-your-tools)。

<Steps>
  <Step title="请 Replit 汇总资料">
    请先发送以下请求。Replit 会确认完成计划所需的信息，
    并在需要访问权限时请求连接相关服务。

    <AiPrompt>
      请利用我的咖啡馆文件，为本地咖啡馆制定首月上线计划。
      更新相关假设，然后将概念、关键决策、待解决问题和上线
      检查清单整理到 Notion 中。
    </AiPrompt>
  </Step>

  <Step title="在 Replit 提示时连接 Google Drive">
    批准连接 Google Drive，以便 Replit 审阅可用资料。
    连接请求会直接在 Conversation 中打开。

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit 请求连接 Google Drive 以审阅咖啡馆文件" />
  </Step>

  <Step title="在 Replit 需要记录计划时连接 Notion">
    当 Replit 要创建上线简报时，请批准连接 Notion。这样便可将概念、
    决策、待解决问题和检查清单集中记录在一处。
  </Step>
</Steps>

Google Drive 为 Replit 提供支撑工作的资料。Notion 可让你在回答
新问题并作出决策的过程中，将不断完善的计划集中保存在一处。

详细了解[添加上下文](/zh/ko/chat/add-context)、[上传文件](/zh/ko/chat/upload-and-use-files)
和[集成工具](/zh/ko/chat/integrate-your-tools)。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ko/home/watch-the-competition">
    ...
    <div className="chat-card-title">关注竞争动态</div>
    <p>在产品上线筹备期间，设置 Routine 持续关注变化。</p>
