...
description: "Build a phone-first app with Agent, test it in a simulator and on your phone, and share it for feedback."
sidebarTitle: "Build a mobile app"
icon: "mobile-screen"
---
...
You will build **Pace Mobile**, a phone-first running tracker inspired by the running tracker example from [What is Replit?](/welcome). The goal is to test a focused mobile flow before committing to the full App Store path.

<Frame>
  <img src="/assets/mirror/mobile-app-4203ff45ecd5.png" alt="A polished mobile app example with fitness tracking screens designed for phone use" width="1440" height="850" data-path="images/build-examples/mobile-app.png" />
</Frame>
...
<Note>
  TestFlight and App Store publishing are separate from this guide. When you are
  ready for that path, see [Build and launch a mobile app](/build/mobile-app).
</Note>
...
<Frame>
  <img src="/assets/mirror/prompt-5cb144699b45.png" alt="The Replit home screen prompt with Mobile app selected as the app type" width="1440" height="900" data-path="images/native-mobile-apps/prompt.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/agent-plan-mode-prompt-059fe8d2c277.png" alt="The Replit prompt composer with Plan mode selected before Agent scopes a mobile app build" width="1440" height="900" data-path="images/fitstart/work-with-agent/agent-plan-mode-prompt.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/workspace-dda0f81e6b83.png" alt="The Replit Project Editor showing a mobile app preview and the option to preview on a mobile device" width="1440" height="900" data-path="images/native-mobile-apps/workspace.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/mobile-screen-e5685fc26793.png" alt="A mobile app running in the Replit Project Editor preview with the Preview on device panel and QR code for Expo Go" width="1440" height="900" data-path="images/native-mobile-apps/mobile-screen.png" />
</Frame>
...
<AiPrompt>
  ...
  Make the Save Run button easier to reach, increase tap targets where needed,
  and keep the run form simple.
...
<Steps>
  <Step title="Open the Publishing tab and start App Store publishing">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-02-start-publishing-190eb7841bcf.png" alt="The Publishing tab in the Project Editor showing Production status and a Ready to publish Pace to the App Store? card with a Start publishing to the App Store button" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-02-start-publishing.png" />
    </Frame>
  </Step>
  ...
  <Step title="Choose your Expo project">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-03-choose-expo-project-4707fafffafe.png" alt="The Launch dialog with a Choose Expo project step active — fields for Project name and Project slug pre-filled with Pace, a Continue button, and a Use existing option" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-03-choose-expo-project.png" />
    </Frame>
  </Step>
  ...
  <Step title="Sign in with Apple">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-04-sign-in-apple-459dfc9b84ba.png" alt="The Launch dialog at the Sign in with Apple step — Apple Developer email or phone number and password fields, with a note that the password never leaves the device and that the account must be enrolled in the Apple Developer Program" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-04-sign-in-apple.png" />
    </Frame>
  </Step>

  <Step title="Choose or create your Apple app">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-05-choose-apple-app-3971aea62f14.png" alt="The Launch dialog at the Choose Apple app step — App name set to Pace, Bundle ID app.replit.pace, with a note that the bundle identifier cannot be changed later, and a Creating app… button" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-05-choose-apple-app.png" />
    </Frame>
  </Step>

  <Step title="Launch to App Store">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-06-ready-for-launch-ab02659ee0bb.png" alt="The Launch dialog at the Ready for launch step with Choose Apple app and Configure Apple certificates marked complete, and a Launch to App Store button plus Optional launch parameters" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-06-ready-for-launch.png" />
    </Frame>
    ...
    <Frame>
      <img src="/assets/mirror/app-store-targeting-f8797071c9e0.png" alt="The Launch dialog with Targeting App Store marked complete and a Redirecting back to Replit message — the confirmation state after Launch to App Store is selected" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-targeting.png" />
    </Frame>
  </Step>
</Steps>

<Note>
  The first build of a version typically requires a TestFlight beta review
  before testers can install it. After approval, additional builds usually push
  to testers faster. To share with external testers or submit for App Store
  release, finish the listing in **App Store Connect** — see [Build and launch a
  mobile app](/build/mobile-app) for the full App Store Connect checklist.
</Note>
...
<CardGroup cols={2}>
  <Card title="Add login" icon="user-lock" href="/build/add-login">
  ...
  <Card title="Build and launch a mobile app" icon="mobile-screen" href="/build/mobile-app">
