---
title: "欢迎使用 Replit"
description: "了解 Replit 如何将创意、日常工作和智能转化为切实成果。"
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <p>将你的创意、日常工作和智能转化为实际成果。</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/zh/ja/home/get-started">开始使用 <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/zh/use-cases">查看使用案例</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Replit 引导式体验之旅">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="咖啡店开业网站，标题为“为日常而设的静谧之所”" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>
    ...
    <div className="welcome-journey-copy">
      ...
      <p>
        从首次对话到调研、规划、设计和发布，跟随引导式旅程
        一步步完成。
      </p>

      <a className="welcome-journey-link" href="/zh/ja/home/get-started">
        开始旅程 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/zh/use-cases">
        查看应用场景 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/zh/ja/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="代表 Replit Chat 的紧凑型对话窗口">
      ...
      <a className="welcome-product-card" href="/zh/ja/build/your-first-app">
      ...
      <a className="welcome-product-card" href="/zh/ja/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="代表 Replit Design 的画布设计稿">
          <span className="product-path-layer product-path-back" />
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      ...
      <p>选择你希望使用 Replit 的方式，然后登录或创建账户。你可以通过 Web、桌面 App 或移动 App 开始使用。</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Web</strong><b aria-hidden="true">→</b><small>在浏览器中打开</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>桌面版</strong><b aria-hidden="true">→</b><small>适用于 macOS 和 Windows</small></a>
      <a className="welcome-access-card" href="https://replit.com/mobile" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▯</span><strong>移动版</strong><b aria-hidden="true">→</b><small>适用于 iOS 和 Android</small></a>
    </div>
  </section>
</div>