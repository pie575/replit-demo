...
description: "Connect the files and tools that give Replit the context to build a coffee shop launch plan."
sidebarTitle: "Integrate tools"
icon: "paperclip"
...
<Steps>
  ...
  <Step title="Connect Google Drive when Replit asks">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit asking to connect Google Drive so it can inspect café files" />
  </Step>
