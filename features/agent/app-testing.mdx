---
title: "App Testing"
description: "Learn how Agent tests your app in a real browser and automatically fixes issues it finds."
...
<Frame>
  <img src="/assets/mirror/app-testing-takeover-6e0b0b56f4d0.png" alt="App Testing take over interface showing Skip and Begin take over buttons with instructions for handling errors and CAPTCHAs" width="924" height="358" data-path="images/replitai/app-testing-takeover.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/app-testing-replay-photo-0706a73801a1.png" alt="Interactive video replay interface showing the testing session with navigation controls" width="1764" height="1394" data-path="images/replitai/app-testing-replay-photo.png" />
</Frame>
