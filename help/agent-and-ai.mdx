---
title: "Agent and AI"
description: "Answers to common Agent questions—fixing a frozen or looping Agent, reducing costs, Agent modes, rolling back changes, and using your own API keys."
sidebarTitle: "Agent and AI"
icon: "robot"
---
...
<AccordionGroup>
  ...
  <Accordion title="How do I reduce Agent costs—what settings actually help?">
    ...
    * **[Free Mode](/features/agent/agent-modes)**—no-cost everyday Agent work within your plan's allowance.
  ...
  <Accordion title="What are the Agent modes, and how do they differ?">
    Agent has three top-level modes, plus an **Auto** setting inside the paid modes. See [Free Mode](/help/free-agent-mode) for full guidance.
