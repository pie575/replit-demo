---
title: "Explore with different models"
description: "Switch the model behind Replit Design to explore different directions: each model brings its own design sensibility and frontend strengths."
sidebarTitle: "Explore with models"
icon: "microchip"
---
...
<Frame caption="The Agent modes popover with the Primary model list and the Effort slider.">
  <img src="/assets/mirror/model-selector-6826a87089a2.png" alt="The Agent modes popover with Lite, Economy, and Power modes, Power selected and described as using a higher-performance model for design work, a Primary model list showing Kimi K3, Claude Fable 5 marked Recommended, Claude Opus 5, and GPT-5.6 Sol, and an Effort slider from Low to Max" width="1432" height="786" data-path="images/design/replit-design/model-selector.png" />
</Frame>
