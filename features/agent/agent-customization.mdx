...
description: "Teach Agent your team's conventions with workspace-wide custom instructions and skills, managed centrally in Workspace Settings."
...
<Frame>
  <img src="/assets/mirror/agent-customization-create-skill-fcb794e6de4e.png" alt="The Customization tab in Workspace Settings, with Skills and Custom instructions sub-tabs and the Create a skill form open" width="2168" height="1350" data-path="images/replitai/agent-customization-create-skill.png" />
</Frame>
...
<Steps>
  <Step title="Open Workspace Settings">
    ...
    <Frame>
      <img src="/assets/mirror/agent-customization-tab-930af2e8ed74.png" alt="The Customization tab in Workspace Settings, showing the Skills and Custom instructions sub-tabs" width="1065" height="394" data-path="images/replitai/agent-customization-tab.png" />
    </Frame>
  </Step>
