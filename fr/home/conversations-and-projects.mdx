...
description: "Découvrez quand poursuivre votre travail dans une Conversation et quand utiliser un projet pour d'importants travaux de Build ou de Design."
sidebarTitle: "Conversations et projets"
icon: "objects-column"
...
Vous avez étudié le quartier, connecté vos outils et élaboré un plan de lancement. Il est maintenant temps de faire connaître votre café. Pour cela, vous allez créer un site d’ouverture.

Avant de commencer, il est utile de comprendre les deux espaces de travail dans Replit : les Conversations et les projets.

<div id="from-plan-to-project">
  ## Du plan au projet
</div>

Le lancement du café a commencé dans une conversation. C’est là que vous avez précisé l’idée, étudié le marché, connecté des outils et créé une Routine.

Vous êtes maintenant prêt à créer un site d’ouverture. Un projet est l’espace dédié à ce travail conséquent de conception et de Build. Replit peut utiliser le contexte déjà présent dans la conversation, vous n’avez donc pas besoin de repartir de zéro.

<div id="what-is-a-conversation">
  ## Qu’est-ce qu’une Conversation ?
</div>

Une **Conversation** est un fil de discussion unique dans lequel vous posez des questions, explorez des
informations, exécutez des Routines et poursuivez votre travail par le biais de suivis. Dans cet exemple,
elle contient les recherches sur le café et le plan de lancement.

<div id="what-is-a-project">
  ## Qu’est-ce qu’un projet ?
</div>

Un **projet** est un espace structuré et pérenne destiné à des travaux de Build et de Design d’envergure.
Dans ce scénario, c’est là que vous créerez et affinerez le site d’ouverture.
...
| ---------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Idéal pour | Explorer une idée, étudier les concurrents et assurer une veille de marché hebdomadaire | Concevoir et développer le site d’ouverture                                   |
| Structure  | Un fil de discussion unique regroupant vos recherches, décisions et suivis              | Un espace structuré pour le site, sa conception et d’autres artefacts de build |
| Routines   | Créer et gérer des recherches récurrentes                                               | Utiliser les résultats renvoyés dans la conversation                           |
| Contexte   | Contient le plan de lancement qui vous a amené jusqu’ici                                | S’appuie sur l’orientation établie dans la conversation                        |

Commencez dans une conversation lorsque vous souhaitez poser une question ou explorer une idée. Passez à un projet
lorsque vous êtes prêt à développer. La transition conserve l’orientation que vous avez déjà
établie.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/chat/conversations">
    ...
    <p>
      Découvrez comment les Conversations vous permettent de poser des questions, d&#39;explorer, d&#39;utiliser des Routines et d&#39;obtenir des résultats.
    </p>
  ...
  <a className="chat-example has-visual" href="/fr/features/projects-and-artifacts/projects">
    ...
    <div className="chat-example-tag">Créer et organiser</div>
    <div className="chat-card-title">projets</div>

    <p>
      Découvrez comment les projets organisent les travaux de Build et de Design d&#39;envergure avec plusieurs artefacts.
    </p>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/home/design-an-opening-site">
    ...
    <div className="chat-card-title">Concevez le site d’ouverture</div>
    <p>Utilisez Conversation et le plan de lancement pour créer un site pour votre café.</p>
