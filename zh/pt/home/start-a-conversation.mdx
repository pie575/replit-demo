---
title: "开始对话"
description: "通过简单提问、网络搜索或已连接的上下文开启 Conversation，然后选择下一步操作。"
---
...
您的 Workspace 已准备就绪。现在就让咖啡馆的创意更进一步。
发起一场[对话](/zh/pt/chat/conversations)，告诉 Replit 您想要
创建什么，并开始将最初的想法转化为切实可行的发布计划。

<div id="iniciar-uma-nova-conversa">
  ## 发起新对话
</div>

在 Replit 侧边栏中选择 **New**。这会打开一个对话，你可以在其中
构思创意、调研市场并规划发布。

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Demo Workspace 的 Replit 主屏幕，突出显示 New 按钮、建议提示词和消息框" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>
...
选择 **New** 后，看看提示词输入框。你可以在这里向 Replit 提供指引、添加有用的上下文，并继续发布咖啡店应用。下一步是编写第一个提示词。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示词输入框的更多选项菜单，包含发送文件、创建新内容、导入项目、使用 skill 或设计系统，以及添加集成的选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/pt/home/describe-your-idea">
    ...
    <div className="chat-card-title">构思你的想法</div>
    <p>为咖啡馆开业编写一条重点明确的初始提示词。</p>
