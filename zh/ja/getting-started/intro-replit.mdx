---
title: "概览"
description: "Replit 是将创意变成应用的最快方式。借助 AI，你可以直接在浏览器中构建并发布精美的项目。"
---
...
Replit 是一个由 AI 驱动的平台，只需一个浏览器标签页就能创建并发布应用。
无需再为复杂的开发环境配置发愁，编码、发布与协作所需的工具都集中在同一个界面中。

传统的应用开发需要安装各种程序、语言和软件包，配置过程往往耗费大量时间。
而在 Replit 上，平台会即时为你配置好环境，无论是初学者还是资深开发者，都能立刻开始构建。

<div align="center">
  <AgentInput />
</div>

只需一个浏览器标签页，无需任何安装，创建应用所需的全部工具就已就绪。
借助 AI 编码工具、实时协作和即时共享功能，Replit 让你的想法快速变成应用。
...
<CardGroup cols={2}>
  <Card title="创建你的第一个应用" icon="robot" href="/zh/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 分钟*

    使用 Replit 的 AI 工具创建你的第一个应用。
  </Card>

  <Card title="重混现有应用" icon="shuffle" href="/zh/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 分钟*

    以社区提供的应用为基础，快速启动你的项目。
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="从 GitHub 导入" icon="github" href="/zh/getting-started/quickstarts/import-from-github/">
    ⏱️ *2 分钟*

    将现有的 GitHub 仓库导入 Replit。
  </Card>

  <Card title="从 Figma 导入" icon="figma" href="/zh/getting-started/quickstarts/import-from-figma/">
    ⏱️ *3 分钟*

    将 Figma 设计转换为 React 应用。
  </Card>

  <Card title="从 Bolt 导入" icon="bolt" href="/zh/getting-started/quickstarts/import-from-bolt/">
    ⏱️ *4 分钟*

    在 Agent 的协助下，将 Bolt 项目迁移到 Replit。
  </Card>

  <Card title="从 Lovable 导入" icon="heart" href="/zh/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4 分钟*

    将 Lovable 项目迁移到 Replit，继续开发。
  </Card>
</CardGroup>
...
* 应用的[实时预览](/zh/core-concepts/workspace/editor-and-tools/preview)
* [几分钟即可发布](/zh/category/replit-deployments)
* 无需安装和配置的浏览器原生应用
* [功能完备的代码编辑器](/zh/core-concepts/workspace/editor-and-tools)
* 可在手机或平板上构建应用的[移动应用](/zh/platforms/mobile-app)
* [AI 辅助构建应用](/zh/core-concepts/agent)
* 用于追踪变更的[版本控制集成](/zh/core-concepts/workspace/version-control)
* 便于协同开发的[团队协作](/zh/ja/category/teams)

<div id="ai">
  ### AI 助手的功能
</div>

Replit 的 [Agent](/zh/core-concepts/agent) 通过以下功能加速应用开发：
...
<CardGroup cols={3}>
  ...
  <Card title="符合 GDPR" icon="lock">
    满足欧洲监管标准的数据隐私保护。
  </Card>

  <Card title="企业版就绪" icon="building" href="/zh/ja/category/teams">
    SSO/SAML、基于角色的访问控制、管理员权限管理以及专属支持。
  </Card>
</CardGroup>
...
如需了解 Replit 的全部功能，请查阅以下资源：

* [Starter 套餐](/zh/ja/billing/plans/starter-plan)：了解 Starter 套餐的功能以及可以免费创建的内容
* 通过[工作区功能](/zh/core-concepts/workspace/editor-and-tools)了解工作区的各项功能。
* 通过 [Replit Agent](/zh/core-concepts/agent/) 了解 Replit 的 AI 驱动功能。
* 通过[共享 Replit 应用](/zh/replit-app/collaborate/)了解如何分享你的作品。
