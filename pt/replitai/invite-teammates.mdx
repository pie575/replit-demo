...
description: "Convide colaboradores para o seu projeto e construa juntos — cada pessoa pode iniciar novos threads com o Agent enquanto trabalha no mesmo projeto."
---
...
O Replit permite que várias pessoas trabalhem no mesmo projeto ao mesmo tempo. Cada pessoa pode iniciar novos threads de planejamento com o Agent, e as tarefas de todos aparecem no quadro compartilhado — para que sua equipe construa juntos em vez de se revezar.

## Comece a construir com colaboradores

### Convidando colaboradores

1. Abra seu projeto
2. Clique em **Convidar** ou compartilhe o link do projeto
3. Os colaboradores entram e iniciam novos threads com o Agent
...
Quando sua equipe trabalha junta, as tarefas de todos aparecem no mesmo quadro. Você pode ver rapidamente quem está trabalhando em quê, o que está em andamento e o que está pronto para aplicar.

<Frame>
  <img src="/assets/mirror/task-board-progress-f4d3b5e7e93e.png" alt="Quadro de tarefas mostrando tarefas organizadas nas colunas Rascunhos, Ativas, Prontas e Concluídas" width="3456" height="1984" data-path="images/replitai/task-board-progress.png" />
</Frame>

Cada tarefa passa por quatro estágios:
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px', margin: '20px 0' }}>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    ...
    <span style={{ fontSize: '13px', color: 'var(--kb-text-dimmer, #666)', padding: '0 4px' }}><strong>Ativa</strong> — O Agent está construindo esta tarefa agora em sua própria cópia isolada do projeto.</span>
  </div>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    ...
    <span style={{ fontSize: '13px', color: 'var(--kb-text-dimmer, #666)', padding: '0 4px' }}><strong>Pronta</strong> — A tarefa está concluída. Revise as alterações e aplique-as à versão principal.</span>
  </div>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    ...
    <span style={{ fontSize: '13px', color: 'var(--kb-text-dimmer, #666)', padding: '0 4px' }}><strong>Concluída</strong> — Esta tarefa está finalizada e suas alterações fazem parte da versão principal.</span>
  </div>
</div>

### Como as equipes usam o quadro

Quando várias pessoas estão construindo ao mesmo tempo, as tarefas de cada pessoa aparecem no quadro compartilhado. Veja como isso se parece — um colaborador está trabalhando em continuações de histórias e regeneração enquanto outro cuida do fluxo de presentes, e o restante do trabalho concluído da equipe fica em Pronto e Concluído.
...
Quando uma tarefa passa para Pronto, qualquer pessoa da equipe pode revisar e aplicar as alterações. O Agent lida com conflitos automaticamente quando várias tarefas são aplicadas.

## O que você pode construir juntos

* **Divida um recurso entre a equipe**: Uma pessoa constrói o frontend enquanto outra cuida do backend, cada uma por meio de seu próprio chat com o Agent. O quadro Kanban mantém todos alinhados.
* **Integre um novo colaborador**: Ele pode explorar o projeto por meio de seu próprio chat com o Agent, fazer perguntas sobre como as coisas funcionam e começar a contribuir — tudo sem bloquear mais ninguém.
* **Lance mais rápido no Pro**: Com execução paralela, duas ou três pessoas podem cada uma despachar tarefas que rodam ao mesmo tempo. Um projeto que levaria uma pessoa uma sessão inteira pode ser concluído em uma fração do tempo.

## Perguntas frequentes

<Accordion title="Posso enviar mensagem ao meu colaborador pelo Agent?">
  Não. O Agent não é uma ferramenta de mensagens — ele está sempre ouvindo e tentará agir sobre qualquer coisa que você digitar. Use Slack, Discord ou outra ferramenta para comunicação da equipe.
</Accordion>

<Accordion title="Vamos sobrescrever o trabalho um do outro?">
  O sistema de tarefas ajuda a evitar isso dando a cada tarefa sua própria cópia isolada, mas está ciente do que outras tarefas existem. Quando as tarefas são concluídas, você as aplica de volta à versão principal e resolve quaisquer conflitos nessa etapa.
</Accordion>

<Accordion title="Como vejo o que meus colaboradores estão fazendo?">
  Verifique o quadro Kanban para ver as tarefas ativas. Você também pode ver a presença do cursor e quais arquivos os colaboradores estão visualizando.
</Accordion>
