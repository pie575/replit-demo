---
title: "Refine"
description: "Shape the winning frame with precision: chat with Agent in your own words, or adjust elements directly with the Visual Editor."
...
<Frame caption="The Edit tool active with an element selected, and the Visual Editor showing its editable properties.">
  <img src="/assets/mirror/visual-editor-edit-tool-71d03803471f.png" alt="A supercar configurator frame with the Edit tool active and an element selected, showing the Visual Editor panel on the right with Layout, Color, and Border sections, plus Discard and Save edits buttons" width="2000" height="1250" data-path="images/replitai/visual-editor-edit-tool.png" />
</Frame>
