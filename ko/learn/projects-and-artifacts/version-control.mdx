...
description: "Replit의 버전 관리 도구로 변경사항을 추적하고 코드 기록을 관리하는 방법을 알아보세요."
...
<Frame>
  <img src="/assets/mirror/checkpoints-vc-23a2274350af.jpg" alt="Git 패널의 Agent 체크포인트" width="1920" height="1080" data-path="images/workspace/checkpoints-vc.jpg" />
</Frame>
...
1. **Agent 체크포인트**는 [Replit Agent](/ko/features/agent/overview)로 빌드할 때 중요한 마일스톤에서 자동으로 커밋을 생성합니다. [체크포인트 및 롤백에 대해 자세히 알아보세요](/ko/features/version-control/checkpoints-and-rollbacks).
...
GitHub에서 기존 프로젝트를 가져오려면 [GitHub에서 가져오기](/ko/build/import-from-providers)를 참조하세요.
...
<Frame>
  <img src="/assets/mirror/git-pane-eb74a42fd963.jpg" alt="저장소 초기화 버튼이 표시된 Git 패널" width="1920" height="1080" data-path="images/workspace/git-pane.jpg" />
</Frame>

### 자동 버전 관리

<Accordion title="Agent 체크포인트">
  [Replit Agent](/ko/features/agent/overview)를 사용한 AI 지원 개발 중에 생성되는 자동 스냅샷입니다.
...
<Accordion title="파일 기록">
  ...
  * 재생 기능
  ...
  파일 기록은 자체 인터페이스를 제공하지만, 기본 변경사항은 Git 기록의 일부입니다. [파일 기록](/ko/features/version-control/file-history)에 대해 자세히 알아보세요.
</Accordion>
...
<Accordion title="Git 패널">
  ...
  * 팀 협업
  ...
  Git 패널 사용에 대한 자세한 지침은 [Git 패널 사용하기](/ko/features/workspace-tools/git-interface)를 참조하세요.
</Accordion>

<Accordion title="Git CLI">
  고급 작업을 위해 [Shell](/ko/features/workspace-tools/shell)을 통해 Git에 완전한 명령줄 접근을 제공합니다.
  ...
  * 완전한 저장소 제어
  ...
  일반적인 Git 명령과 사용법은 [Git 패널 사용하기](/ko/features/workspace-tools/git-interface#using-git-commands-in-shell)를 참조하세요.
</Accordion>
...
* **GitHub에서 가져오기**: 몇 번의 클릭으로 [GitHub 저장소를 Replit 앱으로 변환](/ko/build/import-from-providers)
...
개발하면서 코드 변경사항을 추적하여 필요할 때 이전 버전으로 되돌릴 수 있습니다. [Git 패널](/ko/features/workspace-tools/git-interface)은 변경사항을 시각적으로 보여주어 의미 있는 업데이트를 쉽게 커밋할 수 있습니다.

**팀과 협업**

여러 개발자가 서로의 변경사항을 덮어쓰지 않고 동일한 코드베이스에서 작업합니다. 새 기능을 위한 브랜치를 만든 다음 준비가 되면 병합합니다. [팀원 초대하기](/ko/build/invite-teammates)에 대해 자세히 알아보세요.

## Agent 체크포인트

[Replit Agent](/ko/features/agent/overview)로 애플리케이션을 빌드할 때, 체크포인트를 통해 추가적인 버전 관리 레이어를 활용할 수 있습니다. 체크포인트는 AI 지원 개발 중 주요 순간에 프로젝트의 전체 상태 — 프로젝트 내용, AI 대화 컨텍스트, 연결된 데이터베이스 포함 — 를 자동으로 캡처합니다.

<Frame>
  <img src="/assets/mirror/checkpoints-9927e500693a.jpg" alt="Git 패널의 Agent 체크포인트" width="1920" height="1080" data-path="images/workspace/checkpoints.jpg" />
</Frame>
...
<Info>
  체크포인트가 캡처하는 내용과 포괄적인 롤백 기능에 대한 자세한 정보는 [체크포인트 및 롤백](/ko/features/version-control/checkpoints-and-rollbacks)을 참조하세요.
</Info>
...
* [Git 패널 사용하기](/ko/features/workspace-tools/git-interface): Replit의 시각적 Git 인터페이스 마스터하기
* [GitHub에서 가져오기](/ko/build/import-from-providers): GitHub 저장소를 Replit 앱으로 변환
* [팀원 초대하기](/ko/build/invite-teammates): 공유 프로젝트에서 다른 사람과 협업
* [파일 기록](/ko/features/version-control/file-history): 파일 수준 버전 기록 탐색
* [Replit Agent](/ko/features/agent/overview): AI 지원 개발에 대해 자세히 알아보기
