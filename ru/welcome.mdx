...
description: "Узнайте, как Replit превращает идеи, повседневную работу и интеллект в полезные результаты."
sidebarTitle: "Добро пожаловать в Replit"
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <p>Превращайте идеи, повседневные задачи и интеллект в полезные результаты.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/ru/home/get-started">Начать работу <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/ru/use-cases">Изучить варианты использования</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Знакомство с Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Сайт кофейни с заголовком «Тихое место на каждый день»" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Узнайте, как воплотить свою идею в работающем сайте
      </div>

      <p>
        Пройдите путь от первого разговора до исследования,
        планирования, дизайна и публикации.
      </p>

      <a className="welcome-journey-link" href="/ru/home/get-started">
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/ru/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Получайте краткую справку перед каждой встречей с клиентом.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Выявляйте общие темы и полезные выводы на основе отзывов.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Находите и фильтруйте кандидатов с учётом связанного контекста.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Не упускайте важные обсуждения и оперативно направляйте их.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Создайте еженедельный отчёт о продажах
          </div>

          <p>Преобразуйте текущие данные воронки продаж в понятный отчёт.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/ru/use-cases">
        Изучить сценарии использования <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/ru/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Компактное окно беседы, представляющее Replit Chat">
        ...
        <p>
          Начните с беседы. Задавайте вопросы, изучайте идеи и фиксируйте
          свой план.
        </p>

        <div className="welcome-product-link">
          Начать беседу <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Редактор кода и интерактивный предварительный просмотр, представляющие Replit Build">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Превращайте идеи в настоящие приложения и сайты. Создавайте, дорабатывайте и публикуйте
          с уверенностью.
        </p>

        <div className="welcome-product-link">
          Начать разработку <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Выбранная композиция на Canvas, представляющая Replit Design">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Создавайте красивые интерфейсы и контент. Дорабатывайте макеты, компоненты
          и пользовательский опыт.
        </p>

        <div className="welcome-product-link">
          Начать проектирование <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      ...
      <p>Выберите, где хотите использовать Replit, затем войдите в аккаунт или создайте его. Начните в браузере, настольном или мобильном приложении.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Веб</strong><b aria-hidden="true">→</b><small>Откройте в браузере</small></a>
