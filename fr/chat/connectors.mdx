---
title: "Connecteurs"
description: "Découvrez quelles intégrations Agent prend en charge et comment elles s'activent automatiquement selon vos invites."
...
<div className="chat-mkt" role="img" aria-label="Icône de flux de travail en couches représentant les Connecteurs" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
