...
<Frame>
  <img src="/assets/mirror/checkpoints-vc-23a2274350af.jpg" alt="Points de contrôle Agent dans le panneau Git" width="1920" height="1080" data-path="images/workspace/checkpoints-vc.jpg" />
</Frame>
...
1. **Points de contrôle Agent** créent des commits automatiquement à des étapes importantes lors de la construction avec [Replit Agent](/fr/core-concepts/agent). [En savoir plus sur les points de contrôle et les retours en arrière](/fr/core-concepts/agent/checkpoints-and-rollbacks).
...
Pour importer des projets existants depuis GitHub, consultez [Importer depuis GitHub](/fr/getting-started/quickstarts/import-from-github).
...
<Frame>
  <img src="/assets/mirror/git-pane-eb74a42fd963.jpg" alt="Panneau Git montrant le bouton Initialiser le dépôt" width="1920" height="1080" data-path="images/workspace/git-pane.jpg" />
</Frame>

### Contrôle de version automatique

<Accordion title="Points de contrôle Agent">
  Instantanés automatiques créés lors du développement assisté par IA avec [Replit Agent](/fr/core-concepts/agent).
...
<Accordion title="Historique des fichiers">
  Suivi des versions par fichier avec sauvegarde automatique pour les modifications non Agent effectuées directement dans l'éditeur.
  ...
  * Fonctionnalité de lecture
  ...
  Bien que l'Historique des fichiers fournisse sa propre interface, les modifications sous-jacentes font partie de l'historique de Git. En savoir plus sur [l'Historique des fichiers](/fr/core-concepts/project-editor/version-control/file-history).
</Accordion>
...
<Accordion title="Panneau Git">
  ...
  **Idéal pour** : La plupart des projets nécessitant une intégration GitHub et un workflow visuel
  ...
  * Collaboration en équipe
  ...
  Pour des instructions détaillées sur l'utilisation du panneau Git, consultez [Utiliser le panneau Git](/fr/core-concepts/project-editor/version-control/git-interface).
</Accordion>

<Accordion title="Git CLI">
  Accès complet en ligne de commande à Git via le [Shell](/fr/core-concepts/project-editor/editor-and-tools/shell) pour les opérations avancées.

  **Idéal pour** : Les utilisateurs avancés ayant besoin d'une fonctionnalité Git complète
  ...
  * Contrôle complet du dépôt
  ...
  Pour les commandes Git courantes et leur utilisation, consultez [Utiliser le panneau Git](/fr/core-concepts/project-editor/version-control/git-interface#using-git-commands-in-shell).
</Accordion>
...
* **Importation depuis GitHub** : Transformer n'importe quel [dépôt GitHub en application Replit](/fr/getting-started/quickstarts/import-from-github) en quelques clics
...
Suivez les modifications de votre code au fur et à mesure de son développement, vous permettant de revenir aux versions précédentes si nécessaire. Le [panneau Git](/fr/core-concepts/project-editor/version-control/git-interface) affiche vos modifications visuellement, facilitant la validation des mises à jour significatives.

**Collaboration avec une équipe**

Travaillez avec plusieurs développeurs sur la même base de code sans écraser les modifications des autres. Créez des branches pour les nouvelles fonctionnalités, puis fusionnez-les lorsqu'elles sont prêtes. En savoir plus sur [l'invitation de coéquipiers](/fr/replitai/invite-teammates).

## Points de contrôle Agent

Lors de la construction d'applications avec [Replit Agent](/fr/core-concepts/agent), vous bénéficiez d'une couche supplémentaire de contrôle de version grâce aux points de contrôle. Les points de contrôle capturent automatiquement l'état complet de votre projet — y compris le contenu du projet, le contexte de conversation IA et les bases de données connectées — à des moments clés du développement assisté par IA.
...
<Info>
  Pour des informations détaillées sur ce que capturent les points de contrôle et les capacités complètes de retour en arrière, consultez [Points de contrôle et retours en arrière](/fr/core-concepts/agent/checkpoints-and-rollbacks).
</Info>
...
* [Utiliser le panneau Git](/fr/core-concepts/project-editor/version-control/git-interface) : Maîtriser l'interface Git visuelle de Replit
* [Importer depuis GitHub](/fr/getting-started/quickstarts/import-from-github) : Transformer des dépôts GitHub en applications Replit
* [Inviter des coéquipiers](/fr/replitai/invite-teammates) : Travailler avec d'autres sur des projets partagés
* [Historique des fichiers](/fr/core-concepts/project-editor/version-control/file-history) : Explorer l'historique des versions au niveau des fichiers
* [Replit Agent](/fr/core-concepts/agent) : En savoir plus sur le développement assisté par IA
