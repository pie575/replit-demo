...
description: "Coûts de publication flexibles qui évoluent avec les besoins de votre application. Payez uniquement ce que vous utilisez avec une facturation transparente basée sur les crédits."
...
* **Plan Starter** : Inclut 1 application publiée gratuitement. Le déploiement expire après 30 jours mais peut être republié. Consultez [Plan Starter](/fr/billing/plans/starter-plan) pour plus de détails.
* **[Plan Core](/fr/billing/plans/replit-core)** : Crédits mensuels inclus ; voir [tarification](https://replit.com/pricing)
* **[Plan Pro](/fr/billing/plans/replit-pro)** : Crédits mensuels progressifs ; voir [Replit Pro](/fr/billing/plans/replit-pro) et la [page de tarification](https://replit.com/pricing) pour plus de détails

<Note>
  Les crédits s'appliquent automatiquement à tous les coûts de publication. Les crédits non utilisés ne sont pas reportés au mois suivant. En savoir plus sur la [facturation à l'utilisation](/fr/billing/about-usage-based-billing).
</Note>
...
<Frame>
  <img src="/assets/mirror/deployments-cost-81b1956ff7d7.png" alt="Calculateur interactif des coûts de publication montrant la décomposition des coûts par type de déploiement" width="2540" height="990" data-path="images/deployments/deployments-cost.png" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Déploiements VM réservée" icon="server">
    ...
    **Idéal pour :** Applications de production avec un trafic constant ou des exigences de ressources garanties
    ...
    [En savoir plus sur les déploiements VM réservée](/fr/features/publishing/deployment-types#reserved-vm)
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Service API" icon="gear">
    **Trafic :** 10 000 appels API/jour = 300 000 requêtes/mois
    ...
    | :------------------- | :-------------- | -----------------: |
    | **Frais de base**    | Mensuel         | {AutoscaleBaseFee} |
    | **Unités de calcul** | 3,96 M d'unités |   {ApiComputeCost} |
...
<CardGroup cols={2}>
  ...
  <Card title="En savoir plus sur la facturation IA" icon="brain" href="/fr/billing/ai-billing">
    Comprenez comment [l'Agent](/fr/features/agent/overview) affecte votre facture.
  </Card>

  <Card title="Surveiller les applications publiées" icon="chart-line" href="/fr/features/publishing/monitoring-a-deployment">
