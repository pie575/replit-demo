...
description: "Importez des projets Bolt dans Replit en les exportant d'abord vers GitHub."
---
...
<Warning>L'Agent prend actuellement en charge les importations Bolt pour les applications Vite + React.</Warning>
