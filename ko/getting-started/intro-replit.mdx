---
title: "개요"
description: "Replit은 아이디어를 앱으로 만드는 가장 빠른 방법입니다. AI를 활용하여 브라우저에서 바로 멋진 프로젝트를 빌드하고 게시하세요."
---
...
<YouTubeEmbed videoId="-2xHmkpmCBM" title="Replit 개요" />

Replit은 AI 기반 플랫폼으로, 하나의 브라우저 탭에서 앱을 만들고 게시할 수 있습니다.
복잡한 개발 환경과 씨름하는 대신, 코딩·게시·협업 도구가 하나의 통합 인터페이스에 모두 갖춰져 있습니다.

기존 앱 개발에서는 프로그램, 언어, 패키지를 설치하는 시간 소모적인 설정 과정이 필요했습니다.
Replit에서는 플랫폼이 환경을 즉시 구성해 주므로, 초보자든 숙련된 개발자든 바로 빌드를 시작할 수 있습니다.

<div align="center">
  <AgentInput />
</div>

하나의 브라우저 탭에서 앱을 만드는 데 필요한 모든 것을 갖추고 있으며, 설치가 필요 없습니다.
AI 코딩 도구, 실시간 협업, 즉각적인 공유 기능으로 Replit은 아이디어를 앱으로 빠르게 실현합니다.

## 퀵스타트 가이드

Replit에서 앱을 만들려면 목적에 맞는 가이드를 선택하세요:

### 새 앱 만들기

<CardGroup cols={2}>
  <Card title="첫 번째 앱 만들기" icon="robot" href="/getting-started/quickstarts/ask-ai/">
    ⏱️ *5분*

    AI 기반 Replit 도구로 첫 번째 앱을 만들어 보세요.
  </Card>

  <Card title="기존 앱 리믹스하기" icon="shuffle" href="/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1분*

    커뮤니티가 제공하는 앱을 기반으로 프로젝트를 빠르게 시작하세요.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="GitHub에서 가져오기" icon="github" href="/getting-started/quickstarts/import-from-github/">
    ⏱️ *2분*

    기존 GitHub 저장소를 Replit으로 가져옵니다.
  </Card>

  <Card title="Figma에서 가져오기" icon="figma" href="/getting-started/quickstarts/import-from-figma/">
    ⏱️ *3분*

    Figma 디자인을 기능하는 React 애플리케이션으로 변환합니다.
  </Card>

  <Card title="Bolt에서 가져오기" icon="bolt" href="/getting-started/quickstarts/import-from-bolt/">
    ⏱️ *4분*

    Agent의 도움으로 Bolt 프로젝트를 Replit으로 마이그레이션합니다.
  </Card>

  <Card title="Lovable에서 가져오기" icon="heart" href="/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4분*

    Lovable 프로젝트를 Replit으로 옮겨 계속 개발하세요.
  </Card>
</CardGroup>

### 워크스페이스 기능

Replit은 다음과 같은 필수 앱 제작 도구를 제공합니다:

* 앱의 [실시간 미리보기](/core-concepts/workspace/editor-and-tools/preview)
* [몇 분 만에 게시](/category/replit-deployments)
* 설치 및 설정이 필요 없는 브라우저 네이티브 앱
* [풀 기능 코드 에디터](/core-concepts/workspace/editor-and-tools)
* 스마트폰이나 태블릿에서 앱을 만들 수 있는 [모바일 앱](/platforms/mobile-app)
* [AI 기반 앱 제작 지원](/core-concepts/agent)
* 변경 사항을 추적하는 [버전 관리 통합](/core-concepts/workspace/version-control)
* 함께 개발하는 [팀 협업](/ko/category/teams)

### AI 컴패니언 기능

Replit [Agent](/core-concepts/agent)는 다음과 같은 기능으로 앱 제작을 가속화합니다:

* 자연어 설명으로 완전한 앱 생성 및 설정
* 코드 제안 및 자동 완성
* 자동 오류 감지 및 디버깅 지원
* 앱 문서 생성
...
다음 도구를 사용하여 몇 분 만에 앱을 게시하세요:

* 몇 번의 클릭으로 클라우드에 앱 게시
* 데이터베이스 연동 및 호스팅
* 사용자 지정 도메인 지원 및 애플리케이션 연결 암호화

## 신뢰를 기반으로

<CardGroup cols={3}>
  <Card title="SOC 2 Type 2" icon="shield-check">
    독립적으로 감사된 보안 제어 및 데이터 보호 관행.
  </Card>

  <Card title="GDPR 준수" icon="lock">
    유럽 규제 기준을 충족하는 데이터 개인정보 보호.
  </Card>

  <Card title="엔터프라이즈 지원" icon="building" href="/ko/category/teams">
    SSO/SAML, 역할 기반 접근 제어, 관리자 설정, 전담 지원.
  </Card>
</CardGroup>

## 추가 정보

Replit의 모든 기능에 대해 자세히 알아보려면 다음 리소스를 참고하세요:

* [스타터 플랜](/ko/billing/plans/starter-plan): 스타터 플랜 기능과 무료로 만들 수 있는 것을 알아보세요
* [워크스페이스 기능](/core-concepts/workspace/editor-and-tools)에서 워크스페이스 기능을 알아보세요.
* [Replit Agent](/core-concepts/agent/)에서 Replit AI 기반 기능의 역량을 알아보세요.
* [Replit 앱 공유](/replit-app/collaborate/)에서 작품을 공유하는 방법을 알아보세요.
* iOS 또는 Android 기기용 [모바일 앱을 다운로드](https://replit.com/mobile/)하세요.
