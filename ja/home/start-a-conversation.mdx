---
title: "会話を始める"
description: "簡単な質問、ウェブでのリサーチ、または連携済みのコンテキストから会話を始め、次に何をするかを選びましょう。"
---
...
ワークスペースの準備が整いました。いよいよコーヒーショップのアイデアを前進させましょう。
[会話](/ja/chat/conversations)を始め、Replit に作りたいものを伝えて、最初のアイデアを
実際のローンチプランへと変えていきましょう。

## 新しい会話を始める

Replit のサイドバーで **New** を選択します。これにより、コンセプトを形作り、市場を
リサーチし、ローンチを計画する会話が開きます。

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="New ボタンが強調表示され、提案プロンプトとメッセージボックスが表示された Demo ワークスペースの Replit ホーム画面" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

## プロンプトボックスを見てみる

**New** を選択したら、プロンプトボックスを確認しましょう。ここで Replit に方向性を伝え、
役立つコンテキストを追加し、コーヒーショップのローンチを進めていきます。次のステップは、
最初のプロンプトを書くことです。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="ファイルのアップロード、新規作成、プロジェクトのインポート、スキルやデザインシステムの利用、インテグレーションの追加といったオプションを表示するプロンプトボックスのプラスメニュー" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

## 次のステップ

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ja/home/describe-your-idea">
    ...
    <div className="chat-example-tag">最初のプロンプト</div>
    <div className="chat-card-title">コンセプトを形にする</div>
    <p>コーヒーショップのローンチに向けた、的を絞った最初のリクエストを書きましょう。</p>
