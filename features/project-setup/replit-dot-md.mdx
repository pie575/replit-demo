---
title: "replit.md"
description: "Learn how to use replit.md to customize Agent's behavior, coding style, and project context."
icon: "file-lines"
---
...
<Note>You can edit the `replit.md` file to customize Agent's behavior.</Note>
