...
description: "Apprenez comment Agent teste votre application dans un vrai navigateur et corrige automatiquement les problèmes qu'il détecte."
---
...
<Note>
  Les tests d'application font partie des capacités autonomes d'Agent, en plus de la révision de code intégrée. En savoir plus sur les autres [fonctionnalités
...
<Frame>
  <img src="/assets/mirror/app-testing-takeover-6e0b0b56f4d0.png" alt="Interface de prise en main des tests d'application montrant les boutons Ignorer et Commencer la prise en main avec des instructions pour gérer les erreurs et les CAPTCHAs" width="924" height="358" data-path="images/replitai/app-testing-takeover.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/app-testing-replay-photo-0706a73801a1.png" alt="Interface de rediffusion vidéo interactive montrant la session de test avec les contrôles de navigation" width="1764" height="1394" data-path="images/replitai/app-testing-replay-photo.png" />
</Frame>
...
* Les tests d'application ne fonctionnent qu'avec les applications web[\*](#how-app-testing-works) pour l'instant
...
En savoir plus sur [Replit Agent](/fr/features/agent/overview) et ses capacités complètes.
