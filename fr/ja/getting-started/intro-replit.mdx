---
title: "Présentation"
description: "Replit est le moyen le plus rapide de transformer vos idées en applications. Créez et publiez de superbes projets depuis votre navigateur grâce à l’IA."
---
...
Replit est une plateforme basée sur l&#39;IA qui vous permet de créer et de publier des applications depuis un seul onglet de navigateur.
Inutile de vous soucier de la configuration d&#39;environnements de développement complexes : les outils de codage, de publication et de collaboration sont réunis dans une interface intégrée.

Le développement d&#39;applications traditionnel nécessite l&#39;installation de programmes, de langages et de packages, et la configuration peut prendre beaucoup de temps.
Avec Replit, la plateforme configure instantanément l&#39;environnement, ce qui vous permet de commencer à développer immédiatement, que vous soyez débutant ou développeur expérimenté.

<div align="center">
  <AgentInput />
</div>

Depuis un seul onglet de navigateur, vous disposez de tous les outils nécessaires pour créer des applications sans rien installer.
Grâce aux outils de codage basés sur l&#39;IA, à la collaboration en temps réel et au partage instantané, Replit transforme rapidement vos idées en applications.

<div id="section">
  ## Guide de démarrage rapide
</div>

Pour créer une application avec Replit, choisissez le guide qui répond à vos besoins :
...
<CardGroup cols={2}>
  <Card title="Créer votre première app" icon="robot" href="/fr/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 min*

    Créez votre première app avec les outils d’IA de Replit.
  </Card>

  <Card title="Remixer une app existante" icon="shuffle" href="/fr/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 min*

    Lancez rapidement un projet à partir d’une app créée par la communauté.
  </Card>
</CardGroup>
...
Replit propose les principaux outils de création d’applications suivants :

* [Aperçu en temps réel de votre application](/fr/core-concepts/workspace/editor-and-tools/preview)
* [Publication en quelques minutes](/fr/category/replit-deployments)
* Applications natives du navigateur, sans installation ni configuration
* [Éditeur de code complet](/fr/core-concepts/workspace/editor-and-tools)
* [Application mobile](/fr/platforms/mobile-app) permettant de créer des applications depuis un smartphone ou une tablette
* [Assistance par IA pour la création d’applications](/fr/core-concepts/agent)
* [Intégration du contrôle de version](/fr/core-concepts/workspace/version-control) pour suivre les modifications
* [Collaboration en équipe](/fr/ja/category/teams) pour le développement collaboratif

<div id="ai">
  ### Fonctionnalités d’AI Companion
</div>

L’[Agent](/fr/core-concepts/agent) de Replit accélère la création d’applications grâce aux fonctionnalités suivantes :

* Génération et configuration complètes d’applications à partir de descriptions en langage naturel
* Suggestions de code et saisie semi-automatique
* Détection automatique des erreurs et aide au débogage
* Génération de documentation pour les applications

<div id="section-5">
  ### Partagez votre application en quelques minutes
</div>

Vous pouvez publier votre application en quelques minutes grâce aux outils suivants :
...
<CardGroup cols={3}>
  <Card title="SOC 2 Type 2" icon="shield-check">
    Pratiques de sécurité et de protection des données validées par un audit indépendant.
  </Card>

  <Card title="Conformité au RGPD" icon="lock">
    Protection de la confidentialité des données conforme aux exigences réglementaires européennes.
  </Card>

  <Card title="Adapté aux entreprises" icon="building" href="/fr/ja/category/teams">
    SSO/SAML, accès basé sur les rôles, contrôles administrateur et assistance dédiée.
  </Card>
</CardGroup>
...
Pour en savoir plus sur toutes les fonctionnalités de Replit, consultez les ressources suivantes :

* [Forfait Starter](/fr/ja/billing/plans/starter-plan) : découvrez les fonctionnalités du forfait Starter et ce que vous pouvez créer gratuitement
* Découvrez les fonctionnalités de l’espace de travail dans [Fonctionnalités de l’espace de travail](/fr/core-concepts/workspace/editor-and-tools).
* Découvrez les fonctionnalités d’IA de Replit dans [Replit Agent](/fr/core-concepts/agent/).
* Découvrez comment partager vos applications Replit dans [Partager des applications Replit](/fr/replit-app/collaborate/).
* [Téléchargez l’application mobile](https://replit.com/mobile/) pour iOS ou Android.