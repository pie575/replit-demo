...
description: "Learn how to add payments and subscriptions to your app with Stripe using Agent."
...
<Steps>
  <Step title="Open the Publish pane">
    In your app, select **Publish** to start the live connection flow.
  </Step>

  <Step title="Install the Replit Integrated Payments app">
...
<Steps>
  <Step title="Open the Integrations tab">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-disconnect-1-integrations-371e1e7e5609.png" alt="Integrations tab showing Connectors with the Stripe integration and a Manage button" width="2000" height="1110" data-path="images/replitai/stripe-disconnect-1-integrations.png" />
    </Frame>
  </Step>

  <Step title="Expand your API keys">
    Select the chevron to expand your **Sandbox API keys** and **Live account API keys**, then select **Edit**.

    <Frame>
      <img src="/assets/mirror/stripe-disconnect-2-edit-keys-4e9e76c4065f.png" alt="Stripe sandbox and live account API keys expanded with Edit buttons" width="2000" height="1274" data-path="images/replitai/stripe-disconnect-2-edit-keys.png" />
    </Frame>
  </Step>

  <Step title="Disconnect your account">
    Select **Disconnect account** to remove the Sandbox connection and **Disconnect live account** to remove the Live connection.

    <Frame>
      <img src="/assets/mirror/stripe-disconnect-3-disconnect-f4257f534c5c.png" alt="Stripe sandbox and live account API keys with Disconnect account and Disconnect live account buttons" width="2000" height="1271" data-path="images/replitai/stripe-disconnect-3-disconnect.png" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Find a checkpoint from before the Stripe integration">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-rollback-5-clock-icon-c54cd19246ea.png" alt="Clock icon for viewing chat history and checkpoints" width="56" height="50" data-path="images/replitai/stripe-rollback-5-clock-icon.png" />
    </Frame>
  </Step>
  ...
  <Step title="Select Rollback here">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-rollback-6-checkpoint-2f195b0ea9ce.png" alt="Checkpoint with Rollback here button" width="904" height="202" data-path="images/replitai/stripe-rollback-6-checkpoint.png" />
    </Frame>
  </Step>
</Steps>
