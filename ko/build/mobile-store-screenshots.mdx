---
title: "App Store 스크린샷 생성하기"
description: "Replit의 내장 이미지 생성 기능을 사용해 PixelGames의 스토어 스크린샷을 만들어보세요."
---
...
<Frame caption="Agent가 PixelGames를 위해 생성한 다섯 장의 App Store 마케팅 스크린샷. 각각 고유한 헤드라인과 색상 테마를 가지고 있습니다.">
  <img src="/assets/mirror/appstore-screenshot-1cc502e24428.png" alt="헤드라인과 폰 프레임이 포함된 다섯 장의 생성된 PixelGames App Store 마케팅 스크린샷" data-path="images/pixelgames/mobile/appstore-screenshot.png" width="1917" height="990" data-path="images/pixelgames/mobile/appstore-screenshot.png" />
</Frame>
