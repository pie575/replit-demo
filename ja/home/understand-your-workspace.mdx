---
title: "ワークスペースを理解する"
description: "Replit のワークスペースが、人、プロジェクト、会話、ルーティン、データ、インテグレーション、セキュリティをどのようにまとめているかを理解しましょう。"
---
...
Replit のワークスペースは、あるアイデアに関するすべてのことが集まる場所です。
[プロジェクト](/ja/home/projects)、[会話](/ja/home/conversations)、
[ルーティン](/ja/chat/routines)、そしてインテグレーションをひとつにまとめることで、
初期の疑問から役立つ成果へと進めるようにします。

## コーヒーショッププロジェクトを準備する

コーヒーショップのアイデアを形にし始める前に、その置き場所を用意しましょう。この
ワークスペースは、ローンチの各要素が進展していく中でそれらをまとめておく役割を果たします。

* コンセプトを形にし、地域の市場をリサーチするための会話
* プランに役立つコンテキストを追加するファイルや連携済みのツール
* 後で競合やマーケットの変化を監視するルーティン
* やがてデザインし、公開することになるサイト

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Projects、Conversations、Routines、提案プロンプト、メッセージボックスが表示された Demo ワークスペースの Replit ホーム画面" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

このプロジェクトは、プロンプトボックスから始まります。ここから会話を始め、作りたい
コーヒーショップについて最初の説明を Replit に伝えます。

## ワークスペースの詳細

ワークスペースは、関係する人、設定、共有リソース、インテグレーション、請求もまとめて
管理します。アクセス権によって、閲覧・管理できる範囲が決まります。

ワークスペースの設定や組織の管理項目は、Agent がリクエストにどう応答するかを調整する
ための設定とは別のものです。

ローンチの間はいつでもワークスペースに戻り、それを支えるすべてのものを見つけることが
できます。

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ja/home/start-a-conversation">
    ...
    <div className="chat-card-title">会話を始める</div>
    <p>実現したい成果を説明することで、コーヒーショップのローンチを始めましょう。</p>
    <div className="chat-card-link">詳しく見る →</div>
  </a>

  <a className="chat-example has-visual" href="/ja/features/collaboration/workspaces">
    ...
    <div className="chat-example-tag">ワークスペースの詳細</div>
    <div className="chat-card-title">ワークスペースについてさらに詳しく</div>

    <p>
      個人ワークスペースとチームワークスペース、アクセス権、設定、管理について学びましょう。
    </p>
...
次に、[会話を始める](/ja/home/start-a-conversation)ことで、コーヒーショップの
アイデアを形にし始めましょう。
