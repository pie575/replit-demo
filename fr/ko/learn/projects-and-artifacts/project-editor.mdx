...
description: "Découvrez Project Editor : l'espace central de Replit où vous échangez avec Agent, voyez votre application prendre forme et gérez tout."
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="Écran d’accueil du Replit Project Editor avec un champ de saisie de prompt pour décrire ce que vous souhaitez créer" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

<div id="project-editor">
  ## Qu’est-ce que Project Editor ?
</div>

Project Editor est votre espace de travail central dans Replit : vous pouvez y commencer à créer, gérer vos projets et voir vos applications prendre vie. Décrivez ce que vous souhaitez créer, et [Agent](/fr/ko/features/agent/overview) écrit le code, configure votre projet et vous montre un aperçu en direct en temps réel.

<div id="section">
  ## Premiers pas
</div>

Dans la zone de prompt, indiquez ce que vous souhaitez créer. Décrivez votre idée en langage courant — « un outil de suivi budgétaire qui affiche mes dépenses sous forme de graphique », « une page de destination pour mon café », « un générateur de bandes dessinées IA pour enfants » — et Agent s’occupe du reste.
...
Pour démarrer rapidement, suivez [Créer votre première application](/fr/ko/build/your-first-app).
...
Activez le mode Plan à l’aide du bouton situé sous le champ de saisie. Pour en savoir plus, consultez le [guide du mode Plan](/fr/ko/features/agent/plan-mode).

<div id="section-2">
  ## Ce que vous pouvez créer
</div>

Choisissez un type de projet pour indiquer à Agent ce que vous souhaitez créer, ou décrivez votre idée et laissez Agent choisir la configuration appropriée.
...
* **Diapositives et présentations** — création de présentations aux mises en page élaborées
* **Animations** — visites guidées interactives et motion design
* **Design** — maquettes visuelles et prototypes dans [Design Canvas](/fr/ko/design/canvas)
* **Visualisation de données** — graphiques, tableaux de bord et outils basés sur des bases de données
...
Lorsque Agent commence à créer votre application, vous pouvez voir le projet prendre forme dans Project Editor. La conversation avec Agent s’affiche dans un panneau, tandis que l’aperçu en direct de l’application s’affiche dans l’autre.

<div id="section-3">
  ### Fils de discussion
</div>

Toutes les conversations avec Agent ont lieu dans des fils de discussion. Le fil principal vous permet de décrire ce que vous voulez et de voir Agent créer votre projet. Lorsque vous utilisez le [système de tâches](/fr/ko/core-concepts/agent/task-system), chaque tâche en arrière-plan possède son propre fil de discussion : Agent peut ainsi isoler les tâches sans mélanger les conversations.
...
Le tableau des tâches les organise en colonnes **Drafts**, **Active**, **Ready** et **Done**. À mesure qu’elles progressent, les tâches se déplacent de gauche à droite, ce qui vous permet de voir d’un coup d’œil celles qui sont planifiées, celles sur lesquelles Agent travaille et celles qui sont terminées. Pour en savoir plus, consultez le [système de tâches](/fr/ko/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Tableau des tâches organisé en colonnes Drafts, Active, Ready et Done" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>
...
Design Canvas est un éditeur visuel qui vous permet de créer et d’améliorer des maquettes avant de valider votre code. Faites glisser des éléments, ajustez les mises en page, itérez sur vos designs, puis laissez Agent les transformer en application fonctionnelle. Pour en savoir plus, consultez [Design Canvas](/fr/ko/design/canvas).

<div id="section-5">
  ## Collaboration
</div>

Créez un workspace d’équipe pour créer ensemble. Invitez des membres de l’équipe, partagez des projets et travaillez en temps réel sur la même application. Pour les paramètres de l’équipe, consultez les [workspaces d’équipe](/fr/ko/features/collaboration/team-workspaces) et, pour la collaboration au niveau des projets, [Inviter des membres de l’équipe](/fr/ko/build/invite-teammates).

<div id="section-6">
  ## Importer du code et des designs
</div>

Vous avez déjà un projet ? Importez-le depuis GitHub ou Figma dans Replit, ou téléversez directement vos fichiers. Agent peut reprendre là où vous vous étiez arrêté et continuer à créer à partir de votre code ou de votre design existant. Consultez [Importer dans Replit](/fr/ko/build/import-from-providers).
...
<CardGroup cols={2}>
  <Card title="Éditeur et outils" href="/fr/ko/features/editor/editor-and-tools" icon="window-restore">
    Panneau principal pour afficher l’aperçu de l’application, la sortie de la console et d’autres outils
  </Card>

  <Card title="Configuration de l’application" href="/fr/ko/features/project-setup/configuration" icon="gear">
    Paramètres, dépendances, secrets et configuration de l’environnement de l’application
  </Card>

  <Card title="Contrôle de version" href="/fr/ko/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Suivez les modifications, revenez à une version précédente et gérez l’historique de l’application
  </Card>

  <Card title="Publication" href="/fr/ko/learn/projects-and-artifacts/replit-deployments" icon="rocket">
    Déployez l’application sur une URL publique pour la rendre accessible à tous
  </Card>
</CardGroup>
...
<Accordion title="Dois-je savoir coder ?">
  Non. Décrivez ce que vous souhaitez en langage courant, et Agent se charge des détails techniques. Si vous le souhaitez, vous pouvez aussi modifier le code vous-même.
</Accordion>

<Accordion title="Que se passe-t-il si je ferme mon navigateur ?">
  Votre projet est enregistré dans le cloud. Vous pouvez revenir à tout moment et reprendre exactement là où vous vous êtes arrêté : vos fichiers, votre historique et vos applications en cours d’exécution sont conservés.
</Accordion>

<Accordion title="Puis-je travailler avec d’autres personnes ?">
  Oui. Vous pouvez inviter des collaborateurs à un projet spécifique ou créer un workspace d’équipe dont les membres ont accès à tous les projets. Consultez les [workspaces d’équipe](/fr/ko/features/collaboration/team-workspaces) et [Inviter des membres de l’équipe](/fr/ko/build/invite-teammates).
</Accordion>

<Accordion title="Comment publier mon application ?">
  Lorsque votre application est prête, publiez-la directement sur une URL publique depuis Project Editor. Consultez les [déploiements](/fr/ko/learn/projects-and-artifacts/replit-deployments).
</Accordion>
...
Project Editor est disponible avec tous les plans. Certaines fonctionnalités, comme une puissance de calcul accrue et les déploiements toujours actifs, nécessitent un plan payant. Pour en savoir plus, consultez la [facturation](/fr/ko/billing/ai-billing).