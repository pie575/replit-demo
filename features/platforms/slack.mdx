---
title: "Replit in Slack"
description: "Mention @Replit in Slack to turn a prompt into a working prototype — without leaving your team's workspace."
sidebarTitle: "Slack"
icon: "slack"
---
...
<Frame>
  <img src="/assets/mirror/allow-replit-app-access-slack-32f482f7a39e.png" alt="Slack consent screen titled 'Allow the Replit app to access Slack', marked approved by Slack, with a workspace picker set to Replit, the information the Replit app can view and the actions it can take, and Cancel and Allow buttons" width="1816" height="1358" data-path="images/replitai/slack/allow-replit-app-access-slack.png" />
</Frame>
