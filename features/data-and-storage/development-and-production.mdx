...
description: "Understand your app's two databases: the development database you build with and the production database that serves your published app."
...
<Frame>
  <img src="/assets/mirror/production-databases-fed331a9f523.jpg" alt="Production database management interface" width="1080" height="471" data-path="images/databases/production-databases.jpg" />
</Frame>
...
<Note>
  Each Neon project includes a direct and a pooled connection string. A direct connection string looks like `postgresql://neondb_owner:<password>@<host>.<region>.neon.tech/<db>?sslmode=require`.

  To use the pooled connection, append `-pooler` to the host: `postgresql://neondb_owner:<password>@<host>-pooler.<region>.neon.tech/<db>?sslmode=require`.
</Note>
