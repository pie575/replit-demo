...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <div className="welcome-actions">
        <a className="welcome-action primary" href="/zh/ko/home/get-started">开始使用 <span aria-hidden="true">→</span></a>
  ...
  <section className="welcome-journey-strip" aria-label="Replit 引导之旅">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="以“为日常留一处静谧空间”为标题的咖啡店开业网站" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>
    ...
    <div className="welcome-journey-copy">
      ...
      <p>
        从第一次对话开始，跟随引导式流程完成调研、规划、设计
        直至发布。
      </p>

      <a className="welcome-journey-link" href="/zh/ko/home/get-started">
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/zh/ko/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="代表 Replit Chat 的小型对话窗口">
      ...
      <a className="welcome-product-card" href="/zh/ko/build/your-first-app">
      ...
      <a className="welcome-product-card" href="/zh/ko/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="代表 Replit Design 的选中画布布局">
          <span className="product-path-layer product-path-back" />
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">开始使用 Replit</h2>
      <p>选择你想在哪里使用 Replit，然后登录或注册账户。网页版、桌面应用、移动应用，随处可用。</p>
    </div>
