...
description: "Ajoutez à une Conversation des documents, feuilles de calcul, images ou captures d’écran pertinents, puis indiquez à Replit comment ces informations doivent contribuer à votre demande."
...
Téléverser des documents, feuilles de calcul, images et captures d’écran permet de fournir à Replit des éléments, des exigences ou des indications visuelles plus faciles à transmettre qu’à décrire.

<div id="how-to-upload-a-file">
  ## Comment téléverser un fichier
</div>

Dans le champ de prompt, sélectionnez le bouton **plus**, puis choisissez **Téléverser un fichier**. Vous pouvez également glisser-déposer un fichier dans le champ de prompt. Ajoutez le fichier avant d’envoyer la requête qui en dépend.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu du bouton plus du champ de prompt, avec Téléverser un fichier comme première option" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* Donner à Replit des orientations ou des informations sur une app que vous souhaitez créer.
