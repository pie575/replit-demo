---
title: "Canvas"
description: "Open, navigate, and add to the canvas, the infinite surface where Replit Design displays your frames."
sidebarTitle: "Canvas"
icon: "object-group"
---
...
<Frame caption="The right-click menu on a selected frame.">
  <img src="/assets/mirror/canvas-right-click-menu-4c9edd367894.png" alt="The right-click menu open on a selected Design frame showing a gray Apex X1 supercar, with Edit, Chat, Focus, Cursor chat, Reorder, Copy, Paste, Export as…, Duplicate, Delete, and Select all actions." width="2000" height="1252" data-path="images/replitai/canvas-right-click-menu.png" />
</Frame>
