...
description: "Créez des assets d’images, de vidéos, de graphiques vectoriels, d’animations et audio, puis consultez les guides officiels pour chaque workflow."
...
Demandez à Replit les médias dont vous avez besoin, puis affinez le résultat dans la Conversation ou depuis l&#39;écran produit dédié à ce workflow. Choisissez le parcours d&#39;assets correspondant au résultat souhaité.

<div id="asset">
  ## Choisir un type d&#39;asset
</div>

<section className="chat-mkt chat-workflow-grid has-visuals catalog-three-up">
  <a className="chat-example has-visual" href="/fr/ko/features/agent/image-generation">
    ...
    <p>
      Créez des images personnalisées, des illustrations, des arrière-plans, des icônes
      et d&#39;autres contenus visuels pour votre Project.
    </p>

    <div className="chat-card-link">Ouvrir Image Generation →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/ko/design/toolbar#generate">
    ...
    <p>
      Créez de courts clips animés et des animations avec l&#39;outil Generate media
      de Replit Design.
    </p>
  ...
  <a className="chat-example has-visual" href="/fr/ko/design/toolbar#generate">
    ...
    <p>
      Créez des icônes SVG, des logos, des diagrammes et des illustrations stylisées
      dans Replit Design.
    </p>
  ...
  <a className="chat-example has-visual" href="/fr/ko/features/artifact-types/animated-videos">
    ...
    <p>
      Créez des motion designs par programmation au fil d&#39;une Conversation, puis exportez
  ...
  <a className="chat-example has-visual" href="/fr/ko/features/agent/audio-generation">
    ...
    <p>Créez de la musique, des effets sonores et des narrations pour votre application.</p>
    <div className="chat-card-link">Ouvrir Audio Generation →</div>
  </a>
</section>

La création d’assets génère immédiatement un résultat. Pour les tâches à répéter selon un calendrier, consultez [Exécuter une Routine](/fr/ko/chat/routines).

Les clips vidéo générés et les vidéos animées suivent des flux de travail différents. Les vidéos animées sont des animations graphiques programmatiques exportables au format MP4. Pour des exemples d’assets visuels, consultez [Concevoir votre premier écran](/fr/ko/design/design-your-first-screen).

<div id="section">
  ## Intégrer les dernières informations
</div>

Web Search ne crée pas d’assets. Utilisez-le lorsque des images, extraits audio, vidéos ou éléments graphiques doivent refléter les dernières informations, puis demandez à Replit de créer les assets adaptés.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ko/features/agent/web-search">
    ...
    <p>
      Collectez les dernières informations et leurs sources avant de créer des assets.
    </p>
