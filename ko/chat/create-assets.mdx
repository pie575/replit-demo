---
title: "asset 만들기"
description: "이미지, 비디오, 벡터 그래픽, 애니메이션, 오디오 asset을 만들고 각 workflow의 공식 가이드를 따라 진행하세요."
sidebarTitle: "asset 만들기"
icon: "photo-film"
...
작업에 필요한 미디어를 Replit에 요청해 생성한 다음, Conversation이나 해당 workflow를 담당하는 제품 화면에서 결과물을 다듬으세요. 원하는 결과에 맞는 asset 경로를 선택하세요.
...
<section className="chat-mkt chat-workflow-grid has-visuals catalog-three-up">
  <a className="chat-example has-visual" href="/ko/features/agent/image-generation">
    ...
    <div className="chat-card-title">이미지 생성</div>

    <p>
      Project에 사용할 맞춤 이미지, 일러스트, 배경, icon 등 다양한 시각
      콘텐츠를 만듭니다.
    </p>
  ...
  <a className="chat-example has-visual" href="/ko/design/toolbar#generate">
    ...
    <div className="chat-card-title">비디오 클립 생성</div>

    <p>
      Replit Design의 Generate 미디어 도구로 짧은 모션 클립과 애니메이션을
      만듭니다.
    </p>
  ...
  <a className="chat-example has-visual" href="/ko/design/toolbar#generate">
    ...
    <div className="chat-card-title">벡터 그래픽 생성</div>

    <p>
      Replit Design에서 SVG icon, logo, 다이어그램, 스타일이 적용된 일러스트를
      만듭니다.
    </p>
  ...
  <a className="chat-example has-visual" href="/ko/features/artifact-types/animated-videos">
    ...
    <p>
      Conversation에서 프로그래밍 방식의 모션 그래픽를 만들고 결과물을
      비디오로 내보냅니다.
    </p>
  ...
  <a className="chat-example has-visual" href="/ko/features/agent/audio-generation">
    ...
    <p>App에 사용할 음악, 음향 효과, 음성 내레이션을 만듭니다.</p>
    <div className="chat-card-link">Audio Generation 열기 →</div>
  </a>
</section>

asset 생성은 즉시 결과물을 만들어냅니다. schedule에 따라 반복해야 하는 작업이라면 [정기 작업 실행하기](/ko/chat/routines)로 이동하세요.

생성된 비디오 클립과 Animated Videos는 서로 다른 workflow를 사용합니다. Animated Videos는 MP4로 내보낼 수 있는 프로그래밍 방식의 모션 그래픽입니다. 시각적 asset 예시는 [첫 화면 디자인하기](/ko/design/design-your-first-screen)를 참고하세요.

<div id="bring-in-current-information">
  ## 최신 정보 가져오기
</div>

Web Search는 asset을 직접 만들지 않습니다. 이미지, 오디오 클립, 비디오, 그래픽에 최신 정보를 반영해야 할 때 사용하고, 그렇게 잡은 direction을 바탕으로 적절한 asset을 만들어 달라고 Replit에 요청하세요.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ko/features/agent/web-search">
    ...
    <p>
      asset을 만들기 전에 최신 정보와 출처가 명시된 자료를 모아 보세요.
    </p>
