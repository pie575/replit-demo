...
sidebarTitle: "Executar tarefas de rotina"
tag: "New"
icon: "arrows-rotate"
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/schedule-a-routine">
    ...
    <div className="chat-card-title">Agendar uma routine</div>
    <p>Siga o guia rápido para criar e agendar trabalho recorrente.</p>
    <div className="chat-card-link">Abrir o guia rápido →</div>
  </a>

  <a className="chat-example has-visual" href="/pt/chat/agent-modes">
    ...
    <div className="chat-card-title">Como as Routines são executadas</div>

    <p>
      As Routines agendadas são executadas no Power ou no Max Mode, não no Free Mode.
    </p>

    <div className="chat-card-link">Saiba mais sobre os Modos do Agent →</div>
  </a>
</section>

Depois de decidir o que deve ser executado, compare os [Modos do Agent](/pt/chat/agent-modes) para escolher como o Replit aborda a tarefa.
