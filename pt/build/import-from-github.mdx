...
export const setupDescription_0 = "O Replit detecta a stack do app, instala dependências e configura comandos de execução"

## Importar do GitHub

⏰ *Tempo estimado: dois minutos*

Importe um repositório do GitHub para o Replit para executar, testar e publicar mais rápido.

Para opções de importação abrangentes incluindo outras plataformas como Figma, Bolt e Lovable, consulte a [documentação do recurso de Importação](/pt/references/workspace/import).
...
* Valores de secrets e variáveis de ambiente existentes
* Serviços específicos da plataforma que não executam no Replit por padrão
