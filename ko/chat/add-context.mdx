---
title: "컨텍스트 추가"
description: "Conversation을 이해하는 데 필요한 관련 파일, 소스, 연결된 도구, 기존 작업물을 Replit에 제공하세요."
...
Replit이 요청을 이해하는 데 도움이 될 만한 관련 컨텍스트와 Tools를 추가하세요. 유용한 컨텍스트는 Replit에 의도를 더 명확하게 전달하고 결과물의 품질을 높여줍니다.

<div id="how-do-i-add-context">
  ## 컨텍스트는 어떻게 추가하나요?
</div>

prompt box에서 **더하기** 메뉴를 선택하면 파일을 업로드하거나, 기존 작업물을 가져오거나, Skill 또는 design system을 사용하거나, integration을 추가할 수 있습니다.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Upload a file, Create something new, Import an existing project, Use a skill, Use a design system, Add an integration 항목이 있는 prompt box 더하기 메뉴" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
파일, 스크린샷과 이미지, 웹 소스와 리서치, 연결된 도구를 추가할 수 있습니다. 현재 task에 도움이 되는 소스를 선택하세요:

* **[파일, 스크린샷, 이미지](/ko/chat/upload-and-use-files):** 유용한 근거나 requirements가 담긴 문서, 스프레드시트, 내보낸 자료, 스크린샷, 시각 자료를 추가하세요.
* **[웹 소스 및 리서치](/ko/features/agent/web-search):** 최신 정보나 외부 관점이 결과를 더 낫게 만들 수 있다면 Replit에 웹 검색을 요청하세요.
* **[Integrations](/ko/chat/integrate-your-tools):** 필요한 도구를 연결한 다음, Replit이 참고해야 할 서비스, 채널, 레코드 등의 정보를 지정하세요.
* **[디자인 컨텍스트](/ko/chat/work-with-figma):** layout, 위계, visual direction이 중요할 때는 Figma frame을 첨부하세요.
* **[기존 작업물](/ko/chat/import-a-project):** 코드, 디자인 또는 다른 곳에서 만든 작업물을 이어서 build하려면 Project를 import하세요. Project를 import하는 것은 파일을 근거로 첨부하는 것과는 다릅니다.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ko/chat/upload-and-use-files">
    ...
    <div className="chat-card-title">파일 업로드 및 활용</div>
    <p>업로드한 파일에 대해 질문하거나 근거 자료로 활용하세요.</p>
  ...
  <a className="chat-example has-visual" href="/ko/chat/work-with-figma">
    ...
    <p>비주얼 디렉션이 중요할 때 특정 frame을 사용하세요.</p>
    <div className="chat-card-link">살펴보기 →</div>
  </a>
  ...
  <a className="chat-example has-visual" href="/ko/chat/integrate-your-tools">
    ...
    <div className="chat-card-title">도구 연동하기</div>
    <p>관련 정보를 보유하거나 작업을 지원하는 서비스를 연결하세요.</p>
    <div className="chat-card-link">살펴보기 →</div>
  </a>
  ...
  <a className="chat-example has-visual" href="/ko/chat/import-a-project">
    ...
    <p>
      기존 코드나 디자인, 그 밖의 프로젝트 작업물을 이어서 개발하세요.
    </p>
...
최신 공개 정보가 필요하다면 [Web Search 가이드](/ko/features/agent/web-search)를 참고하세요. [MCP](/ko/chat/connect-through-mcp)는 호환되는 도구 및 클라이언트를 위한 별도의 확장 경로입니다.