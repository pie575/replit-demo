---
title: "Conversations и Projects"
description: "Узнайте, когда продолжать работу в Conversation, а когда переводить масштабную работу в Project."
sidebarTitle: "Conversations и Projects"
tag: "New"
icon: "objects-column"
...
В Replit вы работаете либо в Conversation, либо над Project. Conversations предназначены для вопросов, исследования, уточнений и Routines. Projects — для создания приложений, слайдов и дизайнов.

[Узнайте, как превратить Conversation в Project.](/ru/chat/continue-or-create-a-project)

<div id="how-they-differ">
  ## Чем они отличаются
</div>

Хотя Conversations и Projects связаны между собой, они предназначены для разных задач. Вот основные различия:

| Область                  | Conversations                            | Projects                                                                                                                                       |
| ------------------------ | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Лучше всего подходят для | Вопросов, исследований и Routines        | Более сложной работы в Build и Design: создания приложений, презентаций, панелей мониторинга и нескольких артефактов                           |
| Структура                | Одна ветка обсуждения                    | Рабочее пространство Project с несколькими артефактами                                                                                         |
| Фоновые задачи           | Недоступны                               | Могут выполняться параллельно                                                                                                                  |
| Routines                 | Доступны                                 | Недоступны                                                                                                                                     |
| Integrations             | Доступны                                 | Доступны                                                                                                                                       |
| Может создавать          | Ассеты: документы, изображения и таблицы | Ассеты: документы, изображения и таблицы, а также [Artifacts](/ru/features/projects-and-artifacts/artifacts): презентации, приложения и веб-сайты |
| Publishing               | Публикация недоступна                    | Можно опубликовать и сделать общедоступными                                                                                                    |
