---
title: "후속 메시지 조정 또는 대기열에 추가하기"
description: "Steer와 Queue가 Agent의 후속 메시지를 처리하는 방식을 알아보고, Conversation 및 Project 환경설정을 지정하며, Agent가 Replit에서 작업하는 동안 메시지를 관리하세요."
---
...
<Frame caption="Agent는 후속 메시지를 대기열에 넣는 대신 조정할 수 있습니다.">
  <img src="/assets/mirror/agent-follow-ups-steer-notice-2ad1f91a6337.png" alt="열기 설정 및 조정 활성화 작업이 포함된 후속 조정 알림" width="477" height="264" data-path="images/replitai/agent-follow-ups-steer-notice.png" />
</Frame>
