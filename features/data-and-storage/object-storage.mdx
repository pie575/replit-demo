---
title: "App Storage"
description: "Learn how to use App Storage to host and manage file uploads like images, videos, and documents."
...
<Accordion title="How to access the App Storage tool">
  ...
  2. Select <img class="icon-svg" src="/assets/mirror/object-storage-monoochrome-icon-aaba8f517280.svg" alt="App Storage icon" width="16" height="16" data-path="images/icons/object-storage-monoochrome-icon.svg" /> **App Storage**.
...
1. Navigate to the **Objects** view in the **App Storage** tab.
2. Select the <img class="icon-svg" src="/assets/mirror/download-icon-c7b527953d65.svg" alt="download icon" width="16" height="16" data-path="images/icons/download-icon.svg" /> download icon to the right of the file to download it.
...
1. Navigate to the **Objects** view in the **App Storage** tab.
2. Select <img class="icon-svg" src="/assets/mirror/create-folder-c9acf112a042.svg" alt="create folder icon" width="16" height="16" data-path="images/icons/create-folder.svg" /> **Create Folder** in the **Objects** view.
...
1. Navigate to the **Objects** view in the **App Storage** tab.
2. Select the <img class="icon-svg" src="/assets/mirror/trash-icon-4674cd09b8db.svg" alt="trash icon" width="16" height="16" data-path="images/icons/trash-icon.svg" /> trash icon
...
3. Select <img class="icon-svg" src="/assets/mirror/trash-icon-4674cd09b8db.svg" alt="trash icon" width="16" height="16" data-path="images/icons/trash-icon.svg" /> **Delete Bucket**.
...
1. Select <img class="icon-svg" src="/assets/mirror/workspace-search-icon-d20ee3e562fb.svg" alt="magnifying glass icon" width="16" height="16" data-path="images/icons/workspace-search-icon.svg" />
