...
description: "Démarrez une Conversation avec une question rapide, une recherche sur le Web ou du contexte connecté, puis choisissez la suite."
---
...
Votre espace de travail est prêt. Il est temps de concrétiser votre idée de café.
Lancez une [Conversation](/fr/ko/chat/conversations), expliquez à Replit ce que vous souhaitez créer
et commencez à transformer votre première idée en véritable plan de lancement.

<div id="section">
  ## Démarrer une nouvelle conversation
</div>

Dans la barre latérale de Replit, sélectionnez **New**. Une Conversation s’ouvre alors pour vous permettre d’affiner votre idée, d’étudier le marché et de planifier le lancement.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Écran d’accueil de Replit dans l’espace de travail Demo, avec le bouton New mis en évidence, des prompts suggérés et une zone de message" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

<div id="section-2">
  ## Découvrir la zone de prompt
</div>

Après avoir sélectionné **New**, découvrez la zone de prompt. C’est ici que vous
indiquerez à Replit la marche à suivre, ajouterez du contexte utile et poursuivrez la création de votre café.
L’étape suivante consiste à rédiger votre premier prompt.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu Plus de la zone de prompt proposant des options pour téléverser des fichiers, créer un projet, importer un projet, utiliser des skills ou un système de design, et ajouter des intégrations" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ko/home/describe-your-idea">
    ...
    <div className="chat-card-title">Précisez votre idée</div>
    <p>Rédigez une première demande claire et ciblée pour lancer un café.</p>
