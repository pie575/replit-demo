---
title: "Replit Agent"
description: "O Replit Agent transforma suas ideias em aplicativos, designs, apresentações e muito mais, tudo em linguagem simples. Sem necessidade de programação."
---
...
<Steps>
  <Step title="Descreva o que você quer">
    No [Editor de Projetos](/pt/learn/projects-and-artifacts/project-editor), basta começar a conversar. Descreva um aplicativo que você quer construir, faça uma pergunta, pesquise um tópico ou obtenha dados de [serviços conectados](/pt/features/agent/general-agent) como BigQuery, Slack ou Notion. Não há restrições. O Replit Agent lida com o que você jogar nele.
  ...
  <Step>
    Converse com o Agent para refinar seu projeto, depois publique quando estiver pronto. Todos os artefatos são publicados juntos.
  </Step>
</Steps>

<Note>Você não está preso a um único tipo. Comece com um aplicativo web e adicione um aplicativo móvel, apresentações ou um vídeo depois — tudo no mesmo projeto.</Note>
...
<Frame>
  <img src="/assets/mirror/task-accept-plans-d70b85ce3421.png" alt="Diálogo de planos de tarefas criados mostrando quatro tarefas propostas com as opções Aceitar tarefas e Revisar plano" width="3430" height="1986" data-path="images/replitai/task-accept-plans.png" />
</Frame>

Saiba mais no [guia do modo Plan](/pt/features/agent/plan-mode).

### Modos do Agent

Escolha como o Agent constrói seu projeto:

<Frame caption="O popover de modos do Agent com os modos Free, Power e Max.">
  <img src="/assets/mirror/model-selector-power-mode-52facbd1e206.png" alt="Popover de modos do Agent mostrando os modos Free, Power e Max com Power selecionado, uma lista Primary model e um controle deslizante Effort" width="1452" height="966" data-path="images/replitai/model-selector-power-mode.png" />
</Frame>

* **Free Mode**: Trabalho do dia a dia do Agent sem custo para assinantes Core e Pro. Sua cota é redefinida a cada cinco horas e tem um limite semanal. O nível Starter mantém seus limites atuais. Verifique **Configurações → Uso** para ver seu uso.
* **Power**: Um modo pago, de nível intermediário, com modelos poderosos a um preço acessível.
* **Max**: Um modo pago, de nível superior, com os melhores modelos de ponta para o trabalho mais exigente. Em **Configurações avançadas**, você também pode ativar o **Turbo** para execuções mais rápidas.

Se uma solicitação precisar de mais capacidade do que o Free Mode oferece, o Agent pode oferecer uma opção paga de **Permitir uma vez**. O Replit pede confirmação antes que uma ação paga seja iniciada, e o Agent retorna ao Free Mode depois.

<Note>Dica: Você também pode ativar o **[modo Plan](/pt/features/agent/plan-mode)** para revisar e iterar no plano do Agent antes que a construção comece.</Note>

## O que você pode construir com o Replit Agent

* **Aplicativos web, aplicativos móveis, dashboards de dados e ferramentas com IA**
* **Designs visuais e prototipagem** — explore mockups no [Design Canvas](/pt/design/canvas) antes de se comprometer com código
...
<Accordion title="Qual é a diferença entre Free, Power e Max?">
  **Free Mode** é o trabalho do dia a dia do Agent sem custo para assinantes Core e Pro, dentro de uma cota. **Power** é um modo pago, de nível intermediário, com modelos poderosos a um preço acessível. **Max** é o modo pago, de nível superior, para o trabalho mais exigente. **Turbo** é uma opção alternável opcional exclusiva do Max em Configurações avançadas.

  Ações pagas exigem confirmação antes de serem iniciadas.
</Accordion>

<Accordion title="Posso construir mais de uma coisa em um projeto?">
  Sim. Você pode adicionar aplicativos web, aplicativos móveis, apresentações, vídeos e visualizações de dados ao [mesmo projeto](/pt/features/projects-and-artifacts/artifacts#multiple-artifacts-in-one-project) — todos compartilhando o mesmo backend e os mesmos dados.
</Accordion>
...
O Turbo está desativado por padrão — ative-o por projeto quando precisar, com o Max selecionado. O Free Mode não está disponível para o Enterprise no lançamento. Os workspaces Enterprise terão uma experiência dedicada do Agent pouco depois; o administrador terá os detalhes.

Para preços detalhados, veja [faturamento do Agent](/pt/billing/ai-billing#agent-billing).

## Próximos passos

<CardGroup cols={2}>
  <Card title="Agent Skills" icon="puzzle-piece" href="/pt/features/agent/skills">
    Ensine ao Agent conhecimento especializado — use skills prontas ou crie as suas.
  </Card>

  <Card title="Sistema de tarefas" icon="list-check" href="/pt/core-concepts/agent/task-system">
    Planejamento Kanban, tarefas em segundo plano e alterações aplicadas de volta à versão principal.
  </Card>

  <Card title="Design Canvas" icon="paintbrush" href="/pt/design/canvas">
    Mockups visuais e o editor visual prático.
  </Card>

  <Card title="Connectors" icon="plug" href="/pt/features/agent/general-agent">
  ...
  <Card title="Guia de vibe coding" icon="wand-magic-sparkles" href="/pt/learn/build-with-agent">
    Dicas para prompting eficaz e para construir com IA.
  </Card>
</CardGroup>
