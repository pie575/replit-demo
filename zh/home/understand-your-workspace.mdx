---
title: "了解你的 workspace"
description: "了解 Replit Workspace 如何将成员、Projects、Conversations、Routine、数据、集成与安全整合在一起。"
sidebarTitle: "了解你的 workspace"
icon: "briefcase"
...
你的 Replit Workspace 汇集了与某个想法相关的一切。它将
[Projects](/zh/home/projects)、[Conversations](/zh/home/conversations)、
[Routine](/zh/chat/routines) 和集成整合在一起，让你从最初的
一个问题出发，最终得到有价值的成果。
...
在着手打磨咖啡店这个创意之前，先给它安个家。这个 Workspace 会把开店筹备过程中逐步产生的各个部分集中到一处：

* 一个用于打磨概念、调研本地市场的 Conversation
* 为方案补充有用上下文的文件和已连接工具
* 一个稍后用来关注竞争动向和市场变化的 Routine
* 你最终会设计并发布的网站
...
这个项目正是从提示框开始的。在这里，你将开启一个 Conversation，向 Replit 首次描述你想创建的咖啡店。

<div id="workspace-details">
  ## Workspace 详情
</div>

它还把相关的人员、设置、共享资源、集成和计费集中在一处。你的访问权限决定了你能查看和管理哪些内容。

Workspace 设置和组织管控与你用来调整 Agent 如何响应请求的控制项彼此独立。

在整个上线过程中，你随时可以回到 Workspace，找到支撑它的一切。

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/home/start-a-conversation">
    ...
    <div className="chat-card-title">开始一次对话</div>
    <p>描述你想要的结果，开启咖啡店项目的上线之旅。</p>
    <div className="chat-card-link">探索 →</div>
  </a>

  <a className="chat-example has-visual" href="/zh/features/collaboration/workspaces">
    ...
    <div className="chat-example-tag">Workspace 详情</div>
    <div className="chat-card-title">进一步了解 workspace</div>

    <p>
      了解个人 Workspace 和 Team Workspace，以及访问权限、设置与管理。
    </p>
...
接下来，[开始一次对话](/zh/home/start-a-conversation)，着手打磨这个咖啡店的构想。