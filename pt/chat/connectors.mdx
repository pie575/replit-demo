...
<div className="chat-mkt" role="img" aria-label="Ícone de fluxo de trabalho em camadas representando os Connectors" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
