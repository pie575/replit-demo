---
title: "Explore"
description: "Go wide before you commit: follow suggestions, pull in templates and inspiration, and switch models, all landing as new frames."
...
<Frame caption="Suggestions appear beside the selected frame, one click each.">
...
<Frame caption="The Inspiration tab: app screens from real products, curated by Mobbin.">
...
<Columns cols={3}>
  ...
  <Card title="Templates & inspiration" icon="shapes" href="/design/add-templates-and-inspiration">
    Start from a template or steer by real app screens.
  </Card>

  <Card title="Explore with models" icon="microchip" href="/design/explore-with-different-models">
