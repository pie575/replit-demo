...
description: "Entenda o Model Context Protocol (MCP) — o que é, como funciona e por que é importante para aplicações de IA."
...
<Frame>
  <img src="/assets/mirror/mcp-a04e01a01743.avif" alt="Diagrama MCP mostrando modelos de IA se conectando a ferramentas externas e fontes de dados" width="1920" height="1055" data-path="images/tutorials/mcp.avif" />
</Frame>
...
<AccordionGroup>
  <Accordion title="O que é um cliente MCP?">
    Um cliente MCP é algo como Claude, o Replit Agent ou uma interface de linha de comando que se conecta a um grande modelo de linguagem. É o "dispositivo" que se conecta a ferramentas ou fontes de dados externas.
  ...
  <Accordion title="O que é um servidor MCP?">
    Um servidor MCP fornece ferramentas e capacidades a modelos de IA. Pense nisso como dar à IA um conjunto de ferramentas especializadas para resolver problemas.

    Exemplos do que os servidores MCP permitem:
...
| -------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| **Ideal para** | Fluxos de trabalho, convenções, materiais de referência                     | Conectar a serviços externos, tomar ações                                 |
| **Carrega**    | Leve — apenas nome + descrição até ser invocado                             | Mais pesado — todas as descrições de ferramentas carregam antecipadamente |
| **Define**     | *Como* seu agente deve funcionar                                            | *O que* seu agente pode acessar                                           |
| **Exemplo**    | Skill "Stock Analyzer" — pesquise investimentos com um framework específico | Servidor MCP "Stripe" — leia dados de pagamento e assinatura              |

Consulte [Agent Skills](/pt/learn/agent-skills) para a mentalidade correspondente sobre Skills.
...
<CardGroup cols={2}>
  <Card title="Conectar via MCP" icon="server" href="/pt/build/connect-via-mcp">
    Prático: conecte um servidor MCP pré-listado ou adicione um personalizado no Replit.
  </Card>

  <Card title="Referência de Servidores MCP" icon="folder-tree" href="/pt/features/mcp/overview">
    Catálogo de servidores pré-listados, modelo de segurança e opções de autenticação.
  </Card>

  <Card title="Agent Skills" icon="puzzle-piece" href="/pt/learn/agent-skills">
    A outra forma de estender o Agent — quando e como usar Skills.
  </Card>

  <Card title="Documentação do protocolo MCP" icon="arrow-up-right-from-square" href="https://modelcontextprotocol.io">
