---
title: "Replitへようこそ"
description: "Replitがアイデア、日々の作業、インテリジェンスを有用な成果に変える方法を学びます。"
---
...
<div className="welcome-home">
  ...
  <section className="welcome-journey-strip" aria-label="Replitのガイド付きジャーニー">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="「日々のための静かな場所」という見出しのコーヒーショップのオープニングサイト" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>
