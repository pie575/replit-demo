---
title: "Managing Your Spend"
description: "Control AI costs and monitor spending with usage limits, budgets, Plan Mode, and Agent modes. Learn strategies to optimize your Replit usage and reduce unnecessary token consumption."
icon: "piggy-bank"
---
...
<Frame>
  <img src="/assets/mirror/usage-page-8c0fb231d077.png" alt="The usage page showing account usage totals, remaining credits, extra usage, active users, and a daily spend chart" width="3124" height="1636" data-path="images/billing/usage-page.png" />
</Frame>
...
* **Free Mode**: no-cost everyday Agent work within your plan's allowance.
* **Auto**: automatic model selection for paid work in Power or Max.
* **Power**: more capability at an affordable price.
* **Max**: the best frontier models for the most demanding work.
...
<Tip>
  Start with [Free Mode](/features/agent/agent-modes) for everyday work. Choose [Power mode](/features/agent/agent-modes) when you need more capability at an affordable price. Plan first, then approve changes step by step.
</Tip>
...
If your account uses top-ups, open **Settings** → **Billing** and find **Payment receipts** to review successful one-time top-ups and auto-reload payments. Each row shows the payment date, purchase type, amount, and refund status. Select **View receipt** to open the receipt from the payment provider.
...
For Core accounts, open **Settings** → **Account** → **Usage**. In the **Account usage** section, select **Manage limits** to set up a usage limit. For organizations, open the [usage page](https://replit.com/usage) and select **Manage limits** under **Account usage**.
...
Set this limit from the same **Manage limits** dialog described under [Usage limits](#usage-limits).
...
<Steps>
  <Step title="Open the workspace usage page">
  ...
  <Step title="Edit a member's limit">
    ...
    <Frame>
      <img src="/assets/mirror/edit-usage-limit-87127319c809.png" alt="Edit usage limit dialog for a workspace member, showing the workspace default, current user-specific limit, applicable group limits, and a User threshold input set to $5" width="1202" height="916" data-path="images/billing/edit-usage-limit.png" />
    </Frame>
  </Step>
...
<Note>Per-user spend limits are available on the Enterprise plan. Members assigned to a [custom group](/teams/identity-and-access-management/groups-and-permissions) inherit that group's limit unless an individual override is set. Per-user overrides always take precedence over group and workspace defaults.</Note>
