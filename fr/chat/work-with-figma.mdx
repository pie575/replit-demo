...
description: "Utilisez une frame Figma comme contexte visuel, puis suivez le flux d'importation de Replit Design lorsque vous souhaitez l'explorer, l'affiner ou en faire une application."
...
Replit permet d’importer des frames Figma.

Importez une frame Figma si vous avez déjà une direction visuelle et souhaitez que Replit s’appuie sur ce travail ou le transforme en design.

<div id="when-figma-helps">
  ## Quand Figma est utile
</div>

* **Explorer une autre direction :** conservez la hiérarchie principale tout en testant un autre style ou une autre disposition.
* **Poursuivre un parcours produit :** utilisez un écran existant comme contexte pour l&#39;écran ou l&#39;état suivant.
* **Transformer un travail de design en App :** partez d&#39;une direction visuelle validée, puis affinez-la et construisez à partir de là.

<div id="import-a-figma-frame">
  ## Importer un frame Figma
</div>

Choisissez le frame qui correspond au travail que vous souhaitez poursuivre. Replit Design convertit le frame importé en frame de design, dans lequel vous pouvez explorer des modifications, comparer des suggestions et décider de la suite à construire.

<Frame caption="Un frame Figma importé en tant que frame de design dans Replit Design.">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="Page d'accueil Personal Fitness Trainer importée en tant que frame de design dans Replit Design" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>
...
Le guide Design couvre l&#39;intégralité du processus d&#39;importation, d&#39;affinage et de création (Build).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/design/import-figma-designs-into-replit-design">
    ...
    <p>Suivez le processus complet d&#39;importation et d&#39;affinage d&#39;un frame Figma.</p>
