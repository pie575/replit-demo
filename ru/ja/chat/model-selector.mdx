---
title: "Выбор модели"
description: "Если в вашем режиме и тарифном плане доступен ручной выбор модели, выберите модель и настройте её уровень усилий."
...
<div className="chat-mkt" role="img" aria-label="Логотипы Anthropic, OpenAI и Qimi в селекторе моделей" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
...
Интеллектуальная маршрутизация моделей позволяет Replit подбирать модель под задачу. Чтобы выбрать модель вручную, в поле ввода промпта выберите **Agent Mode**, затем **Power** или **Max**, а после этого — модель в разделе **основная модель**.

Free Mode всегда использует интеллектуальную маршрутизацию моделей. Разработчики с тарифами Core и Pro могут выбирать модели, доступные в Power Mode или Max Mode. Доступность моделей зависит от использования, поэтому список моделей в Replit содержит актуальную информацию для вашей учётной записи.

<Frame caption="Элементы управления моделью и уровнем усилий в меню настроек Agent.">
  <img src="/assets/mirror/model-selector-gpt-5-6-sol-effort-8e4d256bf497.jpg" alt="Селектор модели в демонстрационном рабочем пространстве. В Max Mode выбрана GPT-5.6 Sol, а уровень усилий установлен на Medium" width="1821" height="864" data-path="images/chat/model-selector-gpt-5-6-sol-effort.jpg" />
</Frame>
...
Уровень усилий определяет, сколько вычислительных усилий выбранная модель затрачивает на формирование ответа. Это не отдельный режим, а настройка для каждой модели. Поддерживаемые уровни — от **Low** до **Max**; для каждой модели отображается рекомендуемая настройка.

Выбирайте более высокий уровень усилий, только если задача требует более глубокого анализа. При высоком значении выполнение сложных задач может занимать больше времени и обходиться дороже.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ja/features/agent/model-selector">
    ...
    <div className="chat-card-title">Справочник по выбору моделей</div>

    <p>
      Узнайте об интеллектуальной маршрутизации моделей, доступных моделях, уровнях усилий
      и Compare models.
    </p>
  ...
  <a className="chat-example has-visual" href="/ru/ja/features/agent/model-selector#effort">
    ...
    <div className="chat-card-link">Подробнее об уровне усилий →</div>
  </a>
</section>

Настройки модели и уровня усилий определяют, как отвечает Replit. [Voice Mode](/ru/ja/chat/voice-mode) позволяет формулировать запросы голосом вместо ввода текста.