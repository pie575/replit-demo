---
title: "Publication"
description: "Partagez vos applications Replit avec le monde en quelques clics."
...
<CardGroup>
  ...
  <Card title="Déploiement sur VM réservée" href="/fr/features/publishing/deployment-types#reserved-vm" icon="server">
...
1. Dans votre Éditeur de projet, sélectionnez <img class="icon-svg" src="/assets/mirror/deploy-icon-7dec74bde1ff.svg" alt="Icône Publier" width="16" height="16" data-path="images/icons/deploy-icon.svg" /> **Publier** en haut.
...
* [Déploiement Autoscale](/fr/features/publishing/deployment-types#autoscale) : Apprenez à configurer des applications qui évoluent avec le trafic
* [Déploiement statique](/fr/features/publishing/deployment-types#static) : Découvrez comment publier des sites web statiques rapidement et efficacement
* [Déploiement sur VM réservée](/fr/features/publishing/deployment-types#reserved-vm) : Explorez les options de VM dédiées pour des cas d'utilisation spécialisés
* [Déploiement planifié](/fr/features/publishing/deployment-types#scheduled) : Configurez des tâches récurrentes avec une planification simple
