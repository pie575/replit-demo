...
description: "Conecte os arquivos e ferramentas que dão ao Replit o contexto para construir um plano de lançamento de cafeteria."
---
...
Agora que você aprendeu sobre integrações, vamos aplicá-las ao lançamento da
cafeteria.

Você escolheu uma direção: construir um **café de bairro**, não um bar
voltado para movimento de estação. Dê ao Replit o material de que ele precisa
para transformar essa direção em um plano que você possa colocar em prática.

As integrações conectam o Replit às ferramentas e arquivos que você já usa.
Elas permitem que o Replit traga informações relevantes ou execute as ações
necessárias para a tarefa. Você pode conectar serviços como
**[Slack](/pt/features/integrations/overview#connectors)**,
**[Google Drive](/pt/features/integrations/overview#connectors)**,
**[Notion](/pt/features/integrations/overview#connectors)** ou
**[Salesforce](/pt/features/integrations/overview#connectors)**, além de mais
de 450 outros serviços.

Para a cafeteria, o Google Drive dá ao Replit acesso a um orçamento, notas de
localização, ideias de cardápio, fotos e referências visuais. O Notion dá a
ele um lugar para documentar o plano de lançamento, as decisões e as
questões em aberto.

Saiba mais sobre [integrar suas ferramentas](/pt/chat/integrate-your-tools).

<Steps>
  <Step title="Peça ao Replit para reunir os materiais">
    Comece com o pedido abaixo. O Replit verifica o que precisa para
    completar o plano e pede que você conecte um serviço quando precisar de
    acesso.

    <AiPrompt>
      Use meus arquivos do café para criar um plano de lançamento do primeiro
      mês para o café de bairro. Atualize as premissas relevantes e, em
      seguida, documente o conceito, as principais decisões, as questões em
      aberto e a checklist de lançamento no Notion.
    </AiPrompt>
  </Step>

  <Step title="Conecte o Google Drive quando o Replit pedir">
    Aprove a conexão do Google Drive para que o Replit possa examinar os
    materiais que você quer que ele use. Ele abre o pedido de conexão
    diretamente na Conversa.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit pedindo para conectar o Google Drive para poder examinar os arquivos do café" />
  </Step>

  <Step title="Conecte o Notion quando o Replit precisar documentar o plano">
    Aprove o Notion quando o Replit pedir para criar o resumo de lançamento.
    Ele pode então registrar o conceito, as decisões, as questões em aberto e
    a checklist em um só lugar.
  </Step>
</Steps>

O Google Drive dá ao Replit evidências para trabalhar. O Notion mantém o
plano em evolução em um só lugar enquanto você responde a novas perguntas e
toma decisões.

Saiba mais sobre [adicionar contexto](/pt/chat/add-context), [enviar
arquivos](/pt/chat/upload-and-use-files) e [integrar suas
ferramentas](/pt/chat/integrate-your-tools).

## Próximo

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/home/watch-the-competition">
    ...
    <div className="chat-example-tag">Rotinas</div>
    <div className="chat-card-title">Fique de olho na concorrência</div>
    <p>Configure uma Rotina para monitorar mudanças enquanto você se prepara para lançar.</p>
