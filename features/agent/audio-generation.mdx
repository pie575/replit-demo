...
description: "Generate music, sound effects, and speech for your apps with Agent."
...
<CardGroup cols={2}>
  <Card title="Image Generation" icon="image" href="/features/agent/image-generation">
    Create custom images, icons, and illustrations with Agent.
  </Card>

  <Card title="Connectors" icon="plug" href="/features/integrations/overview">
