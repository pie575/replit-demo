...
description: "Découvrez les outils disponibles dans l'Éditeur de projet — l'éditeur, la prévisualisation, la console, le shell et bien plus encore."
---
...
<Accordion title="Comment accéder à l'arborescence de fichiers">
  Sélectionnez l'icône <img class="icon-svg" src="/assets/mirror/files-icon-f66bf1b04572.svg" alt="icône dossier avec flèches" width="16" height="16" data-path="images/icons/files-icon.svg" /> dossier à gauche pour basculer
...
Pour apprendre à sélectionner, afficher et gérer les workflows, consultez [Workflows](/fr/core-concepts/project-editor/app-setup/workflows/).
...
<Accordion title="Comment accéder au menu Options">
  Sélectionnez les <img class="icon-svg" src="/assets/mirror/vertical-dots-032f1c99d22e.svg" alt="icône points verticaux" height="16" width="16" data-path="images/icons/vertical-dots.svg" /> trois points verticaux
...
<Accordion title="Comment accéder à la barre de recherche">
  1. Pour ouvrir la barre de recherche, sélectionnez l'icône <img class="icon-svg" src="/assets/mirror/workspace-search-icon-d20ee3e562fb.svg" alt="icône loupe" width="16" height="16" data-path="images/icons/workspace-search-icon.svg" /> loupe en haut.
...
<Accordion title="Comment accéder au panneau Ressources">
  1. Sélectionnez l'icône <img class="icon-svg" src="/assets/mirror/resources-237893692826.svg" alt="icône ordinateurs empilés" width="16" height="16" data-path="images/icons/resources.svg" /> ressources située à côté du nom de votre application pour basculer le panneau.
...
<CardGroup cols={3}>
  ...
  <Card title="Historique des fichiers" icon="clock-rotate-left" iconType="solid" href="/fr/core-concepts/project-editor/version-control/file-history" horizontal={true}>
    Revenez en arrière pour récupérer des modifications perdues grâce à la fonctionnalité de suivi des versions de Replit.
  </Card>

  <Card title="Multijoueur" icon="users" iconType="solid" href="/fr/replitai/invite-teammates" horizontal={true}>
    Codez ensemble en temps réel avec deux utilisateurs ou plus.
  </Card>

  <Card title="Paramètres utilisateur" icon="gear" iconType="solid" href="/fr/core-concepts/project-editor/editor-and-tools/user-settings" horizontal={true}>
    Personnalisez votre expérience de codage via l'outil Paramètres.
  </Card>

  <Card title="Console" icon="terminal" iconType="solid" href="/fr/core-concepts/project-editor/editor-and-tools/console" horizontal={true}>
    Voir la sortie de votre application Replit
  </Card>

  <Card title="Shell" icon="terminal" iconType="solid" href="/fr/core-concepts/project-editor/editor-and-tools/shell" horizontal={true}>
    Interagissez avec l'Éditeur de projet à l'aide d'une interface en ligne de commande.
  </Card>

  <Card title="Prévisualisation" icon="laptop" iconType="solid" href="/fr/core-concepts/project-editor/editor-and-tools/preview" horizontal={true}>
