...
description: "Connectez les fichiers et outils qui donnent à Replit le contexte nécessaire pour construire un plan de lancement de café."
---
...
Maintenant que vous avez appris ce que sont les intégrations, appliquons-les
au lancement du café.

Vous avez choisi une direction : construire un **café de quartier**, et non
un bar rapide près de la gare. Donnez à Replit les éléments dont il a besoin
pour transformer cette direction en un plan sur lequel vous pouvez agir.

Les intégrations connectent Replit aux outils et fichiers que vous utilisez
déjà. Elles permettent à Replit d'apporter des informations pertinentes ou de
réaliser les actions nécessaires à la tâche. Vous pouvez connecter des
services comme **[Slack](/features/integrations/overview#connectors)**,
**[Google Drive](/features/integrations/overview#connectors)**,
**[Notion](/features/integrations/overview#connectors)**, ou
**[Salesforce](/features/integrations/overview#connectors)**, ainsi que plus
de 450 autres services.

Pour le café, Google Drive donne à Replit accès à un budget, des notes sur
l'emplacement, des idées de menu, des photos, et des références visuelles.
Notion lui donne un endroit pour documenter le plan de lancement, les
décisions, et les questions en suspens.

En savoir plus sur [l'intégration de vos outils](/chat/integrate-your-tools).

<Steps>
  <Step title="Demandez à Replit de réunir les éléments">
    Commencez par la demande ci-dessous. Replit vérifie ce dont il a besoin
    pour compléter le plan et vous demande de connecter un service lorsqu'il a
    besoin d'y accéder.
    ...
    <AiPrompt>
      ...
      puis documente le concept, les décisions clés, les questions en suspens,
      et la liste de contrôle de lancement dans Notion.
    </AiPrompt>
  </Step>

  <Step title="Connectez Google Drive lorsque Replit le demande">
    Approuvez la connexion Google Drive pour que Replit puisse examiner les
    éléments que vous voulez qu'il utilise. Il ouvre la demande de connexion
    directement dans la Conversation.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit demandant de connecter Google Drive afin de pouvoir examiner les fichiers du café" />
  </Step>

  <Step title="Connectez Notion lorsque Replit doit documenter le plan">
    Approuvez Notion lorsque Replit demande à créer le document de lancement.
    Il peut alors enregistrer le concept, les décisions, les questions en
    suspens, et la liste de contrôle en un seul endroit.
  </Step>
</Steps>

Google Drive donne à Replit des éléments concrets pour travailler. Notion
garde le plan en évolution dans un seul endroit à mesure que vous répondez à
de nouvelles questions et prenez des décisions.

En savoir plus sur [l'ajout de contexte](/chat/add-context), [le
téléchargement de fichiers](/chat/upload-and-use-files), et [l'intégration de
vos outils](/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/home/watch-the-competition">
    ...
    <p>Configurez une Routine pour surveiller les changements pendant que vous préparez le lancement.</p>
