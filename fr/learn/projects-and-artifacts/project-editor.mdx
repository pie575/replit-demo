...
description: "Découvrez ce qu'est le Project Editor : votre point d'ancrage sur Replit, où vous échangez avec Agent, voyez votre app prendre forme et gérez tout au même endroit."
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L'écran d'accueil du Project Editor de Replit, avec le champ de saisie du prompt dans lequel vous décrivez ce que vous souhaitez créer" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

<div id="what-is-the-project-editor">
  ## Qu&#39;est-ce que le Project Editor ?
</div>

Le Project Editor est votre point d&#39;ancrage sur Replit : l&#39;environnement où vous commencez à créer, gérez vos projets et voyez vos apps prendre vie. Depuis cet espace, vous décrivez ce que vous souhaitez construire, et [Agent](/fr/features/agent/overview) prend le relais : il écrit le code, configure votre projet et vous montre un aperçu en direct, en temps réel.

<div id="getting-started">
  ## Premiers pas
</div>

Saisissez ce que vous souhaitez créer dans le champ de prompt. Décrivez votre idée en langage courant — « un suivi de budget qui représente mes dépenses sous forme de graphique », « une page de destination pour mon café », « un générateur de bandes dessinées par IA pour les enfants » — et Agent se charge du reste.

<AgentInput />

Vous pouvez aussi sélectionner un type de projet dans le carrousel pour indiquer à Agent le type de résultat souhaité : web app, mobile app, diapositives, design, et bien plus encore. Vous pouvez également ignorer cette sélection et vous contenter de décrire votre idée : Agent détermine automatiquement la configuration adaptée.

<AgentCarousel />

Pour vous lancer sans attendre, suivez le guide [Créez votre première app](/fr/build/your-first-app).

<div id="plan-mode">
  ## Plan mode
</div>

Plan mode vous permet de réfléchir à des idées, de poser des questions et de structurer votre projet. Agent crée une liste de tâches ordonnée que vous pouvez examiner et affiner — lorsque le plan vous convient, approuvez-le et Agent se met à construire. Vous pouvez également utiliser Plan mode pour poser des questions ou explorer des pistes ; Agent n&#39;apportera aucune modification tant que vous ne l&#39;aurez pas quitté.

<AgentInput highlightPlan={true} showTypewriter={false} />

Activez ou désactivez Plan mode à l&#39;aide du bouton situé en bas de la zone de saisie. Pour en savoir plus, consultez le [guide de Plan mode](/fr/features/agent/plan-mode).

<div id="what-you-can-build">
  ## Ce que vous pouvez créer
</div>

Sélectionnez un type de projet pour indiquer à Agent ce que vous souhaitez, ou décrivez simplement votre idée et laissez Agent choisir la configuration adaptée.

* **Web apps** — Dashboards, outils internes, produits SaaS, pages de destination
* **Applications mobiles** — Applications iOS et Android à partir d&#39;un seul prompt
* **Diapositives et présentations** — Générez des présentations aux mises en page soignées
* **Animations** — Démonstrations interactives et animations graphiques
* **Designs** — Maquettes visuelles et prototypes sur le [Design Canvas](/fr/design/canvas)
* **Visualisations de données** — Graphiques, dashboards et outils connectés à une base de données
* **Documents** — Fichiers CSV, PDF, PowerPoint, documents Markdown
* **Feuilles de calcul** — Tableaux de données et sorties structurées

<div id="the-project-editor">
  ## Le Project Editor
</div>

Dès qu&#39;Agent se met à construire, c&#39;est dans le Project Editor que vous voyez votre projet prendre forme. Celui-ci est divisé en panneaux : d&#39;un côté, votre conversation avec Agent ; de l&#39;autre, un aperçu en direct de votre app.

<div id="threads">
  ### Fils de discussion
</div>

Chaque conversation avec Agent se déroule dans un fil de discussion. Votre fil principal est l&#39;endroit où vous décrivez ce que vous souhaitez et où vous voyez Agent le construire. Lorsque vous utilisez le [système de tâches](/fr/core-concepts/agent/task-system), chaque tâche en arrière-plan dispose de son propre fil de discussion : Agent peut ainsi isoler le travail de chaque tâche sans mélanger les conversations.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Un fil de discussion affichant le prompt de l'utilisateur et Agent en train de construire le projet" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>
...
Le task board organise votre travail en colonnes : **Drafts**, **Active**, **Ready** et **Done**. Chaque tâche progresse de gauche à droite, ce qui vous permet de voir d&#39;un coup d&#39;œil ce qui est planifié, ce sur quoi Agent travaille et ce qui est terminé. Pour en savoir plus, consultez [Système de tâches](/fr/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Task board affichant les tâches réparties entre les colonnes Drafts, Active, Ready et Done" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>
...
Le Design Canvas est un éditeur visuel qui vous permet de créer et d&#39;affiner des maquettes avant de passer au code. Déplacez des éléments, ajustez les mises en page et peaufinez votre design — puis laissez Agent le transformer en une application fonctionnelle. Pour en savoir plus, consultez [Design Canvas](/fr/design/canvas).

<div id="collaboration">
  ## Collaboration
</div>

Créez un Team Workspace pour créer à plusieurs. Invitez vos coéquipiers, partagez des projets et travaillez sur la même App en temps réel. Consultez [Workspaces d&#39;équipe](/fr/features/collaboration/team-workspaces) pour la configuration de l&#39;équipe et [Inviter des coéquipiers](/fr/build/invite-teammates) pour la collaboration au niveau du projet.

<div id="import-code-and-design">
  ## Importer du code et des designs
</div>

Vous avez déjà un projet ? Importez-le dans Replit depuis GitHub ou Figma, ou téléversez directement vos fichiers. Agent peut reprendre là où vous vous êtes arrêté et poursuivre le développement à partir de votre code ou de votre design existant. Consultez [Importer dans Replit](/fr/build/import-from-providers).
...
<CardGroup cols={2}>
  <Card title="Éditeur et outils" href="/fr/features/editor/editor-and-tools" icon="window-restore">
    Les principaux panneaux où s&#39;affichent le Preview de votre App, la sortie de la Console et d&#39;autres
    outils
  </Card>

  <Card title="Configuration de l'App" href="/fr/features/project-setup/configuration" icon="gear">
    Configurez les paramètres, les dépendances, les Secrets et l&#39;environnement de votre App
  </Card>

  <Card title="Gestion des versions" href="/fr/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Suivez les modifications, revenez à des versions antérieures et gérez l&#39;historique de votre App
  </Card>

  <Card title="Publishing" href="/fr/learn/projects-and-artifacts/replit-deployments" icon="rocket">
    Déployez votre App sur une URL en ligne pour que tout le monde puisse l&#39;utiliser
  </Card>
</CardGroup>
...
<Accordion title="Faut-il savoir coder ?">
  Non. Décrivez ce que vous souhaitez en langage courant et Agent se charge des
  détails techniques. Vous pouvez aussi modifier le code vous-même si vous le souhaitez.
</Accordion>

<Accordion title="Que se passe-t-il lorsque je ferme mon navigateur ?">
  Votre projet est enregistré dans le cloud. Revenez quand vous voulez et reprenez exactement
  là où vous vous étiez arrêté : vos fichiers, votre historique et votre app en cours d&#39;exécution sont conservés.
</Accordion>

<Accordion title="Puis-je travailler avec d'autres personnes ?">
  Oui. Vous pouvez inviter des collaborateurs sur un projet précis ou créer un Team
  Workspace donnant accès à tous les projets à ses membres. Consultez [Workspaces d&#39;équipe](/fr/features/collaboration/team-workspaces) et [Inviter des
  coéquipiers](/fr/build/invite-teammates).
</Accordion>

<Accordion title="Comment publier mon app ?">
  Lorsque votre app est prête, publiez-la sur une URL en ligne directement depuis le Project
  Editor. Consultez [Déploiements](/fr/learn/projects-and-artifacts/replit-deployments).
</Accordion>
...
Le Project Editor est disponible avec tous les forfaits. Certaines fonctionnalités, comme la puissance de calcul accrue et les déploiements toujours actifs, nécessitent un forfait payant. Consultez la page [Facturation](/fr/billing/ai-billing) pour en savoir plus.