...
description: "Узнайте, что такое Project Editor: ваша основная рабочая среда в Replit, где вы общаетесь с Agent, наблюдаете, как создаётся ваше приложение, и управляете всем."
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="Главный экран Replit Project Editor с полем ввода запроса, где вы описываете, что хотите создать" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

<div id="what-is-the-project-editor">
  ## Что такое Project Editor?
</div>

Project Editor — ваша основная рабочая среда в Replit: здесь вы начинаете разработку, управляете проектами и видите, как ваши приложения обретают жизнь. Здесь вы можете описать, что хотите создать, а [Agent](/ru/features/agent/overview) сделает всё остальное: напишет код, настроит проект и покажет интерактивный предварительный просмотр в реальном времени.

<div id="getting-started">
  ## Начало работы
</div>

Введите в поле ввода промпта то, что хотите создать. Опишите свою идею простыми словами — «трекер бюджета с графиками расходов», «лендинг для кофейни», «генератор комиксов с ИИ для детей» — а остальное сделает Agent.

<AgentInput />

Также можно выбрать тип проекта в карусели, чтобы указать Agent нужный тип результата: веб-приложение, мобильное приложение, презентация, дизайн и многое другое. Или пропустите выбор и просто опишите свою идею — Agent автоматически подберёт подходящую конфигурацию.

<AgentCarousel />

Чтобы сразу начать работу, воспользуйтесь руководством [Создайте своё первое приложение](/ru/build/your-first-app).

<div id="plan-mode">
  ## Режим Plan
</div>

Режим Plan позволяет проводить мозговой штурм, задавать вопросы и составлять план проекта. Agent создаёт упорядоченный список задач, который вы можете просмотреть и уточнить. Когда план вас устроит, утвердите его — и Agent приступит к разработке. Режим Plan также можно использовать, чтобы задавать вопросы или прорабатывать идеи; Agent не внесёт никаких изменений, пока вы не выйдете из этого режима.

<AgentInput highlightPlan={true} showTypewriter={false} />

Переключайте режим Plan кнопкой в нижней части поля ввода. Подробнее — в [руководстве по режиму Plan](/ru/features/agent/plan-mode).

<div id="what-you-can-build">
  ## Что можно создать
</div>

Выберите тип проекта, чтобы указать Agent, что вы хотите создать, или просто опишите идею — Agent сам подберёт подходящую конфигурацию.

* **Веб-приложения** — Дашборды, внутренние инструменты, SaaS-продукты, лендинги
* **Мобильные приложения** — Приложения для iOS и Android на основе одного prompt
* **Презентации и презентации** — Создавайте презентации с разнообразной раскладкой
* **Анимации** — Интерактивные демонстрации и моушн-графика
* **Дизайны** — Визуальные макеты и прототипы в [Design Canvas](/ru/design/canvas)
* **Визуализация данных** — Диаграммы, дашборды и инструменты на основе баз данных
* **Документы** — CSV, PDF, файлы PowerPoint, документы Markdown
* **Электронные таблицы** — Таблицы данных и структурированные результаты

<div id="the-project-editor">
  ## Project Editor
</div>

Когда Agent начинает работу над приложением, в Project Editor вы видите, как ваш проект обретает форму. Он разделён на панели: с одной стороны — ваша беседа с Agent, с другой — интерактивный предварительный просмотр вашего приложения.

<div id="threads">
  ### Ветки
</div>

Каждое общение с Agent происходит в отдельной ветке. В основной ветке вы описываете, что хотите, и наблюдаете, как Agent это создаёт. При использовании [системы задач](/ru/core-concepts/agent/task-system) для каждой фоновой задачи создаётся отдельная ветка, чтобы Agent мог работать над задачами изолированно, не смешивая обсуждения.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Ветка с prompt пользователя и процессом создания проекта в Agent" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>
...
Доска задач организует работу по столбцам: **Черновики**, **Активные**, **Готовые** и **Выполненные**. По мере выполнения задачи перемещаются слева направо, поэтому вы сразу видите, что запланировано, над чем работает Agent и что уже завершено. Подробнее см. в разделе [Система задач](/ru/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Доска задач с задачами, распределёнными по столбцам «Черновики», «Активные», «Готовые» и «Выполненные»" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>
...
Design Canvas — это визуальный редактор, в котором можно создавать и дорабатывать макеты, прежде чем переходить к написанию кода. Перетаскивайте элементы, настраивайте раскладку и совершенствуйте дизайн, а затем поручите Agent превратить его в работающее приложение. Подробнее — в разделе [Design Canvas](/ru/design/canvas).

<div id="collaboration">
  ## Совместная работа
</div>

Создайте командный workspace для совместной работы. Приглашайте коллег, делитесь проектами и работайте над одним приложением в реальном времени. О настройке команды см. в разделе [Командные workspace](/ru/features/collaboration/team-workspaces), а о совместной работе над проектом — в разделе [Приглашение коллег](/ru/build/invite-teammates).

<div id="import-code-and-design">
  ## Импорт кода и дизайна
</div>

Уже есть проект? Импортируйте его в Replit из GitHub, Figma или напрямую загрузите файлы. Agent продолжит работу с того места, где вы остановились, используя существующий код или дизайн. См. [Импорт в Replit](/ru/build/import-from-providers).
...
<CardGroup cols={2}>
  <Card title="Редактор и инструменты" href="/ru/features/editor/editor-and-tools" icon="window-restore">
    Основные панели для просмотра приложения, вывода Console и работы с другими
    инструментами
  </Card>

  <Card title="Настройка App" href="/ru/features/project-setup/configuration" icon="gear">
    Настройте параметры приложения, зависимости, Secrets и окружение
  </Card>

  <Card title="Контроль версий" href="/ru/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Отслеживайте изменения, возвращайтесь к более ранним версиям и управляйте историей приложения
  </Card>

  <Card title="Publishing" href="/ru/learn/projects-and-artifacts/replit-deployments" icon="rocket">
    Разверните приложение по общедоступному URL, чтобы им мог пользоваться любой
  </Card>
</CardGroup>
...
<Accordion title="Нужно ли мне уметь программировать?">
  Нет. Опишите, что вы хотите, простым языком, а Agent возьмёт на себя технические
  детали. При желании вы также можете вносить изменения вручную.
</Accordion>

<Accordion title="Что произойдёт, если я закрою браузер?">
  Ваш проект сохраняется в облаке. Вернитесь в любое время и продолжите с того места,
  где остановились: ваши файлы, история и запущенное приложение будут сохранены.
</Accordion>

<Accordion title="Могу ли я работать с другими людьми?">
  Да. Вы можете пригласить соавторов в конкретный проект или создать командный
  workspace, где участники получают доступ ко всем проектам. См. [Командные
  рабочие пространства](/ru/features/collaboration/team-workspaces) и [Приглашение
  коллег](/ru/build/invite-teammates).
</Accordion>

<Accordion title="Как опубликовать моё приложение?">
  Когда ваше приложение будет готово, опубликуйте его по общедоступному URL прямо из Project Editor.
  См. [Deployments](/ru/learn/projects-and-artifacts/replit-deployments).
</Accordion>
...
Project Editor доступен на всех тарифах. Для некоторых функций, например увеличенных вычислительных ресурсов и постоянно работающих развертываний, требуется платный тариф. Подробнее см. в разделе [Оплата](/ru/billing/ai-billing).