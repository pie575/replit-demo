...
<Frame>
  <img src="/assets/mirror/enterprise-pricing-card-a828ae4b917f.png" alt="Enterprise plan card on the pricing page listing features like Custom seat limits, SSO / SAML, and Advanced privacy controls, with a Get started button" width="950" height="1426" data-path="images/changelog/2026-05-15/enterprise-pricing-card.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/edit-usage-limit-4a2fba67693a.png" alt="Edit usage limit dialog for a workspace member, showing the workspace default, current user-specific limit, applicable group limits, and a User threshold input set to $5" width="1202" height="916" data-path="images/changelog/2026-05-15/edit-usage-limit.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/canvas-export-png-c67e5aefd406.png" alt="Canvas frame right-click context menu open with Export submenu showing PNG as the export option" width="1740" height="1160" data-path="images/changelog/2026-05-15/canvas-export-png.png" />
</Frame>
