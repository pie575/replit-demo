...
description: "Découvrez comment Replit transforme vos idées, vos tâches quotidiennes et votre intelligence en résultats concrets."
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <div className="welcome-actions">
        <a className="welcome-action primary" href="/fr/ko/home/get-started">Commencer <span aria-hidden="true">→</span></a>
  ...
  <section className="welcome-journey-strip" aria-label="Le parcours guidé de Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Site de lancement d’un café avec le titre « Un espace calme au quotidien »" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Découvrez comment transformer vos idées en sites concrets
      </div>

      <p>
        Suivez un parcours guidé, de votre première conversation à la recherche, la planification, la conception et la publication.
      </p>

      <a className="welcome-journey-link" href="/fr/ko/home/get-started">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/fr/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Recevez un brief qui résume l’essentiel avant chaque réunion client.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Trouvez et filtrez des candidats grâce au contexte connecté.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez les conversations importantes et partagez-les rapidement.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Créer un rapport hebdomadaire des ventes
          </div>

          <p>Transformez les données actuelles de votre pipeline en un rapport clair sur les ventes.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/track-subscriptions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez les paiements récurrents et calculez les coûts mensuels.</p>
        </div>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/fr/ko/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Petite fenêtre de discussion représentant Replit Chat">
        ...
        <p>
          Commencez par une conversation. Posez des questions, explorez des idées
          et documentez vos projets.
        </p>
      ...
      <a className="welcome-product-card" href="/fr/ko/build/your-first-app">
        ...
        <p>
          Transformez vos idées en applications et sites fonctionnels. Créez,
          itérez et publiez en toute confiance.
        </p>

        <div className="welcome-product-link">
          Commencer avec Build <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/fr/ko/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Composition sélectionnée sur le Canvas représentant Replit Design">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Créez de belles interfaces et du contenu. Affinez vos mises en page,
          composants et expériences de manière itérative.
        </p>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Utiliser Replit</h2>
      <p>Choisissez comment utiliser Replit, puis connectez-vous ou créez un compte. Vous pouvez commencer sur le Web, l’application de bureau ou l’application mobile.</p>
    </div>
