...
description: "Replit이 아이디어, 일상 업무, 지능을 유용한 결과로 바꾸는 방법을 알아보세요."
---
...
<div className="welcome-home">
  ...
  <section className="welcome-journey-strip" aria-label="Replit의 안내된 여정">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="일상을 위한 조용한 공간이라는 헤드라인이 있는 커피숍 오프닝 사이트" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        아이디어를 실제 사이트로 만드는 방법을 알아보세요
      </div>

      <p>
        첫 대화부터 조사, 계획, 디자인, 게시까지 안내된 여정을
        따라가 보세요.
      </p>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>매번 고객 미팅 전에 핵심을 짚어주는 브리프를 받아보세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>원시 피드백을 테마와 실행 가능한 인사이트로 바꿔보세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>현재 파이프라인 데이터를 명확한 매출 업데이트로 바꿔보세요.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/use-cases">
        사용 사례 살펴보기 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/ko/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Replit Chat을 나타내는 작은 대화창">
      ...
      <a className="welcome-product-card" href="/ko/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Replit Build를 나타내는 코드 에디터와 실시간 미리보기">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          아이디어를 실제 앱과 사이트로 바꿔보세요. 자신 있게
          빌드하고, 반복하고, 게시하세요.
        </p>

        <div className="welcome-product-link">
          빌드 시작하기 <span aria-hidden="true">→</span>
        </div>
      </a>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Replit 이용하기</h2>
      <p>Replit을 사용할 위치를 선택한 다음 로그인하거나 계정을 만드세요. 웹, Desktop App, Mobile App 중 어디서든 시작할 수 있습니다.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Web</strong><b aria-hidden="true">→</b><small>브라우저에서 열기</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>Desktop</strong><b aria-hidden="true">→</b><small>macOS 및 Windows</small></a>
      <a className="welcome-access-card" href="https://replit.com/mobile" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▯</span><strong>Mobile</strong><b aria-hidden="true">→</b><small>iOS 및 Android</small></a>
    </div>
  </section>
</div>
