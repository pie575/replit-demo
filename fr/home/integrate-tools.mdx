...
description: "Connectez les fichiers et les outils qui fournissent à Replit le contexte nécessaire pour élaborer un plan de lancement de café."
sidebarTitle: "Intégrer des outils"
icon: "paperclip"
canonical: "https://docs.replit.com/home/integrate-tools"
---
...
Maintenant que vous avez découvert les intégrations, appliquons-les au
lancement du café.

Vous avez choisi une direction : créer un **café de quartier**, et non un bar
pour navetteurs en bordure de gare. Donnez à Replit la matière dont il a besoin
pour transformer cette orientation en un plan concret.

Les intégrations connectent Replit aux outils et aux fichiers que vous utilisez
déjà. Elles permettent à Replit de récupérer les informations pertinentes ou
d&#39;effectuer les actions nécessaires à la tâche. Vous pouvez connecter des
services comme **[Slack](/fr/features/integrations/overview#connectors)**,
**[Google Drive](/fr/features/integrations/overview#connectors)**,
**[Notion](/fr/features/integrations/overview#connectors)** ou
**[Salesforce](/fr/features/integrations/overview#connectors)**, ainsi que plus de
450 autres services.

Pour le café, Google Drive donne à Replit accès à un budget, à des notes sur
l&#39;emplacement, à des idées de menu, à des photos et à des références visuelles.
Notion lui offre un espace où documenter le plan de lancement, les décisions et
les questions en suspens.

En savoir plus sur l&#39;[intégration de vos outils](/fr/chat/integrate-your-tools).
...
<Steps>
  <Step title="Demandez à Replit de rassembler les éléments">
    ...
    finaliser le plan et vous demande de connecter un service lorsqu&#39;il lui faut
    un accès.

    <AiPrompt>
      Utilise mes fichiers de café pour créer un plan de lancement du premier
      mois pour le café de quartier. Mets à jour les hypothèses pertinentes,
      puis documente le concept, les décisions clés, les questions en suspens et
      la checklist de lancement dans Notion.
    </AiPrompt>
  </Step>

  <Step title="Connectez Google Drive lorsque Replit vous le demande">
    Approuvez la connexion à Google Drive pour que Replit puisse examiner les
    éléments que vous souhaitez lui faire utiliser. Il ouvre la demande de
    connexion directement dans la Conversation.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit demandant de connecter Google Drive pour examiner les fichiers du café" />
  </Step>

  <Step title="Connectez Notion lorsque Replit doit documenter le plan">
    Approuvez Notion lorsque Replit demande à créer le brief de lancement. Il
    peut alors consigner le concept, les décisions, les questions en suspens et
    la checklist au même endroit.
  </Step>
</Steps>

Google Drive fournit à Replit des éléments concrets sur lesquels s&#39;appuyer.
Notion centralise le plan à mesure qu&#39;il évolue, au fil des questions auxquelles
vous répondez et des décisions que vous prenez.

Apprenez-en plus sur [l&#39;ajout de contexte](/fr/chat/add-context), [l&#39;importation de fichiers](/fr/chat/upload-and-use-files) et [l&#39;intégration de vos outils](/fr/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/home/watch-the-competition">
    ...
    <p>Configurez une Routine pour suivre les changements pendant que vous préparez votre lancement.</p>
