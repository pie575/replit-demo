...
가용성과 전체 동작에 대해서는 [Voice Mode 기능 참고 자료](/ko/features/agent/voice-mode)를 참조하세요. 다음으로, [Skills](/ko/chat/agent-skills)가 Replit에 재사용 가능한 지시와 지원 자료를 제공하는 방법을 알아보세요.
