---
title: "Entenda seu workspace"
description: "Entenda como seu Replit Workspace reúne pessoas, Projects, Conversations, Routines, dados, integrações e segurança."
---
...
Seu Replit Workspace é a base de tudo relacionado a uma ideia. Ele reúne
[Projects](/pt/home/projects), [Conversations](/pt/home/conversations),
[Routines](/pt/chat/routines) e integrações, para que você possa avançar de uma
pergunta inicial até um resultado útil.

## Configure o projeto da cafeteria

Antes de começar a moldar a ideia da cafeteria, dê a ela um lar. Este Workspace
vai manter as partes do lançamento juntas conforme elas se desenvolvem:

* Uma conversa para moldar o conceito e pesquisar o mercado local
* Arquivos e ferramentas conectadas que adicionam contexto útil ao plano
* Uma Routine que depois vai monitorar a concorrência e as mudanças do mercado
* O site que você eventualmente vai projetar e publicar

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Tela inicial do Replit para o workspace Demo com Projects, Conversations, Routines, prompts sugeridos e a caixa de mensagem" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

A caixa de prompt é onde este projeto começa. A partir daqui, você vai iniciar
uma conversa e dar ao Replit a primeira descrição da cafeteria que você quer
criar.

## Detalhes do workspace

Ele também mantém juntos pessoas relacionadas, configurações, recursos
compartilhados, integrações e cobrança. Seu acesso determina o que você pode
ver e gerenciar.

As configurações do Workspace e os controles de organização são separados dos
controles que você usa para moldar como o Agent responde a um pedido.

Você pode voltar ao Workspace ao longo do lançamento para encontrar tudo o que
o sustenta.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/home/start-a-conversation">
    ...
    <div className="chat-example-tag">Próximo passo</div>
    <div className="chat-card-title">Inicie uma conversa</div>
    <p>Comece o lançamento da cafeteria descrevendo o resultado que você quer.</p>
    <div className="chat-card-link">Explorar →</div>
  </a>

  <a className="chat-example has-visual" href="/pt/features/collaboration/workspaces">
    ...
    <div className="chat-example-tag">Detalhes do workspace</div>
    <div className="chat-card-title">Veja mais sobre workspaces</div>

    <p>
      Saiba mais sobre Workspaces Pessoais e de Equipe, acesso, configurações e
      gerenciamento.
    </p>
...
Em seguida, [inicie uma conversa](/pt/home/start-a-conversation) para começar a
moldar a ideia da cafeteria.
