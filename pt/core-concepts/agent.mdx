---
title: "Replit Agent"
description: "O Replit Agent transforma suas ideias em aplicativos, designs, slides e muito mais, tudo a partir de linguagem natural. Sem necessidade de programação."
---
...
O Agent é seu parceiro criativo. Ele recebe suas ideias, ajuda você a refiná-las e depois as torna reais. Ao contrário de um chatbot que apenas responde perguntas, o Agent age: configura seu projeto, cria aplicativos, verifica seu trabalho e corrige problemas ao longo do caminho.

Descreva o que você quer em linguagem cotidiana. Não é necessário código ou conhecimento técnico. O Agent cuida do resto, desde o planejamento até a implantação.
...
<Steps>
  <Step title="Descreva o que você quer">
    No [Project Editor](/pt/core-concepts/project-editor), basta começar a conversar. Descreva um aplicativo que você quer criar, faça uma pergunta, pesquise um tópico ou obtenha dados de [serviços conectados](/pt/core-concepts/agent/general-agent) como BigQuery, Slack ou Notion. Não há restrições. O Replit Agent cuida de tudo o que você precisar.

    <AgentInput />
  </Step>

  <Step title="Escolha o que criar">
    Opcionalmente, selecione um tipo de projeto: aplicativo web, aplicativo móvel, slides, design, visualização de dados e muito mais. Se você já descreveu o que quer no passo 1, o Agent descobre a configuração certa automaticamente.

    <AgentCarousel />
  </Step>

  <Step title="O Agent constrói">
    O Agent escreve código, configura a infraestrutura e testa o resultado. Uma vez em seu projeto, você pode alternar entre os [modos do Agent](#agent-modes) para controlar como ele constrói.
  </Step>

  <Step title="Itere, teste, implante">
    Converse com o Agent para refinar seu projeto e publique quando estiver pronto. Todos os artefatos são implantados juntos.
  </Step>
</Steps>

<Note>Você não fica preso a um único tipo. Comece com um aplicativo web e adicione um aplicativo móvel, slides ou um vídeo depois — tudo no mesmo projeto.</Note>

### Modo Planejamento

Ative o modo Planejamento para explorar ideias, fazer perguntas e mapear seu projeto antes que o Agent altere qualquer código ou dado. No modo Planejamento, o Agent irá:

* **Dividir projetos complexos** em listas de tarefas ordenadas
* **Explorar diferentes abordagens** e avaliar os prós e contras
* **Revisar e refinar** antes que qualquer código seja escrito

Clique em "Plan" na entrada de chat — ou simplesmente peça ao Agent — para mudar para o modo Planejamento. Exemplo: "Crie um plano para construir um rastreador de projetos para minha equipe"
...
Saiba mais no [guia do modo Planejamento](/pt/core-concepts/agent/plan-mode).
...
* **Lite**: Faça alterações leves e econômicas rapidamente. O modo Lite é ideal para ajustes visuais, correções de bugs e funcionalidades bem delimitadas.
* **Economy**: Use os modelos otimizados em custo do Agent para tarefas do dia a dia. Expanda as **Configurações avançadas** para gerenciar funcionalidades como Testes de App e Otimizações de Código.
* **Power**: Use os modelos mais capazes do Agent para problemas mais difíceis, mudanças maiores e builds mais longas. Nas **Configurações avançadas**, você também pode ativar o **Turbo** para builds até 2,5x mais rápidas com custo maior (somente Pro).

<Note>Dica: Você também pode ativar o **[modo Planejamento](/pt/core-concepts/agent/plan-mode)** para revisar e iterar sobre o plano do Agent antes que a construção comece. O modo Max não está mais disponível; use Power para as builds padrão mais capazes.</Note>

## O que você pode criar com o Replit Agent

* **Aplicativos web, aplicativos móveis, dashboards de dados e ferramentas com IA**
* **Designs visuais e protótipos** — explore mockups no [Design Canvas](/pt/replitai/canvas) antes de se comprometer com código
* **Múltiplos outputs em um projeto** — aplicativos web, móveis, slides e vídeos compartilhando o mesmo backend
* **Arquivos e documentos** — CSVs, PDFs, arquivos PowerPoint, documentos Markdown
* **Consultas a serviços conectados** — obtenha dados do BigQuery, Linear, Slack, Notion e muito mais diretamente do chat

<Card title="Comece a criar agora" icon="arrow-up-right" href="https://replit.com">
  Descreva sua ideia e deixe o Agent dar vida a ela — sem necessidade de configuração.
</Card>

## Perguntas frequentes

<Accordion title="Preciso saber programar?">
  Não. O Agent cuida de todo o trabalho técnico — escreve código, configura infraestrutura, configura bancos de dados. Você descreve o que quer em linguagem simples e o Agent constrói.
</Accordion>

<Accordion title="Qual é a diferença entre Lite, Economy e Power?">
  **Lite** é para mudanças rápidas e direcionadas (10-60 segundos), como ajustes visuais, correções de bugs e funcionalidades bem delimitadas. **Economy** é o melhor padrão para a maioria das builds quando você quer equilibrar custo e qualidade. **Power** usa os modelos mais capazes para tarefas mais difíceis, e **Turbo** é um toggle opcional disponível apenas no Power nas Configurações avançadas quando você precisa das execuções mais rápidas.
</Accordion>

<Accordion title="Posso criar mais de uma coisa em um projeto?">
  Sim. Você pode adicionar aplicativos web, aplicativos móveis, slides, vídeos e visualizações de dados ao [mesmo projeto](/pt/replitai/artifacts#multiple-artifacts-in-one-project) — todos compartilhando o mesmo backend e dados.
</Accordion>
...
Para preços detalhados, consulte [Faturamento do Agent](/pt/billing/ai-billing#agent-billing).

## Próximos passos

<CardGroup cols={2}>
  <Card title="Skills do Agent" icon="puzzle-piece" href="/pt/core-concepts/agent/skills">
    Ensine ao Agent conhecimentos especializados — use skills pré-construídas ou crie as suas próprias.
  </Card>
  ...
  <Card title="Design Canvas" icon="paintbrush" href="/pt/replitai/canvas">
    Mockups visuais e o editor visual prático.
  </Card>

  <Card title="Conectores" icon="plug" href="/pt/core-concepts/agent/general-agent">
    Conecte BigQuery, Linear, Slack, Notion e muito mais.
  </Card>

  <Card title="Faturamento" icon="credit-card" href="/pt/billing/ai-billing#agent-billing">
    Preços do Agent, comparação de planos e gerenciamento de gastos.
  </Card>

  <Card title="Guia de vibe coding" icon="wand-magic-sparkles" href="/pt/tutorials/how-to-vibe-code">
    Dicas para prompts eficazes e construção com IA.
  </Card>
</CardGroup>
