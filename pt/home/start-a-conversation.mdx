...
description: "Inicie uma Conversation com uma pergunta simples, pesquisa na web ou contexto conectado e, em seguida, escolha o que fazer a seguir."
---
...
Seu Workspace está pronto. Agora é hora de fazer a ideia da cafeteria avançar.
Inicie uma [conversa](/pt/chat/conversations), diga ao Replit o que você quer
criar e comece a transformar a primeira ideia em um plano de lançamento real.

## Iniciar uma nova conversa

Selecione **New** na barra lateral do Replit. Isso abre a conversa em que você
vai moldar o conceito, pesquisar o mercado e planejar o lançamento.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Tela inicial do Replit para o workspace Demo com o botão New em destaque, prompts sugeridos e a caixa de mensagem" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

## Explore a caixa de prompt

Depois de selecionar **New**, dê uma olhada na caixa de prompt. É aqui que você
vai dar direção ao Replit, adicionar contexto útil e continuar o lançamento da
cafeteria. O próximo passo é escrever o primeiro prompt.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu de mais opções da caixa de prompt com opções para enviar um arquivo, criar algo novo, importar um projeto, usar uma skill ou sistema de design e adicionar uma integração" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

## A seguir

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/home/describe-your-idea">
    ...
    <div className="chat-example-tag">Primeiro prompt</div>
    <div className="chat-card-title">Molde o conceito</div>
    <p>Escreva um primeiro pedido focado para o lançamento da cafeteria.</p>
