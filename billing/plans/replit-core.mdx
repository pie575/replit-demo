---
title: "Replit Core"
description: "Learn about Replit Core membership features including powerful AI tools, high-performance development resources, and one-click publishing."
...
* **Paid Agent modes**: Use Power or Max when you need more capability
* **Free Mode**: Build and chat with Agent at no extra cost within an allowance
* **Intelligent model routing**: Let Replit select a model for each paid task in Power or Max
...
See the <a href="https://replit.com/pricing" target="_blank">pricing page</a> for cost and limits for
specific plans.
...
1. Navigate to the <a href="https://replit.com/pricing" target="_blank">Pricing</a> page
...
* [Replit Pro](/billing/plans/replit-pro): For teams with up to 15 builders, more Free Mode usage, and tiered credits
