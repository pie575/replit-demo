---
title: "Conversations 与 项目的区别"
description: "了解何时应在 Conversation 中继续，何时应将重要工作转为项目。"
sidebarTitle: "Conversations 与 项目"
tag: "New"
icon: "objects-column"
...
使用 Replit 时，你可以在 Conversation 中工作，也可以构建项目。Conversation 适合提问、探索、后续沟通和运行 Routine。项目用于构建应用、创建幻灯片和设计。

[了解如何将 Conversation 转为项目。](/zh/chat/continue-or-create-a-project)

<div id="how-they-differ">
  ## 二者的区别
</div>

虽然二者相互关联，但 Conversations 和 项目的用途各不相同。具体区别如下：

| 方面         | Conversations  | 项目                                                                            |
| ---------- | -------------- | ----------------------------------------------------------------------------------- |
| 适用场景       | 提问、探索和 Routine | 更深入的构建与设计工作，例如应用、幻灯片、仪表板以及多个构建产物                                                 |
| 结构         | 单个线程           | 包含多个构建产物的 项目 workspace                                                         |
| 后台 task    | 不支持            | 可并行运行                                                                               |
| Routine    | 支持             | 不支持                                                                                 |
| 集成         | 支持             | 支持                                                                                  |
| 可创建的内容     | 资源，例如文档、图片和表格  | 资源，例如文档、图片和表格，以及 [构建产物](/zh/features/projects-and-artifacts/artifacts)，例如 幻灯片、应用和网站 |
| Publishing | 无法发布           | 可发布并公开                                                                              |

<Frame>
  <img src="/assets/mirror/conversation-and-project-icons-025a17613daa.png" alt="Replit 侧边栏显示 Conversation 的聊天图标和 项目的网格图标" width="466" height="290" data-path="images/chat/conversation-and-project-icons.png" />
</Frame>