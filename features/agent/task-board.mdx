---
title: "Task board"
description: "Use the task board to review, start, monitor, and apply Agent tasks as they move through each stage."
...
<Frame>
  <img src="/assets/mirror/task-settings-dropdown-7ea7868303b4.png" alt="Task settings dropdown open on a task card showing Apply changes, Rename, Review changes, and Cancel actions in a fixed-width popover" width="858" height="536" data-path="images/replitai/task-settings-dropdown.png" />
</Frame>
