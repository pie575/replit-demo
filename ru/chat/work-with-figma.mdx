...
Replit поддерживает импорт фреймов Figma.

Импортируйте фрейм Figma, если у вас уже есть представление о визуальном оформлении и вы хотите, чтобы Replit использовал его как основу или преобразовал в дизайн.

<div id="when-figma-helps">
  ## Когда полезна Figma
</div>

* **Рассмотреть другой вариант:** Сохраняйте основную иерархию, пробуя другой стиль или компоновку.
* **Продолжить пользовательский сценарий:** Используйте существующий экран как контекст для следующего экрана или состояния.
* **Перейти от дизайна к App:** Начните с утверждённого визуального решения, затем доработайте и создайте App на его основе.

<div id="import-a-figma-frame">
  ## Импорт фрейма Figma
</div>

Выберите фрейм, работу над которым хотите продолжить. Replit Design преобразует импортированный фрейм в дизайн-фрейм, где можно изучать изменения, сравнивать варианты и решать, что создавать дальше.

<Frame caption="Фрейм Figma, импортированный в Replit Design как дизайн-фрейм.">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="Лендинг Personal Fitness Trainer, импортированный в Replit Design как дизайн-фрейм" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>

<div id="continue-in-design">
  ## Продолжите работу в Design
</div>

В руководстве по Design описан весь процесс импорта, доработки и сборки.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/design/import-figma-designs-into-replit-design">
    ...
    <p>Ознакомьтесь со всем процессом импорта и доработки фрейма Figma.</p>
