---
title: "Add context"
description: "Give Replit the relevant files, sources, connected tools, and existing work needed to understand a Conversation."
...
<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Prompt box plus menu with Upload a file, Create something new, Import an existing project, Use a skill, Use a design system, and Add an integration" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
