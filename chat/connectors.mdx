---
title: "Connectors"
description: "Learn what integrations Agent supports and how they activate automatically based on your prompts."
...
<div className="chat-mkt" role="img" aria-label="Layered workflow icon representing Connectors" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
