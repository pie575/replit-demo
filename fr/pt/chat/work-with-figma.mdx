...
description: "Utilisez un frame Figma comme contexte visuel, puis suivez le processus d’importation de Replit Design pour l’explorer, l’affiner ou créer à partir de celui-ci."
...
Replit prend en charge l’importation de frames depuis Figma.

Importez un frame Figma si vous avez déjà une direction visuelle et souhaitez que Replit s’appuie sur ce travail ou le transforme en Design.

<div id="quando-o-figma-ajuda">
  ## Quand Figma est utile
</div>

* **Explorer une autre piste :** Conservez la hiérarchie principale tout en testant un style ou une disposition différente.
* **Poursuivre un parcours produit :** Utilisez un écran existant comme contexte pour l’écran ou l’état suivant.
* **Passer du design à une App :** Partez d’une direction visuelle approuvée, puis affinez-la et développez l’App à partir de celle-ci.

<div id="importar-um-frame-do-figma">
  ## Importer un frame depuis Figma
</div>

Choisissez le frame correspondant au travail que vous souhaitez poursuivre. Replit Design transforme le frame importé en frame de design, dans lequel vous pouvez explorer des modifications, comparer des suggestions et décider de ce que vous souhaitez créer ensuite.

<Frame caption="Un frame Figma importé sous forme de frame de design dans Replit Design.">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="Page de destination Personal Fitness Trainer importée sous forme de frame de design dans Replit Design" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>
...
Le guide de Design couvre l&#39;intégralité du flux d&#39;importation, d&#39;affinage et de construction.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/pt/design/import-figma-designs-into-replit-design">
    ...
    <p>Suivez le flux complet pour importer et affiner un frame Figma.</p>
    <div className="chat-card-link">Ouvrir le guide de Design →</div>
  </a>
</section>