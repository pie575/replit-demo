...
description: "Learn five practical habits for working with Agent: be specific, plan the work, add context, review and test, and use checkpoints."
...
<AiPrompt>Make my app better.</AiPrompt>

Try:

<AiPrompt>
  Improve the signup page so visitors understand what the product does before
  creating an account.

  <br />

  Keep the current color palette, keep the form fields the same, and make the
  primary button more obvious.
</AiPrompt>
...
<AiPrompt>
  ...
  The most important part is being able to see new requests, mark them as
  contacted, and filter by status.
...
<AiPrompt>
  ...
  Include the user flow, data needed, pages or components that will change,
  risks, and how I should test it.
</AiPrompt>
...
<Frame>
  <img src="/assets/mirror/agent-plan-mode-prompt-059fe8d2c277.png" alt="The Replit home prompt box with a running app prompt typed in and the Plan checkbox toggled on" width="1440" height="900" data-path="images/fitstart/work-with-agent/agent-plan-mode-prompt.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/agent-plan-ready-banner-5fbcf58a1668.png" alt="A task plan is ready for review banner with a Review now button at the bottom of the Agent panel" width="560" height="550" data-path="images/fitstart/work-with-agent/agent-plan-ready-banner.png" />
</Frame>
...
<AiPrompt>
  ...
  Keep the form short, make pickup details obvious, and avoid anything that
  feels corporate.
</AiPrompt>
...
<AiPrompt>
  ...
  Match the overall structure, but keep the existing fields and submission
  behavior.
</AiPrompt>
...
<Frame>
  <img src="/assets/mirror/agent-plan-content-c298ea216ebc.png" alt="Expanded task plan showing What and Why, Done looks like criteria, Out of scope items, and numbered build steps" width="1440" height="900" data-path="images/fitstart/work-with-agent/agent-plan-content.png" />
</Frame>
...
<AiPrompt>
  ...
  Keep the new visual style, remove the optional notes field, and make the
  pickup date easier to scan.
</AiPrompt>
...
<Frame>
  <img src="/assets/mirror/agent-checkpoints-history-c33b3b0dd592.png" alt="The Agent History panel showing a checkpoint labeled 'Transitioned from Plan to Build mode' with Rollback here and Changes buttons" width="720" height="450" data-path="images/fitstart/work-with-agent/agent-checkpoints-history.png" />
</Frame>

When you select **Rollback here**, Agent confirms what will be restored before applying the rollback.

<Frame>
  <img src="/assets/mirror/agent-checkpoints-rollback-dialog-28de278b44da.png" alt="The Rollback to checkpoint confirmation dialog listing the target checkpoint and what will be impacted: files, Agent memory, tasks, and a Database checkbox" width="900" height="880" data-path="images/fitstart/work-with-agent/agent-checkpoints-rollback-dialog.png" />
</Frame>
...
<CardGroup cols={2}>
  <Card icon="comment-dots" href="/learn/effective-prompting">
  ...
  <Card title="Build your first app" icon="rocket" href="/build/your-first-app">
    Practice working with Agent from the first prompt through a focused
    refinement.
  </Card>

  <Card title="Checkpoints and rollbacks" icon="rotate-left" href="/features/version-control/checkpoints-and-rollbacks">
