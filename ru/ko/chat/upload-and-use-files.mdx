...
description: "Добавляйте в Conversation связанные документы, электронные таблицы, изображения и снимки экрана и сообщайте Replit, как использовать эту информацию при обработке вашего запроса."
...
Загружайте документы, таблицы, изображения и снимки экрана, чтобы передать Replit подтверждающие материалы,
требования и визуальные ориентиры, которые проще предоставить, чем описать.

<div id="section">
  ## Как загрузить файл
</div>

В поле ввода prompt нажмите кнопку **plus**, затем выберите **Upload a file**. Также можно перетащить файл в поле ввода prompt. Добавьте файл перед отправкой запроса, который от него зависит.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Меню plus в поле ввода prompt, где Upload a file — первый пункт" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* Задавайте вопросы о PDF-файлах.
* Попросите Replit создать или доработать дизайн на основе снимка экрана.
* Расскажите Replit, какое приложение хотите создать, и предоставьте необходимую информацию.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ko/chat/upload-and-use-files">
    ...
    <p>Посмотрите подробный пример анализа файлов.</p>
