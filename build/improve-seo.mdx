---
title: "Improve your app's SEO"
description: "Use Replit's SEO rating and Agent to make your published app rank higher in search engines."
sidebarTitle: "Improve SEO"
...
<Steps>
  ...
  <Step title="Fix with Agent or Fix all with Agent">
    ...
    * **Fix all with Agent** sends every issue to Agent at once. The **Fix all issues** button in the chat does the same thing.
    ...
    <Frame caption="After the scan, fix issues individually, by category, or all at once with Fix all with Agent">
      <img src="/assets/mirror/03-fix-with-agent-c5b9e642818e.png" alt="The scan results table grouped by category with severity and status columns, a red rectangle highlighting the Fix all with Agent button, and per-category Fix with Agent buttons" width="1657" height="947" data-path="images/deployments/seo-agent/03-fix-with-agent.png" />
    </Frame>
  </Step>
  ...
  <Step title="Agent works through the fixes">
    ...
    <Frame caption="Agent spins up fix tasks; issue rows show Fix in progress with a Go to task link">
      <img src="/assets/mirror/04-fixes-in-progress-e05dd10c05b3.png" alt="The scan results table with issue rows now showing a Fix in progress status and Go to task links while Agent works" width="1657" height="947" data-path="images/deployments/seo-agent/04-fixes-in-progress.png" />
    </Frame>
  </Step>
  ...
  <Step title="Apply changes to main version">
    ...
    <Frame caption="Review each fix and select Apply changes to main version to merge it">
      <img src="/assets/mirror/05-apply-changes-7d167b6bb93a.png" alt="A zoomed-in view of the Ready for review task footer with a red rectangle highlighting the green Apply changes to main version button" width="1656" height="946" data-path="images/deployments/seo-agent/05-apply-changes.png" />
    </Frame>
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="SEO Agent" icon="robot" href="/features/publishing/seo-agent">
  ...
  <Card title="Publishing Geography" icon="globe-pointer" href="/features/publishing/project-geography">
