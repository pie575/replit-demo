...
description: "Découvrez comment Replit transforme les idées, le travail quotidien et l’intelligence en résultats utiles."
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <p>Transformez vos idées, votre travail quotidien et votre expertise en résultats concrets.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/fr/pt/home/get-started">Premiers pas <span aria-hidden="true">→</span></a>
  ...
  <section className="welcome-journey-strip" aria-label="Visite guidée de Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Site d'ouverture de café intitulé « Un lieu paisible au quotidien »" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Découvrez comment transformer votre idée en site web publié
      </div>
      ...
      <a className="welcome-journey-link" href="/fr/pt/home/get-started">
        Commencez le parcours <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/fr/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Recevez un brief ciblé avant chaque réunion client.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez les conversations importantes et transmettez-les rapidement.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Transformez les données actuelles du pipeline en un rapport commercial clair.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/track-subscriptions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez vos paiements récurrents et calculez vos coûts mensuels.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/fr/use-cases">
        Explorer les cas d’utilisation <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/fr/pt/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Une fenêtre de conversation compacte représentant le Chat de Replit">
        ...
        <p>
          Lancez une conversation. Posez des questions, explorez des idées et documentez
          votre plan.
        </p>
      ...
      <a className="welcome-product-card" href="/fr/pt/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Un éditeur de code et un aperçu en temps réel représentant le Build de Replit">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Transformez vos idées en applications et en sites web. Créez, itérez et publiez
          en toute confiance.
        </p>
      ...
      <a className="welcome-product-card" href="/fr/pt/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Une composition sélectionnée sur le Canvas représentant le Design de Replit">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Créez de belles interfaces et du contenu. Itérez sur les mises en page, les composants
          et les expériences.
        </p>

        <div className="welcome-product-link">
          Commencer à créer des designs <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Obtenir Replit</h2>
      <p>Choisissez où utiliser Replit, puis connectez-vous ou créez un compte. Commencez sur le Web, l’application de bureau ou l’application mobile.</p>
    </div>
