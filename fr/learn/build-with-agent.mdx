---
title: "Construire avec Agent"
description: "Apprenez cinq habitudes pratiques pour travailler avec Agent : soyez précis, planifiez le travail, ajoutez du contexte, révisez et testez, et utilisez les points de contrôle."
sidebarTitle: "Construire avec Agent"
icon: "robot"
---
...
Utilisez le [mode Plan](/fr/features/agent/plan-mode) lorsque vous voulez qu'Agent réfléchisse d'abord et attende votre approbation avant de modifier les fichiers. Activez **Plan** dans le compositeur d'invite avant de soumettre.

<Frame>
  <img src="/assets/mirror/agent-plan-mode-prompt-059fe8d2c277.png" alt="La boîte d'invite d'accueil Replit avec une invite d'application en cours saisie et la case Plan activée" width="1440" height="900" data-path="images/fitstart/work-with-agent/agent-plan-mode-prompt.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/agent-plan-ready-banner-5fbcf58a1668.png" alt="Bannière 'le plan de tâche est prêt pour révision' avec un bouton Réviser maintenant au bas du panneau Agent" width="560" height="550" data-path="images/fitstart/work-with-agent/agent-plan-ready-banner.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/agent-plan-content-c298ea216ebc.png" alt="Plan de tâche développé montrant Quoi et Pourquoi, les critères de réussite, les éléments hors périmètre et les étapes de construction numérotées" width="1440" height="900" data-path="images/fitstart/work-with-agent/agent-plan-content.png" />
</Frame>
...
Pour plus de conseils sur la récupération, voir [Points de contrôle et retours arrière](/fr/features/version-control/checkpoints-and-rollbacks).
...
<CardGroup cols={2}>
  ...
  <Card title="Créez votre première application" icon="rocket" href="/fr/build/your-first-app">
    Pratiquez le travail avec Agent, du premier prompt jusqu'à un ajustement
    ciblé.
  </Card>

  <Card title="Points de contrôle et retours arrière" icon="rotate-left" href="/fr/features/version-control/checkpoints-and-rollbacks">
