---
title: "上传和使用文件"
description: "将相关文档、电子表格、图片和截图添加到 Conversation，并告诉 Replit 应如何利用这些信息来处理你的请求。"
...
在提示词框中选择 **plus** 按钮，然后选择 **上传文件**。你也可以将文件拖放到提示词框中。请先添加文件，再发送需要依赖该文件的请求。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示词框的 plus 菜单，其中“上传文件”是第一个选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* 分析电子表格。
* 就 PDF 提问。
* 请 Replit 根据截图创建或优化设计。
* 向 Replit 提供有关您想创建的应用的信息或方向。
