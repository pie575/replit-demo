---
title: "Elements"
description: "Select and edit the individual pieces inside a frame on Canvas."
...
<Frame>
  <img src="/assets/mirror/canvas-ask-element-53f7468a07d3.png" alt="Close-up of the inline prompt for a selected element on Canvas: an 'img' chip followed by 'Ask about selected element…' placeholder text and a send button." width="1500" height="500" data-path="images/replitai/canvas-ask-element.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/canvas-inspect-f60f088d2eb6.png" alt="A McLaren 765LT detail page in a Website frame with the McLaren image element selected (highlighted in blue with an 'img' chip). The Visual Editor panel is open, showing the Image source path, an Upload Image button, and Layout, Color, and Border sections." width="2000" height="1252" data-path="images/replitai/canvas-inspect.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/canvas-element-panel-c8972fab0448.png" alt="Canvas with a div element selected (the McLaren booking sidebar). The Visual Editor panel on the right shows Text (Font size 16, Font weight Regular, Alignment), Layout (Outer space with a 24px bottom value, Inner space 20/20 with link toggles), and Color (Text #e4e4e7, Background #0f0f12) sections." width="2000" height="1252" data-path="images/replitai/canvas-element-panel.png" />
</Frame>
