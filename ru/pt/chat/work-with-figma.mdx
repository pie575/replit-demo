...
description: "Используйте фрейм Figma в качестве визуального контекста, а затем импортируйте его в Replit Design, чтобы изучить, доработать или создать на его основе приложение."
sidebarTitle: "Работа с Figma"
icon: "figma"
...
Replit поддерживает импорт фреймов из Figma.

Импортируйте фрейм из Figma, если у вас уже есть визуальная концепция и вы хотите, чтобы Replit взял её за основу или преобразовал в дизайн.

<div id="quando-o-figma-ajuda">
  ## Когда Figma полезен
</div>

* **Исследовать другой вариант:** Сохраните основную иерархию, экспериментируя с другим стилем или макетом.
* **Продолжить пользовательский сценарий:** Используйте существующий экран как контекст для следующего экрана или состояния.
* **Перейти от дизайна к App:** Начните с утверждённой визуальной концепции, затем доработайте его и создайте на его основе App.

<div id="importar-um-frame-do-figma">
  ## Импортируйте фрейм из Figma
</div>

Выберите фрейм, с которым хотите продолжить работу. Replit Design преобразует импортированный фрейм в фрейм дизайна, где можно изучать изменения, сравнивать предложения и решать, что создавать дальше.

<Frame caption="Фрейм из Figma, импортированный как фрейм дизайна в Replit Design.">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="Лендинг Personal Fitness Trainer, импортированный как фрейм дизайна в Replit Design" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>
...
Руководство по Design описывает весь процесс импорта, доработки и создания приложения.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/pt/design/import-figma-designs-into-replit-design">
    ...
    <div className="chat-card-title">Импорт из Figma</div>
    <p>Ознакомьтесь с полным процессом импорта и доработки макета из Figma.</p>
