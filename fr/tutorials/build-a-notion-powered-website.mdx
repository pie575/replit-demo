---
title: "Créer un site web propulsé par Notion"
description: "Apprenez à créer un site web utilisant Notion comme système de gestion de contenu (CMS) avec Replit Agent."
---
...
Notion est un outil puissant pour organiser l'information, et il excelle en tant que système de gestion de contenu (CMS). En intégrant Notion à Replit, vous pouvez gérer le contenu de votre site web — comme des articles de blog, des éléments de portfolio ou des listes de produits — directement depuis votre espace de travail Notion.

Replit, propulsé par [Replit Agent](/fr/features/agent/overview), gère le codage, l'hébergement et le déploiement, vous permettant de passer de l'idée à une application publiée rapidement. Un prompting efficace est essentiel pour guider Agent ; pour un guide complet, consultez [Prompting efficace avec Replit AI](/fr/tutorials/effective-prompting) et [Comment vibe coder efficacement](/fr/tutorials/how-to-vibe-code).

<YouTubeEmbed videoId="AOYqTONf07o" title="Vibe coding a custom website with Notion as a CMS" />

Ce tutoriel vous guide dans la création d'un blog minimaliste qui récupère ses articles depuis un tableau Notion. Vous allez :
...
<Frame caption="Résultat final : un blog minimaliste propulsé par Notion">
  <img src="/assets/mirror/final-app-0a4ae75ee231.png" alt="Capture d'écran de l'application de blog propulsée par Notion avec un design minimaliste" width="3840" height="2160" data-path="images/tutorials/notion-cms/final-app.png" />
</Frame>
...
* D'un compte Replit
* D'un compte Notion
* D'une familiarité avec les interactions de base avec Replit Agent. Si vous êtes nouveau avec Agent, consultez la [documentation Replit Agent](/fr/features/agent/overview).
...
<Steps>
  <Step title="Créer une intégration Notion">
    ...
    <Frame caption="Création d'une nouvelle intégration dans Notion">
      <img src="/assets/mirror/new-integration-1-dcb1779aa5d5.png" alt="Portail développeur Notion affichant le bouton Nouvelle intégration" width="3794" height="2168" data-path="images/tutorials/notion-cms/new-integration-1.png" />
    </Frame>

    5. Nommez votre intégration (par ex., « Mon intégration blog Replit »).
    6. Associez-la à l'espace de travail souhaité.

    <Frame caption="Configuration de votre intégration Notion">
      <img src="/assets/mirror/new-integration-2-95484e5e5ce5.png" alt="Écran de configuration de l'intégration Notion avec sélection du nom et de l'espace de travail" width="3796" height="2168" data-path="images/tutorials/notion-cms/new-integration-2.png" />
    </Frame>

    7. Pour « Type d'intégration », choisissez **Intégration interne**.
    8. Sélectionnez **Soumettre**.
    9. Copiez votre **Secret d'intégration interne** (token) et conservez-le en lieu sûr. C'est votre clé API Notion.

    <Frame caption="Obtention de votre secret d'intégration">
      <img src="/assets/mirror/new-integration-3-6ddc518a34f7.png" alt="Page des secrets d'intégration Notion affichant le token d'intégration" width="3796" height="2168" data-path="images/tutorials/notion-cms/new-integration-3.png" />
    </Frame>

    10. Sous **Capacités**, assurez-vous que « Lire le contenu » est activé. Pour ce tutoriel, la lecture est suffisante. Si vous souhaitez plus tard écrire des données dans Notion, activez « Insérer du contenu » et « Mettre à jour le contenu ».
    ...
    Vous pouvez accéder directement au tableau de bord des intégrations Notion sur [notion.so/my-integrations](https://notion.so/my-integrations).
  </Step>

  <Step title="Créer une page Notion avec une base de données">
    ...
    5. Ajoutez quelques exemples d'articles. Vous pouvez utiliser les fonctionnalités d'IA de Notion pour générer du contenu !
  </Step>

  <Step title="Connecter votre intégration à la page">
    1. Ouvrez la page Notion contenant votre base de données.
    2. Cliquez sur le menu **•••** (trois points) dans le coin supérieur droit.

    <Frame caption="Accéder au menu d'intégration dans Notion">
    ...
    4. Recherchez et sélectionnez l'intégration que vous avez créée (par ex., « Mon intégration blog Replit »).

    <Frame caption="Ajout de votre intégration à la page Notion">
      <img src="/assets/mirror/add-integration-menu-f6b013e70a48.png" alt="Page Notion affichant le menu à trois points pour ajouter des intégrations" width="3840" height="2160" data-path="images/tutorials/notion-cms/add-integration-menu.png" />
    </Frame>

    5. Confirmez la connexion. Cela permet à Replit (via le token d'intégration) d'accéder à cette page et à sa base de données.
  </Step>
</Steps>
...
<Steps>
  <Step title="Ouvrir Replit Agent">
    Naviguez vers la page d'accueil de Replit et ouvrez **Agent**.
  </Step>

  <Step title="Rédiger votre prompt">
    ...
    <Tip>
      Pour plus de conseils sur la rédaction de prompts efficaces, consultez notre guide sur le [Prompting efficace avec Replit AI](/fr/tutorials/effective-prompting).
      Vous pouvez également **montrer** à Agent ce que vous entendez en fournissant une URL à scraper pour des idées de style ou de contenu initiales (par ex., votre portfolio personnel) en ajoutant : `Scrape the content of [URL] for initial design inspiration and placeholder text.`
    </Tip>
  ...
  <Step title="Examiner l'aperçu initial">
...
<Steps>
  <Step title="Ajouter des Secrets dans Replit">
    ...
    * **Plus fiable** : Cliquez sur le menu **•••** de votre vue de base de données, sélectionnez **Copier le lien vers la vue**, et collez-le. Le lien `https://www.notion.so/your-workspace/DATABASE_ID?v=VIEW_ID` contient le `DATABASE_ID` avant `?v=`.
    ...
    Accédez à l'outil **Secrets** (icône 🔒) dans le Project Editor. Ajoutez-y :
    ...
    * Clé : `NOTION_DATABASE_ID`, Valeur : `[Votre_ID_de_Base_de_Données_Notion]`
    ...
    <Frame caption="Ajout de vos secrets Notion à Replit">
      <img src="/assets/mirror/add-secrets-0cf2e788b372.png" alt="Outil Secrets de Replit avec la clé API Notion et l'ID de base de données ajoutés" width="3840" height="2160" data-path="images/tutorials/notion-cms/add-secrets.png" />
    </Frame>
...
Construire avec l'IA est un processus itératif. Des erreurs ou des imperfections sont à prévoir. C'est là que guider efficacement l'IA — souvent appelé « vibe coding » — est essentiel. Pour approfondir cette compétence, consultez notre tutoriel sur [Comment vibe coder efficacement](/fr/tutorials/how-to-vibe-code). **Maîtrisez le contexte** en fournissant uniquement les informations pertinentes pour chaque étape de débogage.

<Tip>
  Gardez la **Console** du Project Editor ouverte. Elle fournit des messages d'erreur et des journaux précieux.
</Tip>

<Frame caption="Débogage de votre application Notion avec la console Replit">
  <img src="/assets/mirror/console-debug-1371ef15d9b5.png" alt="Console Replit affichant des messages d'erreur lors du débogage de l'intégration Notion" width="3840" height="2160" data-path="images/tutorials/notion-cms/console-debug.png" />
</Frame>
...
L'application fonctionne mais n'affiche pas les articles. Les erreurs dans la console peuvent mentionner « Could not find sort property with name ID created\_time » ou d'autres incohérences de colonnes.
...
<AccordionGroup>
  <Accordion title="Implémenter la mise en cache et le préchargement">
  ...
  <Accordion title="Configurer la stratégie de rafraîchissement des données">
...
1. Sélectionnez **Publier** dans le Project Editor (en haut à droite).
2. Vérifiez les paramètres de publication (nom du projet, niveau). Pour plus de détails, consultez [Déploiements](/fr/learn/projects-and-artifacts/replit-deployments).
3. Sélectionnez **Publier**.

<Frame caption="Publication de votre site web propulsé par Notion">
  <img src="/assets/mirror/deploy-13a5233cd675.png" alt="Interface de publication Replit montrant comment publier votre site web propulsé par Notion" width="3840" height="2160" data-path="images/tutorials/notion-cms/deploy.png" />
</Frame>
...
Pour des informations détaillées sur les points de contrôle et les retours en arrière, consultez [Points de contrôle et retours en arrière](/fr/features/version-control/checkpoints-and-rollbacks).

Construire avec l'IA comme Replit Agent est collaboratif. La pensée procédurale, les instructions claires et le débogage méthodique sont essentiels pour transformer les idées en réalité, rapidement.
...
<AccordionGroup>
  <Accordion title="Expérimenter avec des types de contenu">
    Essayez d'ajouter du contenu varié depuis Notion : galeries d'images, vidéos intégrées ou éléments catégorisés.
  </Accordion>

  <Accordion title="Exploiter les fonctionnalités avancées de Notion">
  ...
  <Accordion title="Combiner avec d'autres intégrations Replit">
    Améliorez votre application en fusionnant les données Notion avec d'autres outils [Replit AI](/fr/build/welcome) ou des [intégrations Agent](/fr/features/integrations/overview). Par exemple, utilisez Replit Auth pour du contenu privé ou OpenAI pour des résumés générés par IA à partir de données Notion dans votre application.
  </Accordion>
</AccordionGroup>
