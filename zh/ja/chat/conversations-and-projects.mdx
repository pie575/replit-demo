---
title: "Conversations 与 Projects"
description: "了解何时继续在 Conversation 中工作，以及何时应将较为正式的工作转为 Project。"
sidebarTitle: "Conversations 与 Projects"
tag: "New"
icon: "objects-column"
...
使用 Replit 时，你要么在 Conversation 中工作，要么在构建项目。Conversation 适合提问、探索、跟进和运行 Routine。Project 适合构建应用、制作幻灯片和创建设计。

[了解如何将 Conversation 转换为项目。](/zh/ja/chat/continue-or-create-a-project)

<div id="section">
  ## 两者的区别
</div>

Conversations 和 Projects 相互关联，但用途不同。两者的区别如下：

| 项目       | Conversations   | Projects                                                                              |
| -------- | --------------- | ------------------------------------------------------------------------------------- |
| 最适用场景    | 提问、探索和 Routines | 应用、幻灯片、仪表板、多个 artifact 等更复杂的构建和设计工作                                                   |
| 结构       | 单个线程            | 包含多个 artifact 的项目工作区                                                           |
| 后台任务     | 不可用             | 可并行运行                                                                                 |
| Routines | 可用              | 不可用                                                                                   |
| 集成       | 可用              | 可用                                                                                    |
| 可创建的内容   | 文档、图片、表格等资源     | 除文档、图片、表格等资源外，还可创建幻灯片、应用、网站等[artifact](/zh/ja/features/projects-and-artifacts/artifacts) |
| 发布       | 无法发布            | 可发布并向公众开放                                                                             |

<Frame>
  <img src="/assets/mirror/conversation-and-project-icons-025a17613daa.png" alt="Replit 侧边栏，显示 Conversation 的聊天图标和项目的网格图标" width="466" height="290" data-path="images/chat/conversation-and-project-icons.png" />
</Frame>