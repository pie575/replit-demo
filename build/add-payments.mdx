---
title: "Add payments"
description: "Take a refundable deposit when a customer reserves a Velocity car, then charge the balance on pickup."
...
<Frame>
  <img src="/assets/mirror/stripe-secrets-b04a3e238f51.png" alt="Replit Secrets pane showing the Stripe API keys (STRIPE_SECRET_KEY, STRIPE_PUBLISHABLE_KEY, STRIPE_WEBHOOK_SECRET) that Agent told the builder to paste" width="1280" height="720" data-path="images/velocity/add-payments/stripe-secrets.png" />
</Frame>
