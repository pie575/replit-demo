---
title: "파일 업로드 및 사용"
description: "관련 문서, 스프레드시트, 이미지, 스크린샷을 Conversation에 추가하고 그 정보가 요청을 어떻게 뒷받침해야 하는지 Replit에 알려주세요."
sidebarTitle: "파일 업로드 및 사용"
icon: "file-arrow-up"
...
<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Upload a file이 첫 번째 옵션으로 있는 프롬프트 박스의 plus 메뉴" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
