---
title: "Начало работы с Conversation"
description: "Начните Conversation с простого вопроса, поиска в интернете или подключённого контекста, а затем выберите дальнейшие действия."
---
...
Ваше рабочее пространство готово. Теперь пора развивать идею кофейни.
Начните [Conversation](/ru/ko/chat/conversations), расскажите Replit, что хотите создать,
и превратите свою первую идею в реальный план запуска.

<div id="section">
  ## Начните новый диалог
</div>

Выберите **New** на боковой панели Replit. Откроется диалог, в котором вы сможете развить идею, изучить рынок и спланировать запуск.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Главная страница Replit в рабочем пространстве Demo с выделенной кнопкой New, рекомендуемыми промптами и полем для сообщений" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

<div id="section-2">
  ## Изучите поле запроса
</div>

Выберите **New** и изучите поле запроса. Здесь вы будете направлять Replit,
добавлять полезный контекст и продолжать работу над запуском кофейни.
Далее составьте свой первый промпт.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Меню «плюс» в поле запроса: загрузка файла, создание нового, импорт проекта, использование навыка или дизайн-системы и добавление интеграции" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ko/home/describe-your-idea">
    ...
    <div className="chat-card-title">Уточните концепцию</div>
    <p>Сформулируйте чёткий первый запрос для запуска кофейни.</p>
