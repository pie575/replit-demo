---
title: "Stripe 결제 연동"
description: "Agent를 사용하여 Stripe로 앱에 결제 및 구독을 추가하는 방법을 알아보세요."
---
...
<Note>
  Stripe 연동은 유료 플랜([Core](/ko/billing/plans/replit-core) 및 [Pro](/ko/billing/plans/replit-pro))에서만 사용할 수 있습니다. 무료 [Starter](/ko/billing/plans/starter-plan) 플랜에서는 사용할 수 없으며—Agent가 커넥터를 제안할 때 업그레이드를 안내합니다.
</Note>
...
<Steps>
  <Step title="연동 탭 열기">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-disconnect-1-integrations-371e1e7e5609.png" alt="커넥터에 Stripe 연동과 관리 버튼이 표시된 연동 탭" width="2000" height="1110" data-path="images/replitai/stripe-disconnect-1-integrations.png" />
    </Frame>
  </Step>
  ...
  <Step title="API 키 펼치기">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-disconnect-2-edit-keys-4e9e76c4065f.png" alt="편집 버튼이 있는 Stripe 샌드박스 및 라이브 계정 API 키 펼침" width="2000" height="1274" data-path="images/replitai/stripe-disconnect-2-edit-keys.png" />
    </Frame>
  </Step>
  ...
  <Step title="계정 연결 해제하기">
    **Disconnect account**를 선택하여 샌드박스 연결을 제거하고, **Disconnect live account**를 선택하여 라이브 연결을 제거하세요.
    ...
    <Frame>
      <img src="/assets/mirror/stripe-disconnect-3-disconnect-f4257f534c5c.png" alt="계정 연결 해제 및 라이브 계정 연결 해제 버튼이 있는 Stripe 샌드박스 및 라이브 계정 API 키" width="2000" height="1271" data-path="images/replitai/stripe-disconnect-3-disconnect.png" />
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Stripe 연동 이전 체크포인트 찾기">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-rollback-5-clock-icon-c54cd19246ea.png" alt="채팅 기록과 체크포인트를 보기 위한 시계 아이콘" width="56" height="50" data-path="images/replitai/stripe-rollback-5-clock-icon.png" />
    </Frame>
  </Step>
  ...
  <Step title="여기서 롤백 선택하기">
    ...
    <Frame>
      <img src="/assets/mirror/stripe-rollback-6-checkpoint-2f195b0ea9ce.png" alt="여기서 롤백 버튼이 있는 체크포인트" width="904" height="202" data-path="images/replitai/stripe-rollback-6-checkpoint.png" />
    </Frame>
  </Step>
</Steps>
