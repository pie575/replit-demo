---
title: "오픈 예정 사이트 디자인하기"
description: "커피숍 출시 계획을 오픈 예정 사이트 디자인으로 발전시켜 보세요."
---
...
<Steps>
  <Step title="첫 사이트 검토하기">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/opening-site-preview-269c92373f00.jpg" alt="Replit에서 Publishing 컨트롤과 함께 표시된 커피숍 오픈 예정 사이트 미리보기" />
  </Step>
  ...
  <Step title="Design 열기">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/open-design-94e3ca17d3e8.jpg" alt="오픈 예정 커피숍 사이트 위에 열린 Replit Design 메뉴" />
  </Step>
  ...
  <Step title="디자인 검토하기">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/review-updated-site-design-d8550c0887c0.jpg" alt="히어로 섹션에 생성된 카푸치노 이미지가 적용된, 업데이트된 커피숍 오픈 예정 사이트 디자인" />
  </Step>
  ...
  <Step title="다양한 레이아웃 살펴보기">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/explore-design-directions-af53342d08e9.jpg" alt="커피숍 사이트를 재구상하고, 레이아웃을 시도하고, 다듬기 위해 Replit Design이 제안한 다음 단계" />
  </Step>
  ...
  <Step title="이미지 애셋 추가하기">
    **Generate**를 선택한 다음 **Image**를 선택하세요. 필요한 애셋과 그것이
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/open-generate-menu-c69c7736a0b9.png" alt="Design, Image, Video, Vector Graphic 옵션이 있는 Replit Design 캔버스의 Generate 메뉴" />

    <CoffeeShopScreenshotFrame src="/assets/mirror/write-image-request-61a1e519ba91.png" alt="Replit Design 캔버스에서 카푸치노 이미지를 생성하기 위한 프롬프트" />
  </Step>
  ...
  <Step title="사이트에 새 애셋 사용하기">
    ...
    <CoffeeShopScreenshotFrame src="/assets/mirror/replace-hero-image-1d797508fe6c.jpg" alt="Replit Design 캔버스에서 생성된 카푸치노 이미지가 선택된 상태로, 웹사이트 히어로 이미지를 교체해 달라는 요청이 있는 화면" />
  </Step>
