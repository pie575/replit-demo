...
description: "Подключите файлы и инструменты, чтобы предоставить Replit контекст для составления плана запуска кофейни."
---
...
Теперь, когда вы разобрались с интеграциями, давайте применим их к запуску вашей
кофейни.

Направление вы уже выбрали: не бар для пассажиров у вокзала, а **кафе для
жителей района**. Дайте Replit материалы, которые помогут превратить эту идею
в план, готовый к воплощению.

Интеграции подключают Replit к инструментам и файлам, которыми вы уже пользуетесь.
Благодаря этому Replit может получать нужную информацию и выполнять действия,
необходимые для задачи. Подключить можно более 450 сервисов, среди которых
**[Slack](/ru/ja/features/integrations/overview#connectors)**,
**[Google Drive](/ru/ja/features/integrations/overview#connectors)**,
**[Notion](/ru/ja/features/integrations/overview#connectors)**,
**[Salesforce](/ru/ja/features/integrations/overview#connectors)**.

В случае с этой кофейней Google Drive откроет Replit доступ к бюджету, заметкам
о расположении, идеям для меню, фотографиям и визуальным референсам.
А Notion станет единым местом, где фиксируются план запуска, принятые
решения и открытые вопросы.

Подробнее о том, как [подключить инструменты](/ru/ja/chat/integrate-your-tools).

<Steps>
  <Step title="Попросите Replit собрать материалы">
    Начните со следующего запроса. Replit определит, что нужно для составления
    плана, и предложит подключить сервисы, если потребуется доступ.

    <AiPrompt>
      На основе файлов моей кофейни составь план запуска районной кофейни на первый
      месяц. Обнови соответствующие допущения, а затем запиши концепцию, ключевые
      решения, открытые вопросы и чек-лист запуска в Notion.
    </AiPrompt>
  </Step>

  <Step title="Подключите Google Drive, когда Replit об этом попросит">
    Разрешите подключение Google Drive, чтобы Replit мог просмотреть нужные материалы.
    Запрос на подключение Replit откроет прямо в переписке.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit просит подключить Google Drive, чтобы просмотреть файлы кофейни" />
  </Step>

  <Step title="Подключите Notion, когда Replit понадобится задокументировать план">
    Разрешите доступ к Notion, когда Replit попросит об этом для создания брифа запуска.
    Так концепция, решения, открытые вопросы и чек-лист окажутся
    в одном месте.
  </Step>
</Steps>

Google Drive даёт фактическую основу, на которую Replit опирается в работе. А Notion хранит
в одном месте план, который развивается по мере того, как вы отвечаете на новые
вопросы и принимаете решения.

Подробнее: [добавление контекста](/ru/ja/chat/add-context), [загрузка файлов](/ru/ja/chat/upload-and-use-files),
[подключение инструментов](/ru/ja/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ja/home/watch-the-competition">
    ...
    <p>Пока вы готовитесь к запуску, настройте routine, который будет отслеживать изменения.</p>
