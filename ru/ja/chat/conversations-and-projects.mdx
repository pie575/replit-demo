...
description: "Узнайте, когда продолжать работу в Conversation, а когда преобразовать её в полноценный Project."
...
В Replit вы либо работаете в Conversation, либо создаёте Project. Conversations предназначены для вопросов, исследований, уточнений и Routines. Projects — для создания приложений, слайдов и дизайнов.

[Узнайте, как превратить Conversation в Project.](/ru/ja/chat/continue-or-create-a-project)

<div id="section">
  ## Различия между ними
</div>

Conversations и Projects связаны между собой, но служат разным целям. Вот чем они отличаются.

| Параметр                 | Conversations                                   | Projects                                                                                                                                                      |
| ------------------------ | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Лучше всего подходит для | вопросов, исследования идей, Routines           | более серьёзной работы по созданию и дизайну: приложений, слайдов, дашбордов, нескольких артефактов                                                           |
...
| Что можно создать        | ассеты: документы, изображения, таблицы и т. д. | ассеты (документы, изображения, таблицы и т. д.), а также [артефакты](/ru/ja/features/projects-and-artifacts/artifacts) — слайды, приложения, веб-сайты и другое |
| Публикация               | недоступна                                      | можно опубликовать и открыть общий доступ                                                                                                                     |
