---
title: "대화 시작하기"
description: "간단한 질문, 웹 리서치 또는 연결된 컨텍스트로 대화를 시작하고, 이어서 무엇을 할지 선택하세요."
sidebarTitle: "대화 시작하기"
icon: "comments"
...
Workspace가 준비되었습니다. 이제 커피숍 아이디어를 본격적으로 발전시킬 차례입니다.
[대화](/ko/chat/conversations)를 시작해 만들고 싶은 것을 Replit에 알려주고,
처음의 아이디어를 실제 launch plan으로 만들어 보세요.

<div id="start-a-new-conversation">
  ## 새 대화 시작하기
</div>

Replit 사이드바에서 **New**를 선택하세요. 콘셉트를 구체화하고, 시장을
조사하고, 출시를 계획할 대화가 열립니다.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="New 버튼, 추천 프롬프트, 메시지 입력창이 강조된 Demo workspace의 Replit 홈 화면" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>
...
**New**를 선택한 다음 프롬프트 box를 살펴보세요. 여기에서 Replit에 direction을 제시하고 유용한 컨텍스트를 추가하면서 커피숍 launch 작업을 이어가게 됩니다. 다음 단계는 첫 프롬프트를 작성하는 것입니다.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="파일 upload, 새로 만들기, project import, skill 또는 design system 사용, integration 추가 옵션이 있는 프롬프트 box 더하기 메뉴" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ko/home/describe-your-idea">
    ...
    <div className="chat-example-tag">첫 프롬프트</div>
    <div className="chat-card-title">콘셉트 구체화하기</div>
    <p>커피숍 출시를 위한 핵심을 짚은 첫 요청을 작성해 보세요.</p>
