---
title: "Import a website into Replit Design"
description: "Recreate a live website as a design frame in Replit Design, then refine it with suggestions and chat, and build it into an app."
...
<Steps>
  <Step title="Copy the site's URL">
    ...
    <Frame caption="The example site: Kosmo Studio, a creative studio landing page.">
      <img src="/assets/mirror/url-example-site-e0ad60629981.webp" alt="The Kosmo Studio landing page with the headline We craft bold ideas and visuals that truly work, above a fan of artwork cards" width="3440" height="2160" data-path="images/design/import-from-url/url-example-site.webp" />
    </Frame>
  </Step>
  ...
  <Step title="Open Replit Design">
    ...
    <Frame caption="Import URL on the Replit Design home: paste a link to any website.">
      <img src="/assets/mirror/design-import-url-07a8ac52e188.webp" alt="The Replit Design home with the Import URL option selected and a tooltip reading Paste a link to any website and Agent will recreate its look and feel as a starting point" width="2293" height="1322" data-path="images/design/import-from-url/design-import-url.webp" />
    </Frame>
  </Step>
  ...
  <Step title="Paste the URL and start building">
    ...
    <Frame caption="The prefilled recreate prompt with the example URL, ready to start.">
      <img src="/assets/mirror/design-url-prompt-b6196aac1b17.webp" alt="The Replit Design prompt box reading Recreate the look and feel of this website followed by the example URL, with the Start button" width="2293" height="1322" data-path="images/design/import-from-url/design-url-prompt.webp" />
    </Frame>
  </Step>
</Steps>
...
<Frame caption="The recreated Kosmo Studio landing page as a design frame in Replit Design.">
  <img src="/assets/mirror/url-import-result-7a4114a468f3.webp" alt="The recreated Kosmo Studio landing page as a design frame in Replit Design, with the run marked complete in the chat panel" width="1600" height="1004" data-path="images/design/import-from-url/url-import-result.webp" />
</Frame>
