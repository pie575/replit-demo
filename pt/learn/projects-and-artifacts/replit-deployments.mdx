---
title: "Publicação"
description: "Compartilhe seus Replit Apps com o mundo em apenas alguns cliques."
sidebarTitle: "Publicação"
icon: "cloud-arrow-up"
---
...
<CardGroup>
  <Card title="Autoscale Deployment" href="/pt/features/publishing/deployment-types#autoscale" icon="layer-group">
    Ajusta automaticamente os recursos com base no uso do seu app.
  </Card>

  <Card title="Static Deployment" href="/pt/features/publishing/deployment-types#static" icon="files">
    Fornece uma maneira acessível de hospedar sites que não mudam com base na entrada do usuário.
  </Card>

  <Card title="Reserved VM Deployment" href="/pt/features/publishing/deployment-types#reserved-vm" icon="server">
    Fornece uma quantidade consistente de recursos de computação para que seu app seja executado continuamente.
  </Card>

  <Card title="Scheduled Deployment" href="/pt/features/publishing/deployment-types#scheduled" icon="clock">
...
1. No seu Project Editor, selecione <img class="icon-svg" src="/assets/mirror/deploy-icon-7dec74bde1ff.svg" alt="Ícone de publicação" width="16" height="16" data-path="images/icons/deploy-icon.svg" /> **Publish** no topo.
...
* [Autoscale Deployment](/pt/features/publishing/deployment-types#autoscale): Aprenda a configurar aplicativos que escalam com o tráfego
* [Static Deployment](/pt/features/publishing/deployment-types#static): Descubra como publicar sites estáticos de forma rápida e eficiente
* [Reserved VM Deployment](/pt/features/publishing/deployment-types#reserved-vm): Explore opções de VM dedicada para casos de uso especializados
* [Scheduled Deployment](/pt/features/publishing/deployment-types#scheduled): Configure tarefas recorrentes com agendamento simples
* [Custom Domains](/pt/features/publishing/custom-domains): Conecte seu app publicado a um domínio personalizado
