...
description: "Crie e publique seu primeiro aplicativo com o Replit Agent em minutos."
---
...
Você precisará de uma [conta gratuita no Replit](https://replit.com).

<Note>Este guia de início rápido usa o Agent, incluído no plano Starter gratuito com créditos diários. Não é necessário cartão de crédito.</Note>

## Bem-vindo ao Replit

Ao abrir o Replit, a primeira coisa que você vê é o **Editor de Projetos**, com a caixa de prompt no centro. É aqui que tudo começa. Descreva o que você quer criar e o Agent cuida do resto.

<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="A tela inicial do Editor de Projetos do Replit mostrando o campo de entrada de prompt onde você descreve o que quer criar" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

## Crie seu aplicativo

<Steps>
  <Step title="Descreva o que você quer criar">
    Na caixa de prompt na tela inicial, descreva o que você quer criar. Seja específico sobre os recursos e o comportamento — quanto mais detalhes você fornecer ao Agent, melhor será o resultado.

    Para este guia de início rápido, tente algo como: *"Crie um piano realista de 16 teclas com o layout correto de teclas brancas e pretas. Cada tecla deve pressionar para baixo com animação quando clicada e tocar a nota correta."*

    Pressione **Iniciar** para começar a criação. O Agent configura seu projeto e começa a escrever o código. Isso leva cerca de 3 a 5 minutos.

    <Tip>Você pode criar qualquer ideia que quiser — uma lista de tarefas, uma página de destino, um aplicativo de quiz. Os demais passos funcionam da mesma forma.</Tip>
  </Step>

  <Step title="Visualize seu aplicativo">
    Quando o Agent terminar, navegue até a aba **Visualização** para ver seu aplicativo em ação. Clique e interaja com ele para garantir que funciona como esperado.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-piano-demo-4b7f4ee0053a.mp4" />
    </Frame>

    <Note>Seu aplicativo pode parecer ligeiramente diferente das capturas de tela — o Agent pode gerar resultados variados a partir do mesmo prompt.</Note>
  </Step>

  <Step title="Publique seu aplicativo">
    Pronto para compartilhar? Clique em **Publicar** no Editor de Projetos para implantar seu aplicativo em uma URL pública que qualquer pessoa pode visitar.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-publish-app-ae59052ca92d.mp4" />
    </Frame>

    Seu aplicativo está agora no ar. Copie a URL e compartilhe com quem quiser.
  </Step>
</Steps>

## Experimente agora

Pronto para criar? Pressione <StartButton /> para abrir o Replit com o prompt do piano já preenchido.

<AgentInput highlightStart defaultPrompt="Crie um piano realista de 16 teclas com o layout correto de teclas brancas e pretas que se parece exatamente com um piano real. Cada tecla deve pressionar para baixo com animação de profundidade realista quando clicada e tocar a nota correta." showTypewriter={false} />

## Próximos passos

<CardGroup cols={2}>
  <Card title="Criar design com Canvas" icon="palette" href="/pt/getting-started/quickstarts/design-with-canvas">
    Explore variações de design e reformule seu aplicativo visualmente.
  </Card>
  ...
  <Card title="Publicar seu aplicativo" icon="globe" href="/pt/getting-started/quickstarts/publish">
    Saiba mais sobre domínios personalizados, compartilhamento e como funciona a publicação.
  </Card>

  <Card title="Agent" icon="robot" href="/pt/core-concepts/agent">
    Explore tudo o que o Agent pode fazer.
  </Card>
</CardGroup>
