...
description: "Prenez un dépôt remboursable lorsqu'un client réserve une voiture Velocity, puis facturez le solde à la prise en charge."
---
...
<Frame>
  <img src="/assets/mirror/stripe-secrets-b04a3e238f51.png" alt="Volet Secrets de Replit montrant les clés API Stripe (STRIPE_SECRET_KEY, STRIPE_PUBLISHABLE_KEY, STRIPE_WEBHOOK_SECRET) que l'Agent a demandé au développeur de coller" width="1280" height="720" data-path="images/velocity/add-payments/stripe-secrets.png" />
</Frame>
