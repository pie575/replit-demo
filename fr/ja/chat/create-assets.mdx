---
title: "Créer des assets"
description: "Créez des assets d’image, de vidéo, de graphiques vectoriels, d’animations et audio, puis suivez les guides officiels de chaque flux de travail."
sidebarTitle: "Créer des assets"
icon: "photo-film"
...
Demandez à Replit de créer les médias dont vous avez besoin, puis finalisez-les dans Conversation ou dans les différents produits qui prennent en charge ce flux de travail. Choisissez le type d’asset adapté au résultat souhaité.

<div id="section">
  ## Choisir le type d’asset
</div>

<section className="chat-mkt chat-workflow-grid has-visuals catalog-three-up">
  <a className="chat-example has-visual" href="/fr/ja/features/agent/image-generation">
    ...
    <p>
      Créez du contenu visuel pour vos projets : images personnalisées, illustrations, arrière-plans, icônes, etc.
    </p>

    <div className="chat-card-link">Ouvrir la génération d’images →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/ja/design/toolbar#generate">
    ...
    <p>
      Créez de courts clips animés et des animations avec l’outil Generate media de Replit Design.
    </p>
  ...
  <a className="chat-example has-visual" href="/fr/ja/design/toolbar#generate">
    ...
    <p>
      Créez des icônes SVG, des logos, des illustrations et des images stylisées dans Replit Design.
    </p>

    <div className="chat-card-link">Ouvrir le guide Design →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/ja/features/artifact-types/animated-videos">
    ...
    <div className="chat-card-title">Créer des vidéos animées</div>

    <p>
      Créez des animations graphiques par programmation via Conversation, puis exportez-les au format vidéo.
    </p>

    <div className="chat-card-link">Ouvrir les vidéos animées →</div>
  </a>
  ...
  <a className="chat-example has-visual" href="/fr/ja/features/agent/audio-generation">
    ...
    <p>Créez de la musique, des effets sonores et des voix off pour vos applications.</p>
    <div className="chat-card-link">Ouvrir la génération audio →</div>
  </a>
</section>

La création d’assets produit des résultats immédiatement. Pour les tâches à répéter à intervalles réguliers, consultez [Exécuter des tâches Routine](/fr/ja/chat/routines).

Les clips vidéo générés et les vidéos animées suivent des flux de travail différents. Les vidéos animées sont des animations graphiques créées par programmation et exportables au format MP4. Pour voir des exemples d’assets visuels, consultez [Concevoir votre premier écran](/fr/ja/design/design-your-first-screen).

<div id="section-2">
  ## Intégrer les informations les plus récentes
</div>

Web Search ne crée pas d’assets. Utilisez-le lorsque des images, extraits audio, vidéos ou graphiques doivent s’appuyer sur des informations récentes, puis demandez à Replit de créer les assets appropriés en fonction de ces éléments.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ja/features/agent/web-search">
    ...
    <p>
      Recueillez des informations récentes et des sources avant de créer des assets.
    </p>
