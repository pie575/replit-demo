---
title: "Solução de problemas de apps mobile"
description: "Resolva problemas comuns ao criar apps mobile com Expo e React Native no Replit."
---
...
* Voltar para [Apps Mobile Nativos](/pt/features/artifact-types/building-mobile-apps)
* Aprenda o fluxo completo de publicação: [Criar e lançar um app mobile](/pt/build/mobile-app)
