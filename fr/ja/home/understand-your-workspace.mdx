---
title: "Comprendre l’espace de travail"
description: "Découvrez comment l’espace de travail Replit centralise personnes, projets, conversations, routines, données, intégrations et sécurité."
---
...
L’espace de travail Replit rassemble tout ce qui concerne une idée.
Les [projets](/fr/ja/home/projects), les [Conversations](/fr/ja/home/conversations),
les [Routines](/fr/ja/chat/routines) et les intégrations y sont regroupés
pour vous permettre de passer des premières questions à des résultats utiles.

<div id="section">
  ## Préparer le projet de café
</div>

Avant de commencer à concrétiser votre idée de café, préparez un espace pour l’accueillir. Cet
espace de travail permet de centraliser tous les éléments de votre lancement à mesure qu’ils avancent.

* Des conversations pour développer le concept et étudier le marché local
* Des fichiers et des outils connectés qui apportent un contexte utile à votre projet
* Des Routines pour surveiller ultérieurement les concurrents et les évolutions du marché
* Le site que vous finirez par concevoir et publier

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Écran d’accueil Replit de l’espace de travail Demo affichant Projects, Conversations, Routines, des prompts suggérés et une zone de message" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

Ce projet commence dans la zone de saisie. C’est là que vous démarrez une conversation et donnez à Replit une première
description du café que vous souhaitez créer.

<div id="section-2">
  ## Détails de l&#39;espace de travail
</div>

L&#39;espace de travail regroupe les membres, les paramètres, les ressources partagées, les intégrations et la
facturation. Vos droits d&#39;accès déterminent ce que vous pouvez consulter et gérer.

Les paramètres de l&#39;espace de travail et les options d&#39;administration de l&#39;organisation sont distincts des paramètres qui déterminent la façon dont
Agent répond aux requêtes.

Vous pouvez revenir à tout moment à l&#39;espace de travail pendant le lancement et y retrouver tout ce qui le
soutient.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ja/home/start-a-conversation">
    ...
    <div className="chat-card-title">Commencer une Conversation</div>
    <p>Décrivez le résultat que vous souhaitez obtenir pour commencer à créer votre café.</p>
    <div className="chat-card-link">En savoir plus →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/ja/features/collaboration/workspaces">
    ...
    <p>
      Découvrez les espaces de travail personnels et d&#39;équipe, les droits d&#39;accès, les paramètres et l&#39;administration.
    </p>
...
Ensuite, [commencez une Conversation](/fr/ja/home/start-a-conversation) pour commencer à donner forme à votre idée de
café.