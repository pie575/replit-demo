---
title: "Créer et lancer une application mobile"
description: "Créez une application iOS native avec Agent, testez-la sur votre téléphone avec Expo Go, et publiez-la via TestFlight sur l'App Store."
---
...
* Partager un aperçu Expo Go pour les tests et les retours
* Promouvoir vers TestFlight pour les tests bêta
* Soumettre à l'App Store pour une mise en ligne publique

<Note>
  Exécutez ce tutoriel dans le Project Editor sur [replit.com](https://replit.com). Si vous utilisez l'application iOS Replit, ouvrez le projet sur replit.com pour travailler sur les applications mobiles natives.
</Note>
...
* Un compte Replit avec accès au Project Editor sur [replit.com](https://replit.com)
...
<Steps>
  ...
  <Step title="Laisser Agent construire">
...
<Steps>
  <Step title="Installer Expo Go">
    Installez Expo Go sur votre iPhone ou appareil Android.
  </Step>

  <Step title="Ouvrir le code QR">
    Dans l'Éditeur de projet, sélectionnez **Aperçu sur appareil mobile** pour afficher un code QR.
  </Step>

  <Step title="Scanner et prévisualiser">
    Scannez le code QR avec votre téléphone pour ouvrir un aperçu natif dans Expo Go.
  </Step>
</Steps>

<Frame>
  <img src="/assets/mirror/mobile-screen-e5685fc26793.png" alt="Application mobile s'exécutant dans l'aperçu de l'Éditeur de projet Replit avec le panneau Aperçu sur l'appareil et le code QR" width="1440" height="900" data-path="images/native-mobile-apps/mobile-screen.png" />
</Frame>
...
## Partie 3 : Partager un aperçu avec Expo Go

Le partage avec Expo Go crée un aperçu de développement pour les testeurs qui ont Expo Go installé. Utilisez-le pour recueillir des retours avant de soumettre une build via le processus de révision d'Apple.

<Steps>
  <Step title="Publier depuis le Project Editor">
  ...
  <Step title="Partager votre application">
    Après la publication de l'aperçu, les testeurs avec Expo Go peuvent l'ouvrir via le lien partageable. Aucun compte développeur Apple n'est requis à cette étape.
  </Step>
</Steps>

<Tip>
  Utilisez les aperçus Expo Go pour partager rapidement des prototypes, recueillir des retours précoces et itérer avant de vous engager dans le processus App Store.
</Tip>

## Partie 4 : Promouvoir vers TestFlight

Après le partage d'un aperçu Expo Go, vous pouvez promouvoir votre application vers TestFlight pour des tests bêta plus formels. TestFlight nécessite un compte développeur Apple mais offre une expérience d'application native sans Expo Go.
...
<Steps>
  <Step title="Ouvrir le panneau de publication">
    Avec votre application déjà partagée comme aperçu Expo Go, ouvrez le panneau de publication dans l'Éditeur de projet.
  </Step>

  <Step title="Sélectionner la publication App Store">
    Sélectionnez **Publier sur l'App Store** pour promouvoir votre application vers TestFlight.
  </Step>

  <Step title="Connecter Apple et soumettre">
...
Utilisez cette liste de contrôle pour vérifier que vous êtes prêt pour chaque étape.
...
* En savoir plus sur le fonctionnement des applications mobiles sur Replit : [Applications mobiles natives](/fr/features/artifact-types/building-mobile-apps)
* En savoir plus sur le fonctionnement d'Agent : [Agent](/fr/features/agent/overview)
* Utiliser Replit sur mobile : [Application mobile Replit](/fr/features/platforms/mobile-app)
