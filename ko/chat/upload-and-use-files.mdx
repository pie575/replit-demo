---
title: "파일 업로드 및 활용"
description: "관련 문서, 스프레드시트, 이미지, 스크린샷을 Conversation에 추가하고 해당 정보를 요청에 어떻게 활용할지 Replit에 알려주세요."
sidebarTitle: "파일 업로드 및 활용"
icon: "file-arrow-up"
...
문서, 스프레드시트, 이미지, 스크린샷을 업로드하면 말로 설명하는 것보다 훨씬 쉽게 근거 자료, 요구 사항, 시각적 방향성을 Replit에 전달할 수 있습니다.

<div id="how-to-upload-a-file">
  ## 파일 업로드 방법
</div>

프롬프트 상자에서 **더하기** 버튼을 선택한 다음 **Upload a file**을 선택합니다. 프롬프트 상자로 파일을 끌어다 놓아도 됩니다. 파일이 필요한 요청을 보내기 전에 파일을 먼저 추가하세요.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Upload a file이 첫 번째 옵션으로 표시된 프롬프트 상자 더하기 메뉴" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* 스프레드시트를 분석합니다.
* PDF에 대해 질문합니다.
* 스크린샷을 바탕으로 Design을 만들거나 다듬도록 Replit에 요청합니다.
* 만들려는 앱에 대한 방향이나 정보를 Replit에 전달합니다.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ko/chat/upload-and-use-files">
    ...
    <div className="chat-card-title">파일 다루기</div>
    <p>파일을 이해하고 분석하는 전체 예시를 확인해 보세요.</p>
