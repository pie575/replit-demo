...
description: "Découvrez quand poursuivre votre travail dans une Conversation et quand créer un Projet pour un travail de développement ou de design d'envergure."
---
...
Vous avez étudié le quartier, connecté vos outils et élaboré un plan de
lancement. Il est maintenant temps de faire connaître votre café. Pour cela,
vous allez créer un site d&#39;ouverture.

Avant de vous lancer, il est utile de comprendre les deux espaces dans lesquels ce travail prend vie sur
Replit : les Conversations et les Projects.

<div id="do-plano-ao-projeto">
  ## Du plan au projet
</div>

Le lancement du café a commencé par une conversation. C&#39;est là que vous avez
affiné l&#39;idée, étudié le marché, connecté des outils et créé une Routine.

Vous voilà maintenant prêt à créer un site d&#39;ouverture. Un projet est
l&#39;endroit idéal pour ce travail de conception et de développement en
profondeur. Replit peut s&#39;appuyer sur le contexte déjà présent dans la
conversation : vous n&#39;avez donc pas besoin de repartir de zéro.

<div id="o-que-uma-conversa">
  ## Qu&#39;est-ce qu&#39;une conversation ?
</div>

Une **conversation** est un fil unique dans lequel vous posez des questions, explorez
des informations, exécutez des Routines et poursuivez le travail grâce aux
messages de suivi. Dans cet exemple, elle rassemble la recherche et le plan de
lancement du café.
...
Un **projet** est un espace durable et structuré, conçu pour un travail de fond de
création et de design. Dans cette histoire, c&#39;est là que vous allez créer et affiner le site
d&#39;ouverture.
...
| ---------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Idéal pour | Explorer une idée, étudier les concurrents et assurer une veille hebdomadaire du marché | Concevoir et créer le site d&#39;ouverture                                        |
| Structure  | Un fil unique regroupant vos recherches, décisions et suivis                            | Un espace structuré pour le site, son design et d’autres artefacts de création |
| Routines   | Créer et gérer des recherches récurrentes                                               | Utiliser les résultats renvoyés dans la conversation                           |
| Contexte   | Conserve le plan de lancement qui vous a conduit jusqu’ici                              | S’appuie sur l’orientation établie dans la conversation                        |

Commencez dans une conversation lorsque vous souhaitez poser une question ou explorer. Passez à un
projet lorsque vous êtes prêt à créer. La transition préserve l’orientation
que vous avez déjà établie.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/pt/chat/conversations">
    ...
    <p>
      Découvrez comment les Conversations vous aident à poser des questions, à explorer, à utiliser des Routines et à obtenir des résultats.
    </p>

    <div className="chat-card-link">Explorer →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/pt/features/projects-and-artifacts/projects">
    ...
    <p>
      Découvrez comment les projets organisent les travaux de création et de
      Design impliquant plusieurs artefacts.
    </p>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/pt/home/design-an-opening-site">
    <div className="chat-use-case-visual">
