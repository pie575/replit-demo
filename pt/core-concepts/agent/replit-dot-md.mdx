---
title: "replit.md"
description: "Saiba como usar o replit.md para personalizar o comportamento do Agent, o estilo de programação e o contexto do projeto."
---
...
Para um guia mais detalhado sobre formatação de prompts, consulte o [guia de engenharia de prompts da Anthropic](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/use-xml-tags).
...
**Enterprise**: Pré-configure o `replit.md` em [templates personalizados](/pt/teams/custom-templates) para dar a todos os desenvolvedores da sua organização um contexto inicial consistente. Para orientações específicas de design, veja [como configurar um sistema de design](/pt/teams/custom-design-system).
