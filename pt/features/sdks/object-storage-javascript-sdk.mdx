---
title: "SDK JavaScript para App Storage"
description: "Aprenda como usar o SDK oficial de JavaScript para gerenciar arquivos no Replit App Storage."
---
...
A classe `Client` gerencia as interações com o Replit App Storage. Essa classe possui métodos para realizar operações em arquivos de um bucket.
...
Use o código a seguir para criar uma instância de `Client` que interage com o Replit Object Storage:
...
Esse método sobrescreve qualquer objeto existente no caminho de destino.
...
| Nome         | Tipo     | Descrição                                 |
| :----------- | :------- | :---------------------------------------- |
| `objectName` | `string` | O caminho completo do objeto a verificar. |
...
Retorna uma lista de todos os objetos do bucket.
...
Esse método sobrescreve qualquer objeto existente com o mesmo nome.
...
O stream emite quaisquer erros encontrados durante o upload. Esse método sobrescreve qualquer objeto existente com o mesmo nome.
...
### Recuperar um objeto em sua representação bruta em bytes
...
### Fazer download de um objeto para o sistema de arquivos
