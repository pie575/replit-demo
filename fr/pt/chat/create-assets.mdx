...
description: "Créez des images, des vidéos, des graphiques vectoriels, des animations et des fichiers audio, et suivez les guides officiels propres à chaque flux de travail."
...
Demandez à Replit de créer les médias dont vous avez besoin pour votre projet, puis affinez le résultat dans le Chat ou sur la surface produit dédiée à ce flux de travail. Choisissez le parcours de création de ressources correspondant au résultat souhaité.
...
<section className="chat-mkt chat-workflow-grid has-visuals catalog-three-up">
  <a className="chat-example has-visual" href="/fr/pt/features/agent/image-generation">
    ...
    <p>
      Créez des images, des illustrations, des arrière-plans, des icônes et
      d&#39;autres contenus visuels personnalisés pour un Project.
    </p>

    <div className="chat-card-link">Ouvrir Image Generation →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/pt/design/toolbar#generate">
    ...
    <p>
      Créez de courts clips animés et des animations avec les outils Générer un
      média de Replit Design.
    </p>
  ...
  <a className="chat-example has-visual" href="/fr/pt/features/artifact-types/animated-videos">
    ...
    <p>
      Créez des motion graphics programmatiques depuis un Chat, puis
...
La création de ressources produit un résultat immédiat. Pour les tâches qui doivent se répéter à intervalles réguliers, poursuivez avec [Exécuter des tâches de routine](/fr/pt/chat/routines).

Les clips vidéo générés et les Animated Videos reposent sur des flux de travail différents. Les Animated Videos sont des motion graphics programmatiques que vous pouvez exporter au format MP4. Pour un exemple de ressources visuelles, consultez [Créez votre premier écran](/fr/pt/design/design-your-first-screen).

<div id="traga-informaes-atualizadas">
  ## Obtenez des informations à jour
</div>

Web Search ne crée pas de ressource. Utilisez-le lorsqu&#39;une image, un clip audio, une vidéo ou un graphique doit s&#39;appuyer sur des informations actuelles, puis demandez à Replit de créer la ressource appropriée à partir de ces indications.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/pt/features/agent/web-search">
    ...
    <p>
      Rassemblez des informations actuelles et des sources citées avant de créer une ressource.
    </p>
