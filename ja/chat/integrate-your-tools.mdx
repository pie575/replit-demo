---
title: "ツールを連携する"
description: "対応サービスを接続し、Conversation に必要な情報やアクションを見極め、設定については正式なインテグレーションのドキュメントに従いましょう。"
sidebarTitle: "ツールを連携する"
icon: "plug"
...
インテグレーションは、対応サービスからのコンテキストや機能を Replit に追加します。
...
<Steps>
  <Step title="Integrations を開く">
    ワークスペースからサイドバーの**Integrations**を選択します。

    <Frame>
      <img src="/assets/mirror/integrations-open-from-workspace-4dfe77901ec3.jpg" alt="左サイドバーで Integrations が強調表示された、サニタイズ済みの Replit ワークスペースのホーム画面" width="1451" height="1084" data-path="images/chat/integrations-open-from-workspace.jpg" />
    </Frame>
  </Step>
  ...
  <Step title="インテグレーションを選択する">
    ...
    <Frame>
      <img src="/assets/mirror/integrations-library-sanitized-e4b7670d4e3e.jpg" alt="おすすめと利用可能なインテグレーションを表示する、サニタイズ済みの Replit インテグレーションライブラリ" width="1606" height="979" data-path="images/chat/integrations-library-sanitized.jpg" />
    </Frame>
  </Step>
  ...
  <Step title="接続する">
    ...
    <Frame>
      <img src="/assets/mirror/salesforce-connect-permissions-sanitized-addf13ac4b96.jpg" alt="認証、プライバシー、権限、および Continue to Salesforce ボタンを説明する、サニタイズ済みの Salesforce 接続ダイアログ" width="1455" height="1081" data-path="images/chat/salesforce-connect-permissions-sanitized.jpg" />
    </Frame>
  </Step>
</Steps>

プロンプト入力欄の**プラス**メニューから**インテグレーションを追加**を選ぶこともできます。

## よく知っているツールから始める

<section className="chat-mkt chat-workflow-grid has-visuals catalog-three-up">
  <a className="chat-example has-visual" href="/ja/features/integrations/overview#connectors">
    ...
    <p>会話やスレッドを検索し、そのコンテキストを作業に活用します。</p>
    <div className="chat-card-link">コネクタを見る →</div>
  </a>
  ...
  <a className="chat-example has-visual" href="/ja/features/integrations/overview#connectors">
    ...
    <p>関連するファイルとフォルダを Conversation のコンテキストに取り込みます。</p>
    <div className="chat-card-link">コネクタを見る →</div>
  </a>
  ...
  <a className="chat-example has-visual" href="/ja/features/integrations/overview#connectors">
    ...
    <p>関連する顧客情報やアカウント情報を Conversation の中で活用します。</p>
    <div className="chat-card-link">コネクタを見る →</div>
  </a>
</section>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ja/use-cases/prepare-for-a-customer-call">
    ...
    <div className="chat-example-tag">調査し、分析する</div>

    <div className="chat-card-title" style={{ marginTop: 11, fontSize: 20 }}>
      顧客との商談に備える
    </div>

    <p>Salesforce、Slack、Google Drive のコンテキストをまとめます。</p>
    <div className="chat-card-link">この使用例を見る →</div>
  </a>
</section>

## MCP によるカスタムインテグレーション

ネイティブインテグレーションは、Replit のコネクタカタログに用意された対応サービスへの接続です。対応していないサービスがある場合は、カスタム MCP を作成して Replit にインテグレーションとして追加できます。

[MCP 経由で接続する方法を学ぶ。](/ja/chat/connect-through-mcp)

コネクタの種類、利用条件、設定方法、対応サービス、権限については[インテグレーションの機能ガイド](/ja/features/integrations/overview)に従ってください。

Conversation にまとまった作業を進めるだけのコンテキストがそろったら、[それをプロジェクトに発展させる](/ja/chat/continue-or-create-a-project)方法を学びましょう。
