...
description: "Start a Conversation with a simple question, web research, or connected context, then choose what to do next."
sidebarTitle: "Start a conversation"
icon: "comments"
...
Your Workspace is ready. Now it is time to move the coffee-shop idea forward.
Start a [conversation](/chat/conversations), tell Replit what you want to
create, and begin turning the first idea into a real launch plan.

## Start a new conversation

Select **New** in the Replit sidebar. This opens the conversation where you
will shape the concept, research the market, and plan the launch.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Replit home screen for Demo workspace with the New button highlighted, suggested prompts, and message box" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

## Explore the prompt box

After you select **New**, take a look at the prompt box. This is where you will
give Replit direction, add useful context, and continue the coffee-shop launch.
The next step is to write the first prompt.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Prompt box plus menu with options to upload a file, create something new, import a project, use a skill or design system, and add an integration" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

## Next

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/home/describe-your-idea">
    ...
    <div className="chat-example-tag">First prompt</div>
    <div className="chat-card-title">Shape the concept</div>
    <p>Write a focused first request for the coffee-shop launch.</p>
