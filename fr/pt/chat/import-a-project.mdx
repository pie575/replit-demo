---
title: "Importer un Project existant"
description: "Importez du code ou un travail de design existant dans Replit, découvrez en quoi l'importation diffère de l'ajout d'un fichier et poursuivez votre travail dans le Project obtenu."
sidebarTitle: "Importer un Project existant"
icon: "file-import"
...
Si vous travailliez déjà sur une app ou un projet, vous pouvez l&#39;importer dans Replit et poursuivre votre travail dans un Project. L&#39;importation ne doit pas être confondue avec l&#39;ajout d&#39;un fichier en pièce jointe, qui sert de preuve ou de contexte dans une Conversation.

<div id="escolha-uma-fonte-suportada">
  ## Choisissez une source prise en charge
</div>

La source détermine ce que vous fournissez et la manière dont votre travail existant est importé dans Replit. Le guide d&#39;importation actuel documente les parcours suivants :

| Travail existant              | Sources prises en charge                                                                                        |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------- |
| Dépôts et projets de builders | **GitHub**, **Bitbucket**, **Vercel**, **Bolt**, **Lovable**, **Base44** et **export d&#39;un Agent précédent** |
| Designs                       | **Figma** et **Claude**                                                                                         |
| Fichiers et données locales   | **ZIP** et **Feuille de calcul** (`.xlsx`, `.csv` ou une URL publique Google Sheets)                            |

Certaines importations de builders reposent sur un dépôt GitHub exporté depuis le service d&#39;origine. Consultez le guide propre à la source avant d&#39;importer. Les configurations, secrets, valeurs de base de données ou services spécifiques au fournisseur peuvent nécessiter une configuration supplémentaire par la suite.

Dans la zone de prompt, sélectionnez le menu **plus (+)**, puis **Importer un projet existant** pour ouvrir le flux d&#39;importation.

<div id="importar-ou-anexar">
  ## Importer ou joindre ?
</div>

* **Importez un Project** si vous souhaitez poursuivre le travail à partir de code existant, d’un design ou d’un projet structuré.
* **Téléversez un fichier** si un document, une feuille de calcul, une image ou une capture d’écran apporte du contexte à une question ou à une tâche dans le Chat actuel.

Pour la deuxième option, consultez [Téléverser et utiliser des fichiers](/fr/pt/chat/upload-and-use-files).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/pt/build/import-from-providers">
    ...
    <p>Choisissez une source prise en charge et suivez la procédure complète d’importation.</p>
  ...
  <a className="chat-example has-visual" href="/fr/pt/features/projects-and-artifacts/projects">
    ...
    <p>Découvrez l’espace structuré où le travail importé se poursuit.</p>
    <div className="chat-card-link">En savoir plus sur Projects →</div>
  </a>
</section>

Une fois le Project dans Replit, [utilisez un système de design](/fr/pt/chat/use-a-design-system) si votre travail doit respecter une charte visuelle établie.