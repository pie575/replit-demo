...
description: "Comece a partir de um prompt, construa um pequeno app com o Agent no Modo Free, teste-o no Preview e aprimore-o com um acompanhamento focado."
---
...
<Frame>
  <img src="/assets/mirror/04-refined-my-rsvps-aaebb6cc8e6c.jpg" alt="The finished Gather workshop app showing the My RSVPs view in Preview" width="1393" height="868" data-path="images/first-app-gather/04-refined-my-rsvps.jpg" />
</Frame>
...
<Steps>
  ...
  <Step title="Describe the outcome and success criteria">
    ...
    <Frame>
      <img src="/assets/mirror/01-prompt-free-mode-f5c56ce766c8.jpg" alt="The Gather prompt ready to send with the Website artifact selected and Free Mode enabled" width="1280" height="720" data-path="images/first-app-gather/01-prompt-free-mode.jpg" />
    </Frame>
  ...
  <Step title="Let Agent build in Free Mode">
    ...
    <Frame>
      <img src="/assets/mirror/02-first-version-163a5fb49aac.jpg" alt="The first working Gather website in the default Build layout with Agent chat and Preview" width="1393" height="868" data-path="images/first-app-gather/02-first-version.jpg" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/assets/mirror/03-refinement-prompt-94b96ae38acb.jpg" alt="A focused follow-up prompt asking Agent to add a session-only My RSVPs view in Free Mode" width="1393" height="868" data-path="images/first-app-gather/03-refinement-prompt.jpg" />
</Frame>

Test the RSVP flow again, then open **My RSVPs**. The submitted workshop should appear for the current browser session.

<Frame>
  <img src="/assets/mirror/04-refined-my-rsvps-aaebb6cc8e6c.jpg" alt="The refined Gather app showing a submitted workshop in the My RSVPs view" width="1393" height="868" data-path="images/first-app-gather/04-refined-my-rsvps.jpg" />
</Frame>
