...
Pour des options d'import complètes incluant d'autres plateformes comme GitHub, Figma et Lovable, consultez la [documentation de la fonctionnalité d'import](/fr/core-concepts/project-editor/app-setup/import).
