---
title: "上传和使用文件"
description: "将相关文档、电子表格、图片或截图添加到 Chat，并告诉 Replit 如何利用这些信息来支持你的请求。"
sidebarTitle: "上传和使用文件"
icon: "file-arrow-up"
...
上传文档、电子表格、图像和截图，可向 Replit 提供比文字描述更易传达的依据、需求或视觉方向。

<div id="como-enviar-um-arquivo">
  ## 如何上传文件
</div>

在提示框中，点击**加号 (+)**按钮，然后选择**上传文件**。你也可以将文件拖放到提示框中。请在发送需要使用该文件的请求前添加文件。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示框的加号 (+) 菜单，“上传文件”为第一个选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* 分析电子表格。
* 针对 PDF 提问。
* 要求 Replit 根据截图创建或优化 Design。
* 向 Replit 提供有关你想构建的 App 的说明或信息。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/pt/chat/upload-and-use-files">
    ...
    <div className="chat-card-title">使用文件</div>
    <p>查看理解和分析文件的完整示例。</p>
    <div className="chat-card-link">探索使用案例 →</div>
  </a>
</section>