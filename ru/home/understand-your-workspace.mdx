---
title: "Знакомство с workspace"
description: "Узнайте, как ваш Replit Workspace объединяет людей, Projects, Conversations, Routines, данные, интеграции и безопасность."
sidebarTitle: "Знакомство с workspace"
icon: "briefcase"
...
Ваш Replit Workspace — это единое пространство для всего, что связано с идеей. Он объединяет
[Projects](/ru/home/projects), [Conversations](/ru/home/conversations),
[Routines](/ru/chat/routines) и интеграции, чтобы вы могли пройти путь от первого
вопроса до полезного результата.

<div id="set-up-the-coffee-shop-project">
  ## Настройка проекта кофейни
</div>

Прежде чем прорабатывать идею кофейни, дайте ей место для жизни. В этом Workspace
будут собраны все составляющие запуска по мере их развития:

* Conversation для проработки концепции и исследования местного рынка
* Файлы и подключённые инструменты, которые добавляют полезный контекст к плану
...
<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Главный экран Replit для workspace Demo с разделами проекты, Conversations, Routines, предлагаемыми промптами и полем сообщения" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

Этот проект начинается с поля ввода промпта. Отсюда вы начнёте conversation и
дадите Replit первое описание кофейни, которую хотите создать.

<div id="workspace-details">
  ## Подробнее о Workspace
</div>

Здесь же собраны участники, настройки, общие ресурсы, интеграции и
биллинг. От вашего уровня доступа зависит, что вы можете видеть и чем управлять.

Настройки workspace и средства управления организацией не связаны с инструментами, с помощью которых вы определяете, как Agent отвечает на запрос.

Вы можете возвращаться в Workspace на любом этапе запуска, чтобы найти всё,
что для него нужно.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/home/start-a-conversation">
    ...
    <div className="chat-card-title">Начните conversation</div>
    <p>Начните запуск кофейни с описания результата, которого хотите достичь.</p>
    <div className="chat-card-link">Узнать больше →</div>
  </a>

  <a className="chat-example has-visual" href="/ru/features/collaboration/workspaces">
    ...
    <div className="chat-example-tag">Подробнее о Workspace</div>
    <div className="chat-card-title">Узнайте больше о workspaces</div>

    <p>
      Узнайте о персональных и командных workspaces, доступе, настройках и
      управлении.
    </p>
...
Далее [начните conversation](/ru/home/start-a-conversation), чтобы приступить к проработке
идеи кофейни.