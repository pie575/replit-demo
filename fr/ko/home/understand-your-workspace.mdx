...
description: "Découvrez comment les espaces de travail Replit réunissent les personnes, les Project, les Conversation, les Routine, les données, les intégrations et la sécurité."
---
...
L’espace de travail Replit est le point de départ de toutes vos idées. Il rassemble les
[Project](/fr/ko/home/projects), les [Conversation](/fr/ko/home/conversations),
les [Routine](/fr/ko/chat/routines) et les intégrations pour vous accompagner de votre première question à des
résultats concrets.

<div id="section">
  ## Configurer votre projet de café
</div>

Avant de concrétiser votre idée de café, créez-lui d’abord un espace. Cet
espace de travail regroupe les différents éléments qui évolueront au fil du lancement.

* Des conversations pour développer le concept et étudier le marché local
* Des fichiers et des outils connectés qui apportent un contexte utile à la planification
* Des Routine pour surveiller ensuite la concurrence et les évolutions du marché
* Le site que vous concevrez et publierez par la suite

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Écran d’accueil Replit de l’espace de travail Demo affichant Projects, Conversations, Routines, des invites suggérées et une zone de message" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

Le champ de saisie est le point de départ de ce projet. C’est ici que vous démarrerez une conversation et
transmettrez à Replit votre première description du café que vous souhaitez créer.

<div id="section-2">
  ## Détails de l’espace de travail
</div>

L’espace de travail gère également les membres, les paramètres, les ressources partagées, les intégrations et la facturation.
Ce que vous pouvez consulter et gérer dépend de vos autorisations d&#39;accès.

Les paramètres de l’espace de travail et les fonctionnalités de gestion de l&#39;organisation sont distincts des
contrôles qui déterminent la façon dont Agent répond aux demandes.

Vous pouvez revenir à l’espace de travail à tout moment pour retrouver tout ce dont vous avez besoin pour accompagner votre projet tout au long de son lancement.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ko/home/start-a-conversation">
    ...
    <p>Commencez à lancer votre café en décrivant le résultat souhaité.</p>
    <div className="chat-card-link">Découvrir →</div>
  </a>

  <a className="chat-example has-visual" href="/fr/ko/features/collaboration/workspaces">
    ...
    <p>
      Découvrez les espaces de travail personnels et d&#39;équipe, les autorisations d&#39;accès, les paramètres et les outils de gestion.
    </p>
...
Ensuite, pour commencer à concrétiser votre idée de café,
[démarrez une conversation](/fr/ko/home/start-a-conversation).