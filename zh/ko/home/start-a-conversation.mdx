---
title: "开始使用 Conversation"
description: "通过简单提问、网络调研或关联的上下文开始使用 Conversation，然后选择下一步操作。"
---
...
工作区已准备就绪。现在可以着手推进您的咖啡店创意了。
开始[Conversation](/zh/ko/chat/conversations)，告诉 Replit 您想构建什么，
将您的第一个想法逐步转化为实际的上线计划。

<div id="section">
  ## 开始新 Conversation
</div>

在 Replit 侧边栏中选择 **New**。这会打开一个 Conversation，供你完善想法、调研市场并规划上线。

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Demo 工作区中的 Replit 主页，突出显示 New 按钮，并显示推荐提示词和消息框" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>
...
选择**新建**后，来了解一下提示词框。在这里，你可以为 Replit 提供指引、添加有用的上下文，并继续推进咖啡店的上线。下一步是编写你的第一条提示词。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示词框中的加号菜单，包含上传文件、新建、导入项目、使用技能或设计系统，以及添加集成等选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ko/home/describe-your-idea">
    ...
    <div className="chat-example-tag">第一条提示词</div>
    <div className="chat-card-title">完善创意构想</div>
    <p>撰写一条重点明确的初始请求，为咖啡店上线做好准备。</p>
