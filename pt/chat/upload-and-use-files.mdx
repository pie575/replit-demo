---
title: "Enviar e usar arquivos"
description: "Adicione documentos, planilhas, imagens ou capturas de tela relevantes a uma Conversa e diga ao Replit como a informação deve apoiar sua solicitação."
sidebarTitle: "Enviar e usar arquivos"
icon: "file-arrow-up"
...
Enviar documentos, planilhas, imagens e capturas de tela pode dar ao Replit evidências, requisitos ou direção visual mais fáceis de fornecer do que de descrever.

## Como enviar um arquivo

Na caixa de prompt, selecione o botão **mais (+)** e escolha **Enviar um arquivo**. Você também pode arrastar e soltar um arquivo na caixa de prompt. Adicione o arquivo antes de enviar a solicitação que depende dele.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu de mais (+) da caixa de prompt com Enviar um arquivo como primeira opção" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

## Use arquivos para

* Analisar uma planilha.
* Fazer perguntas sobre um PDF.
* Pedir ao Replit para criar ou refinar um design a partir de uma captura de tela.
* Dar ao Replit direção ou informações sobre um app que você quer construir.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/chat/upload-and-use-files">
    ...
    <div className="chat-card-title">Trabalhar com arquivos</div>
    <p>Veja um exemplo completo de como entender e analisar um arquivo.</p>
