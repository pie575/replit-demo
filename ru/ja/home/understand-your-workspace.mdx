---
title: "Рабочее пространство Replit"
description: "Узнайте, как рабочее пространство Replit объединяет людей, Projects, Conversations, Routines, данные, интеграции и средства безопасности."
---
...
Рабочее пространство Replit — это место, где собирается всё, что связано с вашей идеей.
Оно объединяет [Project](/ru/ja/home/projects), [Conversation](/ru/ja/home/conversations),
[Routine](/ru/ja/chat/routines) и интеграции, помогая пройти путь
от первого вопроса до полезного результата.

<div id="section">
  ## Подготовьте Project кофейни
</div>

Прежде чем воплощать идею кофейни в жизнь, подготовьте для неё рабочее пространство. Здесь будут собраны все элементы по мере подготовки к запуску.

* Conversation для разработки концепции и исследования местного рынка
* Файлы и подключённые инструменты, которые дополнят план полезным контекстом
* Routine для мониторинга конкурентов и изменений на рынке
* Сайт, который вы позже разработаете и опубликуете

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Главный экран Replit в рабочем пространстве Demo с Projects, Conversations, Routines, предлагаемыми промптами и полем сообщения" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

Этот Project начинается с поля промпта. Здесь вы начнёте Conversation и расскажете Replit о кофейне, которую хотите создать.

<div id="section-2">
  ## Подробнее о рабочем пространстве
</div>

Рабочее пространство объединяет участников, настройки, общие ресурсы, интеграции и
оплату. Уровень доступа определяет, что вы можете просматривать и чем управлять.

Настройки рабочего пространства и параметры управления организацией — это не то же самое,
что настройки, определяющие, как Agent отвечает на ваши запросы.

В любой момент во время запуска вы можете вернуться в рабочее пространство и найти всё,
на чём оно держится.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ja/home/start-a-conversation">
    ...
    <p>Опишите желаемый результат и начните запуск своей кофейни.</p>
    <div className="chat-card-link">Подробнее →</div>
  </a>

  <a className="chat-example has-visual" href="/ru/ja/features/collaboration/workspaces">
    ...
    <div className="chat-example-tag">Подробнее о рабочем пространстве</div>
    <div className="chat-card-title">Больше о рабочих пространствах</div>
...
Теперь [начните Conversation](/ru/ja/home/start-a-conversation) и приступайте к воплощению
идеи своей кофейни.