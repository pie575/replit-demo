---
title: "고객 통화 준비하기"
description: "연결된 도구 전반에서 질문을 조사하고, 근거를 비교하고, 명확한 답변을 준비합니다."
---
...
<Steps>
  <Step title="관련 도구 연결하기">
    ...
    <Frame caption="계속 진행하기 전에 공급자와 권한을 검토하세요.">
      <img src="/assets/mirror/research-and-analyze-salesforce-sign-in-5f28ee7d4355.png" alt="공급자 인증과 Replit이 요청하는 권한을 설명하는 Salesforce 연결 대화상자" width="2640" height="1962" data-path="images/chat/research-and-analyze-salesforce-sign-in.png" />
    </Frame>
  </Step>
