---
title: "Auth"
description: "Replit에서 Auth가 무엇인지 알아보세요 — 사용자 계정을 통해 앱이 환경 설정을 저장하고, 기능을 제한하고, 경험을 개인화하는 방법과 Replit Auth와 Clerk Auth 중 선택하는 방법."
sidebarTitle: "Auth"
icon: "user-lock"
---
...
* **[Replit Auth](/ko/features/auth-and-identity/authentication)** — 사용자가 기존 **Replit 계정**으로 로그인합니다. 로그인 페이지는 Replit 브랜드입니다. Agent에게 추가하도록 요청하는 것 외에 설정이 필요 없습니다.
* **[Clerk Auth](/ko/features/auth-and-identity/clerk-auth)** — 앱에 전용 **Clerk 테넌트**가 생깁니다. 사용자는 Replit이 아닌 *여러분의* 앱 내에서 계정을 만듭니다. 브랜딩, 로그인 방법, 로그인 화면의 모양과 느낌을 제어할 수 있습니다.
...
<CardGroup cols={2}>
  ...
  <Card title="로그인 추가하기" icon="user-plus" href="/ko/build/add-login">
