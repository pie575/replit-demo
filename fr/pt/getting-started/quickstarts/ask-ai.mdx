...
description: "Créez et publiez votre première application avec Replit Agent en quelques minutes."
---
...
Vous aurez besoin d’un [compte Replit gratuit](https://replit.com).

<Note>Ce guide de démarrage rapide utilise Agent, inclus dans le forfait Starter gratuit et assorti de crédits quotidiens. Aucune carte de crédit n’est requise.</Note>

<div id="bem-vindo-ao-replit">
  ## Bienvenue sur Replit
</div>

Lorsque vous ouvrez Replit, la première chose que vous voyez est l’**Éditeur de projets**, avec la zone de prompt au centre. C’est là que tout commence. Décrivez ce que vous souhaitez créer, et Agent s’occupe du reste.

<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L’écran d’accueil de l’Éditeur de projets de Replit affichant le champ de saisie du prompt où vous décrivez ce que vous souhaitez créer" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>
...
<Steps>
  <Step title="Décrivez ce que vous voulez créer">
    Dans la zone de prompt de l&#39;écran d&#39;accueil, décrivez ce que vous souhaitez créer. Soyez précis sur les fonctionnalités et le comportement attendus : plus vous donnez de détails à l&#39;Agent, meilleur sera le résultat.

    Pour ce guide de démarrage rapide, essayez quelque chose comme : *« Crée un piano réaliste de 16 touches avec la bonne disposition de touches blanches et noires. Chaque touche doit s&#39;enfoncer avec une animation lorsqu&#39;on clique dessus et jouer la note correspondante. »*

    Appuyez sur **Démarrer** pour lancer la création. L&#39;Agent configure votre projet et commence à écrire le code. Comptez environ 3 à 5 minutes.

    <Tip>Vous pouvez créer l&#39;idée de votre choix : une liste de tâches, une page de destination, une application de quiz. Les autres étapes restent les mêmes.</Tip>
  </Step>

  <Step title="Prévisualisez votre application">
    Une fois que l&#39;Agent a terminé, ouvrez l&#39;onglet **Aperçu** pour voir votre application en action. Cliquez et interagissez avec elle pour vérifier qu&#39;elle fonctionne comme prévu.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-piano-demo-4b7f4ee0053a.mp4" />
    </Frame>

    <Note>Votre application peut différer légèrement des captures d&#39;écran : l&#39;Agent peut générer des résultats variés à partir d&#39;un même prompt.</Note>
  </Step>

  <Step title="Publiez votre application">
    Prêt à partager ? Cliquez sur **Publier** dans l&#39;Éditeur de projets pour déployer votre application sur une URL publique accessible à tous.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-publish-app-ae59052ca92d.mp4" />
    </Frame>

    Votre application est désormais en ligne. Copiez l&#39;URL et partagez-la avec qui vous voulez.
  </Step>
</Steps>
...
Prêt à créer ? Appuyez sur <StartButton /> pour ouvrir Replit avec le prompt du piano déjà prérempli.

<AgentInput highlightStart defaultPrompt="Crée un piano réaliste de 16 touches, avec la bonne disposition de touches blanches et noires, qui ressemble exactement à un vrai piano. Chaque touche doit s'enfoncer avec une animation de profondeur réaliste lorsqu'on clique dessus et jouer la note correspondante." showTypewriter={false} />
...
<CardGroup cols={2}>
  <Card title="Créer un design avec Canvas" icon="palette" href="/fr/pt/getting-started/quickstarts/design-with-canvas">
    Explorez des variations de design et repensez visuellement votre application.
  </Card>
  ...
  <Card title="Publier votre application" icon="globe" href="/fr/pt/getting-started/quickstarts/publish">
    Découvrez les domaines personnalisés, le partage et le fonctionnement de la publication.
  </Card>

  <Card title="Agent" icon="robot" href="/fr/pt/core-concepts/agent">
    Découvrez tout ce qu&#39;Agent peut faire.
  </Card>
</CardGroup>