...
description: "Understand the Model Context Protocol (MCP) — what it is, how it works, and why it matters for AI applications."
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Servers reference" icon="folder-tree" href="/features/mcp/overview">
