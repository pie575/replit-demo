---
title: "プロンプト"
description: "Conversationの中でReplitに明確な方向性を伝え、役立つフォローアップリクエストで結果を磨き上げましょう。"
sidebarTitle: "プロンプト"
icon: "comment-dots"
...
Replitが作業している間に、[フォローアップメッセージを操作またはキューに追加する](/ja/features/agent/steer-and-queue-messages)方法を学びましょう。

リクエストが明確になったら、[コンテキストを追加する](/ja/chat/add-context)方法を学び、タスクに必要な関連情報とツールをReplitに提供しましょう。
