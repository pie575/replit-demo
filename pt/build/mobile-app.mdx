...
description: "Construa um app focado em telefone com o Agent, teste-o em um simulador e no seu celular e compartilhe-o para receber feedback."
---
...
Um app mobile deve parecer natural em um telefone: rápido de abrir, fácil de tocar e confortável para usar com uma mão.

Você vai construir o **Pace Mobile**, um rastreador de corrida focado em telefone inspirado no exemplo de rastreador de corrida de [O que é Replit?](/pt/build/welcome). O objetivo é testar um fluxo mobile focado antes de se comprometer com o caminho completo da App Store.

<Frame>
  <img src="/assets/mirror/mobile-app-4203ff45ecd5.png" alt="Um exemplo de app mobile polido com telas de rastreamento de fitness projetadas para uso em telefone" width="1440" height="850" data-path="images/build-examples/mobile-app.png" />
</Frame>
...
Use este guia quando sua ideia deve ser usada em um telefone.

Isso é útil para rastreadores, fluxos de reserva, ferramentas de campo, apps de eventos, ferramentas de aprendizado, apps de hábitos e qualquer coisa que as pessoas devam usar longe de um desktop.

<Note>
  O TestFlight e a publicação na App Store são separados deste guia. Quando você estiver pronto para esse caminho, veja [Construa e lance um app mobile](/pt/build/mobile-app).
</Note>
...
* Um telefone com [Expo Go](https://expo.dev/go) instalado.
* Um fluxo mobile que você pode testar em alguns minutos.

Para detalhes exatos de simulador, emulador e prévia de dispositivo, veja [Apps Mobile Nativos](/pt/features/artifact-types/building-mobile-apps).

## Defina o fluxo mobile

Antes de construir, decida o que alguém deve fazer no seu telefone.
...
<Frame>
  <img src="/assets/mirror/prompt-5cb144699b45.png" alt="A tela inicial do Replit com App mobile selecionado como tipo de app" width="1440" height="900" data-path="images/native-mobile-apps/prompt.png" />
</Frame>

Use este prompt:

<AiPrompt>
  Construa o Pace Mobile, um rastreador de corrida focado em telefone.<br />
  Um corredor deve conseguir escolher um tipo de corrida, inserir distância e tempo, salvar a corrida e ver o resumo de hoje.<br />
  Projete-o para uso com uma mão, com alvos de toque grandes, navegação simples e uma sensação de app de fitness polido.<br />
  Mantenha a primeira versão pequena o suficiente para testar hoje em um simulador e em um celular real.
</AiPrompt>

Se você quiser que o Agent pense antes de construir, use o [modo Plan](/pt/features/agent/plan-mode). Peça ao Agent para verificar as telas, navegação, alvos de toque e restrições específicas de telefone antes de começar a construir.

<Frame>
  <img src="/assets/mirror/agent-plan-mode-prompt-059fe8d2c277.png" alt="O compositor de prompts do Replit com o modo Plan selecionado antes do Agent definir o escopo de uma construção de app mobile" width="1440" height="900" data-path="images/fitstart/work-with-agent/agent-plan-mode-prompt.png" />
</Frame>

## Teste em um simulador ou emulador

Quando o Agent terminar a primeira construção, abra o [Preview](/pt/features/editor/preview). No seletor de dispositivo, escolha **Simulador iOS** ou **Emulador Android**.

Toque pelo app como se fosse alguém usando em um telefone.

<Frame>
  <img src="/assets/mirror/workspace-dda0f81e6b83.png" alt="O Editor de Projeto do Replit mostrando uma prévia de app mobile e a opção de pré-visualizar em um dispositivo mobile" width="1440" height="900" data-path="images/native-mobile-apps/workspace.png" />
</Frame>
...
Testar no simulador é útil, mas um telefone diz se o app parece certo.

Abra o painel de prévia de dispositivo mobile e escaneie o código QR com seu telefone. Isso abre o app no Expo Go.

<Frame>
  <img src="/assets/mirror/mobile-screen-e5685fc26793.png" alt="Um app mobile rodando na prévia do Editor de Projeto do Replit com o painel Preview no dispositivo e código QR para Expo Go" width="1440" height="900" data-path="images/native-mobile-apps/mobile-screen.png" />
</Frame>
...
<AiPrompt>
  Melhore o Pace Mobile para uso com uma mão no telefone.<br />
  Torne o botão Salvar Corrida mais fácil de alcançar, aumente os alvos de toque onde necessário e mantenha o formulário de corrida simples.<br />
  Não adicione novos recursos.<br />
  Após a mudança, teste que salvar uma corrida ainda atualiza o resumo de hoje.
</AiPrompt>

## Compartilhe para obter feedback

Quando o fluxo no telefone funcionar, publique o app para criar uma versão Expo Go compartilhável para feedback inicial.

Compartilhe-o com uma tarefa focada:
...
Após testar o Pace Mobile no simulador e no seu telefone com Expo Go, você pode promover o mesmo app para TestFlight e a App Store. Este fluxo requer uma associação ao **Apple Developer Program** com autenticação de dois fatores. Para informações sobre inscrição, contas individuais vs. organizacionais, TestFlight vs. revisão da App Store e testes externos, veja [Construa e lance um app mobile](/pt/build/mobile-app).

<Steps>
  <Step title="Abra a aba Publicação e inicie a publicação na App Store">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-02-start-publishing-190eb7841bcf.png" alt="A aba Publicação no Editor de Projeto mostrando o status de Produção e um card 'Pronto para publicar o Pace na App Store?' com um botão Começar a publicar na App Store" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-02-start-publishing.png" />
    </Frame>
  </Step>

  <Step title="Escolha seu projeto Expo">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-03-choose-expo-project-4707fafffafe.png" alt="A caixa de diálogo Launch com a etapa Escolher projeto Expo ativa — campos para Nome do projeto e Slug do projeto pré-preenchidos com Pace, um botão Continuar e uma opção Usar existente" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-03-choose-expo-project.png" />
    </Frame>
  </Step>

  <Step title="Entre com a Apple">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-04-sign-in-apple-459dfc9b84ba.png" alt="A caixa de diálogo Launch na etapa Entrar com a Apple — campos de e-mail ou número de telefone e senha do Apple Developer, com uma nota de que a senha nunca sai do dispositivo e que a conta deve estar inscrita no Apple Developer Program" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-04-sign-in-apple.png" />
    </Frame>
  </Step>

  <Step title="Escolha ou crie seu app Apple">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-05-choose-apple-app-3971aea62f14.png" alt="A caixa de diálogo Launch na etapa Escolher app Apple — Nome do app definido como Pace, Bundle ID app.replit.pace, com uma nota de que o identificador de bundle não pode ser alterado posteriormente, e um botão Criando app…" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-05-choose-apple-app.png" />
    </Frame>
  </Step>

  <Step title="Lance para a App Store">
    ...
    <Frame>
      <img src="/assets/mirror/app-store-06-ready-for-launch-ab02659ee0bb.png" alt="A caixa de diálogo Launch na etapa Pronto para lançar com Escolher app Apple e Configurar certificados Apple marcados como concluídos, e um botão Lançar para a App Store mais Parâmetros de lançamento opcionais" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-06-ready-for-launch.png" />
    </Frame>
    ...
    <Frame>
      <img src="/assets/mirror/app-store-targeting-f8797071c9e0.png" alt="A caixa de diálogo Launch com Direcionando App Store marcado como concluído e uma mensagem Redirecionando de volta para o Replit — o estado de confirmação após Lançar para a App Store ser selecionado" width="3452" height="1988" data-path="images/native-mobile-apps/app-store-targeting.png" />
    </Frame>
  </Step>
</Steps>

<Note>
  O primeiro build de uma versão geralmente requer uma revisão beta do TestFlight antes que os testadores possam instalá-lo. Após a aprovação, builds adicionais geralmente chegam aos testadores mais rapidamente. Para compartilhar com testadores externos ou enviar para lançamento na App Store, conclua a listagem no **App Store Connect** — veja [Construa e lance um app mobile](/pt/build/mobile-app) para a lista de verificação completa do App Store Connect.
</Note>
...
<CardGroup cols={2}>
  <Card title="Adicionar login" icon="user-lock" href="/pt/build/add-login">
  ...
  <Card title="Construa e lance um app mobile" icon="mobile-screen" href="/pt/build/mobile-app">
...
* **O simulador funciona mas o telefone não:** teste o comportamento específico de hardware em um dispositivo real e veja [Apps Mobile Nativos](/pt/features/artifact-types/building-mobile-apps).
* **A publicação falha:** veja [Solução de problemas de app mobile](/pt/features/troubleshooting/mobile-app).

## Experimente agora

<AgentInput highlightStart defaultPrompt="Construa o Pace Mobile, um rastreador de corrida focado em telefone. Um corredor deve conseguir escolher um tipo de corrida, inserir distância e tempo, salvar a corrida e ver o resumo de hoje. Projete-o para uso com uma mão, com alvos de toque grandes, navegação simples e uma sensação de app de fitness polido. Mantenha a primeira versão pequena o suficiente para testar hoje em um simulador e em um celular real." showTypewriter={false} />

## Relacionado

* [Apps Mobile Nativos](/pt/features/artifact-types/building-mobile-apps)
* [Construa e lance um app mobile](/pt/build/mobile-app)
* [Vibe coding 101](/pt/learn/foundations/vibe-coding-101)
* [Solução de problemas de app mobile](/pt/features/troubleshooting/mobile-app)
