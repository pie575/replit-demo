...
description: "Découvrez comment Replit transforme les idées, les tâches quotidiennes et l'intelligence en résultats concrets."
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      <div className="welcome-eyebrow">Premiers pas</div>
      <h1 id="welcome-home-heading">Bienvenue sur Replit</h1>
      <p>Transformez vos idées, vos tâches quotidiennes et votre intelligence en résultats concrets.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/fr/ja/home/get-started">Commencer <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/fr/use-cases">Découvrir les cas d&#39;utilisation</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Parcours guidé de Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Site de lancement d'un café intitulé « Un lieu paisible au quotidien »" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Découvrez comment transformer une idée en site publié
      </div>

      <p>
        De la première conversation à la recherche, en passant par la planification, la conception et la publication, progressez
        dans un parcours guidé.
      </p>

      <a className="welcome-journey-link" href="/fr/ja/home/get-started">
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    <h2 className="welcome-section-heading" id="welcome-use-cases-heading">
      Comment Replit peut-il vous aider ?
    </h2>
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/fr/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Préparez vos appels avec vos clients
          </div>

          <p>Obtenez un briefing ciblé avant chaque réunion avec un client.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Identifiez et filtrez des candidats grâce au contexte connecté.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez les conversations importantes et transmettez-les rapidement à la bonne personne.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Générer un rapport hebdomadaire sur les ventes
          </div>

          <p>Transformez les données actuelles de votre pipeline en un point clair sur les ventes.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/fr/use-cases/track-subscriptions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez les paiements récurrents et calculez vos dépenses mensuelles.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/fr/use-cases">
        Voir des exemples d’utilisation <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/fr/ja/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Fenêtre de conversation compacte représentant Replit Chat">
        ...
        <p>
          Commencez par une conversation. Posez des questions, explorez des idées et
          élaborez un plan.
        </p>

        <div className="welcome-product-link">
          Commencer une conversation <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/fr/ja/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Éditeur de code et aperçu en direct représentant Replit Build">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Transformez vos idées en véritables apps et sites. Créez, itérez et
      ...
      <a className="welcome-product-card" href="/fr/ja/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Composition de canevas sélectionnée représentant Replit Design">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Créez de belles interfaces et du contenu. Affinez les mises en page,
          les composants et les expériences de manière itérative.
        </p>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      ...
      <p>Choisissez où vous souhaitez utiliser Replit, puis connectez-vous ou créez un compte. Vous pouvez commencer sur le Web, l’application de bureau ou l’application mobile.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Web</strong><b aria-hidden="true">→</b><small>Ouvrir dans le navigateur</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>Desktop</strong><b aria-hidden="true">→</b><small>macOS et Windows</small></a>
