---
title: "会話とプロジェクト"
description: "会話で作業を続ける場合と、本格的な構築やデザイン作業にプロジェクトを使う場合の違いを理解する。"
---
...
近隣エリアを調査し、ツールを連携し、ローンチプランを組み立ててきました。次はいよいよ、
あなたのコーヒーショップのことを人々に知らせる番です。そのために、オープン告知サイトを
作成します。

始める前に、この作業がReplit上のどこに存在するのか、つまり会話とプロジェクトという
2つの場所について理解しておくと役立ちます。

## プランからプロジェクトへ

コーヒーショップのローンチは、ひとつの会話から始まりました。そこでアイデアを形にし、
市場を調査し、ツールを連携し、ルーティンを作成しました。

これで、オープン告知サイトを構築する準備が整いました。プロジェクトは、こうした本格的な
デザインと構築作業のための場所です。Replitは会話にすでにあるコンテキストを利用できるため、
最初からやり直す必要はありません。

## 会話とは？

**会話**とは、質問をしたり、情報を調べたり、ルーティンを実行したり、フォローアップを通じて
作業を続けたりするための、ひとつのスレッドです。この例では、コーヒーショップのリサーチと
ローンチプランがここに保存されています。

## プロジェクトとは？

**プロジェクト**とは、本格的な構築およびデザイン作業のための、永続的で構造化された空間です。
この例では、オープン告知サイトを作成し、磨き上げていく場所になります。

## 両者の連携

| 領域     | 会話                           | プロジェクト                         |
| ------ | ---------------------------- | ------------------------------ |
| 得意なこと  | アイデアの探索、競合の調査、毎週の市場ウォッチの実行   | オープン告知サイトのデザインと構築              |
| 構造     | リサーチ、決定事項、フォローアップを含むひとつのスレッド | サイトやそのデザイン、その他の構築物のための構造化された空間 |
| ルーティン  | 定期的なリサーチの作成と管理               | 会話に戻ってきた結果を利用する                |
| コンテキスト | ここまで導いてきたローンチプランを保持する        | 会話で確立した方向性から始まる                |

質問したり探索したりしたいときは会話から始めましょう。構築の準備ができたらプロジェクトに
移りましょう。この引き継ぎによって、すでに作り上げた方向性はそのまま保たれます。

## 関連情報

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ja/chat/conversations">
    ...
    <div className="chat-example-tag">質問と探索</div>
    <div className="chat-card-title">会話</div>

    <p>
      会話が質問、探索、ルーティン、成果をどのようにサポートするかを学びましょう。
    </p>
  ...
  <a className="chat-example has-visual" href="/ja/features/projects-and-artifacts/projects">
    ...
    <div className="chat-example-tag">構築と整理</div>
    <div className="chat-card-title">プロジェクト</div>

    <p>
      プロジェクトが複数のアーティファクトを使った本格的な構築・デザイン作業を
      どのように整理するかを学びましょう。
    </p>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ja/home/design-an-opening-site">
    <div className="chat-use-case-visual">
    ...
    <div className="chat-example-tag">オープン告知サイト</div>
    <div className="chat-card-title">オープン告知サイトをデザインする</div>
    <p>会話とローンチプランを使って、あなたのカフェのサイトを作成しましょう。</p>
