---
title: "Canvas"
description: "Aprenda como usar o Canvas para explorar e iterar em designs com o Agent e ver seus artefatos exibidos em frames."
---
...
<YouTubeEmbed videoId="Qv9cREjl9vQ" title="Visão geral do Canvas do Replit" />
...
<Frame>
  <img src="/assets/mirror/canvas-desktop-85e8bfec38a2.png" alt="Canvas mostrando uma prévia do app ao lado do chat do Agent com atualizações de tarefas" width="3452" height="2006" data-path="images/replitai/canvas-desktop.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/canvas-mockups-057e738a78da.png" alt="Canvas mostrando múltiplos mockups de design dispostos lado a lado — tema escuro, visualizações móveis e páginas de detalhe" width="3452" height="1620" data-path="images/replitai/canvas-mockups.png" />
</Frame>
...
<Steps>
  <Step title="Peça ao Agent no chat">
    ...
    <AgentInput defaultPrompt="Mostre-me um mockup da minha landing page no canvas" showTypewriter={true} />
  </Step>
...
<Steps>
  <Step title="Abra o menu do frame">
  ...
  <Step title="Escolha Exportar PNG">
    Selecione **Exportar** > **PNG**. A imagem é baixada para o seu computador com um nome de arquivo baseado no nome do frame.
  </Step>
</Steps>

<Frame>
  <img src="/assets/mirror/canvas-export-png-b903c6afacb8.png" alt="Menu de contexto do clique direito no frame do Canvas aberto com o submenu Exportar mostrando PNG como opção de exportação" width="1740" height="1160" data-path="images/replitai/canvas-export-png.png" />
</Frame>

<Note>O PNG exportado corresponde ao que o frame mostra atualmente no Canvas. Se seu app ou design ainda estiver carregando, aguarde até que renderize completamente antes de exportar.</Note>
...
<Accordion title="Os frames de design são iguais ao meu app em execução?">
...
<Accordion title="Posso redesenhar uma página sem quebrar meu app ao vivo?">
...
<Accordion title="Como transformo um design em um app real?">
...
<Accordion title="Posso converter para tipos além de web apps?">
  Sim. Você pode transformar frames do Canvas em web apps, apps móveis, slides, visualizações de dados e mais.
</Accordion>

<Accordion title="Posso importar designs do Figma ou outras ferramentas?">
  Sim. Há algumas maneiras de trazer designs do Figma para o Replit:

  * **Importar do Figma**: Acesse [replit.com/import](https://replit.com/import), conecte sua conta do Figma e cole um URL de frame para converter um design em um app React funcional. Veja o [guia de início rápido Importar do Figma](/pt/design/import-figma-designs-into-replit-design) para detalhes.
  * **Figma MCP no chat do Agent**: Cole um link do Figma diretamente no chat do Agent e peça para gerar código, extrair dados de design ou construir um componente a partir do design. Veja o guia de [Integração Figma MCP](/pt/features/mcp/figma).
