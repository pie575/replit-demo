...
description: "Découvrez l’Éditeur de projet : votre espace de travail dans Replit, où vous échangez avec Agent, voyez votre app prendre forme et gérez tout."
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L’écran d’accueil de l’Éditeur de projet Replit affichant le champ de prompt dans lequel vous décrivez ce que vous souhaitez construire" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

<div id="o-que-o-editor-de-projeto">
  ## Qu’est-ce que l’Éditeur de projet ?
</div>

L’Éditeur de projet est votre point de départ dans Replit : c’est là que vous commencez à construire, gérez vos projets et voyez vos apps prendre vie. Vous pouvez y décrire ce que vous souhaitez construire, et l’[Agent](/fr/pt/features/agent/overview) s’occupe du reste : il écrit le code, configure votre projet et affiche un aperçu en direct, en temps réel.

<div id="primeiros-passos">
  ## Premiers pas
</div>

Saisissez ce que vous souhaitez construire dans le champ de prompt. Décrivez votre idée en langage clair — « un outil de suivi du budget qui représente graphiquement mes dépenses », « une page de destination pour mon café », « un générateur de bandes dessinées avec IA pour les enfants » — et Agent s’occupe du reste.

<AgentInput />

Vous pouvez également sélectionner un type de projet dans le carrousel pour indiquer à Agent le type de résultat souhaité — web app, application mobile, diapositives, design et plus encore. Vous pouvez aussi ignorer cette sélection et simplement décrire votre idée ; Agent déterminera automatiquement la configuration adaptée.

<AgentCarousel />

Pour démarrer rapidement, suivez [Construire votre première app](/fr/pt/build/your-first-app).

<div id="modo-de-plano">
  ## Mode Plan
</div>

Le mode Plan vous permet de faire du brainstorming, de poser des questions et de structurer votre projet. Agent crée une liste de tâches ordonnée que vous pouvez examiner et affiner. Lorsque vous êtes satisfait du plan, approuvez-le et Agent commence à construire. Vous pouvez également utiliser le mode Plan pour poser des questions ou explorer des idées ; Agent n’apportera aucune modification tant que vous ne quitterez pas ce mode.

<AgentInput highlightPlan={true} showTypewriter={false} />

Activez le mode Plan à l’aide du bouton situé en bas du champ de saisie. Pour en savoir plus, consultez le [guide du mode Plan](/fr/pt/features/agent/plan-mode).

<div id="o-que-voc-pode-construir">
  ## Ce que vous pouvez construire
</div>

Sélectionnez un type de projet pour indiquer à Agent ce que vous souhaitez créer, ou décrivez simplement votre idée et laissez Agent choisir la configuration adaptée.
...
* **Diapositives et présentations** — Créez des présentations aux mises en page riches
* **Animations** — Guides interactifs et animations graphiques
* **Designs** — Maquettes visuelles et prototypes dans le [Canvas de Design](/fr/pt/design/canvas)
* **Visualisations de données** — Graphiques, tableaux de bord et outils avec base de données
* **Documents** — CSV, PDF, fichiers PowerPoint, documents Markdown
* **Feuilles de calcul** — Tableaux de données et résultats structurés

<div id="o-editor-de-projeto">
  ## L’Éditeur de projet
</div>

Une fois que l’Agent commence à construire, l’Éditeur de projet vous permet de voir votre projet prendre forme. Il est divisé en panneaux : votre conversation avec l’Agent d’un côté et un aperçu en direct de votre app de l’autre.

<div id="threads">
  ### Fils de discussion
</div>

Chaque conversation avec Agent se déroule dans un fil de discussion. Dans votre fil de discussion principal, vous décrivez ce que vous souhaitez et observez Agent le construire. Lorsque vous utilisez le [système de tâches](/fr/pt/core-concepts/agent/task-system), chaque tâche en arrière-plan dispose de son propre fil de discussion, ce qui permet à Agent de garder les tâches séparées sans mélanger les conversations.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Un fil de discussion montrant le prompt de l’utilisateur et Agent en train de construire le projet" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>
...
Le tableau des tâches organise votre travail en colonnes : **Brouillons**, **Actif**, **Prêt** et **Terminé**. Chaque tâche avance de gauche à droite au fil de sa progression, ce qui vous permet de voir rapidement ce qui est prévu, ce sur quoi Agent travaille et ce qui est terminé. Pour en savoir plus, consultez le [système de tâches](/fr/pt/core-concepts/agent/task-system).
...
<div id="canvas-de-design">
  ### Canvas de Design
</div>

Le Canvas de Design est un éditeur visuel qui vous permet de créer et d’affiner des maquettes avant de passer au code. Faites glisser des éléments, ajustez les mises en page et itérez sur votre design, puis laissez Agent le transformer en application fonctionnelle. En savoir plus sur le [Canvas de Design](/fr/pt/design/canvas).

<div id="colaborao">
  ## Collaboration
</div>

Créez un Workspace d’équipe pour travailler ensemble. Invitez des collègues, partagez des projets et collaborez sur la même app en temps réel. Consultez [Workspaces d’équipe](/fr/pt/features/collaboration/team-workspaces) pour configurer votre équipe et [Inviter des collègues](/fr/pt/build/invite-teammates) pour collaborer au niveau d’un projet.

<div id="importe-cdigo-e-design">
  ## Importez du code et des designs
</div>

Vous avez déjà un projet ? Importez-le dans Replit depuis GitHub ou Figma, ou téléversez directement des fichiers. Agent peut reprendre là où vous vous êtes arrêté et continuer à développer à partir de votre code ou de votre design existant. Consultez [Importer dans Replit](/fr/pt/build/import-from-providers).
...
<CardGroup cols={2}>
  <Card title="Éditeur et outils" href="/fr/pt/features/editor/editor-and-tools" icon="window-restore">
    Les principaux panneaux pour afficher l’aperçu de votre app, la sortie de la console et d’autres outils
  </Card>

  <Card title="Configuration de l’app" href="/fr/pt/features/project-setup/configuration" icon="gear">
    Configurez les paramètres, les dépendances, les Secrets et l’environnement de votre app
  </Card>

  <Card title="Contrôle de version" href="/fr/pt/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Suivez les modifications, revenez à des versions antérieures et gérez l’historique de votre app
  </Card>

  <Card title="Publication" href="/fr/pt/learn/projects-and-artifacts/replit-deployments" icon="rocket">
...
<Accordion title="Dois-je savoir programmer ?">
  Non. Décrivez ce que vous voulez en langage simple et Agent s’occupe des détails techniques. Vous pouvez aussi effectuer des modifications directement si vous le souhaitez.
</Accordion>

<Accordion title="Que se passe-t-il lorsque je ferme mon navigateur ?">
  Votre projet est enregistré dans le cloud. Revenez à tout moment et reprenez là où vous vous étiez arrêté : vos fichiers, votre historique et votre app en cours d’exécution sont tous conservés.
</Accordion>

<Accordion title="Puis-je travailler avec d’autres personnes ?">
  Oui. Vous pouvez inviter des collaborateurs à un projet spécifique ou créer un Workspace d’équipe, où les membres ont accès à tous les projets. Consultez [Workspaces d’équipe](/fr/pt/features/collaboration/team-workspaces) et [Inviter des collègues](/fr/pt/build/invite-teammates).
</Accordion>

<Accordion title="Comment publier mon app ?">
  Lorsque votre app est prête, déployez-la à l’aide d’une URL en ligne directement depuis l’Éditeur de projet. Consultez [Déploiements](/fr/pt/learn/projects-and-artifacts/replit-deployments).
</Accordion>
...
L’Éditeur de projet est disponible avec tous les forfaits. Certaines fonctionnalités, comme une puissance de calcul accrue et les déploiements toujours actifs, nécessitent un forfait payant. Consultez la page [Facturation](/fr/pt/billing/ai-billing) pour en savoir plus.