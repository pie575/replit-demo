---
title: "Replitで開く"
description: "アプリやウェブサイトから訪問者がビルドを始められる「Replitで開く」ボタンの作成方法を説明します。"
---
...
| パラメータ      | 型      | 説明                                                                                                                                                      | 必須/任意 |
| ---------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| `stack`    | string | 使用するビルドモード。`Design`または`Build`のいずれか。`Design`はビジュアルプロトタイピング用の[Canvas](/ja/design/canvas)を開きます。`Build`はフルアプリ開発用の[Agent](/ja/features/agent/overview)を開きます。 | 必須    |
...
`stack=Design`を使用すると、プロンプトが[Canvas](/ja/design/canvas)で開きます。Canvasは以下に最適化されています：
...
`stack=Build`を使用すると、プロンプトが[Agent](/ja/features/agent/overview)で開きます。Agentは以下に最適化されています：
...
* [Canvasドキュメント](/ja/design/canvas)
* [Agentドキュメント](/ja/features/agent/overview)
* [Replit AIインテグレーション](/ja/features/integrations/overview)
