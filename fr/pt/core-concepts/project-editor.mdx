---
title: "Éditeur de projets"
description: "Découvrez l’Éditeur de projets : votre espace central sur Replit, où vous échangez avec Agent, suivez le développement de votre app et gérez tout."
---
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L’écran d’accueil de l’Éditeur de projets Replit, affichant le champ de prompt dans lequel vous décrivez ce que vous souhaitez créer" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

<div id="o-que-o-editor-de-projetos">
  ## Qu’est-ce que l’Éditeur de projets ?
</div>

L’Éditeur de projets est votre point de départ sur Replit : c’est là que vous commencez à créer, gérez vos projets et voyez vos apps prendre vie. Vous pouvez décrire ce que vous souhaitez créer, et [Agent](/fr/pt/core-concepts/agent) s’occupe du reste en écrivant le code, en configurant votre projet et en affichant un aperçu en direct en temps réel.

<div id="primeiros-passos">
  ## Premiers pas
</div>

Saisissez ce que vous souhaitez créer dans la boîte de prompt. Décrivez votre idée simplement — « un outil de suivi de budget qui affiche mes dépenses sous forme de graphiques », « une page de destination pour mon café », « un générateur de bandes dessinées avec IA pour enfants » — et Agent s’occupe du reste.

<AgentInput />

Vous pouvez également sélectionner un type de projet dans le carrousel pour indiquer à Agent le type de résultat souhaité — app web, app mobile, présentations, Design et bien plus encore. Vous pouvez aussi ignorer cette sélection et simplement décrire votre idée ; Agent déterminera automatiquement la configuration appropriée.

<AgentCarousel />

Pour commencer immédiatement, consultez le [démarrage rapide Créer avec l’IA](/fr/pt/getting-started/quickstarts/ask-ai/).

<div id="modo-plan">
  ## Mode Plan
</div>

Le mode Plan vous permet de faire du brainstorming, de poser des questions et de planifier votre projet. Agent crée une liste de tâches ordonnée que vous pouvez examiner et affiner. Lorsque vous êtes satisfait du plan, approuvez-le et Agent commence à le construire. Vous pouvez également utiliser le mode Plan pour poser des questions ou explorer des idées ; Agent n’apportera aucune modification tant que vous ne quitterez pas ce mode.

<AgentInput highlightPlan={true} showTypewriter={false} />

Activez le mode Plan à l’aide du bouton situé en bas du champ de saisie. Pour en savoir plus, consultez le [guide du mode Plan](/fr/pt/core-concepts/agent/plan-mode).

<div id="o-que-voc-pode-criar">
  ## Ce que vous pouvez créer
</div>

Sélectionnez un type de projet pour indiquer à l’Agent ce que vous souhaitez, ou décrivez simplement votre idée et laissez l’Agent choisir la configuration adaptée.

* **Applications web** — Tableaux de bord, outils internes, produits SaaS, pages de destination
* **Applications mobiles** — Applications pour iOS et Android à partir d’un seul prompt
* **Présentations et diapositives** — Générez des présentations aux mises en page riches
* **Animations** — Tutoriels interactifs et animations graphiques
* **Designs** — Maquettes visuelles et prototypes dans le [Design Canvas](/fr/pt/replitai/canvas)
* **Visualisations de données** — Graphiques, tableaux de bord et outils avec base de données
* **Documents** — Fichiers CSV, PDF, PowerPoint et documents Markdown
* **Feuilles de calcul** — Tableaux de données et résultats structurés

<div id="o-editor-de-projetos">
  ## L’Éditeur de projets
</div>

Dès que l’Agent commence à créer votre app, vous pouvez suivre son développement dans l’Éditeur de projets. Il est divisé en panneaux : votre conversation avec l’Agent d’un côté et un aperçu en direct de votre app de l’autre.

<div id="threads">
  ### Fils de discussion
</div>

Chaque conversation avec Agent se déroule dans un fil de discussion. Votre fil de discussion principal vous permet de décrire ce que vous souhaitez et de suivre Agent pendant qu’il construit votre projet. Lorsque vous utilisez le [système de tâches](/fr/pt/core-concepts/agent/task-system), chaque tâche en arrière-plan possède son propre fil de discussion : Agent peut ainsi isoler le travail de chaque tâche sans mélanger les conversations.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Un fil de discussion montrant le prompt de l’utilisateur et Agent construisant le projet" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>

<div id="quadro-de-tarefas">
  ### Tableau des tâches
</div>

Le tableau des tâches organise votre travail en colonnes : **Brouillons**, **Actif**, **Prêt** et **Terminé**. Chaque tâche passe de gauche à droite au fil de son avancement, ce qui vous permet de voir d’un coup d’œil ce qui est prévu, ce sur quoi travaille Agent et ce qui est terminé. Pour en savoir plus, consultez [Construire en parallèle](/fr/pt/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Tableau des tâches présentant des tâches organisées dans les colonnes Brouillons, Actif, Prêt et Terminé" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>
...
Design Canvas est un éditeur visuel qui vous permet de créer et d&#39;affiner des maquettes avant de passer au code. Faites glisser des éléments, ajustez les mises en page et itérez sur votre design, puis laissez Agent le transformer en application fonctionnelle. Pour en savoir plus, consultez [Design Canvas](/fr/pt/replitai/canvas).

<div id="colaborao">
  ## Collaboration
</div>

Créez un Workspace d&#39;équipe pour travailler ensemble. Invitez des membres de l&#39;équipe, partagez des projets et travaillez sur la même app en temps réel. Consultez [Workspaces d&#39;équipe](/fr/pt/core-concepts/workspaces/team-workspaces) pour configurer votre équipe et [Inviter des membres de l&#39;équipe](/fr/pt/replitai/invite-teammates) pour la collaboration au niveau des projets.

<div id="importar-cdigo-e-design">
  ## Importer du code et des designs
</div>

Vous avez déjà un projet ? Importez-le dans Replit depuis GitHub ou Figma, ou téléversez directement des fichiers. Agent peut reprendre là où vous vous êtes arrêté et continuer à s’appuyer sur votre code ou design existant. Consultez [Importer dans Replit](/fr/pt/core-concepts/project-editor/app-setup/import).
...
<CardGroup cols={2}>
  <Card title="Éditeur et outils" href="/fr/pt/core-concepts/project-editor/editor-and-tools" icon="window-restore">
    Les principaux panneaux pour afficher l’aperçu de votre app, la sortie de la console et d’autres outils
  </Card>

  <Card title="Configuration de l’app" href="/fr/pt/core-concepts/project-editor/app-setup/configuration" icon="gear">
    Configurez les paramètres, les dépendances, les Secrets et l’environnement de votre app
  </Card>

  <Card title="Contrôle de version" href="/fr/pt/core-concepts/project-editor/version-control" icon="clock-rotate-left">
    Suivez les modifications, revenez à des versions antérieures et gérez l’historique de votre app
  </Card>

  <Card title="Publication" href="/fr/category/replit-deployments" icon="rocket">
    Déployez votre app sur une URL publique afin que tout le monde puisse l’utiliser
  </Card>
</CardGroup>
...
<Accordion title="Dois-je savoir programmer ?">
  Non. Décrivez ce que vous souhaitez en langage simple, et Agent s&#39;occupe des détails techniques. Vous pouvez aussi effectuer des modifications directement si vous le souhaitez.
</Accordion>

<Accordion title="Que se passe-t-il lorsque je ferme mon navigateur ?">
  Votre projet est enregistré dans le cloud. Revenez à tout moment et reprenez là où vous vous étiez arrêté : vos fichiers, votre historique et votre application en cours d&#39;exécution sont préservés.
</Accordion>

<Accordion title="Puis-je travailler avec d'autres personnes ?">
  Oui. Vous pouvez inviter des collaborateurs dans un projet spécifique ou créer un Workspace d&#39;équipe dans lequel les membres ont accès à tous les projets. Consultez [Workspaces d&#39;équipe](/fr/pt/core-concepts/workspaces/team-workspaces) et [Inviter des membres de l&#39;équipe](/fr/pt/replitai/invite-teammates).
</Accordion>

<Accordion title="Comment publier mon application ?">
  Lorsque votre application est prête, déployez-la sur une URL publique directement depuis l&#39;Éditeur de projets. Consultez [Déploiements](/fr/category/replit-deployments).
</Accordion>
...
L’Éditeur de projets est disponible avec tous les forfaits. Certaines fonctionnalités, telles qu’une puissance de calcul accrue et les déploiements toujours actifs, nécessitent un forfait payant. Consultez [Facturation](/fr/pt/billing/ai-billing) pour en savoir plus.