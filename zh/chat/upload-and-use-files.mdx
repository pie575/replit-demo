---
title: "上传和使用文件"
description: "将相关文档、电子表格、图片或屏幕截图添加到 Conversation，并告诉 Replit 如何利用这些信息来支持你的请求。"
...
上传文档、电子表格、图片和截图，可为 Replit 提供比文字描述更容易传达的依据、requirements 或视觉方向。
...
<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示框的加号菜单，“上传文件”是第一个选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/chat/upload-and-use-files">
    ...
    <div className="chat-card-title">处理文件</div>
    <p>查看理解和分析文件的完整示例。</p>
