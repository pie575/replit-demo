...
description: "Answers to common project questions—recovering deleted projects, exporting, sharing, connecting GitHub, secrets, and rolling back to a checkpoint."
sidebarTitle: "Projects and files"
icon: "folder"
---
...
<AccordionGroup>
  ...
  <Accordion title="How do I move a project to a different Replit account?">
    ...
    After copying, set up secrets, the database, and deployment configuration in the new project—those aren't included in the copy. For step-by-step instructions, including how to move your database data, see [Manually copy a project to another workspace](/teams/identity-and-access-management/manually-copy-projects).
  </Accordion>
</AccordionGroup>
