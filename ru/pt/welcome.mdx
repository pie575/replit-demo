...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <div className="welcome-actions">
        <a className="welcome-action primary" href="/ru/pt/home/get-started">Начать <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/ru/use-cases">Изучить сценарии использования</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Знакомство с Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Сайт об открытии кофейни с заголовком «Уютное место на каждый день»" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Узнайте, как воплотить свою идею в готовый сайт
      </div>

      <p>
        Пройдите пошаговый путь от первого разговора до исследования,
        планирования, дизайна и публикации.
      </p>

      <a className="welcome-journey-link" href="/ru/pt/home/get-started">
        Начните путь <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/ru/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Получайте краткий брифинг перед каждой встречей с клиентом.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Превращайте необработанные отзывы в темы и выводы, которые помогут действовать.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Находите и фильтруйте кандидатов, используя подключённый контекст.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Находите важные обсуждения и быстро направляйте их нужным людям.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/ru/use-cases">
        Изучить варианты использования <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/ru/pt/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Компактное окно чата, представляющее Chat в Replit">
      ...
      <a className="welcome-product-card" href="/ru/pt/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Редактор кода и предпросмотр в реальном времени, представляющие Build в Replit">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Превращайте идеи в реальные приложения и сайты. Создавайте, дорабатывайте и публикуйте
          с уверенностью.
        </p>

        <div className="welcome-product-link">
          Начать создавать <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/pt/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Выделенная композиция на Canvas, представляющая Design в Replit">
          <span className="product-path-layer product-path-back" />
        ...
        <div className="welcome-product-link">
          Начать создавать дизайны <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Скачайте Replit</h2>
      <p>Выберите, где вы хотите использовать Replit, затем войдите в учётную запись или создайте её. Начните в веб-версии, настольном приложении или Mobile App.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>Веб-версия</strong><b aria-hidden="true">→</b><small>Откройте в браузере</small></a>
