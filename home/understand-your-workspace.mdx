...
description: "Understand how your Replit Workspace brings together people, Projects, Conversations, Routines, data, integrations, and security."
sidebarTitle: "Understand your workspace"
icon: "briefcase"
...
Your Replit Workspace is the home for everything related to an idea. It brings
together [Projects](/home/projects), [Conversations](/home/conversations),
[Routines](/chat/routines), and integrations, so you can move from an early
question to a useful outcome.

## Set up the coffee-shop project

Before you start shaping the coffee-shop idea, give it a home. This Workspace
will keep the parts of the launch together as they develop:

* A conversation for shaping the concept and researching the local market
* Files and connected tools that add useful context to the plan
* A Routine that later watches for competition and market changes
* The site you will eventually design and publish

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Replit home screen for Demo workspace with Projects, Conversations, Routines, suggested prompts, and the message box" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

The prompt box is where this project begins. From here, you will start a
conversation and give Replit the first description of the coffee shop you want
to create.

## Workspace details

It also keeps related people, settings, shared resources, integrations, and
billing together. Your access determines what you can see and manage.

Workspace settings and organization controls are separate from the controls you use to shape how Agent responds to a request.

You can return to the Workspace throughout the launch to find everything that
supports it.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/home/start-a-conversation">
    ...
    <div className="chat-example-tag">Next step</div>
    <div className="chat-card-title">Start a conversation</div>
    <p>Start the coffee-shop launch by describing the outcome you want.</p>
    <div className="chat-card-link">Explore →</div>
  </a>

  <a className="chat-example has-visual" href="/features/collaboration/workspaces">
    ...
    <div className="chat-example-tag">Workspace details</div>
    <div className="chat-card-title">See more about workspaces</div>

    <p>
      Learn about Personal and Team Workspaces, access, settings, and
      management.
    </p>
...
Next, [start a conversation](/home/start-a-conversation) to begin shaping the
coffee-shop idea.
