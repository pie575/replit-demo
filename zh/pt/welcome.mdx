...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      <div className="welcome-eyebrow">快速上手</div>
      <h1 id="welcome-home-heading">欢迎来到 Replit</h1>
      <p>将创意、日常工作和智能转化为实用成果。</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/zh/pt/home/get-started">快速上手 <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/zh/use-cases">探索使用场景</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Replit 引导之旅">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="咖啡馆开业网站，标题为“日常生活中的宁静之所”" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>
    ...
    <div className="welcome-journey-copy">
      ...
      <a className="welcome-journey-link" href="/zh/pt/home/get-started">
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/zh/use-cases">
        探索使用场景 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/zh/pt/chat/overview">
      ...
      <a className="welcome-product-card" href="/zh/pt/build/your-first-app">
      ...
      <a className="welcome-product-card" href="/zh/pt/design/what-is-replit-design">
        ...
        <p>
          创建精美的界面和内容。不断优化布局、组件
          和体验。
        </p>

        <div className="welcome-product-link">
          开始创建设计 <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      ...
      <p>选择你想使用 Replit 的方式，然后登录或创建账户。你可以通过网页版、桌面 App 或移动 App 开始使用。</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>网页版</strong><b aria-hidden="true">→</b><small>在浏览器中打开</small></a>
