---
title: "Voice Mode"
description: "Fale seus prompts para o Agent em vez de digitá-los. O Voice Mode transcreve o que você diz para a caixa de chat, para que você possa revisar e enviar."
sidebarTitle: "Voice Mode"
icon: "microphone"
canonical: "https://docs.replit.com/chat/voice-mode"
---

<div className="chat-mkt" role="img" aria-label="Microfone representando o Voice Mode" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
...
Para disponibilidade e comportamento completo, veja a [referência de recursos do Voice Mode](/pt/features/agent/voice-mode). Em seguida, saiba como as [Skills](/pt/chat/agent-skills) dão ao Replit instruções reutilizáveis e materiais de apoio.
