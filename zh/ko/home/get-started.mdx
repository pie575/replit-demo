---
title: "开始使用"
description: "跟随咖啡店的上线历程，了解如何使用 Replit 将最初的想法变为已发布的开业网站。"
---
...
想象一下，你想在自家社区里开一间咖啡店。你需要调研本地市场、
选好店址、制定开业计划、做一个网站，再把它分享给街坊
邻里。

动手之前，你不必事先想清楚所有问题。先从你的目标、你心中描绘的
那个社区，以及你希望吸引的客人开始。
...
* 如何将 Replit 与你正在使用的工具连接起来，获取更贴合需求的
  上下文
* 如何持续关注本地竞争对手和市场变化
* 如何构建并发布一个让全世界了解你咖啡店的
  网站
...
* 定位清晰的咖啡馆概念和开业计划
* 支撑您决策的调研资料和原始资料
* 让计划保持最新状态的每周 Routine
* 方便人们发现的已发布开业网站

<Frame caption="您将创建并发布的咖啡店开业网站。">
  <img src="/assets/mirror/review-updated-site-design-df2f186ddc53.jpg" alt="Replit Design 中显示的咖啡店开业网站" width="3436" height="1970" data-path="images/coffee-shop-launch/review-updated-site-design.jpg" />
</Frame>

请先从[了解 Workspace](/zh/home/understand-your-workspace)开始。在这里，Conversation、原始资料、Routine 和网站汇集于一处。