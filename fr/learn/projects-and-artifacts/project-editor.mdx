...
description: "Découvrez ce qu'est l'éditeur de projet : votre base sur Replit où vous parlez à Agent, voyez votre application prendre forme et gérez tout."
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L'écran d'accueil de l'éditeur de projet Replit montrant la saisie du prompt où vous décrivez ce que vous souhaitez construire" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

## Qu'est-ce que l'éditeur de projet ?

L'éditeur de projet est votre base sur Replit : l'environnement où vous commencez à construire, gérez vos projets et voyez vos applications prendre vie. De là, vous pouvez décrire ce que vous souhaitez construire, et [Agent](/fr/features/agent/overview) prend le relais, en écrivant du code, en configurant votre projet et en vous montrant un aperçu en direct en temps réel.

## Premiers pas

Tapez ce que vous souhaitez construire dans la zone de prompt. Décrivez votre idée en langage simple — « un suivi budgétaire qui représente mes dépenses », « une page de destination pour mon café », « un générateur de bandes dessinées IA pour enfants » — et Agent s'occupe du reste.

<AgentInput />

Vous pouvez également sélectionner un type de projet dans le carrousel pour indiquer à Agent quel type de résultat vous souhaitez — application web, application mobile, diapositives, design, et plus encore. Ou ignorez la sélection entièrement et décrivez simplement votre idée ; Agent détermine automatiquement la configuration appropriée.

<AgentCarousel />

Pour commencer directement, suivez [Créez votre première application](/fr/build/your-first-app).

## Mode Plan

Le mode Plan vous permet de faire du brainstorming, de poser des questions et de planifier votre projet. Agent crée une liste de tâches ordonnée que vous pouvez examiner et affiner — lorsque vous êtes satisfait du plan, approuvez-le et Agent commence à construire. Vous pouvez également utiliser le mode Plan pour poser des questions ou explorer des idées ; Agent n'effectuera aucune modification tant que vous n'aurez pas quitté le mode.

<AgentInput highlightPlan={true} showTypewriter={false} />

Activez le mode Plan depuis le bouton en bas de la saisie. Pour en savoir plus, consultez le [guide du mode Plan](/fr/features/agent/plan-mode).

## Ce que vous pouvez construire

Sélectionnez un type de projet pour indiquer à Agent ce que vous souhaitez, ou décrivez simplement votre idée et laissez Agent choisir la configuration appropriée.
...
* **Diapositives et présentations** — Générez des présentations avec des mises en page riches
* **Animations** — Tutoriels interactifs et graphiques animés
* **Designs** — Maquettes visuelles et prototypes sur le [Canvas de design](/fr/design/canvas)
* **Visualisations de données** — Graphiques, tableaux de bord et outils alimentés par des bases de données
* **Documents** — Fichiers CSV, PDF, PowerPoint, documents Markdown
* **Feuilles de calcul** — Tableaux de données et résultats structurés

## L'éditeur de projet

Une fois qu'Agent commence à construire, l'éditeur de projet est l'endroit où vous voyez votre projet prendre forme. Il est divisé en panneaux : votre conversation avec Agent d'un côté et un aperçu en direct de votre application de l'autre.

### Fils de discussion

Chaque conversation avec Agent se déroule dans un fil de discussion. Votre fil principal est l'endroit où vous décrivez ce que vous voulez et regardez Agent le construire. Lorsque vous utilisez le [système de tâches](/fr/core-concepts/agent/task-system), chaque tâche en arrière-plan obtient son propre fil — ainsi Agent peut garder le travail des tâches isolé sans mélanger les conversations.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Un fil montrant le prompt de l'utilisateur et Agent construisant le projet" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>

### Tableau des tâches

Le tableau des tâches organise votre travail en colonnes : **Brouillons**, **Actif**, **Prêt** et **Terminé**. Chaque tâche se déplace de gauche à droite au fur et à mesure de sa progression, de sorte que vous pouvez voir d'un coup d'œil ce qui est planifié, sur quoi Agent travaille et ce qui est terminé. Pour en savoir plus, consultez [Système de tâches](/fr/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Tableau des tâches affichant les tâches organisées en colonnes Brouillons, Actif, Prêt et Terminé" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>

### Canvas de design

Le Canvas de design est un éditeur visuel où vous pouvez créer et affiner des maquettes avant de vous engager dans le code. Faites glisser des éléments, ajustez les mises en page et itérez sur votre design — puis laissez Agent le transformer en application fonctionnelle. Pour en savoir plus, consultez [Canvas de design](/fr/design/canvas).

## Collaboration

Créez un espace de travail d'équipe pour construire ensemble. Invitez des coéquipiers, partagez des projets et travaillez sur la même application en temps réel. Consultez [Espaces de travail d'équipe](/fr/features/collaboration/team-workspaces) pour la configuration d'équipe et [Inviter des coéquipiers](/fr/build/invite-teammates) pour la collaboration au niveau du projet.

## Importer du code et des designs

Vous avez déjà un projet ? Apportez-le dans Replit depuis GitHub, Figma ou téléchargez des fichiers directement. Agent peut reprendre là où vous vous êtes arrêté et continuer à construire à partir de votre code ou design existant. Consultez [Importer dans Replit](/fr/build/import-from-providers).

## Prochaines étapes

<CardGroup cols={2}>
  <Card title="Éditeur et outils" href="/fr/features/editor/editor-and-tools" icon="window-restore">
    Les panneaux principaux où vous voyez l'aperçu de votre application, la sortie de la console et d'autres outils
  </Card>

  <Card title="Configuration de l'application" href="/fr/features/project-setup/configuration" icon="gear">
    Configurez les paramètres, les dépendances, les secrets et l'environnement de votre application
  </Card>

  <Card title="Contrôle de version" href="/fr/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Suivez les modifications, revenez à des versions antérieures et gérez l'historique de votre application
  </Card>

  <Card title="Publication" href="/fr/learn/projects-and-artifacts/replit-deployments" icon="rocket">
    Déployez votre application vers une URL en direct pour que tout le monde puisse l'utiliser
  </Card>
</CardGroup>
...
<Accordion title="Dois-je savoir coder ?">
  Non. Décrivez ce que vous voulez en langage simple et Agent s'occupe des détails techniques. Vous pouvez également effectuer des modifications directes si vous le souhaitez.
</Accordion>

<Accordion title="Que se passe-t-il lorsque je ferme mon navigateur ?">
  Votre projet est sauvegardé dans le cloud. Revenez à tout moment et reprenez exactement là où vous vous étiez arrêté : vos fichiers, votre historique et votre application en cours d'exécution sont tous préservés.
</Accordion>

<Accordion title="Puis-je travailler avec d'autres personnes ?">
  Oui. Vous pouvez inviter des collaborateurs à un projet spécifique ou créer un espace de travail d'équipe où les membres accèdent à tous les projets. Consultez [Espaces de travail d'équipe](/fr/features/collaboration/team-workspaces) et [Inviter des coéquipiers](/fr/build/invite-teammates).
</Accordion>

<Accordion title="Comment publier mon application ?">
  Lorsque votre application est prête, déployez-la vers une URL en direct directement depuis l'éditeur de projet. Consultez [Déploiements](/fr/learn/projects-and-artifacts/replit-deployments).
</Accordion>

## Disponibilité

L'éditeur de projet est disponible sur tous les plans. Certaines fonctionnalités comme les calculs accrus et les déploiements toujours actifs nécessitent un plan payant. Consultez [Facturation](/fr/billing/ai-billing) pour plus de détails.
