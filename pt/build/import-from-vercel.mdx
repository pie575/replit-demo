---
title: "Importar do Vercel"
description: "Importe projetos do Vercel para o Replit selecionando o repositório do GitHub vinculado."
---
...
Importe um projeto do Vercel para o Replit vinculando o repositório do GitHub por trás do projeto.

Para opções de importação abrangentes incluindo outras plataformas como GitHub, Figma, Bolt e Lovable, consulte a [documentação do recurso de Importação](/pt/references/workspace/import).

## Antes de começar

* Um projeto do Vercel conectado ao GitHub
* Acesso ao repositório do GitHub vinculado
* Uma conta no Replit
...
5. Adicione quaisquer secrets e variáveis de ambiente solicitados.
6. Selecione **Import**.

## O que é importado

* Arquivos do projeto e estrutura de diretórios
* Configuração de dependências e framework
...
* Comportamento específico de edge ou middleware do Vercel
* Configuração externa de analytics ou monitoramento
