---
title: "Store images in your mobile app"
description: "Save profile photos and other images to App Storage, linked to each player."
sidebarTitle: "Save player images"
icon: "image"
---
...
<Frame caption="PixelGames' profile screen, showing the player's photo alongside their high score.">
  <img src="/assets/mirror/database-ef6b19f2ecde.png" alt="PixelGames profile screen with the player's photo, name, and high score" data-path="images/pixelgames/mobile/database.png" width="1516" height="590" data-path="images/pixelgames/mobile/database.png" />
</Frame>
