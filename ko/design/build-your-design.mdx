---
title: "디자인 빌드하기"
description: "우승한 프레임을 실제 소프트웨어로 만드세요: 새 앱으로 빌드하거나, 이미 가지고 있는 앱에 그 모습을 적용할 수 있습니다."
...
<Frame caption="Build… 메뉴: 새 아티팩트를 만들거나, 기존 아티팩트에 디자인을 적용합니다.">
  <img src="/assets/mirror/canvas-build-menu-f06b8b8b455f.png" alt="선택된 Design 프레임(APEX X1 Exact Replica)에서 열린 Build 메뉴. 'Build or apply your designs' 헤더 아래 새 아티팩트를 만드는 'Build this design'과, 프로젝트의 APEX X1 Design System 및 Scroll Hero 웹사이트를 나열하는 'Apply to an existing creation'이 표시됨" width="2000" height="1153" data-path="images/replitai/canvas-build-menu.png" />
</Frame>
...
* [템플릿으로 빌드하고 퍼블리시하기](/ko/build/build-and-publish-from-template): 갤러리에서 실제 사이트까지 이어지는 전체 빠른 시작 가이드를 따라 해보세요.
