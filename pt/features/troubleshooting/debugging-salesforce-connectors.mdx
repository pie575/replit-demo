---
title: "Corrigindo Erros de Conexão Expirada do Salesforce"
description: "Corrija erros de 'Conexão Expirada' ao usar o conector Salesforce no Replit atualizando sua política de token de atualização."
---
...
* [Visão geral dos Conectores](/pt/features/integrations/overview) -- Saiba mais sobre todos os tipos de integração, incluindo conectores Salesforce
