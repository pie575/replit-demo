...
description: "Conecte o Replit Agent a ferramentas externas, fontes de dados e APIs através do Model Context Protocol (MCP) — faça login em um servidor pré-listado ou adicione um personalizado."
---
...
Para o catálogo completo, consulte a [referência de Servidores MCP](/pt/features/mcp/overview).
...
<Frame>
  <img src="/assets/mirror/mcp-connect-dialog-5b8f9b0d828e.png" alt="Diálogo Conectar um servidor MCP mostrando campo de Nome de exibição, campo URL do Servidor MCP e seção de Configurações avançadas expansível" width="3452" height="1988" data-path="images/replitai/mcp-connect-dialog.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/tool-call-7a53f51a11ae.png" alt="Agent chamando ferramentas de um servidor MCP personalizado no chat" width="571" height="817" data-path="images/replitai/custom-mcp/tool-call.png" />
</Frame>
...
Para o formato do link, consulte a [referência de link de instalação](/pt/features/mcp/overview#share-your-own-install-link).
...
<CardGroup cols={2}>
  ...
  <Card title="Lista de MCP" icon="folder-tree" href="/pt/features/mcp/overview">
    Navegue pela lista curada de servidores MCP com botões de instalação com um clique.
  </Card>
</CardGroup>
