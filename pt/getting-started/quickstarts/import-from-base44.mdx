---
title: "Importar do Base44"
description: "Importe projetos do Base44 para o Replit exportando para o GitHub primeiro."
---
...
Importe um projeto do Base44 para o Replit exportando-o para o GitHub e depois importando esse repositório.
...
* Um projeto do Base44 que você pode exportar
* Uma conta do GitHub conectada ao Base44
* Uma conta no Replit

## Passos de importação

1. Exporte seu projeto do Base44 para o GitHub.
2. Abra [replit.com/import](https://replit.com/import).
3. Selecione **Base44**.
4. Conecte sua conta do GitHub.
5. Selecione o repositório exportado do Base44.
