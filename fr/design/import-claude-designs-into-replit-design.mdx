...
description: "Envoyez un design depuis Claude vers Replit, créez un projet à partir du HTML statique, et laissez Agent le transformer en application interactive."
...
<Frame>
  <img src="/assets/mirror/claude-design-canvas-fa8be1a1ea5a.png" alt="Le design Velocity ouvert dans le canvas de design de Claude, le design autonome que vous transférez à Replit pour le transformer en application interactive" width="2000" height="1143" data-path="images/claude-to-app/claude-design-canvas.png" />
</Frame>
...
<Steps>
  ...
  <Step title="Ouvrir le menu Send to">
    ...
    <Frame>
      <img src="/assets/mirror/claude-send-to-menu-d4353906aea3.png" alt="Le menu Send to… de Claude listant Replit comme destination aux côtés de Claude Code" width="2000" height="1143" data-path="images/claude-to-app/claude-send-to-menu.png" />
    </Frame>
  </Step>
...
<Frame caption="Le design Velocity de Claude sous forme de frame dans Replit Design, avec l'exécution d'Agent terminée.">
  <img src="/assets/mirror/claude-design-in-replit-design-ff81b055b1f5.webp" alt="Le design de location de supercar Velocity envoyé depuis Claude, ouvert sous forme de frame de design Claude dans Replit Design avec la tâche d'Agent marquée comme terminée dans le panneau de chat" width="1600" height="1004" data-path="images/claude-to-app/claude-design-in-replit-design.webp" />
</Frame>
