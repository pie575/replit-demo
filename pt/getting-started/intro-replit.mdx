---
title: "Visão Geral"
description: "O Replit é a forma mais rápida de transformar uma ideia em aplicativo. Crie e publique projetos incríveis no seu navegador com IA ao seu alcance."
---
...
<YouTubeEmbed videoId="-2xHmkpmCBM" title="Visão Geral do Replit" />

O Replit é uma plataforma movida por IA que permite criar e publicar aplicativos em uma única aba do navegador.
Em vez de lidar com ambientes de desenvolvimento complexos, você conta com ferramentas de codificação, publicação e colaboração em uma interface integrada.

Criar aplicativos da forma tradicional exige instalar programas, linguagens e pacotes — um processo de configuração demorado.
No Replit, a plataforma configura seu ambiente instantaneamente, para que você possa começar a construir independentemente de ser iniciante ou desenvolvedor experiente.

<div align="center">
  <AgentInput />
</div>

Você tem tudo o que precisa para criar aplicativos em uma única aba do navegador — sem instalação necessária.
Com ferramentas de codificação com IA, colaboração em tempo real e compartilhamento instantâneo, o Replit leva você da ideia ao aplicativo rapidamente.

## Guias de início rápido

Para criar seu aplicativo no Replit, escolha o guia que atende às suas necessidades:

### Criar novos aplicativos

<CardGroup cols={2}>
  <Card title="Crie seu primeiro aplicativo" icon="robot" href="/pt/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 minutos*

    Crie seu primeiro aplicativo com as ferramentas do Replit movidas por IA.
  </Card>

  <Card title="Remixar um aplicativo existente" icon="shuffle" href="/pt/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 minuto*

    Impulsione seu projeto construindo sobre aplicativos contribuídos pela comunidade.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Importar do GitHub" icon="github" href="/pt/getting-started/quickstarts/import-from-github/">
    ...
    Importe um repositório GitHub existente para o Replit.
  </Card>

  <Card title="Importar do Figma" icon="figma" href="/pt/getting-started/quickstarts/import-from-figma/">
    ⏱️ *3 minutos*

    Converta seus designs do Figma em aplicações React funcionais.
  </Card>

  <Card title="Importar do Bolt" icon="bolt" href="/pt/getting-started/quickstarts/import-from-bolt/">
    ⏱️ *4 minutos*

    Migre seus projetos do Bolt para o Replit com a assistência do Agente.
  </Card>

  <Card title="Importar do Lovable" icon="heart" href="/pt/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4 minutos*

    Transfira seus projetos do Lovable para o Replit e continue construindo.
  </Card>
</CardGroup>

### Recursos do ambiente de trabalho

O Replit fornece as seguintes ferramentas essenciais de criação de aplicativos:

* [Pré-visualização em tempo real](/core-concepts/workspace/editor-and-tools/preview) do seu aplicativo
* [Publicação em minutos](/category/replit-deployments)
* Aplicativo nativo no navegador sem necessidade de instalação ou configuração
* [Editor de código completo](/core-concepts/workspace/editor-and-tools)
* [Aplicativo mobile](/platforms/mobile-app) para criar aplicativos pelo celular ou tablet
* [Criação de aplicativos assistida por IA](/pt/core-concepts/agent)
* [Integração com controle de versão](/core-concepts/workspace/version-control) para acompanhar alterações
* [Colaboração em equipe](/pt/category/teams) para construir junto

### Capacidades do assistente de IA

O [Agente](/pt/core-concepts/agent) do Replit acelera a criação de aplicativos com as seguintes capacidades:

* Geração e configuração completa de aplicativos a partir de descrições em linguagem natural
* Sugestões de código e autocompletar
* Detecção automatizada de erros e assistência para depuração
* Geração de documentação para seu aplicativo

### Compartilhe em minutos

Publique seus aplicativos em minutos usando as seguintes ferramentas:

* Publicação de aplicativos na nuvem em poucos cliques
* Integração de banco de dados e hospedagem
* Suporte a domínio personalizado e criptografia de conexão para suas aplicações

## Construído com confiança

<CardGroup cols={3}>
  <Card title="SOC 2 Tipo 2" icon="shield-check">
    Controles de segurança e práticas de proteção de dados auditados de forma independente.
  </Card>

  <Card title="Conformidade com LGPD/GDPR" icon="lock">
    Proteções de privacidade de dados que atendem aos padrões regulatórios aplicáveis.
  </Card>

  <Card title="Pronto para Empresas" icon="building" href="/pt/category/teams">
    SSO/SAML, acesso baseado em funções, controles administrativos e suporte dedicado.
  </Card>
</CardGroup>

## Informações adicionais

Para saber mais sobre todos os recursos do Replit, consulte os seguintes recursos:

* [Plano Starter](/pt/billing/plans/starter-plan): Conheça os recursos do plano Starter e o que você pode criar gratuitamente
* Conheça os recursos do ambiente de trabalho em [Recursos do Ambiente de Trabalho](/core-concepts/workspace/editor-and-tools).
* Conheça as capacidades dos recursos movidos por IA do Replit em [Agente Replit](/pt/core-concepts/agent/).
* Aprenda a compartilhar suas criações em [Compartilhando seu Aplicativo Replit](/replit-app/collaborate/).
* [Baixe o aplicativo mobile](https://replit.com/mobile/) para dispositivos iOS ou Android.
