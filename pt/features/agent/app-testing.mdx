...
<Note>
  O App Testing faz parte das capacidades autônomas do Agent. Saiba mais sobre a [revisão de código](/pt/features/agent/agent-modes#code-review) e outros [recursos do Agent](/pt/features/agent/overview).
</Note>
...
Saiba mais sobre o [Replit Agent](/pt/features/agent/overview) e suas capacidades completas.
