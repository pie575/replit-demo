---
title: "Replit App Configuration"
description: "Learn how to configure your Replit app using .replit and replit.nix files."
...
| <a name="nix" />`[nix]`                         |                                        | Specifies settings for using Nix, a package manager, to manage system dependencies. Refer to [Dependency Management](/features/project-setup/dependency-management) document for more information. |
...
| <a name="REPLIT_DEV_DOMAIN" />`REPLIT_DEV_DOMAIN` | Provides the `replit.dev` URL for your Replit App in the Project Editor. Note that this environment variable is not available in Deployments                                         |
