...
description: "Подключите файлы и инструменты, чтобы предоставить Replit контекст, необходимый для создания плана открытия кофейни."
---
...
Теперь, когда вы узнали об интеграциях, примените их при запуске кофейни.

Вы решили открыть **кафе для местных жителей**, а не бар для пассажиров у станции. Предоставьте
Replit материалы, которые помогут превратить эту идею в осуществимый план.

Интеграции связывают Replit с инструментами и файлами, которыми вы уже пользуетесь. Благодаря этому
Replit может получать нужную информацию и выполнять необходимые действия.
Вы можете подключить более 450 сервисов, включая
**[Slack](/ru/ko/features/integrations/overview#connectors)**,
**[Google Drive](/ru/ko/features/integrations/overview#connectors)**,
**[Notion](/ru/ko/features/integrations/overview#connectors)** и
**[Salesforce](/ru/ko/features/integrations/overview#connectors)**.

Для кофейни Google Drive предоставляет Replit доступ к бюджету, заметкам о местоположении, идеям
для меню, фотографиям и визуальным референсам. Notion предоставляет пространство для документирования
плана запуска, принятых решений и нерешённых вопросов.

Подробнее о [интеграции инструментов](/ru/ko/chat/integrate-your-tools).

<Steps>
  <Step title="Попросите Replit собрать все материалы">
    Начните со следующего запроса. Replit определит, что нужно для подготовки плана,
    и при необходимости запросит подключение сервисов.

    <AiPrompt>
      Используя файлы моего кафе, составьте план запуска местной кофейни на первый месяц.
      Обновите соответствующие предположения, а затем задокументируйте в Notion концепцию, ключевые решения, открытые вопросы и
      контрольный список запуска.
    </AiPrompt>
  </Step>

  <Step title="Подключите Google Drive по запросу Replit">
    Разрешите подключение Google Drive, чтобы Replit мог просмотреть материалы,
    которые будет использовать. Запрос на подключение откроется прямо в Conversation.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit запрашивает подключение Google Drive для просмотра файлов кафе" />
  </Step>

  <Step title="Подключите Notion, когда Replit потребуется задокументировать план">
    Разрешите доступ к Notion, когда Replit будет создавать бриф запуска. Так вы сможете
    хранить концепцию, решения, открытые вопросы и контрольный список в одном месте.
  </Step>
</Steps>

Google Drive предоставляет Replit материалы, на которых основывается работа. Notion
помогает хранить в одном месте план, который развивается по мере появления
новых вопросов и принятия решений.

Подробнее о [добавлении контекста](/ru/ko/chat/add-context), [загрузке файлов](/ru/ko/chat/upload-and-use-files)
и [интеграции инструментов](/ru/ko/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ko/home/watch-the-competition">
    ...
    <p>Настройте Routine для отслеживания изменений во время подготовки к запуску.</p>
