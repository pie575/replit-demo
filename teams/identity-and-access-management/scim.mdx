---
title: "SCIM"
description: "Set up SCIM to automate provisioning from your identity provider, then manage how synced groups map to your Replit workspaces, roles, and account admins."
icon: "arrows-rotate"
---
...
<CardGroup cols={2}>
  <Card title="Automated member management" icon="user-plus">
...
<Frame>
  <img src="/assets/mirror/scim-workspace-access-overview-09bbb29aff91.png" alt="SCIM workspace access overview showing the Active SCIM card, the Account admin group block with the Engineering group designated, and the Workspaces tab listing workspaces with their group assignment chips." width="2342" height="1390" data-path="images/teams/identity-and-access-management/scim-workspace-access-overview.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/scim-workspace-access-account-admin-group-3bd9468f581a.png" alt="Account admin group dialog explaining that members of the selected IdP-synced group hold the account-admin role, with a radio list of synced groups (Engineering marked Current, plus others) and member counts." width="1674" height="2634" data-path="images/teams/identity-and-access-management/scim-workspace-access-account-admin-group.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/scim-workspace-access-edit-assignments-886c65f54221.png" alt="Edit workspace access dialog listing synced groups with checkboxes and per-group role selectors. The Engineering group is tagged as the account admin group with a locked Admin role, while the other groups show editable role selectors." width="1674" height="2154" data-path="images/teams/identity-and-access-management/scim-workspace-access-edit-assignments.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/scim-workspace-access-user-groups-31742064305d.png" alt="User groups tab showing a table of synced groups (Engineering, Marketing, Sales, Design, Product) with assigned-workspace role chips and a member-count column. The Engineering group carries an Account admin group label, and a 'Page 1 of 2' pager appears at the bottom." width="2342" height="1710" data-path="images/teams/identity-and-access-management/scim-workspace-access-user-groups.png" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Account and Workspace Admins" icon="user-shield" href="/teams/identity-and-access-management/account-and-workspace-admins">
    Learn what account admins and workspace admins can do
  </Card>

  <Card title="Viewer Seats" icon="eye" href="/teams/identity-and-access-management/viewer-seats">
