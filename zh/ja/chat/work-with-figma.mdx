---
title: "与 Figma 集成"
description: "如果你想将 Figma 画框作为视觉上下文，并在此基础上进行探索、优化和构建，请按照 Replit Design 的导入流程操作。"
sidebarTitle: "与 Figma 集成"
icon: "figma"
...
Replit 支持导入 Figma 画框。

如果你已确定视觉方向，并希望 Replit 以此为起点开始构建，或将其转换为设计，请导入 Figma 画框。

<div id="figma">
  ## Figma 的适用场景
</div>

* **探索不同方向：** 在保留核心层级结构的同时，尝试不同的风格和布局。
* **延续产品流程：** 将现有界面作为后续界面或状态的上下文。
* **将设计工作推进为应用：** 从已获批准的视觉方向出发，在此基础上迭代并构建应用。

<div id="figma-2">
  ## 导入 Figma 画框
</div>

选择要继续处理的内容所在的画框。Replit Design 会将导入的画框转换为设计画框，你可以在其中探索修改方案、比较建议，并决定下一步要构建什么。

<Frame caption="导入 Replit Design 并转换为设计画框的 Figma 画框。">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="导入 Replit Design 并转换为设计画框的 Personal Fitness Trainer 着陆页" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>
...
Design 指南涵盖从导入、优化到构建的完整工作流程。

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ja/design/import-figma-designs-into-replit-design">
