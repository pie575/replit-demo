...
description: "Learn about file storage and database options on Replit."
...
<CardGroup>
  <Card title="Database" href="/features/data-and-storage/sql-database" icon="database">
  ...
  <Card title="App Storage" href="/features/data-and-storage/object-storage" icon="bucket">
