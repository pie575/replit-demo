---
title: "Начать Conversation"
description: "Начните Conversation с простого вопроса, поиска в интернете или подключённого контекста, а затем выберите, что делать дальше."
---
...
Ваш Workspace готов. Самое время двигать идею кофейни дальше.
Начните [Conversation](/ru/pt/chat/conversations), расскажите Replit, что вы хотите
создать, и превратите первоначальную идею в реальный план запуска.

<div id="iniciar-uma-nova-conversa">
  ## Начало новой Conversation
</div>

Выберите **New** на боковой панели Replit. Откроется Conversation, в которой вы
проработаете концепцию, изучите рынок и спланируете запуск.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Главный экран Replit для workspace Demo с выделенной кнопкой New, предложенными prompts и полем ввода сообщения" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

<div id="explore-a-caixa-de-prompt">
  ## Изучите поле промпта
</div>

После выбора **New** присмотритесь к полю промпта. Именно здесь вы будете
задавать направление Replit, добавлять полезный контекст и продолжать запуск
кофейни. Следующий шаг — написать первый промпт.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Меню дополнительных опций поля промпта с возможностью отправить файл, создать что-то новое, импортировать проект, использовать skill или дизайн-систему и добавить интеграцию" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/pt/home/describe-your-idea">
    ...
    <div className="chat-card-title">Сформулируйте концепцию</div>
    <p>Напишите первый чёткий запрос для запуска сайта кофейни.</p>
