...
Vous aurez besoin d'un [compte Replit](https://replit.com) gratuit.

<Note>Ce guide de démarrage rapide utilise Agent, inclus dans le plan Starter gratuit avec des crédits quotidiens. Aucune carte de crédit requise.</Note>

## Bienvenue sur Replit

Lorsque vous ouvrez Replit, la première chose que vous voyez est votre **Éditeur de projet**, avec la zone de saisie au centre. C'est là que tout commence. Décrivez ce que vous souhaitez créer, et Agent s'en charge.

<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L'écran d'accueil de l'Éditeur de projet Replit affichant la zone de saisie où vous décrivez ce que vous souhaitez créer" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

## Créez votre application

<Steps>
  <Step title="Décrivez ce que vous souhaitez créer">
    Dans la zone de saisie sur l'écran d'accueil, décrivez ce que vous souhaitez créer. Soyez précis sur les fonctionnalités et le comportement — plus vous donnez de détails à Agent, meilleur sera le résultat.

    Pour ce guide de démarrage rapide, essayez quelque chose comme : *« Crée un piano réaliste à 16 touches avec la disposition correcte des touches blanches et noires. Chaque touche doit s'enfoncer avec une animation au clic et jouer la bonne note. »*

    Appuyez sur **Start** pour lancer la création. Agent configure votre projet et commence à écrire le code. Cela prend environ 3 à 5 minutes.

    <Tip>Vous pouvez créer n'importe quelle idée — une liste de tâches, une page d'accueil, une application de quiz. Les étapes suivantes fonctionnent de la même manière.</Tip>
  </Step>

  <Step title="Prévisualisez votre application">
    Lorsqu'Agent a terminé, accédez à l'onglet **Preview** pour voir votre application en action. Cliquez et interagissez avec elle pour vous assurer qu'elle fonctionne comme prévu.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-piano-demo-4b7f4ee0053a.mp4" />
    </Frame>

    <Note>Votre application peut être légèrement différente des captures d'écran — Agent peut générer des résultats variés à partir du même prompt.</Note>
  </Step>

  <Step title="Publiez votre application">
    Prêt à partager ? Cliquez sur **Publier** dans l'Éditeur de projet pour déployer votre application sur une URL publique accessible à tous.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-publish-app-ae59052ca92d.mp4" />
    </Frame>

    Votre application est maintenant en ligne. Copiez l'URL et partagez-la avec n'importe qui.
  </Step>
</Steps>

## Essayez maintenant

Prêt à créer ? Appuyez sur <StartButton /> pour ouvrir Replit avec le prompt du piano pré-rempli.

<AgentInput highlightStart defaultPrompt="Build a realistic 16-key piano with proper white and black key layout that looks exactly like a real piano. Each key should press down with realistic depth animation when clicked and play the correct note." showTypewriter={false} />

## Étapes suivantes

<CardGroup cols={2}>
  <Card title="Designer avec Canvas" icon="palette" href="/fr/getting-started/quickstarts/design-with-canvas">
    Explorez des variations de design et restylisez votre application visuellement.
  </Card>
  ...
  <Card title="Publiez votre application" icon="globe" href="/fr/getting-started/quickstarts/publish">
    Découvrez les domaines personnalisés, le partage et le fonctionnement de la publication.
  </Card>

  <Card title="Agent" icon="robot" href="/fr/core-concepts/agent">
    Explorez tout ce qu'Agent peut faire.
  </Card>
</CardGroup>
