---
title: "replit.md"
description: "Apprenez à utiliser replit.md pour personnaliser le comportement de l'Agent, son style de codage et le contexte du projet."
---
...
<Frame>
  <img src="/assets/mirror/replitmd-65360844a148.jpg" alt="L'Agent utilisant replit.md pour construire un projet" width="1920" height="1080" data-path="images/replitai/replitmd.jpg" />
</Frame>
...
3. L'Agent génèrera automatiquement un nouveau fichier `replit.md` basé sur votre projet actuel
...
Pour un guide plus détaillé sur le formatage des invites, consultez le [guide d'ingénierie des invites d'Anthropic](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/use-xml-tags).
...
2. **Itérez et améliorez** : Mettez à jour votre `replit.md` au fur et à mesure que vous travaillez avec l'Agent
3. **Partagez des modèles** : Utilisez des configurations `replit.md` réussies dans des projets similaires
4. **Surveillez l'efficacité** : Faites attention à la façon dont l'Agent suit vos directives et ajustez en conséquence

Apprenez-en plus sur le [travail avec l'Agent](/fr/features/agent/overview) ou explorez d'autres [outils d'IA](/fr/build/welcome).

**Entreprise** : Pré-configurez `replit.md` dans des [modèles personnalisés](/fr/teams/custom-templates) pour donner à chaque développeur de votre organisation un contexte de départ cohérent. Pour des conseils spécifiques au design, consultez [configuration d'un système de design](/fr/teams/custom-design-system).
