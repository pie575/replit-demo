---
title: "프롬프트 작성하기"
description: "Conversation에서 Replit에 명확한 방향을 제시하고, 유용한 후속 요청으로 결과를 다듬으세요."
sidebarTitle: "프롬프트 작성하기"
icon: "comment-dots"
...
Replit이 작업하는 동안 [후속 메시지를 조정하거나 대기열에 추가하는 방법](/ko/features/agent/steer-and-queue-messages)을 알아보세요.

요청이 명확해졌다면, Replit이 작업에 필요한 관련 정보와 도구를 갖추도록 [컨텍스트를 추가하는 방법](/ko/chat/add-context)을 알아보세요.
