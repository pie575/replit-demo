---
title: "Importe designs do Claude para o Replit Design"
description: "Envie um design do Claude para a Replit, crie um projeto a partir do HTML estático e deixe o Agent transformá-lo em um app interativo."
sidebarTitle: "Importar do Claude"
icon: "file-import"
---
...
<Frame>
  <img src="/assets/mirror/claude-design-canvas-fa8be1a1ea5a.png" alt="O design Velocity aberto no canvas de design do Claude, o design autocontido que você repassa para a Replit para transformar em um app interativo" width="2000" height="1143" data-path="images/claude-to-app/claude-design-canvas.png" />
</Frame>
...
<Steps>
  ...
  <Step title="Abra o menu Send to">
    ...
    <Frame>
      <img src="/assets/mirror/claude-send-to-menu-d4353906aea3.png" alt="O menu Send to… do Claude listando a Replit como destino ao lado do Claude Code" width="2000" height="1143" data-path="images/claude-to-app/claude-send-to-menu.png" />
    </Frame>
  </Step>
  ...
  <Step title="Autorize o acesso da Replit">
    ...
    <Frame>
      <img src="/assets/mirror/replit-oidc-consent-76dfc4d92a2f.png" alt="A tela de consentimento da Replit intitulada Claude would like to access your Replit account, mostrando os escopos Access apps, Create and manage apps e Stay signed in com um seletor de workspace" width="2000" height="1143" data-path="images/claude-to-app/replit-oidc-consent.png" />
    </Frame>
  </Step>
...
<Frame caption="O design Velocity do Claude como um frame no Replit Design, com a execução do Agent concluída.">
  <img src="/assets/mirror/claude-design-in-replit-design-ff81b055b1f5.webp" alt="O design de aluguel de supercarros Velocity enviado do Claude, aberto como um frame de design do Claude no Replit Design com a tarefa do Agent marcada como concluída no painel de chat" width="1600" height="1004" data-path="images/claude-to-app/claude-design-in-replit-design.webp" />
</Frame>
