...
description: "Scan your workspace's projects for vulnerabilities, view CVE details by severity, fix issues with Agent, and export SBOMs for compliance."
...
<Frame>
  <img src="/assets/mirror/dependency-vulnerabilities-table-1a6ca7375b9f.png" alt="The Dependency vulnerabilities table in the Workspace Security Center listing CVE ID, severity, package, and version for each finding" width="3438" height="1984" data-path="images/workspace-security-center/dependency-vulnerabilities-table.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/cve-affected-projects-89f807e09c87.png" alt="An expanded CVE row in the Workspace Security Center revealing the workspace projects affected by the vulnerability" width="3438" height="1984" data-path="images/workspace-security-center/cve-affected-projects.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/home-nav-security-d50562142845.png" alt="The Replit home page with Security highlighted in the left navigation" width="1440" height="900" data-path="images/workspace-security-center/home-nav-security.png" />
</Frame>
