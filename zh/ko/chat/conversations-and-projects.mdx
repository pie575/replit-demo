---
title: "Conversations 与 Projects 的比较"
description: "了解何时继续使用 Conversation，何时将较大的工作转为 Project。"
sidebarTitle: "Conversations 与 Projects 的比较"
tag: "New"
icon: "objects-column"
...
使用 Replit 时，您可以在 Conversation 中开展工作，也可以构建 Project。Conversations 用于提问、探索、后续工作和 Routines。Projects 用于构建应用、创建幻灯片和设计。

[了解如何将 Conversation 转为 Project。](/zh/ko/chat/continue-or-create-a-project)

<div id="section">
  ## 差异
</div>

Conversations 和 Projects 虽然相互关联，但用途不同。具体区别如下：

| 领域         | Conversations  | Projects                                                                    |
| ---------- | -------------- | --------------------------------------------------------------------------- |
| 适用场景       | 提问、探索、Routines | 应用、幻灯片、仪表板等需要更深入构建和设计的工作，以及多个工件                                             |
| 结构         | 单个会话           | 包含多个工件的 Project 工作区                                                         |
| 后台任务       | 不支持            | 可并行运行                                                                       |
| Routines   | 支持             | 不支持                                                                         |
| 集成         | 支持             | 支持                                                                          |
| 可创建内容      | 文档、图片、表格等资源    | 文档、图片、表格等资源，以及幻灯片、应用、网站等[工件](/zh/ko/features/projects-and-artifacts/artifacts) |
| Publishing | 不支持发布          | 可发布并公开                                                                      |

<Frame>
  <img src="/assets/mirror/conversation-and-project-icons-025a17613daa.png" alt="显示 Conversation 聊天图标和 Project 网格图标的 Replit 侧边栏" width="466" height="290" data-path="images/chat/conversation-and-project-icons.png" />
</Frame>