...
description: "Apprenez à installer et gérer les packages et dépendances pour votre Replit App dans différents langages."
---

Replit propose plusieurs façons d'installer et de gérer les packages pour votre Replit App. Vous pouvez installer des packages via le [Shell](/fr/references/editor/shell), demander à [Agent](/fr/features/agent/overview/) de le faire pour vous, ou laisser Replit détecter et installer automatiquement les dépendances manquantes lorsque vous exécutez votre Replit App.
...
Vous pouvez demander à [Agent](/fr/features/agent/overview/) d'installer des packages directement dans le chat. Par exemple :
...
<Note>
  Vous pouvez configurer la détection automatique des imports dans le fichier [.replit](/fr/references/configuration/configuration#replit-file) en utilisant le paramètre `packager.features.guessImports`.
</Note>
...
Vous pouvez également exclure des packages ou des chemins spécifiques de la détection automatique dans votre fichier [.replit](/fr/references/configuration/configuration#replit-file) :
...
Vous pouvez personnaliser les modules et d'autres paramètres Nix en utilisant le fichier [.replit](/fr/references/configuration/configuration#replit-file).

## Configuration du gestionnaire de packages

Vous pouvez affiner le comportement de gestion des packages dans votre fichier [.replit](/fr/references/configuration/configuration#replit-file) :
