...
description: "Aprenda como rastrear alterações e gerenciar o histórico do seu código com as ferramentas de controle de versão do Replit."
...
1. **Checkpoints do Agent** criam commits automaticamente em marcos importantes ao construir com o [Replit Agent](/pt/features/agent/overview). [Saiba mais sobre checkpoints e rollbacks](/pt/features/version-control/checkpoints-and-rollbacks).
...
Para importar projetos existentes do GitHub, veja [Importar do GitHub](/pt/build/import-from-providers).
...
<Frame>
  <img src="/assets/mirror/git-pane-eb74a42fd963.jpg" alt="Painel Git mostrando o botão de inicializar repositório" width="1920" height="1080" data-path="images/workspace/git-pane.jpg" />
</Frame>

### Controle de versão automático

<Accordion title="Checkpoints do Agent">
  Instantâneos automáticos criados durante o desenvolvimento assistido por IA com o [Replit Agent](/pt/features/agent/overview).

  **Ideal para**: Desenvolvimento com o Replit Agent
...
<Accordion title="Histórico de arquivos">
  Rastreamento de versão por arquivo com salvamento automático para alterações não realizadas pelo Agent feitas diretamente no editor.

  **Ideal para**: Recuperação rápida de alterações recentes em arquivos
  ...
  * Recurso de reprodução
  ...
  Embora o Histórico de Arquivos forneça sua própria interface, as alterações subjacentes fazem parte do histórico do Git. Saiba mais sobre [Histórico de Arquivos](/pt/features/version-control/file-history).
</Accordion>

### Interfaces baseadas em Git

<Accordion title="Painel Git">
  Uma interface visual para operações Git que torna o controle de versão acessível sem conhecimento de linha de comando.

  **Ideal para**: A maioria dos projetos que requerem integração com GitHub e fluxo de trabalho visual
  ...
  * Colaboração em equipe
  ...
  Para instruções detalhadas sobre como usar o painel Git, veja [Usando o painel Git](/pt/features/workspace-tools/git-interface).
</Accordion>

<Accordion title="Git CLI">
  Acesso completo por linha de comando ao Git através do [Shell](/pt/features/workspace-tools/shell) para operações avançadas.

  **Ideal para**: Usuários avançados que precisam de funcionalidade Git completa
  ...
  * Controle completo do repositório
  ...
  Para comandos Git comuns e uso, veja [Usando o painel Git](/pt/features/workspace-tools/git-interface#using-git-commands-in-shell).
</Accordion>
...
* **Importar do GitHub**: Transforme qualquer [repositório GitHub em um Replit App](/pt/build/import-from-providers) com alguns cliques
...
Acompanhe as alterações no seu código à medida que desenvolve, permitindo reverter para versões anteriores se necessário. O [painel Git](/pt/features/workspace-tools/git-interface) mostra suas alterações visualmente, facilitando o commit de atualizações significativas.

**Colaborando com uma equipe**

Trabalhe com múltiplos desenvolvedores no mesmo código sem sobrescrever as alterações uns dos outros. Crie branches para novos recursos e depois mescle-os quando estiverem prontos. Saiba mais sobre [convidar colegas](/pt/build/invite-teammates).
...
<Info>
  Para informações detalhadas sobre o que os checkpoints capturam e capacidades abrangentes de rollback, veja [Checkpoints e Rollbacks](/pt/features/version-control/checkpoints-and-rollbacks).
</Info>
...
* [Usando o painel Git](/pt/features/workspace-tools/git-interface): Domine a interface Git visual do Replit
* [Importar do GitHub](/pt/build/import-from-providers): Transforme repositórios GitHub em Replit Apps
* [Convidar colegas](/pt/build/invite-teammates): Trabalhe com outros em projetos compartilhados
* [Histórico de Arquivos](/pt/features/version-control/file-history): Explore o histórico de versões no nível de arquivo
* [Replit Agent](/pt/features/agent/overview): Saiba mais sobre desenvolvimento assistido por IA
