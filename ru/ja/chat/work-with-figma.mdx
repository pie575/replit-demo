...
description: "Чтобы использовать фреймы Figma как визуальный контекст для изучения, доработки и создания, следуйте инструкции по импорту в Replit Design."
...
Если вы уже определились с визуальным направлением и хотите, чтобы Replit начал с него работу или преобразовал его в дизайн, импортируйте фрейм из Figma.

<div id="figma">
  ## Когда Figma особенно полезна
</div>

* **Поиск альтернативного направления:** Сохраняйте основную иерархию, пробуя другие стили и раскладки.
* **Продолжение пользовательского сценария:** Используйте существующие экраны как контекст для следующих экранов или состояний.
* **Переход от дизайна к App:** Начните с утверждённого визуального направления, а затем развивайте и создавайте App.

<div id="figma-2">
  ## Импорт фрейма из Figma
</div>

Выберите фрейм, с которым хотите продолжить работу. Replit Design преобразует импортированный фрейм в дизайн-фрейм, где можно вносить изменения, сравнивать предложения и решать, что создавать дальше.
...
<div id="design">
  ## Продолжайте в Design
</div>

В руководстве по Design описан весь рабочий процесс: от импорта и доработки до создания приложения.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ja/design/import-figma-designs-into-replit-design">
