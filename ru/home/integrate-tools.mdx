...
description: "Подключите файлы и инструменты, которые помогут Replit создать план запуска кофейни."
...
Теперь, когда вы узнали об интеграциях, примените их для запуска
кофейни.

Вы выбрали направление: открыть **кафе для жителей района**, а не бар у станции
для спешащих пассажиров. Предоставьте Replit материалы, необходимые, чтобы превратить это направление в
план действий.

Интеграции подключают Replit к инструментам и файлам, которыми вы уже пользуетесь. Они позволяют
Replit получать нужную информацию или выполнять действия, необходимые для задачи.
Вы можете подключить такие сервисы, как **[Slack](/ru/features/integrations/overview#connectors)**,
**[Google Drive](/ru/features/integrations/overview#connectors)**,
**[Notion](/ru/features/integrations/overview#connectors)** или
**[Salesforce](/ru/features/integrations/overview#connectors)**, а также более
450 других сервисов.

Для кофейни Google Drive предоставляет Replit доступ к бюджету, заметкам о локации,
идеям меню, фотографиям и визуальным референсам. Notion позволяет
документировать план запуска, решения и открытые вопросы.

Узнайте больше об [интеграции ваших инструментов](/ru/chat/integrate-your-tools).

<Steps>
  <Step title="Попросите Replit собрать материалы">
    Начните с приведённого ниже запроса. Replit проверит, что ему нужно для выполнения
    плана, и попросит вас подключить сервис, когда ему потребуется доступ.

    <AiPrompt>
      Используй мои файлы о кафе, чтобы создать план запуска районного кафе на первый
      месяц. Обнови соответствующие допущения, затем задокументируй концепцию, ключевые
      решения, открытые вопросы и контрольный список запуска в Notion.
    </AiPrompt>
  </Step>

  <Step title="Подключите Google Drive, когда Replit попросит">
    Подтвердите подключение Google Drive, чтобы Replit мог изучить материалы,
    которые вы хотите использовать. Он откроет запрос на подключение прямо в
    Conversation.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit просит подключить Google Drive, чтобы изучить файлы о кафе" />
  </Step>

  <Step title="Подключите Notion, когда Replit понадобится задокументировать план">
    Подтвердите подключение Notion, когда Replit попросит создать описание запуска. После этого он сможет
    собрать концепцию, решения, открытые вопросы и контрольный список в одном месте.
  </Step>
</Steps>

Google Drive предоставляет Replit материалы, на которые он может опираться. Notion хранит развивающийся план
в одном месте, пока вы отвечаете на новые вопросы и принимаете решения.

Подробнее о [добавлении контекста](/ru/chat/add-context), [загрузке файлов](/ru/chat/upload-and-use-files) и [интеграции ваших инструментов](/ru/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/home/watch-the-competition">
    ...
    <div className="chat-card-title">Следите за конкурентами</div>
    <p>Настройте Routine для отслеживания изменений, пока готовитесь к запуску.</p>
