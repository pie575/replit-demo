...
description: "Saiba mais sobre as opções de armazenamento de arquivos e bancos de dados no Replit."
---
...
* **Banco de Dados**: armazena dados estruturados como perfis de usuários, pontuações de jogos e catálogos de produtos.
  Você pode armazenar ou recuperar dados por atributos e relacionamentos entre pontos de dados.

* **App Storage**: armazena dados não estruturados como imagens, vídeos e documentos.
...
Saiba mais sobre as seguintes ferramentas do Replit para configurar e gerenciar o armazenamento de dados do seu aplicativo:
...
A maneira mais rápida de começar com as soluções de armazenamento do Replit é seguir um dos tutoriais abaixo:

<CardGroup cols={3}>
  <Card title="Banco de Dados" href="/getting-started/quickstarts/database-connection/" icon="database">
    Conecte seu aplicativo a um banco de dados SQL
  </Card>

  <Card title="App Storage em Python" href="/getting-started/quickstarts/object-storage-python/" icon="python">
    Gerencie o App Storage usando o SDK Python do Replit
  </Card>

  <Card title="App Storage em JavaScript" href="/getting-started/quickstarts/object-storage-javascript/" icon="js">
...
Os exemplos a seguir mostram como as ferramentas de banco de dados e armazenamento de objetos podem dar suporte aos seus Replit Apps.
...
* [Banco de Dados](/pt/features/data-and-storage/sql-database/): Saiba mais sobre a ferramenta de Banco de Dados do Replit e como conectar seu Replit App a um banco de dados
* [App Storage](/pt/features/data-and-storage/object-storage/): Saiba como usar a solução de App Storage do Replit
