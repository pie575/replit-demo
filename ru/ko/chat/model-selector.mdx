---
title: "Выбор модели"
description: "Если в вашем режиме и тарифе доступен ручной выбор модели, выберите нужную модель и задайте уровень усилий."
...
<div className="chat-mkt" role="img" aria-label="Логотипы Anthropic, OpenAI и Qimi для выбора модели" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
...
Интеллектуальная маршрутизация моделей позволяет Replit самому подобрать модель под задачу. Чтобы выбрать её вручную, в поле запроса выберите **Agent Mode**, затем **Power** или **Max**, после чего укажите модель в разделе **Primary model**.

Free Mode всегда использует интеллектуальную маршрутизацию моделей. Разработчики на планах Core и Pro могут выбирать доступные модели в Power Mode или Max Mode. Набор доступных моделей может меняться, поэтому ориентируйтесь на список моделей Replit для вашей учётной записи.

<Frame caption="Элементы управления Model и уровнем усилий в меню настроек Agent.">
  <img src="/assets/mirror/model-selector-gpt-5-6-sol-effort-8e4d256bf497.jpg" alt="Выбор модели в демонстрационном рабочем пространстве: в Max Mode выбрана GPT-5.6 Sol, а уровень усилий установлен на Medium" width="1821" height="864" data-path="images/chat/model-selector-gpt-5-6-sol-effort.jpg" />
</Frame>

<div id="effort">
  ## Настройка уровня усилий модели
</div>

Уровень усилий определяет, сколько ресурсов на рассуждения выбранная модель задействует при формировании ответа. Это не отдельный режим, а настройка для конкретной модели. Поддерживаемые уровни — от **Low** до **Max**; для каждой модели отображается рекомендуемая настройка.

Выбирайте более высокий уровень усилий только для задач, требующих более глубоких рассуждений. При выполнении сложных задач более высокие настройки могут требовать больше времени и обходиться дороже.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ko/features/agent/model-selector">
    ...
    <div className="chat-card-title">Справочник по выбору модели</div>
    <p>Узнайте про интеллектуальную маршрутизацию моделей, доступные модели, уровни усилий и Compare models.</p>
    <div className="chat-card-link">Открыть справочник →</div>
  </a>

  <a className="chat-example has-visual" href="/ru/ko/features/agent/model-selector#effort">
    ...
    <div className="chat-card-title">Подробнее об уровнях усилий</div>
    <p>Сравните Low, Medium, High, Extra High и Max.</p>
    <div className="chat-card-link">Посмотреть уровни усилий →</div>
  </a>
</section>

Выбор модели и уровня усилий определяет, как Replit отвечает на запросы. А [Voice Mode](/ru/ko/chat/voice-mode) меняет сам способ передачи запроса: можно говорить вместо того, чтобы печатать.