---
title: "Создайте первое приложение"
description: "Создайте и опубликуйте первое приложение с помощью Replit Agent за несколько минут."
---
...
Вам понадобится [бесплатная учётная запись Replit](https://replit.com).

<Note>В этом кратком руководстве используется Agent, включённый в бесплатный тариф Starter с ежедневными кредитами. Банковская карта не требуется.</Note>

<div id="bem-vindo-ao-replit">
  ## Добро пожаловать в Replit
</div>

При открытии Replit вы сначала увидите **редактор проекта** с полем для промпта в центре. Здесь всё начинается. Опишите, что вы хотите создать, — Agent сделает всё остальное.

<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="Главный экран редактора проекта Replit с полем для промпта, где вы описываете, что хотите создать" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>
...
<Steps>
  <Step title="Опишите, что хотите создать">
    В поле промпта на главном экране опишите, что хотите создать. Подробно укажите нужные функции и поведение приложения — чем больше деталей вы сообщите Agent, тем лучше будет результат.

    Для этого краткого руководства попробуйте такой вариант: *&quot;Создай реалистичное пианино с 16 клавишами и правильным расположением белых и чёрных клавиш. При нажатии каждая клавиша должна анимированно опускаться и воспроизводить нужную ноту.&quot;*

    Нажмите **Iniciar**, чтобы начать создание. Agent настроит проект и начнёт писать код. Это займёт примерно 3–5 минут.

    <Tip>Вы можете создать что угодно: список задач, лендинг или приложение-викторину. Остальные шаги будут такими же.</Tip>
  </Step>

  <Step title="Просмотрите приложение">
    Когда Agent завершит работу, перейдите на вкладку **Visualização**, чтобы увидеть приложение в действии. Нажимайте на элементы и взаимодействуйте с приложением, чтобы убедиться, что всё работает как ожидается.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-piano-demo-4b7f4ee0053a.mp4" />
    </Frame>

    <Note>Ваше приложение может немного отличаться от снимков экрана — Agent может выдавать разные результаты для одного и того же промпта.</Note>
  </Step>

  <Step title="Опубликуйте приложение">
    Готовы поделиться? Нажмите **Publicar** в редакторе проекта, чтобы развернуть приложение по общедоступному URL-адресу, который сможет открыть любой пользователь.

    <Frame>
      <video autoPlay muted loop playsInline src="/assets/mirror/quickstart-publish-app-ae59052ca92d.mp4" />
    </Frame>

    Теперь ваше приложение доступно в интернете. Скопируйте URL-адрес и поделитесь им с кем захотите.
  </Step>
</Steps>
...
Готовы создавать? Нажмите <StartButton />, чтобы открыть Replit с уже заполненным промптом для пианино.

<AgentInput highlightStart defaultPrompt="Создайте реалистичное пианино с 16 клавишами и правильным расположением белых и чёрных клавиш, которое выглядит в точности как настоящее пианино. При нажатии каждая клавиша должна опускаться с реалистичной анимацией глубины и воспроизводить правильную ноту." showTypewriter={false} />
...
<CardGroup cols={2}>
  <Card title="Создайте дизайн в Canvas" icon="palette" href="/ru/pt/getting-started/quickstarts/design-with-canvas">
    Изучайте варианты дизайна и визуально дорабатывайте приложение.
  </Card>

  <Card title="Расширьте свой проект" icon="layer-group" href="/ru/pt/getting-started/quickstarts/expand-your-project">
    Добавьте в свой проект мобильное приложение, презентацию или другие артефакты.
  </Card>

  <Card title="Опубликуйте приложение" icon="globe" href="/ru/pt/getting-started/quickstarts/publish">
    Узнайте больше о пользовательских доменах, предоставлении доступа и публикации.
  </Card>

  <Card title="Agent" icon="robot" href="/ru/pt/core-concepts/agent">
    Узнайте обо всём, что может делать Agent.
  </Card>
</CardGroup>