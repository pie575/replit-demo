...
description: "Invitez des membres de l’équipe à votre projet et créez ensemble : chacun peut travailler sur le même projet avec son propre Agent et de nouveaux fils de discussion."
---
...
<div id="section">
  ## Développer avec les membres de votre équipe
</div>

Dans Replit, plusieurs personnes peuvent travailler simultanément sur le même projet. Chacun peut lancer Agent et un nouveau fil de discussion, et le travail de chacun s’affiche sur un tableau partagé : votre équipe peut ainsi développer ensemble plutôt que de travailler à tour de rôle.

<div id="section-2">
  ## Commencer à créer avec les membres de votre équipe
</div>
...
3. Les membres de l’équipe rejoignent le projet et lancent un nouveau fil de discussion avec Agent
...
Chacun peut créer son propre fil de discussion et travailler de façon indépendante, sans gêner les autres. Le travail de chacun apparaît sur le tableau Kanban partagé : vous voyez facilement qui fait quoi et vous évitez les chevauchements.

<Note>
  Avec Core, une seule tâche en arrière-plan peut s&#39;exécuter à la fois sur l&#39;ensemble du projet. Avec Pro, vous pouvez exécuter jusqu&#39;à 10 tâches en parallèle, ce qui permet à plusieurs personnes de demander simultanément à Agent de développer différentes parties du projet.
</Note>

<div id="section-5">
  ## Tableau des tâches partagé
</div>

Lorsque votre équipe travaille ensemble, le travail de chacun apparaît sur le même tableau. Vous pouvez voir en un coup d’œil qui fait quoi, ce qui est en cours et ce qui est prêt à être appliqué.

<Frame>
  <img src="/assets/mirror/task-board-progress-f4d3b5e7e93e.png" alt="Tableau des tâches avec les colonnes Brouillons, En cours, Prêt et Terminé" width="3456" height="1984" data-path="images/replitai/task-board-progress.png" />
</Frame>
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px', margin: '20px 0' }}>
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    <TaskCard title="Ajouter une option cadeau pour la famille et les amis" description="Permettez aux parents de créer une histoire pour l'enfant de quelqu'un d'autre et de l'envoyer en cadeau." status="draft-static" timestamp="2m" width="100%" />
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    <TaskCard title="Suites d'histoires — continuations" description="L'ajout d'un bouton « Continuer l'aventure » génère une suite qui reprend là où la précédente s'est arrêtée." status="active" timestamp="12m" width="100%" />

    <span style={{ fontSize: '13px', color: 'var(--kb-text-dimmer, #666)', padding: '0 4px' }}><strong>En cours</strong> — Agent développe actuellement cette tâche dans une copie isolée du projet.</span>
  </div>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    <TaskCard title="Lecture à voix haute avec mise en évidence des mots" description="La synthèse vocale permet aux enfants de profiter des histoires de façon autonome tout en suivant les mots mis en évidence." status="done" timestamp="4h" width="100%" />
...
<div id="section-6">
  ### Comment les Teams utilisent le tableau
</div>

Lorsque plusieurs personnes développent simultanément, leur travail apparaît sur le tableau partagé. Un membre de l’équipe travaille sur les suites et la régénération d’histoires, un autre sur le flux de cadeaux, tandis que les tâches terminées des autres membres apparaissent dans Prêt et Terminé.
...
{ title: 'Régénération d’histoires — refaire des pages', description: 'La possibilité de régénérer des pages individuelles donne davantage de contrôle aux parents et réduit leur frustration.', status: 'active', timestamp: '8m' },
{ title: 'Ajouter un flux de cadeaux pour la famille et les amis', description: 'Permet aux parents de créer une histoire pour l’enfant de quelqu’un d’autre et de l’envoyer en cadeau.', status: 'active-queued', timestamp: '1m' },
] },
{ title: 'Prêt', count: 2, cards: [
{ title: 'Mode lecture du soir avec thème sombre', description: 'Un mode dédié à la lecture du soir avec un thème sombre aux tons chauds et des sons d’ambiance.', status: 'ready-drop', timestamp: '35m', showMenu: true },
{ title: 'Liens d’histoires partageables avec aperçus OG', description: 'L’ajout de liens publics partageables est le principal levier de croissance.', status: 'ready-drop', timestamp: '31m', showMenu: true },
] },
{ title: 'Terminé', count: 3, cards: [
{ title: 'Mode lecture à voix haute avec surlignage des mots', description: 'La synthèse vocale permet aux enfants de profiter des histoires en toute autonomie.', status: 'done', timestamp: '4h' },
...
{ title: 'Compatibilité mobile et finitions pour la production', description: 'De meilleurs états d’erreur, mises en page mobiles et animations de chargement.', status: 'done', timestamp: '4h' },
] }
]}
/>

Lorsqu’une tâche passe à Prêt, n’importe quel membre de l’équipe peut examiner et appliquer les modifications. Lorsque plusieurs modifications sont appliquées, Agent gère automatiquement les conflits.

<div id="section-7">
  ## Ce que vous pouvez créer ensemble
</div>

* **Répartir les fonctionnalités au sein de l&#39;équipe** : une personne développe le frontend via le chat avec Agent pendant qu&#39;une autre s&#39;occupe du backend. Le tableau Kanban garde tout le monde aligné.
* **Intégrer les nouveaux membres de l&#39;équipe** : ils peuvent explorer le projet depuis leur propre chat Agent, poser des questions sur son fonctionnement et commencer à contribuer sans bloquer les autres.
* **Lancer plus vite avec Pro** : l&#39;exécution parallèle permet d&#39;attribuer à deux ou trois personnes des tâches qui s&#39;exécutent simultanément. Un projet qui occuperait une personne pendant toute une session peut ainsi être bouclé en bien moins de temps.

<div id="section-8">
  ## Questions fréquentes
</div>

<Accordion title="Puis-je envoyer des messages aux membres de mon équipe via Agent ?">
  Non. Agent n&#39;est pas un outil de messagerie — il est constamment à l&#39;écoute et tente de réagir à tout ce que vous saisissez. Pour la communication d&#39;équipe, utilisez Slack, Discord ou un autre outil.
</Accordion>

<Accordion title="Pouvons-nous écraser le travail des autres ?">
  Le système de tâches aide à l&#39;éviter en attribuant à chaque tâche une copie isolée, tout en tenant compte des autres tâches en cours. Une fois une tâche terminée, vous la réappliquez à la version principale et résolvez les conflits à ce moment-là.
</Accordion>

<Accordion title="Comment savoir ce que font les membres de mon équipe ?">
  Consultez les tâches actives sur le tableau Kanban. Vous pouvez également voir la présence des curseurs et les fichiers que les membres de votre équipe consultent.
</Accordion>

<Accordion title="Puis-je retirer quelqu'un d'un projet ?">
  Oui. Les propriétaires de projet peuvent gérer les membres de l&#39;équipe et révoquer les accès à tout moment.
</Accordion>
