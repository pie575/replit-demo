...
<div className="chat-mkt" role="img" aria-label="Microphone representing Voice Mode" style={{ margin: "28px 0 42px", borderTop: 0, paddingTop: 0 }}>
...
For availability and complete behavior, see the [Voice Mode feature reference](/features/agent/voice-mode). Next, learn how [Skills](/chat/agent-skills) give Replit reusable instructions and supporting material.
