...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <p>Transformez les idées, le travail quotidien et l'intelligence en résultats utiles.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/fr/home/get-started">Commencer <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/use-cases">Explorer les cas d'usage</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Parcours Replit guidé">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Site d'ouverture d'un café avec le titre « A quiet place for the everyday »" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Découvrez comment transformer votre idée en site en ligne
      </div>

      <p>
        Suivez un parcours guidé depuis votre première conversation jusqu'à la
        recherche, la planification, le design et la publication.
      </p>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    <h2 className="welcome-section-heading" id="welcome-use-cases-heading">
      Que peut faire Replit pour vous ?
    </h2>
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Préparez-vous pour un appel client
          </div>

          <p>Obtenez un brief ciblé avant chaque réunion client.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Repérez les conversations importantes et orientez-les rapidement.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Transformez les données de pipeline actuelles en un point de vente clair.</p>
        </div>
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/use-cases">
        Explorer les cas d'usage <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      ...
      <a className="welcome-product-card" href="/fr/build/your-first-app">
        ...
        <p>
          Transformez des idées en véritables applications et sites. Construisez,
          itérez et publiez en toute confiance.
        </p>

        <div className="welcome-product-link">
          Commencer à construire <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/fr/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Une composition de canvas sélectionnée représentant Replit Design">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Créez de belles interfaces et du contenu. Itérez sur les mises en page,
          les composants et les expériences.
        </p>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      ...
      <p>Choisissez où vous voulez utiliser Replit, puis connectez-vous ou créez un compte. Commencez sur le web, sur Desktop App ou sur Mobile App.</p>
    </div>
