---
title: "开始对话"
description: "通过简单提问、网络搜索或已连接的上下文开启对话，然后选择下一步操作。"
---
...
工作区已准备就绪。现在就让我们把您的咖啡店创意付诸实践。
开始使用[会话](/zh/ja/chat/conversations)，告诉 Replit 您想创建什么，将最初的想法
转化为切实可行的发布计划。
...
在 Replit 侧边栏中选择 **New**。这会打开一个 对话，帮助你构思创意、研究市场并规划发布。

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Demo 工作区中的 Replit 主页，突出显示 New 按钮，并显示建议提示词和消息框" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>
...
选择 **New** 后，看看提示词框。在这里告诉 Replit 你的想法，
添加有用的上下文，并推进咖啡店的上线。接下来，
编写第一条提示词。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示词框的加号菜单，显示上传文件、新建、导入项目、使用技能或设计系统以及添加集成等选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/ja/home/describe-your-idea">
    ...
    <div className="chat-card-title">将想法变为现实</div>
    <p>为即将开业的咖啡店撰写一条具体的初始请求。</p>
