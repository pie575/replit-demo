...
description: "Review, start, and bulk manage Agent follow-up task suggestions after a task finishes."
sidebarTitle: "Follow-up tasks"
...
<Frame>
  <img src="/assets/mirror/follow-up-tasks-dialog-c1660cec2d1d.png" alt="Suggested next tasks dialog showing a follow-up task with a Start button and a link to view more tasks in the task board" width="495" height="290" data-path="images/agent/follow-up-tasks-dialog.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/follow-up-tasks-kanban-21087e0210b6.png" alt="Task board showing many follow-up task suggestions under Suggested in the Drafts column" width="980" height="627" data-path="images/agent/follow-up-tasks-kanban.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/follow-up-tasks-kanban-edit-mode-a3909563a1c0.png" alt="Task board edit mode showing selected follow-up task suggestions with bulk Start and Cancel actions" width="980" height="627" data-path="images/agent/follow-up-tasks-kanban-edit-mode.png" />
</Frame>
