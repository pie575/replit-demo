...
description: "Connectez les fichiers et outils qui fournissent à Replit le contexte nécessaire pour élaborer un plan de lancement pour un café."
---
...
Maintenant que vous connaissez les intégrations, voyons comment les utiliser pour le lancement d&#39;un café.

Vous avez décidé de créer un **café de quartier** plutôt qu&#39;un bar pour navetteurs près d&#39;une gare. Donnez à Replit les ressources nécessaires pour transformer cette orientation en plan concret.

Les intégrations connectent Replit aux outils et fichiers que vous utilisez déjà. Elles permettent à
Replit d&#39;importer des informations pertinentes ou d&#39;effectuer les actions nécessaires à votre travail.
Vous pouvez connecter plus de 450 autres services, notamment
**[Slack](/fr/ko/features/integrations/overview#connectors)**,
**[Google Drive](/fr/ko/features/integrations/overview#connectors)**,
**[Notion](/fr/ko/features/integrations/overview#connectors)** ou
**[Salesforce](/fr/ko/features/integrations/overview#connectors)**.

Pour votre café, Google Drive permet à Replit d&#39;accéder aux budgets, aux notes sur les emplacements, aux idées de menu,
aux photos et aux références visuelles. Notion offre un espace pour documenter le plan de lancement,
les décisions et les questions en suspens.

Découvrez comment [intégrer vos outils](/fr/ko/chat/integrate-your-tools).

<Steps>
  <Step title="Demander à Replit de rassembler les ressources">
    Commencez par la demande ci-dessous. Replit détermine ce dont il a besoin
    pour finaliser le plan et demande à connecter des services lorsqu’il a besoin d’un accès.

    <AiPrompt>
      Utilisez les fichiers de mon café pour élaborer un plan de lancement du premier mois pour un café de quartier.
      Mettez à jour les hypothèses pertinentes, puis documentez le concept, les décisions clés, les questions en suspens et la
      liste de contrôle du lancement dans Notion.
    </AiPrompt>
  </Step>

  <Step title="Connecter Google Drive lorsque Replit le demande">
    Autorisez la connexion à Google Drive afin que Replit puisse examiner les ressources à utiliser.
    La demande de connexion s’ouvre directement dans Conversation.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit demande à connecter Google Drive afin d’examiner les fichiers du café" />
  </Step>

  <Step title="Connecter Notion lorsque Replit doit documenter le plan">
    Autorisez Notion lorsque Replit est prêt à créer le brief de lancement. Vous pourrez ainsi consigner le concept,
    les décisions, les questions en suspens et la liste de contrôle en un seul endroit.
  </Step>
</Steps>

Google Drive fournit à Replit les ressources sur lesquelles s’appuie son travail. Notion permet de
conserver en un seul endroit un plan qui évolue à mesure que vous répondez à de nouvelles questions et prenez
des décisions.

Découvrez comment [ajouter du contexte](/fr/ko/chat/add-context), [téléverser des fichiers](/fr/ko/chat/upload-and-use-files)
et [intégrer vos outils](/fr/ko/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/ko/home/watch-the-competition">
    ...
    <div className="chat-card-title">Surveiller la concurrence</div>
    <p>Configurez une Routine pour suivre les évolutions pendant la préparation de votre lancement.</p>
