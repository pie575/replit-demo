...
description: "Используйте фреймы Figma как визуальный контекст, а когда захотите изучить их, доработать или создать на их основе приложение, воспользуйтесь импортом в Replit Design."
...
Импортируйте фреймы Figma, если у вас уже есть визуальное направление и вы хотите, чтобы Replit
взял его за основу или преобразовал в дизайн.

<div id="figma">
  ## Когда Figma полезна
</div>

* **Поиск других направлений:** попробуйте другие стили или макеты, сохранив основную структуру.
* **Продолжение продуктового флоу:** используйте готовые экраны как контекст для следующих экранов или состояний.
* **Превращение дизайна в App:** начните с утвержденного визуального направления, а затем доработайте его и
  создайте.
...
Выберите фрейм, с которым хотите продолжить работу. Replit Design преобразует импортированный фрейм в дизайн-фрейм, чтобы вы могли пробовать изменения, сравнивать Suggestions и решать, что создавать дальше.

<Frame caption="Фрейм Figma, импортированный в Replit Design как дизайн-фрейм.">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="Импортированная лендинговая страница Personal Fitness Trainer, отображаемая как дизайн-фрейм в Replit Design" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>

<div id="design">
  ## Продолжайте работу в Design
</div>

Руководство по Design охватывает весь воркфлоу: импорт, доработку и сборку приложения.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ko/design/import-figma-designs-into-replit-design">
    ...
    <p>Пройдите весь путь импорта и доработки фреймов Figma.</p>
