---
title: "欢迎使用 Replit"
description: "了解 Replit 如何将创意、日常工作和智能转化为实用成果。"
sidebarTitle: "欢迎使用 Replit"
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      ...
      <h1 id="welcome-home-heading">欢迎使用 Replit</h1>
      <p>将创意、日常工作和智能转化为实用成果。</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/zh/home/get-started">开始使用 <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/zh/use-cases">探索应用场景</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Replit 引导式体验">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="咖啡店开业网站，标题为“日常中的静谧之所”" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>
    ...
    <div className="welcome-journey-copy">
      ...
      <p>
        跟随引导，从第一次 Conversation 开始，完成研究、
        规划、Design 和 Publishing。
      </p>

      <a className="welcome-journey-link" href="/zh/home/get-started">
        开启旅程 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/zh/use-cases/prepare-for-a-customer-call">
      ...
      <a className="welcome-use-case-card" href="/zh/use-cases/analyze-customer-feedback">
      ...
      <a className="welcome-use-case-card" href="/zh/use-cases/source-candidates">
      ...
      <a className="welcome-use-case-card" href="/zh/use-cases/monitor-brand-mentions">
      ...
      <a className="welcome-use-case-card" href="/zh/use-cases/weekly-pipeline-report">
      ...
      <a className="welcome-use-case-card" href="/zh/use-cases/track-subscriptions">
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/zh/use-cases">
        探索应用场景 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/zh/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="代表 Replit Chat 的简洁对话窗口">
      ...
      <a className="welcome-product-card" href="/zh/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="代表 Replit Build 的代码编辑器和实时预览">
          <span className="product-path-layer product-path-back" />
      ...
      <a className="welcome-product-card" href="/zh/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="代表 Replit Design 的选中 Canvas 设计稿">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          打造精美的界面和内容。不断优化布局、组件
          和体验。
        </p>

        <div className="welcome-product-link">
          开始设计 <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">获取 Replit</h2>
      <p>选择要在何处使用 Replit，然后登录或创建账户。你可以通过网页版、桌面 App 或移动 App 开始使用。</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>网页</strong><b aria-hidden="true">→</b><small>在浏览器中打开</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>桌面版</strong><b aria-hidden="true">→</b><small>macOS 和 Windows</small></a>
      <a className="welcome-access-card" href="https://replit.com/mobile" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▯</span><strong>移动版</strong><b aria-hidden="true">→</b><small>iOS 和 Android</small></a>
    </div>
  </section>
</div>