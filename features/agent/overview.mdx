---
title: "Replit Agent"
description: "Replit Agent turns your ideas into apps, designs, slides, and more, all from plain language. No coding required."
...
<Frame caption="The Agent modes popover with Free, Power, and Max modes.">
  <img src="/assets/mirror/model-selector-power-mode-52facbd1e206.png" alt="Agent modes popover showing Free, Power, and Max modes with Power selected, a Primary model list, and an Effort slider" width="1452" height="966" data-path="images/replitai/model-selector-power-mode.png" />
</Frame>

* **Free Mode**: No-cost everyday Agent work within your plan's allowance. The Core and Pro allowances reset every five hours and have weekly limits. The Starter tier keeps its existing limits. Check **Settings → Usage** to see your usage.
* **Auto**: Automatic model selection for paid work in Power or Max on Core and Pro.
...
If a request needs more capability than Free Mode, Agent may offer a paid **Allow once** option. Replit asks for confirmation before a paid action starts, and Agent returns to Free Mode afterward.

<Note>Tip: You can also enable **[Plan mode](/features/agent/plan-mode)** to review and iterate on Agent's plan before building begins.</Note>
...
<Accordion title="How does Auto differ from Free, Power, and Max?">
  **Free Mode** is no-cost everyday Agent work within your plan's allowance. In Power or Max, **Auto** selects a model for each paid task. **Power** is a paid, mid-tier mode with powerful models at an affordable price. **Max** is the paid, top-tier mode for the most demanding work.

  Paid actions require confirmation before they start.
</Accordion>
...
Enterprise workspaces use one Auto mode instead of Free Mode. Auto chooses the mode and an allowed model for each task. Account admins can manage model access with [Enterprise model controls](/features/collaboration/enterprise-model-controls).
...
<CardGroup cols={2}>
  <Card title="Agent Skills" icon="puzzle-piece" href="/features/agent/skills">
  ...
  <Card title="Design Canvas" icon="paintbrush" href="/design/canvas">
    Visual mockups and the hands-on visual editor.
  </Card>

  <Card title="Connectors" icon="plug" href="/features/agent/general-agent">
  ...
  <Card title="Vibe coding guide" icon="wand-magic-sparkles" href="/learn/build-with-agent">
