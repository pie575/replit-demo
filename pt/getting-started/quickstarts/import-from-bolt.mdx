...
<Warning>O Agent atualmente suporta importações do Bolt para aplicativos Vite + React.</Warning>

Importe um projeto do Bolt para o Replit exportando-o para o GitHub e depois importando esse repositório.

Para opções de importação abrangentes, incluindo outras plataformas como GitHub, Figma e Lovable, consulte a [documentação do recurso de Importação](/pt/core-concepts/project-editor/app-setup/import).
...
5. Selecione o repositório exportado do Bolt.
