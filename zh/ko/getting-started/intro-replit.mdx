---
title: "概览"
description: "Replit 是将创意变为应用的最快方式。借助 AI，直接在浏览器中构建并发布精彩项目。"
---
...
Replit 是一个 AI 驱动的平台，让你可以在一个浏览器标签页中构建和发布应用。
无需再与复杂的开发环境周旋，编码、发布和协作工具全都集成在统一的界面中。

传统的应用开发需要经历耗时的环境配置流程，包括安装程序、编程语言和软件包。
在 Replit 中，平台会立即配置好环境，因此无论是初学者还是经验丰富的开发者，都能立即开始构建。

<div align="center">
  <AgentInput />
</div>

一个浏览器标签页就能满足构建应用所需的一切，无需安装。
借助 AI 编码工具、实时协作和即时分享功能，Replit 能帮助你快速将想法变为应用。

<div id="section">
  ## 快速入门指南
</div>

想在 Replit 上创建应用，请根据你的目标选择合适的指南：
...
<CardGroup cols={2}>
  <Card title="创建第一个 App" icon="robot" href="/zh/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 分钟*

    使用 AI 驱动的 Replit 工具创建第一个 App。
  </Card>

  <Card title="重混现有 App" icon="shuffle" href="/zh/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 分钟*
...
* [几分钟内即可发布](/zh/category/replit-deployments)
* 无需安装和配置的浏览器原生应用
* [功能完备的代码编辑器](/zh/core-concepts/workspace/editor-and-tools)
* 可在手机或平板上构建应用的[移动应用](/zh/platforms/mobile-app)
* [AI 驱动的应用构建辅助](/zh/core-concepts/agent)
* 追踪变更的[版本控制集成](/zh/core-concepts/workspace/version-control)
* 共同开发的[团队协作](/zh/ko/category/teams)

<div id="ai">
  ### AI 助手功能
</div>

Replit [Agent](/zh/core-concepts/agent) 通过以下功能加速应用开发：
...
<CardGroup cols={3}>
  ...
  <Card title="GDPR 合规" icon="lock">
    符合欧洲监管标准的数据隐私保护。
  </Card>

  <Card title="企业版支持" icon="building" href="/zh/ko/category/teams">
    SSO/SAML、基于角色的访问控制、管理员设置与专属支持。
  </Card>
</CardGroup>
...
如需详细了解 Replit 的所有功能，请参考以下资源：

* [Starter 套餐](/zh/ko/billing/plans/starter-plan)：了解 Starter 套餐的功能，以及可免费创建的内容
* 通过[工作区 功能](/zh/core-concepts/workspace/editor-and-tools)了解 工作区 的功能。
* 通过[Replit Agent](/zh/core-concepts/agent/)了解 Replit AI 功能的能力。
* 通过[共享 Replit App](/zh/replit-app/collaborate/)了解如何分享你的作品。
