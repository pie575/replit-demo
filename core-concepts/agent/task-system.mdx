---
title: "Task system"
description: "Agent breaks work into tasks you can review, run in the background, and apply back to your main version."
sidebarTitle: "Task system"
icon: "list-check"
---
...
<Steps>
  ...
  <Step title="Tasks start running">
    Once accepted, tasks start running in isolated copies of your project. Starter does not support background tasks. Core runs 1 at a time, Pro supports up to 10, and Enterprise supports up to 64. Your main version stays untouched until you choose to apply changes. You can track progress in two ways:
...
<CardGroup cols={3}>
  <Card title="Task board" icon="table-columns" href="/features/agent/task-board">
    Review Drafts, Active, Ready, and Done tasks from the board.
  </Card>

  <Card title="Task lifecycle" icon="rotate" href="/features/agent/task-lifecycle">
    Understand task states, queued work, applying changes, archiving, and cancelling.
  </Card>

  <Card title="Follow-up tasks" icon="list-check" href="/features/agent/follow-up-tasks">
...
<Accordion title="Why are my tasks running one at a time?">
  Starter does not support background tasks. Core runs 1 at a time, Pro supports up to 10, and Enterprise supports up to 64. Once you hit your plan's limit, additional tasks queue and start as slots open up.
</Accordion>
...
<Note>
  Starter does not support background tasks. Enterprise supports up to 64 active background tasks.
</Note>
