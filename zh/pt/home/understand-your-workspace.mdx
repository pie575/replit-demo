---
title: "了解你的 工作区"
description: "了解 Replit 工作区 如何汇集人员、Projects、Conversations、Routines、数据、集成和安全功能。"
---
...
你的 Replit 工作区 是一个想法从萌生到落地的基础。它将
[Projects](/zh/pt/home/projects)、[Conversations](/zh/pt/home/conversations)、
[Routines](/zh/pt/chat/routines) 和集成汇聚在一起，让你从最初的
一个问题一路推进到切实可用的成果。
...
在着手构思咖啡馆之前，先为它安个家。这个 工作区
会将发布过程中逐渐成形的各个部分集中在一起：

* 用于构思概念和调研本地市场的对话
* 为方案补充实用背景信息的文件和已连接工具
* 后续用于监测竞争对手和市场变化的 Routine
* 你最终将设计并发布的网站

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-neutral-874efff00786.jpg" alt="Demo 工作区 的 Replit 首页，其中包含 Projects、Conversations、Routines、建议提示词和消息输入框" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized-neutral.jpg" />
</Frame>

提示词输入框是这个项目的起点。从这里开始，你将开启
一段对话，并向 Replit 描述你想打造的咖啡馆。

<div id="detalhes-do-workspace">
  ## 工作区详情
</div>

它还汇集了相关成员、设置、共享资源、集成和计费信息。你的访问权限决定了你可以查看和管理哪些内容。

工作区 设置和组织管理控件与用于调整 Agent 如何响应请求的控件相互独立。

在整个发布过程中，你随时可以返回 工作区，找到支持项目的一切资源。

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/pt/home/start-a-conversation">
    ...
    <div className="chat-card-title">开始对话</div>
    <p>描述你想要的结果，开始打造咖啡馆项目。</p>
    <div className="chat-card-link">探索 →</div>
  </a>

  <a className="chat-example has-visual" href="/zh/pt/features/collaboration/workspaces">
...
接下来，[开始对话](/zh/pt/home/start-a-conversation)，着手完善咖啡馆项目的想法。