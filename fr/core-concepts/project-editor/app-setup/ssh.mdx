---
title: "SSH"
description: "Apprenez à configurer et utiliser SSH pour connecter votre environnement de développement local aux applications Replit pour un accès distant sécurisé et la synchronisation des fichiers."
---
...
<Frame>
  <img src="/assets/mirror/add-ssh-key-with-values-5d6f440e56ba.png" alt="Boîte de dialogue d'ajout de clé SSH avec les champs libellé et clé remplis" width="500" height="511" data-path="images/ssh-vscode/add-ssh-key-with-values.png" />
</Frame>
...
<Tabs>
  <Tab title="Se connecter avec VSCode">
    <img src="/assets/mirror/ssh-connect-439a3c150846.png" alt="Onglet de connexion SSH montrant l'option Lancer VS Code" width="788" height="482" data-path="images/ssh-vscode/ssh-connect.png" />
  </Tab>
</Tabs>
