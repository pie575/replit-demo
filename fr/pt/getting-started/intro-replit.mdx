...
description: "Replit est le moyen le plus rapide de transformer une idée en application. Créez et publiez des projets exceptionnels depuis votre navigateur, avec l’IA à portée de main."
---
...
<YouTubeEmbed videoId="-2xHmkpmCBM" title="Présentation de Replit" />

Replit est une plateforme alimentée par l’IA qui vous permet de créer et de publier des applications depuis un seul onglet de navigateur.
Au lieu de gérer des environnements de développement complexes, vous disposez d’outils de programmation, de publication et de collaboration dans une interface intégrée.

Créer des applications de manière traditionnelle nécessite d’installer des programmes, des langages et des pacotes — un processus de configuration fastidieux.
Avec Replit, la plateforme configure instantanément votre environnement afin que vous puissiez commencer à créer, que vous soyez débutant ou développeur expérimenté.

<div align="center">
  <AgentInput />
</div>

Vous avez tout ce dont vous avez besoin pour créer des applications depuis un seul onglet de navigateur, sans aucune installation.
Grâce aux outils de programmation basés sur l’IA, à la collaboration en temps réel et au partage instantané, Replit vous permet de passer rapidement de l’idée à l’application.

<div id="guias-de-incio-rpido">
  ## Guides de démarrage rapide
</div>

Pour créer votre application avec Replit, choisissez le guide qui répond à vos besoins :
...
<CardGroup cols={2}>
  <Card title="Créez votre première application" icon="robot" href="/fr/pt/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 minutes*

    Créez votre première application avec les outils d’IA de Replit.
  </Card>

  <Card title="Remixer une application existante" icon="shuffle" href="/fr/pt/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 minute*

    Faites progresser votre projet en vous appuyant sur des applications créées par la communauté.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Importer depuis GitHub" icon="github" href="/fr/pt/getting-started/quickstarts/import-from-github/">
    ...
    Importez un dépôt GitHub existant dans Replit.
  </Card>

  <Card title="Importer depuis Figma" icon="figma" href="/fr/pt/getting-started/quickstarts/import-from-figma/">
    ⏱️ *3 minutes*

    Convertissez vos designs Figma en applications React fonctionnelles.
  </Card>

  <Card title="Importer depuis Bolt" icon="bolt" href="/fr/pt/getting-started/quickstarts/import-from-bolt/">
    ⏱️ *4 minutes*

    Migrez vos projets Bolt vers Replit avec l’aide d’Agent.
  </Card>

  <Card title="Importer depuis Lovable" icon="heart" href="/fr/pt/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4 minutes*

    Transférez vos projets Lovable vers Replit et poursuivez le développement.
  </Card>
</CardGroup>

<div id="recursos-do-ambiente-de-trabalho">
  ### Fonctionnalités du workspace
</div>

Replit fournit les outils essentiels suivants pour créer des applications :

* [Aperçu en temps réel](/fr/core-concepts/workspace/editor-and-tools/preview) de votre application
* [Déploiement en quelques minutes](/fr/category/replit-deployments)
* Application native dans le navigateur, sans installation ni configuration
* [Éditeur de code complet](/fr/core-concepts/workspace/editor-and-tools)
* [Application mobile](/fr/platforms/mobile-app) pour créer des applications depuis votre téléphone ou votre tablette
* [Création d’applications assistée par l’IA](/fr/pt/core-concepts/agent)
* [Intégration du contrôle de version](/fr/core-concepts/workspace/version-control) pour suivre les modifications
* [Collaboration en équipe](/fr/pt/category/teams) pour créer ensemble

<div id="capacidades-do-assistente-de-ia">
  ### Capacités de l’assistant IA
</div>

L’[Agent](/fr/pt/core-concepts/agent) de Replit accélère la création d’applications grâce aux fonctionnalités suivantes :

* Création et configuration complètes d’applications à partir de descriptions en langage naturel
* Suggestions de code et complétion automatique
* Détection automatisée des erreurs et aide au débogage
* Génération de documentation pour votre application

<div id="compartilhe-em-minutos">
  ### Publiez en quelques minutes
</div>

Publiez vos applications en quelques minutes grâce aux fonctionnalités suivantes :

* Déploiement d’applications dans le cloud en quelques clics
* Intégration de bases de données et hébergement
* Prise en charge de domaines personnalisés et chiffrement des connexions pour vos applications

<div id="construdo-com-confiana">
  ## Conçu en toute confiance
</div>

<CardGroup cols={3}>
  <Card title="SOC 2 Type 2" icon="shield-check">
    Contrôles de sécurité et pratiques de protection des données audités de manière indépendante.
  </Card>

  <Card title="Conformité à la LGPD/RGPD" icon="lock">
    Protections des données personnelles conformes aux normes réglementaires applicables.
  </Card>

  <Card title="Prêt pour les entreprises" icon="building" href="/fr/pt/category/teams">
    SSO/SAML, accès basé sur les rôles, contrôles administratifs et assistance dédiée.
  </Card>
</CardGroup>
...
Pour en savoir plus sur les fonctionnalités de Replit, consultez les ressources suivantes :

* [Forfait Starter](/fr/pt/billing/plans/starter-plan) : découvrez les fonctionnalités du forfait Starter et ce que vous pouvez créer gratuitement
* Découvrez les fonctionnalités du workspace dans [Fonctionnalités du workspace](/fr/core-concepts/workspace/editor-and-tools).
* Découvrez les possibilités offertes par les fonctionnalités d&#39;IA de Replit dans [Replit Agent](/fr/pt/core-concepts/agent/).
* Découvrez comment partager vos créations dans [Partager votre App Replit](/fr/replit-app/collaborate/).
* [Téléchargez l&#39;application mobile](https://replit.com/mobile/) pour les appareils iOS ou Android.