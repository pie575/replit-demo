...
description: "Learn the difference between Plan and Build modes in Replit, and how to combine them for more effective development."
...
<CardGroup cols={2}>
  <Card title="Plan Mode" icon="lightbulb" href="/features/agent/plan-mode">
  ...
  <Card title="Checkpoints" icon="clock-rotate-left" href="/features/version-control/checkpoints-and-rollbacks">
    Learn about rollbacks and recovery
  </Card>

  <Card title="Effective Prompting" icon="message" href="/learn/effective-prompting">
