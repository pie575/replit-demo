...
description: "Learn about Replit's security practices, data protection, and compliance standards"
icon: "shield-check"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Commercial Agreement" icon="users" href="https://replit.com/commercial-agreement" className="hover:bg-gray-50 dark:hover:bg-gray-800">
