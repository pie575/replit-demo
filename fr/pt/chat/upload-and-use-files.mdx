...
description: "Ajoutez des documents, des feuilles de calcul, des images ou des captures d’écran pertinents à une Conversa et indiquez à Replit comment ces informations doivent contribuer à votre demande."
...
Téléverser des documents, des feuilles de calcul, des images et des captures d’écran permet de fournir à Replit des éléments de preuve, des exigences ou des indications visuelles plus faciles à transmettre qu’à décrire.

<div id="como-enviar-um-arquivo">
  ## Comment envoyer un fichier
</div>

Dans la zone de prompt, sélectionnez le bouton **plus (+)**, puis choisissez **Envoyer un fichier**. Vous pouvez également faire glisser-déposer un fichier dans la zone de prompt. Ajoutez le fichier avant d’envoyer la demande qui en dépend.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu du bouton plus (+) de la zone de prompt, avec Envoyer un fichier comme première option" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

<div id="use-arquivos-para">
  ## Utilisez des fichiers pour
</div>
...
* Donner à Replit des indications ou des informations sur une application que vous souhaitez créer.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/fr/pt/chat/upload-and-use-files">
    ...
    <p>Découvrez un exemple complet pour comprendre et analyser un fichier.</p>
    <div className="chat-card-link">Explorer ce cas d’utilisation →</div>
  </a>
</section>