---
title: "Configurer X (Twitter) OAuth"
description: "Configurez X (anciennement Twitter) comme fournisseur de connexion sociale pour l'authentification de votre application"
---
...
* Le panneau de modification du fournisseur **X** ouvert dans : **volet Auth** → onglet **Configure** → section **SSO providers** → sélectionnez l'environnement **Production** → sélectionnez **Edit** à côté de **X**
...
Sélectionnez le niveau de permission minimal :
...
3. Sélectionnez **Save**
4. **Sauvegardez votre Client ID et votre Client Secret**
