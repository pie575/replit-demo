...
description: "Aprenda o que é o Editor de Projeto: sua base no Replit onde você conversa com o Agent, vê seu app tomar forma e gerencia tudo."
sidebarTitle: "Editor de Projeto"
icon: "window"
---
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="A tela inicial do Editor de Projeto do Replit mostrando o campo de prompt onde você descreve o que quer construir" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

## O que é o Editor de Projeto?

O Editor de Projeto é sua base no Replit: o ambiente onde você começa a construir, gerencia seus projetos e vê seus apps ganharem vida. A partir daqui, você pode descrever o que quer construir, e o [Agent](/pt/features/agent/overview) cuida do resto, escrevendo código, configurando seu projeto e mostrando uma prévia ao vivo em tempo real.

## Primeiros passos

Digite o que você quer construir no campo de prompt. Descreva sua ideia em linguagem simples — "um rastreador de orçamento que gráfica meus gastos", "uma landing page para minha cafeteria", "um gerador de histórias em quadrinhos com IA para crianças" — e o Agent cuida do resto.

<AgentInput />

Você também pode selecionar um tipo de projeto do carrossel para dizer ao Agent que tipo de saída você quer — web app, app móvel, slides, design e mais. Ou pule a seleção e apenas descreva sua ideia; o Agent descobre a configuração certa automaticamente.

<AgentCarousel />

Para começar logo, siga [Construir seu primeiro app](/pt/build/your-first-app).

## Modo de plano

O modo de plano permite que você faça brainstorming, faça perguntas e mapeie seu projeto. O Agent cria uma lista de tarefas ordenada que você pode revisar e refinar — quando estiver satisfeito com o plano, aprove-o e o Agent começa a construir. Você também pode usar o Modo de plano para fazer perguntas ou explorar ideias; o Agent não fará nenhuma alteração até que você saia.

<AgentInput highlightPlan={true} showTypewriter={false} />

Ative o Modo de plano pelo botão na parte inferior do campo de entrada. Saiba mais no [guia do Modo de plano](/pt/features/agent/plan-mode).

## O que você pode construir

Selecione um tipo de projeto para dizer ao Agent o que você quer, ou apenas descreva sua ideia e deixe o Agent escolher a configuração certa.

* **Web apps** — Dashboards, ferramentas internas, produtos SaaS, landing pages
* **Apps móveis** — Apps para iOS e Android a partir de um único prompt
* **Slides e apresentações** — Gere decks com layouts ricos
* **Animações** — Walkthroughs interativos e motion graphics
* **Designs** — Mockups visuais e protótipos no [Canvas de Design](/pt/design/canvas)
* **Visualizações de dados** — Gráficos, dashboards e ferramentas com banco de dados
* **Documentos** — CSVs, PDFs, arquivos PowerPoint, docs Markdown
* **Planilhas** — Tabelas de dados e saídas estruturadas

## O Editor de Projeto

Depois que o Agent começa a construir, o Editor de Projeto é onde você vê seu projeto tomar forma. Ele é dividido em painéis: sua conversa com o Agent de um lado e uma prévia ao vivo do seu app do outro.

### Threads

Cada conversa com o Agent acontece em um thread. Seu thread principal é onde você descreve o que quer e observa o Agent construí-lo. Quando você usa o [sistema de tarefas](/pt/core-concepts/agent/task-system), cada tarefa em segundo plano recebe seu próprio thread — para que o Agent mantenha o trabalho das tarefas isolado sem misturar as conversas.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Um thread mostrando o prompt do usuário e o Agent construindo o projeto" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>

### Quadro de tarefas

O quadro de tarefas organiza seu trabalho em colunas: **Rascunhos**, **Ativo**, **Pronto** e **Concluído**. Cada tarefa avança da esquerda para a direita à medida que progride, para que você possa ver rapidamente o que está planejado, no que o Agent está trabalhando e o que está terminado. Saiba mais em [Sistema de tarefas](/pt/core-concepts/agent/task-system).
...
O Canvas de Design é um editor visual onde você pode criar e refinar mockups antes de se comprometer com o código. Arraste elementos, ajuste layouts e itere no seu design — depois deixe o Agent transformá-lo em um app funcional. Saiba mais em [Canvas de Design](/pt/design/canvas).

## Colaboração

Crie um Workspace de Equipe para construir juntos. Convide colegas, compartilhe projetos e trabalhe no mesmo app em tempo real. Veja [Workspaces de equipe](/pt/features/collaboration/team-workspaces) para configuração de equipe e [Convidar colegas](/pt/build/invite-teammates) para colaboração no nível do projeto.

## Importe código e design

Já tem um projeto? Traga-o para o Replit a partir do GitHub, Figma ou faça upload de arquivos diretamente. O Agent pode continuar de onde você parou e seguir construindo a partir do seu código ou design existente. Veja [Importar para o Replit](/pt/build/import-from-providers).

## Próximos passos

<CardGroup cols={2}>
  <Card title="Editor e ferramentas" href="/pt/features/editor/editor-and-tools" icon="window-restore">
    Os painéis principais onde você vê a prévia do seu app, saída do console e outras ferramentas
  </Card>

  <Card title="Configuração do app" href="/pt/features/project-setup/configuration" icon="gear">
    Configure as definições, dependências, secrets e ambiente do seu app
  </Card>

  <Card title="Controle de versão" href="/pt/learn/projects-and-artifacts/version-control" icon="clock-rotate-left">
    Acompanhe alterações, reverta para versões anteriores e gerencie o histórico do seu app
  </Card>

  <Card title="Publicação" href="/pt/learn/projects-and-artifacts/replit-deployments" icon="rocket">
    Implante seu app em uma URL ao vivo para que qualquer pessoa possa usá-lo
  </Card>
</CardGroup>
...
<Accordion title="Posso trabalhar com outras pessoas?">
  Sim. Você pode convidar colaboradores para um projeto específico ou criar um Workspace de Equipe onde os membros acessam todos os projetos. Veja [Workspaces de equipe](/pt/features/collaboration/team-workspaces) e [Convidar colegas](/pt/build/invite-teammates).
</Accordion>

<Accordion title="Como faço para publicar meu app?">
  Quando seu app estiver pronto, implante-o em uma URL ao vivo diretamente do Editor de Projeto. Veja [Deployments](/pt/learn/projects-and-artifacts/replit-deployments).
</Accordion>

## Disponibilidade

O Editor de Projeto está disponível em todos os planos. Alguns recursos, como computação aumentada e deployments sempre ativos, requerem um plano pago. Veja [Faturamento](/pt/billing/ai-billing) para detalhes.
