...
description: "Replit의 Plan과 Build 모드의 차이점과 더 효과적인 개발을 위해 이 두 모드를 결합하는 방법을 알아보세요."
...
[Plan 모드](/ko/features/agent/plan-mode)는 코드를 수정하지 않고 Agent와 함께 브레인스토밍하고, 질문하고, 작업을 계획할 수 있게 합니다. 아이디어를 자유롭게 탐색할 수 있는 협업 계획 세션으로 생각하세요.
...
<Steps>
  ...
  <Step title="작업 목록 생성하기">
    ...
    <Frame>
      <img src="/assets/mirror/plan-mode-task-list-6adcdd56f689.png" alt="우선순위 및 의존성이 있는 생성된 작업 목록" width="924" height="1180" data-path="images/replitai/plan-mode-task-list.png" />
    </Frame>
  </Step>
  ...
  <Step title="빌드 시작하기">
    ...
    <Frame>
      <img src="/assets/mirror/plan-mode-selector-a4f6b14596fa.png" alt="Plan 모드와 Build 모드 옵션을 보여주는 모드 선택기" width="918" height="224" data-path="images/replitai/plan-mode-selector.png" />
    </Frame>
  </Step>
