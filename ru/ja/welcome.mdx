...
description: "Узнайте, как Replit превращает идеи, повседневные задачи и интеллектуальные возможности в полезные результаты."
---
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      <div className="welcome-eyebrow">Начать работу</div>
      ...
      <div className="welcome-actions">
        <a className="welcome-action primary" href="/ru/ja/home/get-started">Начать работу <span aria-hidden="true">→</span></a>
  ...
  <section className="welcome-journey-strip" aria-label="Пошаговое знакомство с Replit">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="Сайт кофейни с заголовком «Тихое место для каждого дня»" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        Узнайте, как превратить идею в опубликованный сайт
      </div>

      <p>
        Пройдите пошаговый путь — от первого Conversation через исследование,
        планирование, дизайн и публикацию.
      </p>

      <a className="welcome-journey-link" href="/ru/ja/home/get-started">
    ...
    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/ru/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Перед каждой встречей с клиентом получайте чёткий бриф.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Превращайте необработанные отзывы в ключевые темы и практические выводы.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Находите и отбирайте кандидатов с помощью подключённого контекста.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>Не упускайте важные обсуждения и быстро направляйте их нужному специалисту.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ru/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          <div className="welcome-card-title" role="heading" aria-level="3">
            Создавайте еженедельные отчёты о продажах
          </div>

          <p>Преобразуйте актуальные данные воронки продаж в понятный отчёт.</p>
        </div>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/ru/ja/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Компактное окно Conversation в Replit Chat">
        ...
        <p>
          Начните с разговора. Задавайте вопросы, изучайте идеи
          и составляйте планы.
        </p>

        <div className="welcome-product-link">
          Начать разговор <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/ja/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Редактор кода и предпросмотр в реальном времени в Replit Build">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Превращайте идеи в реальные приложения и сайты. Создавайте, дорабатывайте
          и уверенно публикуйте их.
        </p>

        <div className="welcome-product-link">
          Начать работу в Build <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ru/ja/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Выбранная композиция на холсте в Replit Design">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          Создавайте красивые интерфейсы и контент. Дорабатывайте макеты,
          компоненты и пользовательский опыт.
        </p>

        <div className="welcome-product-link">
          Начать работу в Design <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      ...
      <p>Выберите, где хотите использовать Replit, затем войдите в аккаунт или создайте его. Начать можно в браузере, настольном или мобильном приложении.</p>
    </div>
