...
description: "Ajoutez à Conversation des documents, feuilles de calcul, images et captures d’écran pertinents, puis indiquez à Replit comment utiliser ces informations pour répondre à vos demandes."
...
Téléversez des documents, des feuilles de calcul, des images et des captures d’écran pour transmettre plus facilement à Replit des éléments de preuve, des exigences ou une orientation visuelle qu’en les décrivant.

<div id="section">
  ## Comment téléverser des fichiers
</div>

Dans la zone de saisie, sélectionnez le bouton **Plus**, puis choisissez **Téléverser un fichier**. Vous pouvez également glisser-déposer des fichiers dans la zone de saisie. Ajoutez les fichiers avant d&#39;envoyer une demande qui en dépend.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Menu Plus de la zone de saisie avec « Téléverser un fichier » comme première option" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>

<div id="section-2">
  ## Utilisations des fichiers
</div>

* Analyser des feuilles de calcul.
* Poser des questions sur des PDF.
* Demander à Replit de créer ou d&#39;améliorer un design à partir d&#39;une capture d&#39;écran.
* Indiquer à Replit vos idées ou des informations sur l&#39;application que vous souhaitez créer.
