...
description: "Добавляйте в Conversation нужные документы, таблицы, изображения или скриншоты и указывайте Replit, как эта информация должна помочь с вашим запросом."
...
Загружая документы, таблицы, изображения и снимки экрана, вы можете предоставить Replit данные, требования или визуальные ориентиры, которые проще показать, чем описать.

<div id="how-to-upload-a-file">
  ## Как загрузить файл
</div>

В поле ввода промпта нажмите кнопку **плюс**, затем выберите **Загрузить файл**. Вы также можете перетащить файл в поле ввода промпта. Добавьте файл перед отправкой запроса, для которого он нужен.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Меню кнопки «плюс» в поле ввода промпта; первый пункт — «Загрузить файл»" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
* Задавать вопросы о PDF-документах.
* Попросить Replit создать или доработать дизайн по снимку экрана.
* Передать Replit инструкции или информацию о приложении, которое вы хотите создать.
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/chat/upload-and-use-files">
    ...
    <p>Посмотрите полный пример работы с файлом: от понимания содержимого до анализа.</p>
