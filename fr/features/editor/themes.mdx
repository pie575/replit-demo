---
title: "Thèmes Replit"
description: "Apprenez à personnaliser l'Éditeur de projet avec des thèmes personnalisés, des palettes de couleurs et de la coloration syntaxique."
---

Les thèmes dans Replit vous permettent de personnaliser l'apparence de l'Éditeur de projet, des couleurs d'arrière-plan et des éléments d'interface à la coloration syntaxique de votre code. Personnalisez votre environnement de développement pour une meilleure lisibilité, une fatigue oculaire réduite et une expérience de codage plus agréable.
...
3. Saisissez un titre, sélectionnez une palette de couleurs (claire ou sombre), et ajoutez une description facultative
...
* **Négatif** : S'affiche pour les erreurs et les avertissements d'actions destructrices
...
<Tip>
  Une coloration syntaxique appropriée rend le code plus facile à parcourir et à comprendre en un coup d'œil. Choisissez des couleurs qui s'harmonisent bien et offrent un contraste suffisant par rapport à votre arrière-plan.
</Tip>
...
<Accordion title="Éléments de coloration syntaxique">
  ...
  | **Définitions de variables**  | Colore les noms de variables définis avec des mots-clés comme `const` ou `var`  |
  ...
  | **Noms de propriétés**        | Colore l'accès aux propriétés depuis des variables                              |
  ...
  | **Crochets**                  | Colore les crochets carrés et angulaires lorsque approprié                      |
</Accordion>
...
* **Équilibrez le contraste** : Assurez une différence suffisante entre les éléments d'arrière-plan et de premier plan
* **Créez des palettes cohérentes** : Choisissez des couleurs qui se complètent plutôt que qui s'opposent
* **Maintenez une luminosité constante** : Gardez un niveau de luminosité similaire entre les éléments syntaxiques
* **Concevez pour l'accessibilité** : Tenez compte des utilisateurs malvoyants en évitant les combinaisons à faible contraste
...
Supprimez des thèmes personnalisés à l'aide du menu à trois points et en sélectionnant **Supprimer**.
...
* Recherchez par couleurs spécifiques pour correspondre à vos préférences

Prévisualisez n'importe quel thème avant de l'installer pour voir comment il apparaîtra dans l'Éditeur de projet.

## Porter depuis VS Code

Importez vos thèmes VS Code préférés dans Replit en associant les couleurs équivalentes lors du processus de création de thème.
...
* [Fonctionnalités de l'Éditeur de projet](/fr/features/workspace-tools/console) - Explorez d'autres fonctionnalités de l'Éditeur de projet comme Console, Shell et Multiplayer
* [Paramètres utilisateur](/fr/features/editor/user-settings) - Configurez vos préférences de l'Éditeur de projet
* [Raccourcis clavier](/fr/features/editor/keyboard-shortcuts) - Accélérez votre flux de travail avec des raccourcis clavier
* [Inviter des coéquipiers](/fr/build/invite-teammates) - Collaborez en temps réel avec des membres de l'équipe
