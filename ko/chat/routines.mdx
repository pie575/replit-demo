...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ko/schedule-a-routine">
    ...
    <p>퀵스타트를 따라 반복 작업을 만들고 예약하세요.</p>
    <div className="chat-card-link">퀵스타트 열기 →</div>
  </a>
  ...
  <a className="chat-example has-visual" href="/ko/chat/agent-modes">
    ...
    <div className="chat-card-title">Routines가 실행되는 방식</div>

    <p>
      예약된 Routines는 Free Mode가 아니라 Power 또는 Max Mode에서 실행됩니다.
    </p>

    <div className="chat-card-link">Agent Modes에 대해 알아보기 →</div>
  </a>
</section>

무엇을 실행할지 결정한 다음, [Agent Modes](/ko/chat/agent-modes)를 비교해서 Replit이 작업에
접근하는 방식을 선택하세요.
