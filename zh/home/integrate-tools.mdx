---
title: "集成工具"
description: "连接文件和工具，为 Replit 提供制定咖啡店开业计划所需的上下文。"
sidebarTitle: "集成工具"
icon: "paperclip"
...
现在你已了解集成，接下来让我们将其应用到咖啡店开业中。

你已经选定了方向：打造一家**社区咖啡馆**，而非车站旁面向通勤者的咖啡吧。向 Replit 提供将这一方向转化为可执行计划所需的材料。

集成可将 Replit 连接到你已在使用的工具和文件，让 Replit 获取相关信息或执行完成 task 所需的操作。你可以连接 **[Slack](/zh/features/integrations/overview#connectors)**、**[Google Drive](/zh/features/integrations/overview#connectors)**、**[Notion](/zh/features/integrations/overview#connectors)** 或 **[Salesforce](/zh/features/integrations/overview#connectors)** 等服务，以及其他 450 多种服务。

对于这家咖啡店，Google Drive 可让 Replit 访问预算、选址备注、菜单创意、照片和视觉参考资料。Notion 则可用于记录开业计划、决策和待解决的问题。

详细了解如何[集成你的工具](/zh/chat/integrate-your-tools)。

<Steps>
  <Step title="让 Replit 汇总材料">
    从以下请求开始。Replit 会检查完成计划所需的内容，并在需要访问权限时提示你连接服务。

    <AiPrompt>
      使用我的咖啡馆文件，为这家社区咖啡馆制定首月开业计划。更新相关假设，然后在 Notion 中记录概念、关键决策、待解决问题和开业检查清单。
    </AiPrompt>
  </Step>

  <Step title="当 Replit 提示时连接 Google Drive">
    批准 Google Drive 连接，以便 Replit 检查你希望它使用的材料。它会直接在 Conversation 中打开连接请求。

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit 正请求连接 Google Drive，以便检查咖啡馆文件" />
  </Step>

  <Step title="当 Replit 需要记录计划时连接 Notion">
    当 Replit 请求创建开业简报时，批准 Notion 连接。随后，它便可在一处记录概念、决策、待解决问题和检查清单。
  </Step>
</Steps>

Google Drive 为 Replit 提供开展工作的依据。随着你回答新问题并作出决策，Notion 会将不断完善的计划集中保存在一处。

详细了解如何[添加上下文](/zh/chat/add-context)、[上传文件](/zh/chat/upload-and-use-files)和[集成你的工具](/zh/chat/integrate-your-tools)。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/home/watch-the-competition">
    ...
    <div className="chat-card-title">关注竞争对手动态</div>
    <p>在准备发布期间，设置 Routine 以监测竞争对手的变化。</p>
