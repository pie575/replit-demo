---
title: "Présentation"
description: "Replit est le moyen le plus rapide de transformer vos idées en applications. Utilisez l’IA pour créer et publier de superbes projets directement depuis votre navigateur."
---
...
Replit est une plateforme propulsée par l&#39;IA qui vous permet de créer et de publier des applications depuis un seul onglet de navigateur.
Plutôt que de vous battre avec des environnements de développement complexes, vous retrouvez les outils de codage, de publication et de collaboration réunis dans une seule interface.

Le développement d&#39;applications traditionnel imposait de longues étapes de configuration : installation de programmes, de langages et de paquets.
Sur Replit, la plateforme configure l&#39;environnement instantanément : que vous soyez débutant ou développeur chevronné, vous pouvez vous lancer immédiatement.

<div align="center">
  <AgentInput />
</div>

Tout ce dont vous avez besoin pour créer une application tient dans un seul onglet de navigateur, sans aucune installation.
Avec ses outils de codage assistés par IA, sa collaboration en temps réel et son partage instantané, Replit transforme rapidement vos idées en applications.

<div id="section">
  ## Guide de démarrage rapide
</div>

Pour créer une application sur Replit, choisissez le guide correspondant à votre objectif :
...
<CardGroup cols={2}>
  <Card title="Créer votre première application" icon="robot" href="/fr/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 minutes*

    Créez votre première application avec les outils d&#39;IA de Replit.
  </Card>

  <Card title="Remixer une application existante" icon="shuffle" href="/fr/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 minute*

    Démarrez rapidement un projet à partir d&#39;une application de la communauté.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Importer depuis GitHub" icon="github" href="/fr/getting-started/quickstarts/import-from-github/">
    ⏱️ *2 minutes*

    Importez un dépôt GitHub existant dans Replit.
  </Card>

  <Card title="Importer depuis Figma" icon="figma" href="/fr/getting-started/quickstarts/import-from-figma/">
    ⏱️ *3 minutes*

    Convertissez vos maquettes Figma en une application React fonctionnelle.
  </Card>

  <Card title="Importer depuis Bolt" icon="bolt" href="/fr/getting-started/quickstarts/import-from-bolt/">
    ⏱️ *4 minutes*

    Migrez vos projets Bolt vers Replit avec l&#39;aide d&#39;Agent.
  </Card>

  <Card title="Importer depuis Lovable" icon="heart" href="/fr/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4 minutes*

    Transférez vos projets Lovable vers Replit pour poursuivre leur développement.
  </Card>
</CardGroup>
...
Replit propose les outils essentiels suivants pour créer des applications :

* [Aperçu en temps réel](/fr/core-concepts/workspace/editor-and-tools/preview) de votre application
* [Publication en quelques minutes](/fr/category/replit-deployments)
* Application native du navigateur, sans installation ni configuration
* [Éditeur de code complet](/fr/core-concepts/workspace/editor-and-tools)
* [Application mobile](/fr/platforms/mobile-app) pour créer des applications depuis un smartphone ou une tablette
* [Aide à la création d&#39;applications par IA](/fr/core-concepts/agent)
* [Intégration du contrôle de version](/fr/core-concepts/workspace/version-control) pour suivre les modifications
* [Collaboration en équipe](/fr/ko/category/teams) pour développer ensemble

<div id="ai">
  ### Fonctionnalités du compagnon IA
</div>

Replit [Agent](/fr/core-concepts/agent) accélère la création d&#39;applications grâce aux fonctionnalités suivantes :

* Création et configuration d&#39;applications complètes à partir de descriptions en langage naturel
* Suggestions de code et complétion automatique
* Détection automatique des erreurs et aide au débogage
* Génération de la documentation de l&#39;application

<div id="section-5">
  ### Partagez en quelques minutes
</div>

Publiez votre application en quelques minutes grâce aux outils suivants :

* Publication de votre application dans le cloud en quelques clics
* Intégration et hébergement de bases de données
* Prise en charge des domaines personnalisés et chiffrement des connexions à l&#39;application
...
<CardGroup cols={3}>
  ...
  <Card title="Conformité au RGPD" icon="lock">
    Protection des données personnelles conforme aux réglementations européennes.
  </Card>

  <Card title="Assistance Enterprise" icon="building" href="/fr/ko/category/teams">
    SSO/SAML, contrôle d’accès basé sur les rôles, paramètres d’administration et assistance dédiée.
  </Card>
</CardGroup>
...
Pour tout savoir sur les fonctionnalités de Replit, consultez les ressources suivantes :

* [Plan Starter](/fr/ko/billing/plans/starter-plan) : découvrez les fonctionnalités du plan Starter et ce que vous pouvez créer gratuitement
* [Fonctionnalités du workspace](/fr/core-concepts/workspace/editor-and-tools) : explorez les possibilités du workspace.
* [Replit Agent](/fr/core-concepts/agent/) : découvrez tout ce que permettent les fonctionnalités d&#39;IA de Replit.
* [Partager une application Replit](/fr/replit-app/collaborate/) : apprenez à partager vos créations.
* [Téléchargez l&#39;application mobile](https://replit.com/mobile/) pour appareils iOS ou Android.