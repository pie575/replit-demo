---
title: "replit.md"
description: "Saiba como usar o replit.md para personalizar o comportamento do Agent, o estilo de codificação e o contexto do projeto."
---
...
<Frame>
  <img src="/assets/mirror/replitmd-65360844a148.jpg" alt="Agent usando replit.md para construir um projeto" width="1920" height="1080" data-path="images/replitai/replitmd.jpg" />
</Frame>
...
<YouTubeEmbed videoId="kYv525W-vaU" title="Personalize como o Replit Agent responde" />
...
Esta abordagem fornece soluções que são tanto atuais quanto adaptadas às necessidades específicas do seu projeto.
...
**Enterprise**: Pré-configure o `replit.md` em [templates personalizados](/pt/teams/custom-templates) para dar a todos os construtores da sua organização um contexto inicial consistente. Para orientação específica de design, consulte [como configurar um design system](/pt/teams/custom-design-system).
