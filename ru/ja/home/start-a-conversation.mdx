...
Ваше рабочее пространство готово. Пора воплотить идею кофейни в жизнь.
Начните [Conversation](/ru/ja/chat/conversations), расскажите Replit, что хотите создать, и превратите исходную идею
в полноценный план запуска.

<div id="section">
  ## Начните новый Conversation
</div>

На боковой панели Replit выберите **New**. Откроется Conversation, где можно сформировать концепцию, изучить рынок и спланировать запуск.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Главная страница Replit в рабочем пространстве Demo: выделена кнопка New, отображаются предложенные промпты и поле ввода сообщения" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

<div id="section-2">
  ## Ознакомьтесь с полем промпта
</div>

Выбрав **New**, ознакомьтесь с полем промпта. Здесь вы зададите Replit направление,
добавите полезный контекст и продолжите работу над запуском кофейни. Следующий шаг —
написать первый промпт.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="Меню с плюсом в поле промпта с такими опциями, как загрузка файлов, создание нового проекта, импорт проекта, использование навыков и дизайн-систем, а также добавление интеграций" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/ja/home/describe-your-idea">
    ...
    <div className="chat-card-title">Воплотите идею в жизнь</div>
    <p>Составьте чёткий первый запрос для запуска кофейни.</p>
