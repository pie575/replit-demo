---
title: "Crie um dashboard a partir de dados"
description: "Transforme um CSV público, planilha, banco de dados, conector de warehouse ou API em um dashboard que responde a uma pergunta clara."
---
...
Os dashboards também podem suportar exportação de PDF, exportação de CSV de gráfico, atualização, atualização automática, modo claro/escuro e resumos de análise. Veja [Visualização de Dados](/pt/features/artifact-types/data-apps) para a visão geral do conceito.
...
* [Visualização de Dados](/pt/features/artifact-types/data-apps)
* [Conectores de Dados](/pt/connectors/warehouses/overview)
* [Adicionar login](/pt/build/add-login)
