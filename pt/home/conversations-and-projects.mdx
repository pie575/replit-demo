---
title: "Conversas e projetos"
description: "Entenda quando continuar o trabalho em uma Conversa e quando usar um Projeto para trabalho substancial de construção ou design."
---
...
Você pesquisou a vizinhança, conectou suas ferramentas e criou um plano de
lançamento. Agora é hora de contar às pessoas sobre sua cafeteria. Para isso,
você vai criar um site de abertura.

Antes de começar, ajuda entender os dois lugares onde esse trabalho vive no
Replit: conversas e projetos.

## Do plano ao projeto

O lançamento da cafeteria começou em uma conversa. Foi ali que você moldou a
ideia, pesquisou o mercado, conectou ferramentas e criou uma Rotina.

Agora você está pronto para construir um site de abertura. Um projeto é o
lugar para esse trabalho substancial de design e construção. O Replit pode
usar o contexto já existente na conversa, então você não precisa começar do
zero.

## O que é uma conversa?

Uma **conversa** é uma única thread onde você faz perguntas, explora
informações, executa Rotinas e continua o trabalho por meio de
acompanhamentos. Nesta história, ela guarda a pesquisa e o plano de
lançamento da cafeteria.

## O que é um projeto?

Um **projeto** é um espaço durável e estruturado para trabalho substancial de
construção e design. Nesta história, é onde você vai criar e refinar o site
de abertura.

## Como eles trabalham juntos

| Área        | Conversa                                                                               | Projeto                                                                        |
| ----------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Melhor para | Explorar a ideia, pesquisar concorrentes e executar o monitoramento semanal de mercado | Projetar e construir o site de abertura                                        |
| Estrutura   | Uma única thread com sua pesquisa, decisões e acompanhamentos                          | Um espaço estruturado para o site, seu design e outros artefatos de construção |
| Rotinas     | Criar e gerenciar pesquisas recorrentes                                                | Usar os resultados que retornam à conversa                                     |
| Contexto    | Guarda o plano de lançamento que trouxe você até aqui                                  | Começa com a direção que você estabeleceu na conversa                          |

Comece em uma conversa quando quiser perguntar ou explorar. Passe para um
projeto quando estiver pronto para construir. A transição mantém a direção
que você já criou.

## Relacionados

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/chat/conversations">
    ...
    <div className="chat-example-tag">Perguntar e explorar</div>
    <div className="chat-card-title">Conversas</div>

    <p>
      Saiba como as Conversas dão suporte a perguntas, exploração, Rotinas e
      resultados.
    </p>
  ...
  <a className="chat-example has-visual" href="/pt/features/projects-and-artifacts/projects">
    ...
    <div className="chat-example-tag">Construir e organizar</div>
    <div className="chat-card-title">Projetos</div>

    <p>
      Saiba como os Projetos organizam trabalho substancial de construção e
      design com múltiplos artefatos.
    </p>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/home/design-an-opening-site">
    <div className="chat-use-case-visual">
    ...
    <div className="chat-example-tag">Site de abertura</div>
    <div className="chat-card-title">Projetar o site de abertura</div>
    <p>Use a conversa e o plano de lançamento para criar um site para seu café.</p>
