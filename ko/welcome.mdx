---
title: "Replit에 오신 것을 환영합니다"
description: "Replit이 아이디어와 일상 업무, 그리고 인공지능을 유용한 결과물로 바꿔주는 방법을 알아보세요."
sidebarTitle: "Replit에 오신 것을 환영합니다"
...
<div className="welcome-home">
  <section className="welcome-hero-card" aria-labelledby="welcome-home-heading">
    <div>
      <div className="welcome-eyebrow">시작하기</div>
      <h1 id="welcome-home-heading">Replit에 오신 것을 환영합니다</h1>
      <p>아이디어와 일상 업무, 그리고 AI를 유용한 결과물로 만들어 보세요.</p>

      <div className="welcome-actions">
        <a className="welcome-action primary" href="/ko/home/get-started">시작하기 <span aria-hidden="true">→</span></a>
        <a className="welcome-action" href="/ko/use-cases">활용 사례 살펴보기</a>
      </div>
    </div>
  ...
  <section className="welcome-journey-strip" aria-label="Replit 가이드 여정">
    <div className="welcome-journey-preview">
      <img src="/assets/mirror/coffee-shop-opening-site-hero-13cea43653ac.jpg" alt="'일상을 위한 조용한 공간'이라는 헤드라인이 담긴 커피숍 오픈 사이트" width="1800" height="989" data-path="images/coffee-shop-launch/coffee-shop-opening-site-hero.jpg" />
    </div>

    <div className="welcome-journey-copy">
      <div className="welcome-journey-title">
        아이디어를 live site로 만드는 방법을 알아보세요
      </div>

      <p>
        첫 conversa부터 리서치, 기획, Design, Publishing까지
        안내에 따라 여정을 따라가 보세요.
      </p>

      <a className="welcome-journey-link" href="/ko/home/get-started">
        여정 시작하기 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-use-cases-heading">
    <h2 className="welcome-section-heading" id="welcome-use-cases-heading">
      Replit으로 무엇을 할 수 있나요?
    </h2>

    <div className="chat-mkt welcome-use-case-grid">
      <a className="welcome-use-case-card" href="/ko/use-cases/prepare-for-a-customer-call">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>고객 미팅 전마다 핵심만 정리된 brief를 받아보세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ko/use-cases/analyze-customer-feedback">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>정리되지 않은 feedback을 theme과 실행 가능한 인사이트로 바꿔보세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ko/use-cases/source-candidates">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>연결된 컨텍스트를 활용해 후보자를 찾고 필터링하세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ko/use-cases/monitor-brand-mentions">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>중요한 대화를 놓치지 않고 빠르게 담당자에게 전달하세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ko/use-cases/weekly-pipeline-report">
        ...
        <div className="welcome-use-case-copy">
          ...
          <p>현재 파이프라인 데이터를 한눈에 보기 쉬운 영업 현황 리포트로 만들어 보세요.</p>
        </div>
      ...
      <a className="welcome-use-case-card" href="/ko/use-cases/track-subscriptions">
    ...
    <div className="welcome-use-cases-cta">
      <a className="welcome-use-cases-button" href="/ko/use-cases">
        활용 사례 살펴보기 <span aria-hidden="true">→</span>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-section" aria-labelledby="welcome-products-heading">
    ...
    <div className="welcome-products-grid">
      <a className="welcome-product-card" href="/ko/chat/overview">
        <div className="product-path-visual chat" role="img" aria-label="Replit Chat을 나타내는 간결한 대화 창">
        ...
        <p>
          대화로 시작하세요. 질문하고, 아이디어를 탐색하고, 계획을
          문서로 정리하세요.
        </p>

        <div className="welcome-product-link">
          대화 시작하기 <span aria-hidden="true">→</span>
        </div>
      </a>

      <a className="welcome-product-card" href="/ko/build/your-first-app">
        <div className="product-path-visual build" role="img" aria-label="Replit Build를 나타내는 코드 편집기와 라이브 미리보기">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          아이디어를 실제 앱과 사이트로 구현하세요. 자신 있게 만들고, 개선하고,
          게시하세요.
        </p>
      ...
      <a className="welcome-product-card" href="/ko/design/what-is-replit-design">
        <div className="product-path-visual design" role="img" aria-label="Replit Design을 나타내는 선택된 캔버스 구성">
          <span className="product-path-layer product-path-back" />
        ...
        <p>
          아름다운 인터페이스와 콘텐츠를 만드세요. layout과 구성 요소,
          사용자 경험을 다듬어 나가세요.
        </p>

        <div className="welcome-product-link">
          디자인 시작하기 <span aria-hidden="true">→</span>
        </div>
      </a>
    </div>
  </section>
  ...
  <section className="welcome-access-panel" aria-labelledby="welcome-access-heading">
    <div className="welcome-access-copy">
      <h2 id="welcome-access-heading">Replit 시작하기</h2>
      <p>Replit을 사용할 환경을 선택한 다음 로그인하거나 계정을 만드세요. 웹, 데스크톱 앱, 모바일 앱 어디서든 시작할 수 있습니다.</p>
    </div>

    <div className="welcome-access-grid">
      <a className="welcome-access-card" href="https://replit.com" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">◎</span><strong>웹</strong><b aria-hidden="true">→</b><small>브라우저에서 열기</small></a>
      <a className="welcome-access-card" href="https://replit.com/desktop" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▣</span><strong>데스크톱</strong><b aria-hidden="true">→</b><small>macOS 및 Windows</small></a>
      <a className="welcome-access-card" href="https://replit.com/mobile" target="_blank" rel="noreferrer"><span className="welcome-access-icon" aria-hidden="true">▯</span><strong>모바일</strong><b aria-hidden="true">→</b><small>iOS 및 Android</small></a>
    </div>
  </section>
</div>