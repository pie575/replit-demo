---
title: "Configurando um Sistema de Design"
description: "Configure o Agent com o sistema de design da sua organização — biblioteca de componentes, ativos de marca, tokens de design e padrões visuais — para que cada aplicativo, site e artefato siga a linguagem visual da sua organização."
sidebarTitle: "Sistemas de Design"
icon: "palette"
---
...
3. **Revise o resultado.** Verifique se todos os componentes parecem corretos e correspondem às suas expectativas. Depois que tudo for verificado, prossiga para [Criando a skill do sistema de design](#criando-a-skill-do-sistema-de-design).

### Criando a skill do sistema de design

Com seus componentes prontos, a etapa final é criar uma skill do sistema de design para que o Agent possa referenciar seus componentes, tokens e padrões de uso em cada projeto.

Copie o prompt completo abaixo e cole-o no Agent. Substitua `<nome-do-seu-sistema-de-design>` pelo nome do seu sistema de design:
...
Defina o acesso dos membros como **Somente leitura** para que os membros possam ver e usar o sistema de design fixado sem poder editá-lo.
...
O sistema de design agora aparece como uma pílula selecionável abaixo da caixa de entrada do Agent para todos os membros da sua organização. Para removê-lo, abra o mesmo menu e selecione **Desafixar da caixa de entrada do Agent**.

<img src="/assets/mirror/custom-templates-input-box-553384ac7dd0.png" alt="Sistema de design aparecendo como uma pílula selecionável na caixa de entrada do Agent" width="1746" height="726" data-path="images/teams/custom-templates-input-box.png" />
...
Os sistemas de design e os [templates personalizados](/pt/teams/custom-templates) servem a propósitos diferentes:

|                   | Sistemas de Design                                                                           | Templates Personalizados                                                              |
| ----------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
...
* [Templates Personalizados](/pt/teams/custom-templates) - Configure stacks completamente personalizadas para sua organização
* [Agent Skills](/pt/features/agent/skills) - Como as skills funcionam e como criá-las
* [Usar uma skill](/pt/build/use-agent-skills) - Guia prático para usar skills
* [replit.md](/pt/features/project-setup/replit-dot-md) - Personalize o comportamento do Agent com contexto do projeto
