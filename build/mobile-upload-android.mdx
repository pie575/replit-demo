---
title: "Upload your app to Play Console"
description: "Build a production release and upload it to Google Play Console by hand."
...
<Steps>
  <Step title="Download the .aab file">
    ...
    <Frame caption="Agent's download link for the finished .aab build.">
      <img src="/assets/mirror/download-aab-file-37eb1c14cbd2.png" alt="Agent chat message with a download link to the finished .aab file" data-path="images/pixelgames/mobile/download-aab-file.png" width="449" height="206" data-path="images/pixelgames/mobile/download-aab-file.png" />
    </Frame>
  </Step>
