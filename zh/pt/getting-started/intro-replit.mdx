---
title: "概览"
description: "Replit 是将创意变为应用的最快方式。有 AI 触手可及，你可以在浏览器中构建并发布出色的项目。"
---
...
<YouTubeEmbed videoId="-2xHmkpmCBM" title="Replit 概览" />

Replit 是一个由 AI 驱动的平台，让你在一个浏览器标签页中就能创建并部署应用。
无需折腾复杂的开发环境，编程、部署和协作工具都集中在同一个界面里。

用传统方式开发应用，需要安装各种程序、语言和包，配置过程既繁琐又耗时。
在 Replit 上，平台会即时为你配置好环境，无论你是初学者还是经验丰富的开发者，都能立即上手构建。

<div align="center">
  <AgentInput />
</div>

创建应用所需的一切，都在一个浏览器标签页中，无需任何安装。
借助 AI 编程工具、实时协作和即时分享，Replit 助你快速将创意变成应用。

<div id="guias-de-incio-rpido">
  ## 快速入门指南
</div>

要在 Replit 上创建应用，请选择适合你需求的指南：
...
<CardGroup cols={2}>
  <Card title="创建你的第一个应用" icon="robot" href="/zh/pt/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 分钟*

    使用 Replit 的 AI 工具创建你的第一个应用。
  </Card>

  <Card title="Remix 现有应用" icon="shuffle" href="/zh/pt/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 分钟*

    在社区贡献的应用基础上构建，让项目快速起步。
  </Card>
</CardGroup>
...
Replit 提供以下核心的应用构建工具：

* 实时[预览 Preview](/zh/core-concepts/workspace/editor-and-tools/preview) 你的应用
* [几分钟内完成部署](/zh/category/replit-deployments)
* 浏览器原生应用，无需安装或配置
* [功能完备的代码编辑器](/zh/core-concepts/workspace/editor-and-tools)
* [移动应用](/zh/platforms/mobile-app)，随时在手机或平板上构建应用
* [AI 辅助应用构建](/zh/pt/core-concepts/agent)
* [版本控制集成](/zh/core-concepts/workspace/version-control)，轻松跟踪变更
* [团队协作](/zh/pt/category/teams)，与他人共同构建

<div id="capacidades-do-assistente-de-ia">
  ### AI 助手功能
</div>

Replit 的 [Agent](/zh/pt/core-concepts/agent) 可通过以下功能加速应用开发：
...
<CardGroup cols={3}>
  ...
  <Card title="符合 LGPD/GDPR" icon="lock">
    满足适用监管标准的数据隐私保护措施。
  </Card>

  <Card title="企业级就绪" icon="building" href="/zh/pt/category/teams">
    SSO/SAML、基于角色的访问控制、管理员控制项与专属支持。
  </Card>
</CardGroup>
...
如需了解 Replit 的全部功能，请参阅以下资源：

* [Starter 方案](/zh/pt/billing/plans/starter-plan)：了解 Starter 方案包含哪些功能，以及你可以免费构建些什么
* 在[工作区功能](/zh/core-concepts/workspace/editor-and-tools)中了解工作区的各项功能。
* 在 [Replit Agent](/zh/pt/core-concepts/agent/) 中了解 Replit AI 驱动功能的能力。
* 在[分享你的 Replit App](/zh/replit-app/collaborate/) 中了解如何分享你的作品。
* 为 iOS 或 Android 设备[下载移动应用](https://replit.com/mobile/)。