---
title: "Prompts"
description: "Dê ao Replit uma direção clara em uma Conversa e refine o resultado com solicitações de acompanhamento úteis."
...
Saiba como [direcionar ou enfileirar mensagens de acompanhamento](/pt/features/agent/steer-and-queue-messages) enquanto o Replit trabalha.

Depois que a solicitação estiver clara, saiba como [adicionar contexto](/pt/chat/add-context) para que o Replit tenha as informações e ferramentas relevantes para a tarefa.
