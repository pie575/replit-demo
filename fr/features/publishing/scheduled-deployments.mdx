---
title: "Déploiements programmés"
description: "Découvrez comment exécuter des tâches selon un calendrier avec les déploiements programmés."
---
...
<Frame>
  <img src="/assets/mirror/scheduled-deployments-11ce7794e4cb.jpg" alt="Déploiements programmés" width="1920" height="1080" data-path="images/deployments/scheduled/scheduled-deployments.jpg" />
</Frame>
...
<Frame caption="Écran de configuration des tâches programmées dans l'outil de publication">
  <img src="/assets/mirror/scheduled-deployment-options-89fb7f0241e5.png" alt="Options de déploiement programmé" width="4052" height="2040" data-path="images/deployments/scheduled/scheduled-deployment-options.png" />
</Frame>
...
consultez la [section Déploiements programmés](/fr/billing/deployment-pricing#scheduled-deployments) dans notre documentation sur les tarifs.
...
<img class="icon-svg" src="/assets/mirror/vertical-dots-032f1c99d22e.svg" width="16" height="16" alt="icône trois points verticaux" data-path="images/icons/vertical-dots.svg" /> les trois points verticaux et choisissez **Modifier** dans le menu. Le gestionnaire de secrets applique uniquement
