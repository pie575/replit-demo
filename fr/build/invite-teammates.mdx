...
description: "Invitez des coéquipiers sur votre projet et développez ensemble — chacun peut ouvrir de nouveaux fils de discussion avec Agent tout en travaillant sur le même projet."
sidebarTitle: "Inviter des coéquipiers"
icon: "user-plus"
---
...
Replit permet à plusieurs personnes de travailler simultanément dans le même projet. Chacun peut lancer de nouveaux fils de discussion de planification avec Agent, et les tâches de tous s&#39;affichent sur le tableau partagé : votre équipe construit ainsi ensemble, au lieu de se relayer.

<div id="start-building-with-teammates">
  ## Commencez à développer avec vos coéquipiers
</div>
...
3. Vos coéquipiers rejoignent le projet et lancent de nouveaux fils de discussion avec Agent
...
Chaque personne peut créer de nouveaux fils de discussion, ce qui vous permet de travailler chacun de votre côté sans vous interrompre mutuellement. Les tâches de chacun apparaissent sur le tableau Kanban partagé : vous voyez ainsi facilement qui travaille sur quoi et vous évitez d&#39;empiéter sur le travail des autres.

<Note>
  Avec Core, une seule tâche en arrière-plan peut s&#39;exécuter à la fois pour l&#39;ensemble du projet. Avec Pro, jusqu&#39;à 10 tâches peuvent s&#39;exécuter en parallèle : plusieurs personnes peuvent donc faire développer différentes parties du projet par Agent simultanément.
</Note>

<div id="the-shared-task-board">
  ## Le tableau de tâches partagé
</div>

Lorsque votre équipe collabore, les tâches de chacun apparaissent sur le même tableau. Vous voyez d’un coup d’œil qui travaille sur quoi, ce qui est en cours et ce qui est prêt à être appliqué.

<Frame>
  <img src="/assets/mirror/task-board-progress-f4d3b5e7e93e.png" alt="Tableau de tâches présentant des tâches organisées dans les colonnes Brouillons, En cours, Prêtes et Terminées" width="3456" height="1984" data-path="images/replitai/task-board-progress.png" />
</Frame>
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px', margin: '20px 0' }}>
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    <TaskCard title="Ajouter une fonctionnalité de cadeau pour la famille et les amis" description="Permettre aux parents de créer une histoire pour l'enfant d'une autre personne et de l'offrir en cadeau." status="draft-static" timestamp="2m" width="100%" />
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    <TaskCard title="Suites d'histoires — continuations" description="L'ajout d'un bouton « Poursuivre l'aventure » génère une suite qui reprend là où la précédente s'est arrêtée." status="active" timestamp="12m" width="100%" />

    <span style={{ fontSize: '13px', color: 'var(--kb-text-dimmer, #666)', padding: '0 4px' }}><strong>En cours</strong> — Agent réalise actuellement cette tâche dans sa propre copie isolée du projet.</span>
  </div>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
    <TaskCard title="Lecture à voix haute avec mise en évidence des mots" description="La synthèse vocale permet aux enfants de profiter des histoires de manière autonome tout en suivant les mots mis en évidence." status="done" timestamp="4h" width="100%" />

    <span style={{ fontSize: '13px', color: 'var(--kb-text-dimmer, #666)', padding: '0 4px' }}><strong>Terminée</strong> — Cette tâche est terminée et ses modifications font partie de la version principale.</span>
  </div>
</div>
...
Lorsque plusieurs personnes développent en même temps, les tâches de chacun apparaissent sur le tableau partagé. Voici ce que cela donne : un coéquipier travaille sur les suites et la régénération d&#39;histoires pendant qu&#39;un autre s&#39;occupe du parcours cadeau, tandis que le reste du travail terminé par l&#39;équipe se trouve dans Prêt et Terminé.

<KanbanColumns
  columns={[
{ title: 'En cours', count: 3, cards: [
{ title: 'Suites d\'histoires — épisodes suivants', description: 'L\'ajout d\'un bouton « Continuer l\'aventure » génère une suite qui reprend là où la précédente s\'est arrêtée.', status: 'active', timestamp: '12 min' },
{ title: 'Régénération d\'histoires — refaire des pages', description: 'La possibilité de régénérer des pages individuelles donne le contrôle aux parents et réduit la frustration.', status: 'active', timestamp: '8 min' },
{ title: 'Ajouter un parcours cadeau pour la famille et les amis', description: 'Permettre aux parents de créer une histoire pour l\'enfant de quelqu\'un d\'autre et de l\'offrir en cadeau.', status: 'active-queued', timestamp: '1 min' },
] },
{ title: 'Prêt', count: 2, cards: [
{ title: 'Mode lecture du soir avec thème sombre', description: 'Un mode coucher dédié avec un thème sombre aux tons chauds et des sons d\'ambiance.', status: 'ready-drop', timestamp: '35 min', showMenu: true },
...
{ title: 'Adaptation mobile et finitions pour la production', description: 'Meilleurs états d\'erreur, mises en page mobiles et animations de chargement.', status: 'done', timestamp: '4 h' },
] }
]}
/>
...
* **Intégrer un nouveau coéquipier** : il peut explorer le projet depuis son propre chat Agent, poser des questions sur le fonctionnement de l&#39;ensemble et commencer à contribuer, le tout sans bloquer personne.
* **Livrer plus vite avec Pro** : grâce à l&#39;exécution parallèle, deux ou trois personnes peuvent lancer chacune des tâches qui s&#39;exécutent simultanément. Un projet qui occuperait une personne pendant toute une session peut être bouclé en une fraction du temps.
...
<Accordion title="Puis-je envoyer un message à un coéquipier via Agent ?">
  Non. Agent n&#39;est pas un outil de messagerie : il écoute en permanence et tentera d&#39;agir sur tout ce que vous saisissez. Utilisez Slack, Discord ou un autre outil pour communiquer avec votre équipe.
</Accordion>

<Accordion title="Risquons-nous d'écraser mutuellement notre travail ?">
  Le système de tâches limite ce risque en attribuant à chaque tâche sa propre copie isolée, tout en tenant compte des autres tâches existantes. Une fois les tâches terminées, vous les appliquez à la version principale et résolvez les éventuels conflits à ce moment-là.
</Accordion>

<Accordion title="Comment voir ce que font mes coéquipiers ?">
  Consultez le tableau Kanban pour voir les tâches en cours. Vous pouvez également voir la présence des curseurs et les fichiers que vos coéquipiers consultent.
</Accordion>

<Accordion title="Puis-je retirer quelqu'un de mon projet ?">
  Oui. Les propriétaires de projet peuvent gérer les membres de l&#39;équipe et révoquer leur accès à tout moment.
</Accordion>
...
| ------------------------------ | ---- | --- |
| Licences de collaboration      | 5    | 15  |
| Chats simultanés               | ✅    | ✅   |
| Kanban partagé                 | ✅    | ✅   |
