...
description: "Apprenez à créer un bouton « Ouvrir dans Replit » qui permet aux visiteurs de commencer à construire depuis votre application ou site web."
---
...
| ---------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `stack`    | string | Le mode de construction à utiliser. Doit être soit `Design` soit `Build`. `Design` ouvre [Canvas](/fr/design/canvas) pour le prototypage visuel. `Build` ouvre [Agent](/fr/features/agent/overview) pour le développement d'applications complet. | Requis           |
...
Utilisez `stack=Design` pour ouvrir votre invite dans [Canvas](/fr/design/canvas), qui est optimisé pour :
...
Utilisez `stack=Build` pour ouvrir votre invite dans [Agent](/fr/features/agent/overview), qui est optimisé pour :
...
* [Intégrations IA Replit](/fr/features/integrations/overview)
