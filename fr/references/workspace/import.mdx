...
| ZIP                    | Upload de fichier `.zip`                                     | Importation d'archives de projets locaux                  |
| Tableur                | Fichier `.xlsx`, `.csv` ou URL Google Sheets                 | Créer une application à partir de données de tableur      |
...
<CardGroup cols={2}>
  <Card title="Importer depuis GitHub" icon="github" href="/fr/build/import-from-github">
    ⏰ *2 minutes*

    Importez un dépôt GitHub dans Replit.
  </Card>

  <Card title="Importer depuis Figma" icon="figma" href="/fr/design/import-figma-designs-into-replit-design">
    ⏱️ *3 minutes*

    Convertissez un frame Figma en application React.
  </Card>

  <Card title="Importer depuis Vercel" icon="triangle" href="/fr/build/import-from-vercel">
    ⏱️ *3 minutes*

    Importez le dépôt GitHub derrière un projet Vercel.
  </Card>

  <Card title="Importer depuis Base44" icon="grid-2" href="/fr/build/import-from-base44">
    ⏱️ *4 minutes*

    Exportez depuis Base44, puis importez dans Replit.
  </Card>

  <Card title="Importer depuis Bolt" icon="bolt" href="/fr/build/import-from-bolt">
    ⏱️ *4 minutes*

    Exportez depuis Bolt, puis importez dans Replit.
  </Card>

  <Card title="Importer depuis Lovable" icon="heart" href="/fr/build/import-from-lovable">
    ⏱️ *4 minutes*

    Exportez depuis Lovable, puis importez dans Replit.
  </Card>

  <Card title="Importer depuis ZIP" icon="file-zip" href="/fr/build/import-from-zip">
    ⏱️ *3 minutes*

    Uploadez une archive `.zip` et continuez avec Agent.
  </Card>
</CardGroup>
