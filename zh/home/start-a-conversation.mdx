---
title: "开始对话"
description: "通过简单提问、网络研究或关联的上下文开始对话，然后选择下一步操作。"
sidebarTitle: "开始对话"
icon: "comments"
...
你的 Workspace 已准备就绪。现在就来推进你的咖啡店创意。
发起一段[对话](/zh/chat/conversations)，告诉 Replit 你想要
创建什么，开始将最初的想法变为切实可行的上线计划。

<div id="start-a-new-conversation">
  ## 开始新对话
</div>

在 Replit 侧边栏中选择 **新建**。随即会打开一个对话，你可以在其中构思想法、调研市场并规划发布。

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="Demo workspace 的 Replit 主界面，突出显示了“新建”按钮、推荐提示词和消息输入框" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>
...
选择 **新建** 后，来了解一下提示词框。你可以在这里向 Replit 说明需求、添加有用的上下文，并继续推进咖啡店上线。
下一步是编写第一条提示词。

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="提示词框的加号菜单，包含上传文件、新建内容、导入项目、使用 skill 或设计系统，以及添加集成等选项" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/home/describe-your-idea">
    ...
    <div className="chat-example-tag">第一个提示词</div>
    <div className="chat-card-title">明确构想</div>
    <p>为咖啡店开业撰写一条明确的初始请求。</p>
