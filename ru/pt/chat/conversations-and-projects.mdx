---
title: "Conversation и Project"
description: "Разберитесь, когда стоит продолжить работу в Conversation, а когда превратить серьёзную задачу в Project."
sidebarTitle: "Conversation и Project"
tag: "New"
icon: "objects-column"
...
Работая в Replit, вы либо ведёте Conversation, либо создаёте Project. Conversation подходят для вопросов, исследования идей, уточняющих запросов и Routines. Project предназначены для разработки приложений, а также для создания презентаций и дизайнов.

[Узнайте, как превратить Conversation в Project.](/ru/pt/chat/continue-or-create-a-project)

<div id="como-eles-diferem">
  ## Чем они отличаются
</div>

Хотя Conversation и Project связаны между собой, у них разные назначения. Вот основные различия:

| Область                  | Conversation                              | Project                                                                                                                                        |
| ------------------------ | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Лучше всего подходит для | Вопросов, изучения и Routine              | Более масштабной работы над разработкой и дизайном: приложениями, презентациями, дашбордами и несколькими артефактами                          |
| Структура                | Одна ветка                                | Рабочее пространство Project с несколькими артефактами                                                                                         |
| Фоновые задачи           | Недоступны                                | Могут выполняться параллельно                                                                                                                  |
| Routine                  | Доступны                                  | Недоступны                                                                                                                                     |
| Интеграции               | Доступны                                  | Доступны                                                                                                                                       |
| Может создавать          | Ресурсы: документы, изображения и таблицы | Ресурсы: документы, изображения и таблицы, а также [артефакты](/ru/pt/features/projects-and-artifacts/artifacts): презентации, приложения и сайты |
| Публикация               | Нельзя опубликовать                       | Можно опубликовать и сделать общедоступным                                                                                                     |

<Frame>
  <img src="/assets/mirror/conversation-and-project-icons-025a17613daa.png" alt="Боковая панель Replit со значком чата для Conversation и значком сетки для Project" width="466" height="290" data-path="images/chat/conversation-and-project-icons.png" />
</Frame>