...
<Frame>
  <img src="/assets/mirror/integrations-page-5bba136204d7.png" alt="The redesigned Integrations settings page with All integrations and Your integrations tabs, a search box, a Recommended for you row showing GitHub, GitLab, and AWS, and an All integrations grid of cards including Airtable, Apollo, and Asana with Sign in or Enable buttons and verified badges" width="2000" height="1062" data-path="images/changelog/2026-06-26/integrations-page.png" />
</Frame>
...
<Frame>
  <img src="/assets/mirror/allow-replit-app-access-slack-d236d2698281.png" alt="Slack consent screen titled 'Allow the Replit app to access Slack', marked approved by Slack, with a workspace picker set to Replit, the information the Replit app can view and the actions it can take, and Cancel and Allow buttons" width="1816" height="1358" data-path="images/changelog/2026-06-26/allow-replit-app-access-slack.png" />
</Frame>
