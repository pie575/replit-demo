...
description: "Découvrez l'Éditeur de projet : votre base sur Replit où vous parlez à Agent, regardez votre application prendre forme et gérez tout."
---
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="L'écran d'accueil de l'Éditeur de projet Replit montrant le champ de saisie où vous décrivez ce que vous souhaitez construire" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

## Qu'est-ce que l'Éditeur de projet ?

L'Éditeur de projet est votre base sur Replit : l'environnement où vous commencez à construire, gérez vos projets et regardez vos applications prendre vie. Depuis cet espace, vous pouvez décrire ce que vous souhaitez créer, et [Agent](/fr/core-concepts/agent) s'occupe du reste — il écrit le code, configure votre projet et vous affiche une prévisualisation en direct en temps réel.

## Premiers pas

Saisissez ce que vous souhaitez créer dans le champ de saisie. Décrivez votre idée en langage courant — « un suivi de budget qui trace mes dépenses », « une page d'accueil pour mon café », « un générateur de bandes dessinées IA pour enfants » — et Agent gère le reste.

<AgentInput />

Vous pouvez également sélectionner un type de projet dans le carrousel pour indiquer à Agent le type de résultat souhaité — application web, application mobile, présentations, design, et plus encore. Ou ignorez la sélection et décrivez simplement votre idée ; Agent détermine automatiquement la bonne configuration.

<AgentCarousel />

Pour démarrer directement, suivez le [guide de démarrage rapide Créer avec l'IA](/fr/getting-started/quickstarts/ask-ai/).
...
Activez le mode Plan depuis le bouton en bas du champ de saisie. En savoir plus dans le [guide du mode Plan](/fr/core-concepts/agent/plan-mode).
...
* **Applications web** — Tableaux de bord, outils internes, produits SaaS, pages d'accueil
* **Applications mobiles** — Applications iOS et Android à partir d'une seule invite
* **Diaporamas et présentations** — Générez des présentations avec des mises en page riches
* **Animations** — Présentations interactives et graphiques animés
* **Designs** — Maquettes visuelles et prototypes sur le [Design Canvas](/fr/replitai/canvas)
* **Visualisations de données** — Graphiques, tableaux de bord et outils basés sur des bases de données
* **Documents** — Fichiers CSV, PDF, PowerPoint, documents Markdown
* **Feuilles de calcul** — Tableaux de données et sorties structurées

## L'Éditeur de projet

Une fois qu'Agent commence à construire, l'Éditeur de projet est l'endroit où vous voyez votre projet prendre forme. Il est divisé en panneaux : votre conversation avec Agent d'un côté, et une prévisualisation en direct de votre application de l'autre.

### Fils de discussion

Chaque conversation avec Agent se déroule dans un fil de discussion. Votre fil principal est l'endroit où vous décrivez ce que vous voulez et regardez Agent le construire. Lorsque vous utilisez le [système de tâches](/fr/core-concepts/agent/task-system), chaque tâche en arrière-plan obtient son propre fil de discussion — Agent peut ainsi isoler le travail des tâches sans mélanger les conversations.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Un fil de discussion montrant l'invite de l'utilisateur et Agent construisant le projet" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>

### Tableau des tâches

Le tableau des tâches organise votre travail en colonnes — **Brouillons**, **Actif**, **Prêt** et **Terminé**. Chaque tâche se déplace de gauche à droite au fur et à mesure de sa progression, ce qui vous permet de voir en un coup d'œil ce qui est planifié, sur quoi Agent travaille et ce qui est terminé. En savoir plus dans [Construire en parallèle](/fr/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Tableau des tâches montrant les tâches organisées en colonnes Brouillons, Actif, Prêt et Terminé" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>

### Design Canvas

Le Design Canvas est un éditeur visuel où vous pouvez créer et affiner des maquettes avant de vous engager dans le code. Faites glisser des éléments, ajustez les mises en page et itérez sur votre design — puis laissez Agent le transformer en application fonctionnelle. En savoir plus dans [Design Canvas](/fr/replitai/canvas).

## Collaboration

Créez un Espace de travail d'équipe pour construire ensemble. Invitez des coéquipiers, partagez des projets et travaillez sur la même application en temps réel. Consultez [Espaces de travail d'équipe](/fr/core-concepts/workspaces/team-workspaces) pour la configuration de l'équipe et [Inviter des coéquipiers](/fr/replitai/invite-teammates) pour la collaboration au niveau du projet.

## Importer du code et des designs

Vous avez déjà un projet ? Importez-le dans Replit depuis GitHub, Figma, ou téléchargez des fichiers directement. Agent peut reprendre là où vous vous êtes arrêté et continuer à construire à partir de votre code ou design existant. Consultez [Importer dans Replit](/fr/core-concepts/project-editor/app-setup/import).

## Prochaines étapes

<CardGroup cols={2}>
  <Card title="Éditeur et outils" href="/fr/core-concepts/project-editor/editor-and-tools" icon="window-restore">
    Les panneaux principaux où vous voyez la prévisualisation de votre application, la sortie console et d'autres outils
  </Card>

  <Card title="Configuration de l'application" href="/fr/core-concepts/project-editor/app-setup/configuration" icon="gear">
    Configurez les paramètres, les dépendances, les secrets et l'environnement de votre application
  </Card>

  <Card title="Contrôle de version" href="/fr/core-concepts/project-editor/version-control" icon="clock-rotate-left">
  ...
  <Card title="Publication" href="/fr/category/replit-deployments" icon="rocket">
    Déployez votre application sur une URL en direct accessible à tous
  </Card>
</CardGroup>
...
<Accordion title="Dois-je savoir coder ?">
  Non. Décrivez ce que vous souhaitez en langage courant et Agent gère les détails techniques. Vous pouvez également effectuer des modifications directes si vous le souhaitez.
</Accordion>

<Accordion title="Que se passe-t-il quand je ferme mon navigateur ?">
  Votre projet est sauvegardé dans le cloud. Revenez à tout moment et reprenez exactement là où vous vous êtes arrêté : vos fichiers, votre historique et votre application en cours d'exécution sont tous préservés.
</Accordion>

<Accordion title="Puis-je travailler avec d'autres personnes ?">
  Oui. Vous pouvez inviter des collaborateurs à un projet spécifique ou créer un Espace de travail d'équipe où les membres accèdent à tous les projets. Consultez [Espaces de travail d'équipe](/fr/core-concepts/workspaces/team-workspaces) et [Inviter des coéquipiers](/fr/replitai/invite-teammates).
</Accordion>

<Accordion title="Comment publier mon application ?">
  Lorsque votre application est prête, déployez-la sur une URL en direct directement depuis l'Éditeur de projet. Consultez [Déploiements](/fr/category/replit-deployments).
</Accordion>

## Disponibilité

L'Éditeur de projet est disponible sur tous les plans. Certaines fonctionnalités comme le calcul accru et les déploiements toujours actifs nécessitent un plan payant. Consultez [Facturation](/fr/billing/ai-billing) pour plus de détails.
