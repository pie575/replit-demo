...
description: "Learn how to use the Git pane for version control, branch management, and collaboration in the Project Editor."
icon: "code-fork"
---
...
* To avoid re-entering credentials, you can store them using Replit Secrets:
  ...
  2. Set the value to `https://<username>:<token>@<git-host>/<owner>/<repository>`
