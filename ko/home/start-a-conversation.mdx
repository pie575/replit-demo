---
title: "대화 시작하기"
description: "간단한 질문, 웹 리서치, 연결된 컨텍스트로 Conversation을 시작한 다음, 다음에 할 일을 선택하세요."
---
...
워크스페이스가 준비되었습니다. 이제 커피숍 아이디어를 진전시킬 차례입니다.
[대화](/ko/chat/conversations)를 시작하고, Replit에 만들고 싶은 것을 알려주고,
첫 번째 아이디어를 실제 출시 계획으로 바꾸기 시작하세요.

## 새 대화 시작하기

Replit 사이드바에서 **New**를 선택하세요. 그러면 개념을 구체화하고, 시장을
조사하고, 출시를 계획할 대화가 열립니다.

<Frame>
  <img src="/assets/mirror/start-new-conversation-home-sanitized-f9395b6924ec.jpg" alt="New 버튼이 강조된 Demo 워크스페이스의 Replit 홈 화면, 추천 프롬프트와 메시지 박스가 함께 표시됨" width="1451" height="1084" data-path="images/chat/start-new-conversation-home-sanitized.jpg" />
</Frame>

## 프롬프트 박스 살펴보기

**New**를 선택한 후, 프롬프트 박스를 살펴보세요. 여기서 Replit에 방향을
제시하고, 유용한 컨텍스트를 추가하고, 커피숍 출시를 계속 진행하게 됩니다.
다음 단계는 첫 번째 프롬프트를 작성하는 것입니다.

<Frame>
  <img src="/assets/mirror/prompt-box-plus-menu-8c1e2d807e0b.png" alt="파일 업로드, 새로 만들기, 프로젝트 가져오기, 스킬이나 디자인 시스템 사용, 통합 추가 옵션이 있는 프롬프트 박스의 플러스 메뉴" width="1558" height="556" data-path="images/chat/prompt-box-plus-menu.png" />
</Frame>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ko/home/describe-your-idea">
    ...
    <div className="chat-example-tag">첫 번째 프롬프트</div>
    <div className="chat-card-title">개념 구체화하기</div>
    <p>커피숍 출시를 위한 초점이 명확한 첫 요청을 작성하세요.</p>
