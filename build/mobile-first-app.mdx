---
title: "Start your first mobile app"
description: "Build PixelGames, a retro-style game app, as a native iOS and Android app with Agent."
sidebarTitle: "Start your mobile app"
...
<Frame caption="End result: PixelGames' menu and the Blocks game running on a phone.">
  <img src="/assets/mirror/pixelgames-home-screen-eeffe5c27dc1.webp" alt="PixelGames menu listing Blocks, Snake, Racer, and Pinball, with Blocks selected" width="420" height="420" data-path="images/pixelgames/mobile/pixelgames-home-screen.webp" />
</Frame>
...
<Frame caption="Agent setting up the mobile project and the console shell UI.">
  <img src="/assets/mirror/pixelgames-scaffolding-6b34f56cd5f2.png" alt="The PixelGames build prompt entered on Replit's homepage, with Mobile mode selected" data-path="images/pixelgames/mobile/pixelgames-scaffolding.png" width="877" height="411" data-path="images/pixelgames/mobile/pixelgames-scaffolding.png" />
</Frame>
...
<Frame caption="The Simulate on... dropdown in the Replit preview pane.">
  <img src="/assets/mirror/replit-simulate-dropdown-130bd3168cfe.png" alt="Replit preview pane with the Simulate on Web, iOS, or Android dropdown open" data-path="images/pixelgames/mobile/replit-simulate-dropdown.png" width="1920" height="992" data-path="images/pixelgames/mobile/replit-simulate-dropdown.png" />
</Frame>
