---
title: "Sécurité"
description: "Découvrez pourquoi la sécurité est importante lorsque vous publiez depuis Replit, où se trouvent les outils de sécurité et quelle page utiliser pour les vérifications de projet ou d'espace de travail."
---
...
* Vous travaillez sur un seul projet ? Utilisez le [Centre de sécurité de projet](/fr/core-concepts/security/project-security-center).
* Vous effectuez un audit dans tout votre espace de travail ? Utilisez le [Centre de sécurité d'espace de travail](/fr/core-concepts/security/workspace-security-center).
* Besoin d'une définition ? Consultez les [Concepts de sécurité](/fr/core-concepts/security/concepts).
