...
description: "Подключите файлы и инструменты, которые дадут Replit контекст для составления плана запуска кофейни."
---
...
Теперь, когда вы разобрались с интеграциями, давайте применим их к запуску
кофейни.

Вы выбрали направление: открыть **районную кофейню**, а не заведение,
рассчитанное на поток людей у вокзала. Дайте Replit материалы, которые
помогут превратить эту идею в план, готовый к реализации.

Интеграции соединяют Replit с инструментами и файлами, которыми вы уже
пользуетесь. Благодаря им Replit может подтянуть нужную информацию или
выполнить действия, необходимые для задачи. Вы можете подключить такие сервисы, как
**[Slack](/ru/pt/features/integrations/overview#connectors)**,
**[Google Drive](/ru/pt/features/integrations/overview#connectors)**,
**[Notion](/ru/pt/features/integrations/overview#connectors)** или
**[Salesforce](/ru/pt/features/integrations/overview#connectors)**, а также более
450 других.

В случае с кофейней Google Drive открывает Replit доступ к бюджету, заметкам о
локации, идеям меню, фотографиям и визуальным референсам. А Notion даёт
место, где можно зафиксировать план запуска, принятые решения и
открытые вопросы.

Подробнее об [интеграции ваших инструментов](/ru/pt/chat/integrate-your-tools).

<Steps>
  <Step title="Попросите Replit собрать материалы">
    Начните с запроса ниже. Replit проверит, что ему нужно для составления
    плана, и попросит подключить сервис, когда потребуется доступ.

    <AiPrompt>
      Используй мои файлы кофейни, чтобы составить план запуска на первый
      месяц для районной кофейни. Обнови соответствующие исходные допущения, а
      затем задокументируй концепцию, ключевые решения, открытые вопросы и
      чек-лист запуска в Notion.
    </AiPrompt>
  </Step>

  <Step title="Подключите Google Drive, когда Replit попросит">
    Одобрите подключение Google Drive, чтобы Replit мог изучить материалы,
    которые вы хотите ему передать. Запрос на подключение он откроет прямо в
    Chat.

    <CoffeeShopScreenshotFrame src="/assets/mirror/connect-google-drive-f7951617b078.png" alt="Replit просит подключить Google Drive, чтобы получить доступ к файлам кофейни" />
  </Step>

  <Step title="Подключите Notion, когда Replit понадобится задокументировать план">
    Одобрите Notion, когда Replit попросит создать сводку по запуску. После
    этого он сможет собрать концепцию, решения, открытые вопросы и
    чек-лист в одном месте.
  </Step>
</Steps>

Google Drive даёт Replit фактуру для работы. Notion хранит меняющийся
план в одном месте, пока вы отвечаете на новые вопросы и принимаете
решения.

Подробнее о [добавлении контекста](/ru/pt/chat/add-context), [загрузке
файлов](/ru/pt/chat/upload-and-use-files) и [интеграции ваших
инструментов](/ru/pt/chat/integrate-your-tools).
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/ru/pt/home/watch-the-competition">
    ...
    <div className="chat-example-tag">Регулярные задачи</div>
    <div className="chat-card-title">Следите за конкурентами</div>
    <p>Настройте регулярную задачу, которая будет отслеживать изменения, пока вы готовитесь к запуску.</p>
