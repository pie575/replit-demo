...
Para opções de importação abrangentes incluindo outras plataformas como GitHub, Figma e Bolt, consulte a [documentação do recurso de Importação](/pt/references/workspace/import).
...
5. Selecione o repositório do Lovable exportado.
6. Selecione **Import**.
