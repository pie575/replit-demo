---
title: "Aperçu"
description: "Replit est le moyen le plus rapide de passer d'une idée à une application. Créez et publiez de beaux projets depuis votre navigateur avec l'IA à portée de main."
---
...
<YouTubeEmbed videoId="-2xHmkpmCBM" title="Aperçu de Replit" />
...
Au lieu de vous débattre avec des environnements de développement complexes, vous disposez d'outils de codage, de publication et de collaboration dans une interface intégrée.

Créer des applications traditionnellement nécessite d'installer des programmes, des langages et des packages — un processus de configuration fastidieux.
Sur Replit, la plateforme configure votre environnement instantanément, afin que vous puissiez commencer à construire que vous soyez débutant ou développeur expérimenté.

<div align="center">
  <AgentInput />
</div>

Vous disposez de tout ce qu'il faut pour créer des applications depuis un seul onglet de navigateur — aucune installation requise.
Avec les outils de codage IA, la collaboration en temps réel et le partage instantané, Replit vous emmène de l'idée à l'application, rapidement.

## Guides de démarrage rapide

Pour créer votre application sur Replit, choisissez le guide qui correspond à vos besoins :

### Créer de nouvelles applications

<CardGroup cols={2}>
  <Card title="Créez votre première application" icon="robot" href="/fr/getting-started/quickstarts/ask-ai/">
    ⏱️ *5 minutes*

    Créez votre première application avec les outils Replit alimentés par l'IA.
  </Card>

  <Card title="Remixer une application existante" icon="shuffle" href="/fr/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1 minute*

    Lancez votre projet en vous appuyant sur des applications contribuées par la communauté.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Importer depuis Bolt" icon="bolt" href="/fr/getting-started/quickstarts/import-from-bolt/">
    ...
    Migrez vos projets Bolt vers Replit avec l'assistance de l'Agent.
  </Card>

  <Card title="Importer depuis Lovable" icon="heart" href="/fr/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4 minutes*

    Transférez vos projets Lovable vers Replit et continuez à construire.
  </Card>
</CardGroup>

### Fonctionnalités de l'Éditeur de projet

Replit fournit les outils essentiels de création d'applications suivants :

* [Aperçu en temps réel](/fr/core-concepts/project-editor/editor-and-tools/preview) de votre application
* [Publier en quelques minutes](/fr/category/replit-deployments)
* Application native dans le navigateur ne nécessitant aucune installation ni configuration
* [Éditeur de code complet](/fr/core-concepts/project-editor/editor-and-tools)
* [Application mobile](/platforms/mobile-app) pour créer des applications depuis votre téléphone ou tablette
* [Création d'applications assistée par IA](/fr/core-concepts/agent)
* [Intégration du contrôle de version](/fr/core-concepts/project-editor/version-control) pour suivre les modifications
* [Collaboration en équipe](/fr/category/teams) pour développer ensemble

### Capacités de l'assistant IA

L'[Agent](/fr/core-concepts/agent) Replit accélère la création d'applications avec les capacités suivantes :

* Génération et configuration complète d'applications à partir de descriptions en langage naturel
* Suggestions de code et autocomplétion
* Détection automatisée des erreurs et assistance au débogage
* Génération de documentation pour votre application

### Partager en quelques minutes

Publiez vos applications en quelques minutes à l'aide des outils suivants :

* Publication d'applications dans le cloud en quelques clics
* Intégration de base de données et hébergement
* Prise en charge des domaines personnalisés et chiffrement des connexions pour vos applications
...
<CardGroup cols={3}>
  ...
  <Card title="Conforme au RGPD" icon="lock">
    Protections de la confidentialité des données conformes aux normes réglementaires européennes.
  </Card>

  <Card title="Prêt pour l'entreprise" icon="building" href="/fr/category/teams">
    SSO/SAML, accès basé sur les rôles, contrôles d'administration et support dédié.
  </Card>
</CardGroup>
...
* [Plan Starter](/fr/billing/plans/starter-plan) : Découvrez les fonctionnalités du plan Starter et ce que vous pouvez créer gratuitement
* Découvrez les fonctionnalités de l'Éditeur de projet depuis [Fonctionnalités de l'Éditeur de projet](/fr/core-concepts/project-editor/editor-and-tools).
* Apprenez à partager vos créations depuis [Partager votre application Replit](/fr/replitai/invite-teammates).
