---
title: "Conversation 和项目"
description: "了解何时应在 Conversation 中继续工作，何时应使用项目进行较大规模的构建或设计工作。"
---
...
你已经调研了周边环境、连接了工具，并制定了发布计划。现在该让大家了解你的咖啡馆了。为此，你将创建一个网站首页。

开始前，先了解这项工作在 Replit 中涉及的两个位置会很有帮助：Conversation 和项目。

<div id="do-plano-ao-projeto">
  ## 从计划到项目
</div>

咖啡馆的开业始于一段 Conversation。你在这里构思
想法、研究市场、连接工具，并创建了一个例程。

现在，你已准备好构建一个开业网站。项目是开展这类重要设计和
开发工作的地方。Replit 可以利用 Conversation 中已有的上下文，因此你无需
从零开始。
...
**Conversation**是一个独立的线程，你可以在其中提问、探索
信息、执行例程，并通过后续跟进持续推进工作。在这个示例中，
它记录了咖啡馆的调研和发布计划。
...
**项目**是用于开展大型构建和设计工作的持久化、结构化空间。在本教程中，你将在这里创建并完善落地页。
...
| 领域   | Conversation                   | 项目                    |
| ---- | -------------------- | --------------------- |
| 最适合  | 探索想法、研究竞争对手并进行每周市场监测 | 设计和构建上线网站             |
| 结构   | 一个包含研究、决策和后续事项的线程    | 用于网站、其设计和其他构建产物的结构化空间 |
| 例程 | 创建和管理定期调研            | 使用回传到 Conversation 中的结果           |
| 上下文  | 保留带你走到这一步的发布计划       | 基于你在 Conversation 中确定的方向开始        |

想要提问或探索时，请从 Conversation 开始。准备好构建后，再转到
项目。切换后会保留你已经确定的
方向。
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/pt/chat/conversations">
  ...
  <a className="chat-example has-visual" href="/zh/pt/features/projects-and-artifacts/projects">
    ...
    <div className="chat-example-tag">构建与组织</div>
    <div className="chat-card-title">项目</div>

    <p>
      了解项目如何组织包含多个产物的大型构建和
      设计工作。
    </p>
...
<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/zh/pt/home/design-an-opening-site">
    <div className="chat-use-case-visual">
    ...
    <div className="chat-card-title">设计开业网站</div>
    <p>使用 Conversation 和发布计划，为你的咖啡馆创建网站。</p>
