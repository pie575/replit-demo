---
title: "Trabalhar com o Figma"
description: "Use um frame do Figma como contexto visual e depois siga o fluxo de importação do Replit Design quando quiser explorar, refinar ou construir a partir dele."
sidebarTitle: "Trabalhar com o Figma"
icon: "figma"
...
O Replit oferece suporte à importação de frames do Figma.

Importe um frame do Figma quando você já tiver uma direção visual e quiser que o Replit comece a partir desse trabalho ou o transforme em um design.

## Quando o Figma ajuda

* **Explorar outra direção:** Mantenha a hierarquia principal enquanto experimenta um estilo ou layout diferente.
* **Continuar um fluxo de produto:** Use uma tela existente como contexto para a próxima tela ou estado.
* **Avançar do design para um app:** Comece a partir de uma direção visual aprovada e depois refine e construa a partir dela.

## Importar um frame do Figma

Escolha o frame que representa o trabalho que você quer continuar. O Replit Design transforma o frame importado em um frame de design, onde você pode explorar mudanças, comparar sugestões e decidir o que construir a seguir.

<Frame caption="Um frame do Figma importado como um frame de design no Replit Design.">
  <img src="/assets/mirror/figma-import-result-052394025b8d.webp" alt="Landing page do Personal Fitness Trainer importada como um frame de design no Replit Design" width="3440" height="2160" data-path="images/fitstart/turn-mockup-into-app/figma-import-result.webp" />
</Frame>

## Continue no Design

O guia de Design cobre o fluxo completo de importação, refinamento e construção.

<section className="chat-mkt chat-workflow-grid has-visuals">
  <a className="chat-example has-visual" href="/pt/design/import-figma-designs-into-replit-design">
    ...
    <div className="chat-card-title">Importar do Figma</div>
    <p>Siga o fluxo completo para importar e refinar um frame do Figma.</p>
