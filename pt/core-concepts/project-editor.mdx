...
description: "Saiba o que é o Editor de Projetos: sua base no Replit onde você conversa com o Agent, acompanha o desenvolvimento do seu app e gerencia tudo."
---
...
<Frame>
  <img src="/assets/mirror/workspace-home-e7642fab34cb.png" alt="A tela inicial do Editor de Projetos do Replit mostrando o campo de prompt onde você descreve o que quer criar" width="3456" height="1994" data-path="images/workspace/workspace-home.png" />
</Frame>

## O que é o Editor de Projetos?

O Editor de Projetos é sua base no Replit: o ambiente onde você começa a criar, gerencia seus projetos e vê seus apps ganharem vida. A partir daqui, você pode descrever o que quer criar e o [Agent](/pt/core-concepts/agent) cuida do resto, escrevendo código, configurando seu projeto e mostrando uma prévia ao vivo em tempo real.

## Primeiros passos

Digite o que você quer criar na caixa de prompt. Descreva sua ideia em linguagem simples — "um rastreador de orçamento que exibe meus gastos em gráficos", "uma landing page para minha cafeteria", "um gerador de histórias em quadrinhos com IA para crianças" — e o Agent cuida do resto.

<AgentInput />

Você também pode selecionar um tipo de projeto no carrossel para indicar ao Agent que tipo de resultado você quer — app web, app móvel, apresentações, design e muito mais. Ou pule a seleção e apenas descreva sua ideia; o Agent descobre a configuração certa automaticamente.

<AgentCarousel />

Para começar imediatamente, siga o [quickstart Criar com IA](/pt/getting-started/quickstarts/ask-ai/).

## Modo Plan

O modo Plan permite que você faça brainstorming, tire dúvidas e planeje seu projeto. O Agent cria uma lista de tarefas ordenada que você pode revisar e refinar — quando estiver satisfeito com o plano, aprove-o e o Agent começa a construir. Você também pode usar o modo Plan para fazer perguntas ou explorar ideias; o Agent não fará nenhuma alteração até que você saia.

<AgentInput highlightPlan={true} showTypewriter={false} />

Ative o modo Plan pelo botão na parte inferior do campo de entrada. Saiba mais no [guia do modo Plan](/pt/core-concepts/agent/plan-mode).

## O que você pode criar

Selecione um tipo de projeto para indicar ao Agent o que você quer, ou apenas descreva sua ideia e deixe o Agent escolher a configuração certa.

* **Apps web** — Dashboards, ferramentas internas, produtos SaaS, landing pages
* **Apps móveis** — Apps para iOS e Android a partir de um único prompt
* **Apresentações e slides** — Gere decks com layouts ricos
* **Animações** — Tutoriais interativos e motion graphics
* **Designs** — Mockups visuais e protótipos no [Design Canvas](/pt/replitai/canvas)
* **Visualizações de dados** — Gráficos, dashboards e ferramentas com banco de dados
* **Documentos** — Arquivos CSV, PDF, PowerPoint e docs Markdown
* **Planilhas** — Tabelas de dados e saídas estruturadas

## O Editor de Projetos

Assim que o Agent começa a construir, o Editor de Projetos é onde você acompanha o desenvolvimento do seu projeto. Ele é dividido em painéis: sua conversa com o Agent de um lado e uma prévia ao vivo do seu app do outro.

### Threads

Cada conversa com o Agent acontece em uma thread. Sua thread principal é onde você descreve o que quer e acompanha o Agent construindo. Quando você usa o [sistema de tarefas](/pt/core-concepts/agent/task-system), cada tarefa em segundo plano tem sua própria thread — assim o Agent mantém o trabalho das tarefas isolado sem misturar as conversas.

<Frame>
  <img src="/assets/mirror/task-describe-idea-555338f515fd.png" alt="Uma thread mostrando o prompt do usuário e o Agent construindo o projeto" width="3430" height="1986" data-path="images/replitai/task-describe-idea.png" />
</Frame>

### Quadro de tarefas

O quadro de tarefas organiza seu trabalho em colunas — **Rascunhos**, **Ativo**, **Pronto** e **Concluído**. Cada tarefa avança da esquerda para a direita conforme progride, para que você possa ver de relance o que está planejado, no que o Agent está trabalhando e o que foi concluído. Saiba mais em [Construir em paralelo](/pt/core-concepts/agent/task-system).

<Frame>
  <img src="/assets/mirror/task-board-active-355ecd390c49.png" alt="Quadro de tarefas mostrando tarefas organizadas nas colunas Rascunhos, Ativo, Pronto e Concluído" width="3430" height="1986" data-path="images/replitai/task-board-active.png" />
</Frame>

### Design Canvas

O Design Canvas é um editor visual onde você pode criar e refinar mockups antes de se comprometer com o código. Arraste elementos, ajuste layouts e itere no seu design — depois deixe o Agent transformá-lo em um app funcional. Saiba mais em [Design Canvas](/pt/replitai/canvas).

## Colaboração

Crie um Workspace de Equipe para construir junto. Convide membros da equipe, compartilhe projetos e trabalhe no mesmo app em tempo real. Veja [Workspaces de Equipe](/pt/core-concepts/workspaces/team-workspaces) para configuração de equipe e [Convidar membros da equipe](/pt/replitai/invite-teammates) para colaboração no nível do projeto.

## Importar código e design

Já tem um projeto? Traga-o para o Replit a partir do GitHub, Figma ou faça upload de arquivos diretamente. O Agent pode continuar de onde você parou e seguir construindo a partir do seu código ou design existente. Veja [Importar para o Replit](/pt/core-concepts/project-editor/app-setup/import).

## Próximos passos

<CardGroup cols={2}>
  <Card title="Editor e ferramentas" href="/pt/core-concepts/project-editor/editor-and-tools" icon="window-restore">
    Os painéis principais onde você vê a prévia do seu app, a saída do console e outras ferramentas
  </Card>

  <Card title="Configuração do app" href="/pt/core-concepts/project-editor/app-setup/configuration" icon="gear">
    Configure as definições, dependências, Secrets e ambiente do seu app
  </Card>

  <Card title="Controle de versão" href="/pt/core-concepts/project-editor/version-control" icon="clock-rotate-left">
    Acompanhe alterações, reverta para versões anteriores e gerencie o histórico do seu app
  </Card>

  <Card title="Publicação" href="/category/replit-deployments" icon="rocket">
    Implante seu app em uma URL pública para que qualquer pessoa possa usá-lo
  </Card>
</CardGroup>
...
<Accordion title="Preciso saber programar?">
  Não. Descreva o que você quer em linguagem simples e o Agent cuida dos detalhes técnicos. Você também pode fazer edições diretas se quiser.
</Accordion>

<Accordion title="O que acontece quando fecho o navegador?">
  Seu projeto é salvo na nuvem. Volte a qualquer momento e continue de onde parou: seus arquivos, histórico e app em execução estão todos preservados.
</Accordion>

<Accordion title="Posso trabalhar com outras pessoas?">
  Sim. Você pode convidar colaboradores para um projeto específico ou criar um Workspace de Equipe onde os membros acessam todos os projetos. Veja [Workspaces de Equipe](/pt/core-concepts/workspaces/team-workspaces) e [Convidar membros da equipe](/pt/replitai/invite-teammates).
</Accordion>

<Accordion title="Como publico meu app?">
  Quando seu app estiver pronto, implante-o em uma URL pública diretamente do Editor de Projetos. Veja [Deployments](/category/replit-deployments).
</Accordion>

## Disponibilidade

O Editor de Projetos está disponível em todos os planos. Alguns recursos, como computação aumentada e implantações sempre ativas, exigem um plano pago. Veja [Cobrança](/pt/billing/ai-billing) para mais detalhes.
