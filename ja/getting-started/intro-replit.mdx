---
title: "概要"
description: "Replitはアイデアをアプリにする最速の方法です。AIを活用しながら、ブラウザから美しいプロジェクトをビルドして公開できます。"
---
...
<YouTubeEmbed videoId="-2xHmkpmCBM" title="Replit 概要" />

ReplitはAIを搭載したプラットフォームで、1つのブラウザタブからアプリを作成・公開できます。
複雑な開発環境の設定に悩む必要はなく、コーディング・公開・コラボレーションのツールが1つの統合インターフェースに揃っています。

従来のアプリ開発では、プログラム・言語・パッケージのインストールが必要で、セットアップに多くの時間がかかります。
Replitではプラットフォームが環境を即座に構成するため、初心者でも経験豊富な開発者でもすぐにビルドを始めることができます。

<div align="center">
  <AgentInput />
</div>

1つのブラウザタブから、インストール不要でアプリを作成するために必要なすべてのツールが揃っています。
AIコーディングツール、リアルタイムコラボレーション、即時共有機能により、Replitはアイデアをアプリへすばやくつなげます。

## クイックスタートガイド

Replitでアプリを作成するには、ニーズに合ったガイドを選んでください：

### 新しいアプリを作成する

<CardGroup cols={2}>
  <Card title="はじめてのアプリを作る" icon="robot" href="/getting-started/quickstarts/ask-ai/">
    ⏱️ *5分*

    AIを活用したReplitツールではじめてのアプリを作成します。
  </Card>

  <Card title="既存のアプリをリミックスする" icon="shuffle" href="/getting-started/quickstarts/remix-an-app/">
    ⏱️ *1分*

    コミュニティが提供するアプリをベースにプロジェクトをすぐに始めましょう。
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="GitHubからインポート" icon="github" href="/getting-started/quickstarts/import-from-github/">
    ⏱️ *2分*

    既存のGitHubリポジトリをReplitにインポートします。
  </Card>

  <Card title="Figmaからインポート" icon="figma" href="/getting-started/quickstarts/import-from-figma/">
    ⏱️ *3分*

    FigmaのデザインをReactアプリケーションに変換します。
  </Card>

  <Card title="Boltからインポート" icon="bolt" href="/getting-started/quickstarts/import-from-bolt/">
    ⏱️ *4分*

    AgentのサポートでBoltプロジェクトをReplitに移行します。
  </Card>

  <Card title="Lovableからインポート" icon="heart" href="/getting-started/quickstarts/import-from-lovable/">
    ⏱️ *4分*

    LovableプロジェクトをReplitに移して、開発を続けましょう。
  </Card>
</CardGroup>

### ワークスペース機能

Replitは以下の主要なアプリ作成ツールを提供しています：

* アプリの[リアルタイムプレビュー](/core-concepts/workspace/editor-and-tools/preview)
* [数分で公開](/category/replit-deployments)
* インストールや設定が不要なブラウザネイティブアプリ
* [フル機能のコードエディタ](/core-concepts/workspace/editor-and-tools)
* スマートフォンやタブレットからアプリを作成できる[モバイルアプリ](/platforms/mobile-app)
* [AIによるアプリ作成支援](/core-concepts/agent)
* 変更を追跡する[バージョン管理連携](/core-concepts/workspace/version-control)
* 共同開発のための[チームコラボレーション](/ja/category/teams)

### AIコンパニオンの機能

Replitの[Agent](/core-concepts/agent)は以下の機能でアプリ作成を加速します：

* 自然言語の説明からの完全なアプリ生成とセットアップ
* コードの提案と自動補完
* 自動エラー検出とデバッグ支援
* アプリのドキュメント生成
...
以下のツールを使って数分でアプリを公開できます：

* 数クリックでクラウドへアプリを公開
* データベース連携とホスティング
* カスタムドメインのサポートとアプリケーションの接続暗号化

## 信頼の基盤

<CardGroup cols={3}>
  <Card title="SOC 2 Type 2" icon="shield-check">
    独立した監査によるセキュリティ管理とデータ保護の実践。
  </Card>

  <Card title="GDPR準拠" icon="lock">
    欧州の規制基準を満たすデータプライバシー保護。
  </Card>

  <Card title="エンタープライズ対応" icon="building" href="/ja/category/teams">
    SSO/SAML、ロールベースアクセス、管理者コントロール、専任サポート。
  </Card>
</CardGroup>

## 追加情報

Replitのすべての機能については、以下のリソースをご覧ください：

* [スタータープラン](/ja/billing/plans/starter-plan)：スタータープランの機能と無料で作成できるものを確認する
* [ワークスペース機能](/core-concepts/workspace/editor-and-tools)からワークスペース機能について学ぶ。
* [Replit Agent](/core-concepts/agent/)からReplitのAI搭載機能について学ぶ。
* [Replitアプリの共有](/replit-app/collaborate/)から作成物の共有方法を学ぶ。
* iOSまたはAndroidデバイス向けに[モバイルアプリをダウンロード](https://replit.com/mobile/)する。
