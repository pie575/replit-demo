---
title: "Build Data Apps on Microsoft Fabric"
description: "Build and publish data apps on Microsoft Fabric with Replit Agent."
...
<Steps>
  <Step title="Start from the Fabric template">
    ...
    <Frame caption="Selecting the Microsoft Fabric App org template on the Replit home page (private-preview UI).">
      <img src="/assets/mirror/fabric-template-selector-d3f975e2e1d0.png" alt="Replit home page with the Templates dropdown open, showing Microsoft Fabric App highlighted under Org templates" width="872" height="406" data-path="images/connectors/microsoft-fabric/fabric-template-selector.png" />
    </Frame>
  </Step>
  ...
  <Step title="Add your data sources">
    ...
    <Frame caption="Agent asking for the Power BI / Fabric semantic model link (private-preview UI).">
      <img src="/assets/mirror/fabric-agent-semantic-model-prompt-732ce9c4a29d.png" alt="Agent panel asking the builder to share the Power BI or Fabric semantic model, either as a full Fabric portal URL or a workspace ID plus dataset or item ID, noting that local .pbix files cannot be used because the model must be published to the Power BI service" width="1316" height="650" data-path="images/connectors/microsoft-fabric/fabric-agent-semantic-model-prompt.png" />
    </Frame>
  </Step>

  <Step title="Let Agent build and iterate">
...
<AccordionGroup>
  <Accordion title="Data does not load in the app preview">
  ...
  <Accordion title="Agent cannot find your semantic model">
  ...
  <Accordion title="The connector is stuck or repeatedly prompts to connect">
