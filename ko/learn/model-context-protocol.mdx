...
description: "Model Context Protocol(MCP)이 무엇인지, 어떻게 작동하는지, AI 애플리케이션에 왜 중요한지 알아보세요."
...
<Frame>
  <img src="/assets/mirror/mcp-a04e01a01743.avif" alt="MCP diagram showing AI models connecting to external tools and data sources" width="1920" height="1055" data-path="images/tutorials/mcp.avif" />
</Frame>
...
스킬에 대한 사고 방식은 [Agent 스킬](/ko/learn/agent-skills)을 참조하세요.
...
<CardGroup cols={2}>
  <Card title="MCP로 연결하기" icon="server" href="/ko/build/connect-via-mcp">
  ...
  <Card title="Agent 스킬" icon="puzzle-piece" href="/ko/learn/agent-skills">
